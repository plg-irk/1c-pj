...
Версия формата: `2.20` (платформа 8.3.27; была 2.17 на 8.3.17–8.3.24).

> **Обновлено 2026-02-28:** Версия формата актуализирована до 2.20/8.3.27. Основные паттерны совместимы с 8.3.24. Для специфических атрибутов 8.3.27 — grep по XML-выгрузке реальной конфигурации.
