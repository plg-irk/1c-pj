...
name: img-grid
description: >
  Этот скилл MUST быть вызван когда нужно наложить пронумерованную сетку на изображение для определения пропорций колонок макета.
  SHOULD также вызывать при проектировании формы на основе изображения-прототипа.
  Do NOT использовать для других задач анализа изображений.
