...
name: db-load-git
description: >
  Этот скилл MUST быть вызван когда пользователь просит загрузить изменения из гита, обновить базу из репозитория, partial load из коммита.
  SHOULD также вызывать после git-коммитов для синхронизации изменений с базой.
  Do NOT использовать для полной загрузки конфигурации из XML — используй db-load-xml; для загрузки CF — используй db-load-cf.
