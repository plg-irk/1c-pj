...
name: form-compile
description: >
  Этот скилл MUST быть вызван когда нужно создать управляемую форму с нуля по JSON-определению элементов.
  SHOULD также вызывать когда структура формы хорошо определена и требует генерации.
  Do NOT использовать для модификации существующей формы — используй form-edit; для добавления формы-заглушки — используй form-add.
