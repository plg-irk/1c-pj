...
name: help-add
description: >
  Этот скилл MUST быть вызван когда нужно добавить встроенную справку к объекту 1С: обработка, отчёт, справочник, документ.
  SHOULD также вызывать когда документация объекта должна быть встроена в конфигурацию.
  Do NOT использовать для создания внешней документации или README.
