...
name: web-info
description: >
  Этот скилл MUST быть вызван когда пользователь спрашивает про статус веб-сервера, опубликованные базы, работает ли Apache, какие ошибки.
  SHOULD также вызывать перед web-publish для проверки текущего состояния.
  Do NOT использовать для публикации — используй web-publish; для остановки Apache — используй web-stop.
argument-hint: ""
allowed-tools:
  - Bash
  - Read
