...
description: >
  ...
  SHOULD также вызывать после db-load-xml или db-load-cf для применения изменений к базе данных.
  Do NOT использовать для загрузки конфигурации — используй db-load-xml или db-load-cf; для запуска — используй db-run.
