...
name: meta-compile
description: >
  Этот скилл MUST быть вызван когда пользователь просит добавить или создать объект конфигурации: справочник, документ, регистр, перечисление, константа, общий модуль, обработка, HTTP-сервис.
  SHOULD также вызывать для создания любого нового объекта метаданных 1С.
  Do NOT использовать для модификации существующего объекта — используй meta-edit; для изменений на уровне конфигурации — используй cf-edit.
