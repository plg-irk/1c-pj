...
name: form-edit
description: >
  Этот скилл MUST быть вызван когда нужно точечно добавить или изменить элементы, реквизиты и команды в существующей управляемой форме.
  SHOULD также вызывать для инкрементальных изменений готовой формы.
  Do NOT использовать для создания формы с нуля — используй form-compile; для анализа формы — используй form-info.
