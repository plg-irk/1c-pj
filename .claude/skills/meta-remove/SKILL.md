...
name: meta-remove
description: >
  Этот скилл MUST быть вызван когда пользователь просит удалить, убрать объект из конфигурации 1С.
  SHOULD также вызывать при очистке неиспользуемых объектов конфигурации.
  Do NOT использовать для модификации объекта — используй meta-edit; для удаления формы — используй form-remove.
