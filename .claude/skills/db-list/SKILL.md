...
description: >
  ...
  SHOULD также вызывать в начале сессии для получения списка доступных баз.
  Do NOT использовать для создания новой базы — используй db-create; для запуска базы — используй db-run.
