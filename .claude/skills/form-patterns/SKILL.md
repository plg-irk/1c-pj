...
name: form-patterns
description: >
  Этот скилл MUST быть вызван как справочник паттернов компоновки управляемых форм 1С: архетипы, конвенции, продвинутые приёмы.
  SHOULD также вызывать перед проектированием форм через form-compile когда расположение элементов не уточнено.
  Do NOT использовать для создания формы — используй form-compile; для модификации — используй form-edit.
