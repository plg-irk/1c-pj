...
description: >
  Этот скилл MUST быть вызван когда нужно перехватить метод заимствованного объекта в расширении: вставить код до, после или вместо оригинального.
  SHOULD также вызывать после cfe-borrow когда требуется изменение метода.
  Do NOT использовать для заимствования объектов — используй cfe-borrow; для создания расширения — используй cfe-init.
