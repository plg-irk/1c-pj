...
Функция ПечатьКорректировкаЗаказаПоставщику(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Документ Из МассивОбъектов Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.КорректировкаЗаказаПоставщику.ПФ_MXL_КорректировкаЗаказаПоставщику");
...
Процедура ДобавитьКомандыЗаполнения(КомандыЗаполнения) Экспорт
	...
	ЗаполнениеДокументовСервер.ДобавитьКоманду(КомандыЗаполнения, "ТоварыЗаполнитьПоЗаказу",, "Товары", НСтр("ru = 'Заполнить по заказу поставщика'"));
