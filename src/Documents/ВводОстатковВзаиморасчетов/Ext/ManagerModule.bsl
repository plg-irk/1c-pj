...
Функция ПечатьОстаткиВзаимозачетов(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Документ Из МассивОбъектов Цикл
		...
		СтруктураИтоговПоСтранице = Новый Структура("ВалютаДокумента,СуммаДебет, СуммаКредит", Документ.ВалютаДокумента,0,0);
		...
		// сумма прописью
		ОбластьПодвал.Параметры.ИтогоСуммаДебетПрописью = РаботаСКурсамиВалют.СформироватьСуммуПрописью(ИтогоСуммаДебет,Документ.ВалютаДокумента);
		ОбластьПодвал.Параметры.ИтогоСуммаКредитПрописью = РаботаСКурсамиВалют.СформироватьСуммуПрописью(ИтогоСуммаКредит,Документ.ВалютаДокумента);
