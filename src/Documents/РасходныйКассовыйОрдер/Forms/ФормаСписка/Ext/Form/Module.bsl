// Модуль формы списка документа "Расходный кассовый ордер"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Список.ПодчиненныеЭлементы.Пробит.Видимость = Константы.ИспользоватьПодключаемоеОборудование.Получить();
