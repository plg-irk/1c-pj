// Модуль формы списка документа "Поступление товаров"
...
Процедура ОбработкаКомандыФормыНаСервере(ИмяКоманды, ПараметрыДействия=Неопределено)
	...
	//Если ИмяКоманды="ДопДанные" Тогда

	//	ИмяФайла=""; ТипДанных="";
	//	ДД = ТорговыйКомплекс.ПрочитатьДополнительныеДанные(Элементы.Список.ТекущаяСтрока.Ссылка, ИмяФайла, ТипДанных);
	//	
	//	ПараметрыДействия.Вставить("ДвоичныеДанные", ДД);
	//	ПараметрыДействия.Вставить("ИмяФайла", ИмяФайла);
	//КонецЕсли;
...
Процедура Подключаемый_ОбработкаКомандыФормы(Команда) Экспорт
	...
	//Если Команда.Имя="ДопДанные" Тогда
	//	ПараметрыДействия.Вставить("Результат", Истина);
	//КонецЕсли;
	...
	//	ПараметрыДействия.Свойство("ИмяФайла", ИмяФайла);
	//	ПараметрыДействия.Свойство("ДвоичныеДанные", ДвоичныеДанные);
	//	
	//	Диалог = Новый ДиалогВыбораФайла(РежимДиалогаВыбораФайла.Сохранение);
	//	Диалог.Заголовок = "Имя файла для сохранения ...";
	//	Диалог.ПолноеИмяФайла = ИмяФайла;
	//	Диалог.Фильтр = "MS Excel (*.xls;*.xlsx)|*.xls;*.xlsx";
...
Процедура СписокПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	...
	Для Каждого Строка Из Строки Цикл
		Попытка
			Строка.Значение.Данные.ГруппыПоставки = СтрСоединить(Строка.Ключ.ГруппыПоставки.ВыгрузитьКолонку("ГруппаПоставки"), ", ");
		Исключение
			Прервать;
		КонецПопытки;
	КонецЦикла;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ЗащищенныеФункцииСервер.ДобавитьКоманду(ЭтаФорма, "ДопДанные", "ОсновныеДействия", БиблиотекаКартинок.СохранитьФайлКак, НСтр("ru = 'Сохранить доп.данные'"), НСтр("ru = 'Сохранить доп.данные в файл'"), ЛОЖЬ,,, ОтображениеКнопки.КартинкаИТекст);
