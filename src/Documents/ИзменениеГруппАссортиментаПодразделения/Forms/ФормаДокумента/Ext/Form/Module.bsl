// Модуль основной формы документа "Изменение групп ассортимента подразделения"
...
Процедура ДатаПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ИзменениеГруппАссортиментаПодразделения.ДатаПриИзменении(Объект, ПараметрыДействия);
	// Обновляем отображение элементов формы
	УправлениеДиалогомНаСервере();
...
Процедура ХозОперацияПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.ИзменениеГруппАссортиментаПодразделения.ХозОперацияПриИзменении(Объект, ПараметрыДействия);
...
///////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ПОЛЕЙ ТАБЛИЦЫ ФОРМЫ "ГруппыАссортимента"


////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ "ГруппыАссортимента"
...
Процедура ДеревоПодразделенийПометкаПриИзменении(Элемент)
	...
	//Иначе
		...
		Если Пометка Тогда
			Элементы.ДеревоПодразделений.Развернуть(ТекущиеДанные.ПолучитьИдентификатор());
		КонецЕсли;
		УправлениеДиалогомКлиент.ДеревоПодразделенийУстановитьФлажкиРекурсивно(ТекущиеДанные.ПолучитьЭлементы(), Пометка, Объект.Подразделения);
	//КонецЕсли;
