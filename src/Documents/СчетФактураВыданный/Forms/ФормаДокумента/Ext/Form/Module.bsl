...
//
&НаСервере
Процедура УправлениеДиалогомНаСервере() Экспорт
...
Процедура БлокироватьЭлементыФормы()
	...
	ВводНаОсновании = ЗначениеЗаполнено(Объект.ДокументОснование);
	СписокРеквизитов.Добавить("Товары"                                      ,"Товары"                                      ,ВводНаОсновании);
	...
	СписокРеквизитов.Добавить("ДокументОснование"                           ,"ДокументОснование"                           ,ВводНаОсновании);
	СписокРеквизитов.Добавить("ПараметрыДокумента"                          ,"ПараметрыДокумента"                          ,ВводНаОсновании);
	СписокРеквизитов.Добавить("Грузополучатель"                             ,"Грузополучатель"                             ,ВводНаОсновании);
	СписокРеквизитов.Добавить("СчетФактураНеВыставляется"                   ,"СчетФактураНеВыставляется"                   ,ВводНаОсновании);
	СписокРеквизитов.Добавить("Выставлен"                                   ,"Выставлен"                                   ,ВводНаОсновании);
	СписокРеквизитов.Добавить("УчитыватьИсправлениеИсходногоДокумента"      ,"УчитыватьИсправлениеИсходногоДокумента"      ,ВводНаОсновании);
	СписокРеквизитов.Добавить("Исправление"                                 ,"Исправление"                                 ,ВводНаОсновании);
	СписокРеквизитов.Добавить("НомерИсправления"                            ,"НомерИсправления"                            ,ВводНаОсновании);
	СписокРеквизитов.Добавить("НомерИсправляемогоКорректировочногоДокумента","НомерИсправляемогоКорректировочногоДокумента",ВводНаОсновании);
	СписокРеквизитов.Добавить("ДатаИсправляемогоКорректировочногоДокумента" ,"ДатаИсправляемогоКорректировочногоДокумента" ,ВводНаОсновании);
	СписокРеквизитов.Добавить("НомерИсправленияИсходногоДокумента"          ,"НомерИсправленияИсходногоДокумента"          ,ВводНаОсновании);
	СписокРеквизитов.Добавить("ДатаИсправленияИсходногоДокумента"           ,"ДатаИсправленияИсходногоДокумента"           ,ВводНаОсновании);
	СписокРеквизитов.Добавить("НомерИсходногоДокумента"                     ,"НомерИсходногоДокумента"                     ,ВводНаОсновании);
	СписокРеквизитов.Добавить("ДатаИсходногоДокумента"                      ,"ДатаИсходногоДокумента"                      ,ВводНаОсновании);
	СписокРеквизитов.Добавить("ДатаВыставления"                             ,"ДатаВыставления"                             ,ВводНаОсновании);
	СписокРеквизитов.Добавить("КодСпособаВыставления"                       ,"КодСпособаВыставления"                       ,ВводНаОсновании);
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "Счет фактура не выставляется".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
Процедура СчетФактураНеВыставляетсяПриИзменении(Элемент)
	...
	УправлениеДиалогомНаСервере();
КонецПроцедуры // СчетФактураНеВыставляетсяПриИзменении

// Обработчик события возникающего на клиенте при изменении данных реквизита "Выставлен".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
Процедура ВыставленПриИзменении(Элемент)
	...
	УправлениеДиалогомНаСервере();
КонецПроцедуры // ВыставленПриИзменении()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Исправление".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
КонецПроцедуры // ИсправлениеПриИзменении()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Учитывать исправления исходного документа".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
КонецПроцедуры // УчитыватьИсправлениеИсходногоДокументаПриИзменении()
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("ЗаписьСчетФактуры",Новый Структура("Ссылка",Объект.Ссылка),ВладелецФормы);
