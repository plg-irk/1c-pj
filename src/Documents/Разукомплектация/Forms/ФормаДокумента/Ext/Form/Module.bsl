...
// Производит заполнение реквизита "Количество всего" в табличной части.
//
// Параметры:
//  Строка - Строка табличной части для которой необходимо выполнить событие.
//
&НаСервере
...
КонецПроцедуры // ЗаполнитьКоличествоВсего()
...
Процедура КомплектПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// перезаполним колонку "Количество всего"
...
КонецПроцедуры // КоличествоКомплектовПриИзмененииНаСервере()
