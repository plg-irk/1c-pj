...
Процедура УправлениеДиалогомНаСервере()
	...
	РедактированиеЦенИСуммВНоменклатурныхТаблицах = ПравоПользователя("РедактированиеЦенИСуммВНоменклатурныхТаблицах",Объект);
...
КонецПроцедуры // ТоварыПодтверждениеПриИзмененииНаСервере()
...
КонецПроцедуры // ТоварыПодтверждениеПриИзменении()
