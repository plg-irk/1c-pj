...
///////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ПОЛЕЙ ТАБЛИЦЫ ФОРМЫ "ЦЕННЫЕ БУМАГИ"

// Обработчик события возникающего при изменении данных реквизита "Ценная бумага" в контексте сервера.
//
// Параметры:
//  ПараметрыДействия - Структура - Набор параметров, использующихся при выполнения операции.
//
...
КонецПроцедуры // ЦенныеБумагиЦеннаяБумагаПриИзмененииНаСервере()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Ценная бумага".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
КонецПроцедуры // ЦенныеБумагиКоличествоПриИзмененииНаСервере()
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ "ЦЕННЫЕ БУМАГИ"
...
КонецПроцедуры // ЦенныеБумагиПриОкончанииРедактирования()
...
КонецПроцедуры // ЦенныеБумагиПослеУдаленияНаСервере()
...
КонецПроцедуры // ЦенныеБумагиПослеУдаления()
