// Модуль основной формы документа "Списание активов"
...
Процедура ДатаПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.СписаниеАктивов.ДатаПриИзменении(Объект, ПараметрыДействия);
...
Процедура ХозОперацияПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.СписаниеАктивов.ХозОперацияПриИзменении(Объект, ПараметрыДействия);
...
Процедура АктивыПрочийАктивПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.СписаниеАктивов.АктивыПрочийАктивПриИзменении(Объект, ТекущиеДанные, ПараметрыДействия);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Перезаполним количество активов
	Для каждого ТекущаяСтрока Из Объект.Активы Цикл
		
		Количество = ТекущаяСтрока.Количество;
		
		// Обнулим количество для получения остатка
		ТекущаяСтрока.Количество = 0;
		
		// Заполним служебные реквизиты табличной части "Активы"
		ОбработкаТабличнойЧастиАктивы.ЗаполнитьСлужебныеРеквизиты(Объект,ТекущаяСтрока);
		
		Если НЕ ТекущаяСтрока.Количество = 0 И Количество < ТекущаяСтрока.Количество Тогда
	...
	МассивПустогоКоличества = Объект.Активы.НайтиСтроки(СтруктураПоиска);
	
	Для Каждого Строка Из МассивПустогоКоличества Цикл
		Объект.Активы.Удалить(Строка);
	КонецЦикла;
