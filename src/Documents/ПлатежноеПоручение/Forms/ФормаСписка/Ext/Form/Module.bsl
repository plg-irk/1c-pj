...
// Процедура для установки отбора 
//
&НаСервере
Процедура УстановитьОтбор()
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "Дата", ЭтотОбъект.Параметры.ДатаДокумента - (3*60*60*24), ВидСравненияКомпоновкиДанных.Больше);
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "Дата", ЭтотОбъект.Параметры.ДатаДокумента, ВидСравненияКомпоновкиДанных.Меньше);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Установим отбор по дате из параметров формы
