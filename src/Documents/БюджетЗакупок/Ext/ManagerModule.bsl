...
Процедура ДобавитьКомандыЗаполнения(КомандыЗаполнения) Экспорт
	...
	ПоследовательныеОперации.ДобавитьВыборСсылки(ПараметрыКоманды, "РезультатВыбора", "Документ.БюджетЗакупок.Форма.ФормаДляЗаполненияПростымСпособом", ПараметрыФормы,, ИСТИНА);
	...
	ПараметрыКоманды = Новый Структура();
	ПоследовательныеОперации.ДобавитьВыборСсылки(ПараметрыКоманды, "РезультатВыбора", "Документ.БюджетЗакупок.Форма.ФормаДляЗаполненияМатМетодами", ПараметрыФормы,, ИСТИНА);
	...
	ПараметрыКоманды = Новый Структура();
	ПоследовательныеОперации.ДобавитьВыборСсылки(ПараметрыКоманды, "РезультатВыбора", "Документ.БюджетЗакупок.Форма.ФормаДляЗаполненияПоДокументуОснованию", ПараметрыФормы,, ИСТИНА);
