...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ДатаНачала > ДатаКонца Тогда
		ВывестиСообщение(НСтр("ru = 'Дата начала периода планирования должна быть меньше, чем дата конца'"), ЭтотОбъект,,,Отказ);
	КонецЕсли;
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ИначеЕсли ХозОперация.Наименование = "Факт" Тогда
		...
		#КонецЕсли
	Иначе
		ВывестиСообщение(НСтр("ru = 'Ошибка. Неверная хозяйственная операция.'"),ЭтотОбъект,,,Отказ);
	КонецЕсли;
