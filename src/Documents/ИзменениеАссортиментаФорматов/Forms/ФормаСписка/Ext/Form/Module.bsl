// Модуль формы списка документа "Изменение содержания групп ассортимента"
...
Процедура СписокПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	...
	Для Каждого Строка Из Строки Цикл
		Строка.Значение.Данные.Форматы = СтрСоединить(Строка.Ключ.Форматы.ВыгрузитьКолонку("Формат"), ", ");
	КонецЦикла;
