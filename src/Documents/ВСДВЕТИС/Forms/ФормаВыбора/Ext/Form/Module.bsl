...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Отправитель") Тогда
		Отправитель = Параметры.Отбор.Отправитель;
		Параметры.Отбор.Удалить("Отправитель");
	КонецЕсли;
	
	Если Параметры.Отбор.Свойство("ПредприятиеОтправитель") Тогда
		ПредприятиеОтправитель = Параметры.Отбор.ПредприятиеОтправитель;
		Параметры.Отбор.Удалить("ПредприятиеОтправитель");
	КонецЕсли;
	
	Если Параметры.Отбор.Свойство("Получатель") Тогда
		Получатель = Параметры.Отбор.Получатель;
		Параметры.Отбор.Удалить("Получатель");
	КонецЕсли;
	
	Если Параметры.Отбор.Свойство("ПредприятиеПолучатель") Тогда
		ПредприятиеПолучатель = Параметры.Отбор.ПредприятиеПолучатель;
		Параметры.Отбор.Удалить("ПредприятиеПолучатель");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(Номенклатура) Тогда
		...
		Если МассивПродукции.Количество() = 0 Тогда
			ОбщегоНаЗначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Продукция", Отправитель, ВидСравненияКомпоновкиДанных.Равно,, Ложь,РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
		Иначе
			СписокПродукции = Новый СписокЗначений;
			СписокПродукции.ЗагрузитьЗначения(МассивПродукции);
			ОбщегоНаЗначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Продукция", СписокПродукции, ВидСравненияКомпоновкиДанных.ВСписке,, Истина,РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
		КонецЕсли;
	Иначе
		ОбщегоНаЗначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Продукция", Отправитель, ВидСравненияКомпоновкиДанных.Равно,, Ложь,РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
	КонецЕсли;
