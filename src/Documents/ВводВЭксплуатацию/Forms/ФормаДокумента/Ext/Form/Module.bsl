...
// Обработчик события возникающего при изменении данных реквизита "Актив" в контексте сервера.
//
// Параметры:
//  ПараметрыДействия - Структура - Набор параметров, использующихся при выполнения операции.
//
...
КонецПроцедуры // ТоварыАктивПриИзмененииНаСервере()
...
КонецПроцедуры // ТоварыТипЭксплуатацииПриИзмененииНаСервере()
