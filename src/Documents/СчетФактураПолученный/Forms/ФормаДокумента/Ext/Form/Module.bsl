...
Процедура БлокироватьЭлементыФормы()
	...
	СписокРеквизитов.Добавить("Грузоотправитель"                            ,"Грузоотправитель"                            ,ВводНаОсновании);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ИзменениеДокументовЗавершенныеСтатусыЭДО 
			И Документы.ПоступлениеТоваров.ДокументВЗавершенномСтатусеЭДО(Объект.ДокументОснование) Тогда
