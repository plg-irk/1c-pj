// Модуль основной формы документа "Ввод остатков прочих активов"
...
Процедура ДатаПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	Документы.ВводОстатковПрочихАктивов.ДатаПриИзменении(Объект, ПараметрыДействия);
...
Процедура ХозОперацияПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.ВводОстатковПрочихАктивов.ХозОперацияПриИзменении(Объект, ПараметрыДействия);
...
Процедура МОЛПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.ВводОстатковПрочихАктивов.МОЛПриИзменении(Объект, ПараметрыДействия);
...
Процедура МОЛПриИзменении(Элемент)
	...
	// Обработаем событие в контексте сервера
	МОЛПриИзмененииНаСервере(ПараметрыДействия);
...
Процедура АктивыПрочийАктивПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.ВводОстатковПрочихАктивов.АктивыПрочийАктивПриИзменении(Объект, ТекущиеДанные, ПараметрыДействия);
...
Процедура АктивыТипЭксплуатацииПриИзмененииНаСервере(ПараметрыДействия = Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.ВводОстатковПрочихАктивов.АктивыТипЭксплуатацииПриИзменении(Объект, ТекущиеДанные, ПараметрыДействия);
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	// Заполним служебные реквизиты табличной части "Активы"
