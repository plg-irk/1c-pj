// Модуль формы списка документа "Изменение цен"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Список.ПодчиненныеЭлементы.ПодразделениеКомпанииПолучатель.Видимость = НЕ ПолучитьЗначениеУчетнойПолитики("НеИспользоватьПодразделениеПриУстановкеЦен",, ТекущаяДата());
