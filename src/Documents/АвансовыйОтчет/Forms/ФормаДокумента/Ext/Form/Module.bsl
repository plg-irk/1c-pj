...
Процедура НастроитьПараметрыВыбораЭлементовФормы()
	...
	// Обновим параметры выбора контрагента
...
///////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ПОЛЕЙ ТАБЛИЦЫ ФОРМЫ "РАСХОДЫ"
...
КонецПроцедуры // РасходыКонтрагентПриИзмененииНаСервере()
...
КонецПроцедуры // РасходыСделкаПриИзмененииНаСервере()
...
///////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ПОЛЕЙ ТАБЛИЦЫ ФОРМЫ "ВЫДАННЫЕ АВАНСЫ"
...
КонецПроцедуры // ВыданныеАвансыДокументОснованиеПриИзмененииНаСервере()
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ "РАСХОДЫ"
...
КонецПроцедуры // РасходыПослеУдаленияНаСервере()
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ "ВЫДАННЫЕ АВАНСЫ"
...
//
&НаКлиенте
Процедура ВыданныеАвансыПередУдалением(Элемент, Отказ)
	
	// Вызываем общий обработчик события
	Зарезервировано = Истина;
	
КонецПроцедуры // ВыданныеАвансыПередУдалением()
...
КонецПроцедуры // ВыданныеАвансыПослеУдаления()

// Обработчик события возникающего на клиенте при окончании редактирования.
//
// Параметры:
// 
&НаКлиенте
...
КонецПроцедуры // ВыданныеАвансыПриОкончанииРедактирования()
