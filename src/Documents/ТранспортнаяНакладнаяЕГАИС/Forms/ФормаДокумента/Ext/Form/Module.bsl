// Модуль основной формы документа "Транспортная накладная ЕГАИС"
...
Процедура ОбновитьСтатусОбработки()
	...
	СтатусОбработки     = СтатусПоУмолчанию.ВидСтатуса;
...
Процедура БлокироватьЭлементыФормы()
	...
	//Сформирован = НЕ (Документы.ТранспортнаяНакладнаяЕГАИС.ВидыСтатусовДвижений().Найти(СтатусОбработки) = Неопределено);
	//ЭлементыФомы = ";СтраницаДополнительно, Шапка";
	//СписокРеквизитов.Добавить("ТранспортныеНакладные", "ТранспортныеНакладные",Сформирован);
...
Процедура ХозОперацияПриИзмененииНаСервере(ПараметрыДействия=Неопределено)
	...
	Документы.ТранспортнаяНакладнаяЕГАИС.ХозОперацияПриИзменении(Объект, ПараметрыДействия);
...
Процедура ДатаПриИзмененииНаСервере(ПараметрыДействия=Неопределено)
	...
	// Вызываем обработчик изменения данных объекта
	Документы.ТранспортнаяНакладнаяЕГАИС.ДатаПриИзменении(Объект, ПараметрыДействия);
...
&НаСервере
Процедура ОрганизацияЕГАИСПриИзмененииНаСервере(ПараметрыДействия=Неопределено)
	
	// Вызываем обработчик изменения данных объекта
	Документы.ТранспортнаяНакладнаяЕГАИС.ОрганизацияЕГАИСПриИзменении(Объект, ПараметрыДействия);
