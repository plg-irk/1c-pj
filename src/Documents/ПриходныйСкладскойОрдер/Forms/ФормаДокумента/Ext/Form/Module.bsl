...
Процедура УправлениеДиалогомНаСервере()
	...
	ОписаниеОснования = "";
	Если ЕстьРеквизит(ЭтотОбъект.Объект.ДокументОснование,"Контрагент") Тогда
		ОписаниеОснования =  ОписаниеОснования + УправлениеПечатьюПлатформа.ПолучитьНаименованиеСправочника(ЭтотОбъект.Объект.ДокументОснование.Контрагент);
	КонецЕсли;
	
	Если НЕ ПустаяСтрока(ОписаниеОснования) И (ЕстьРеквизит(ЭтотОбъект.Объект.ДокументОснование, "ВхДокНомер") И ЕстьРеквизит(ЭтотОбъект.Объект.ДокументОснование,"ВхДокДата")) Тогда
		ОписаниеОснования = ОписаниеОснования + "," + Символы.НПП + НСтр("ru = 'вход. документ №'") + Символы.НПП 
							+ ЭтотОбъект.Объект.ДокументОснование.ВхДокНомер
							+ " от " + Формат(ЭтотОбъект.Объект.ДокументОснование.ВхДокДата,"ДЛФ=D");
	КонецЕсли;
