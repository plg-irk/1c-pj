// Модуль формы списка документа "Бюджет продаж"


////////////////////////////////////////////////////////////////////////////////
// СЛУЖЕБНЫЕ ПРОЦЕДУРЫ И ФУНКЦИИ

// Процедура, которая инициализирует отбор списка для выбора документа основания
//
&НаСервере
Процедура УстановитьОтборПриВыбореДокументаОснования()
	
	Если Параметры.Свойство("ОтборДатаКонца") Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "ДатаПланирования", Параметры.ОтборДатаКонца, ВидСравненияКомпоновкиДанных.МеньшеИлиРавно,, Истина);
	КонецЕсли;
	
	Если Параметры.Свойство("ОтборДокументИсключение") Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "Ссылка", Параметры.ОтборДокументИсключение, ВидСравненияКомпоновкиДанных.НеРавно,, Истина);
	КонецЕсли;
	
	Если Параметры.Свойство("ОтборПоСценариюПланирования") Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "СценарийПланирования", Параметры.ОтборПоСценариюПланирования, ВидСравненияКомпоновкиДанных.ВСписке,, Истина);
	КонецЕсли;
	
	Если Параметры.Свойство("ОтборПоХозОперации") Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "ХозОперация",Параметры.ОтборПоХозОперации, ВидСравненияКомпоновкиДанных.Равно,, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный);
	КонецЕсли;
	
	Если Параметры.Свойство("ОтборПодразделениеКомпании") Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "ПодразделениеКомпании",Параметры.ОтборПодразделениеКомпании, ВидСравненияКомпоновкиДанных.Равно,, Истина);
	КонецЕсли;
	
КонецПроцедуры // УстановитьОтборПриВыбореДокументаОснования()
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// установим отборы по списку для выбора документа основания
	Если Параметры.РежимВыбора Тогда
		УстановитьОтборПриВыбореДокументаОснования();
	КонецЕсли;
