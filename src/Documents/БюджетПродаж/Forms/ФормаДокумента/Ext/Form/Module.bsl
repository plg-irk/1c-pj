	...
	Если ДополнительныеПараметры = "ЗаполнениеПростымСпособом" Тогда
		Если ЗначениеЗаполнено(Результат) Тогда
			Если Элементы.Страницы.ТекущаяСтраница.Заголовок = "Товары" Тогда
				Объект.Товары.Очистить();
				Документы.БюджетПродаж.ЗаполнениеТабличнойЧастиТовары(Объект, Новый Структура("РезультатВыбора",Результат));
			Иначе
				Объект.Услуги.Очистить();
				Документы.БюджетПродаж.ЗаполнениеТабличнойЧастиУслуги(Объект, Новый Структура("РезультатВыбора",Результат));
			КонецЕсли;
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "Планирование себестоимости" в контексте сервера.
//
&НаСервере
...
КонецПроцедуры // ПланированиеСебестоимостиПриИзмененииНаСервере()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Планирование себестоимости".
//
// Параметры:
//  Элемент - ЭлементФормы  - Элемент, в котором возникло данное событие.
//
...
КонецПроцедуры // ПланированиеСебестоимостиПриИзменении()

// Обработчик события возникающего на клиенте при нажатии надписи "Информация о типе цен".
//
// Параметры:
//  Элемент - ЭлементФормы  - Элемент, в котором возникло данное событие.
//
...
// Обработчик события возникающего на клиенте при нажатии надписи "Параметры".
//
// Параметры:
//  Элемент - ЭлементФормы  - Элемент, в котором возникло данное событие.
//
...
// Обработчик события возникающего при изменении данных реквизита "Нормативная цена" в контексте сервера.
//
&НаСервере
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "Нормативная цена".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
// Обработчик события возникающего при изменении данных реквизита "Себестоимость (упр.)" в контексте сервера.
//
&НаСервере
...
КонецПроцедуры // ТоварыСебестоимостьУпрПриИзмененииНаСервере()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Себестоимость (упр.)".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
