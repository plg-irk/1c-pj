...
Функция ПечатьСнятиеРаспределенияЗаказовПокупателя(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Документ Из МассивОбъектов Цикл
		...
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.СнятиеРаспределенияЗаказовПокупателя.ПФ_MXL_СнятиеРаспределенияЗаказовПокупателя");
		...
		ОбластьЗаголовок.Параметры.ПредставлениеПоставщика		 = УправлениеПечатьюПлатформа.ПолучитьПредставлениеСправочника(Документ.Контрагент,,,,Документ.Дата);
		...
		Для каждого СтрокаТЧ Из ВыборкаТабличнойЧасти Цикл
			...
			СтруктураСтроки.Вставить("ЗаказПоставщика", УправлениеПечатьюПлатформа.ПолучитьПредставлениеДокумента(СтрокаТЧ.ЗаказПоставщика));
...
Процедура ДобавитьКомандыЗаполнения(КомандыЗаполнения) Экспорт
	...
	ЗаполнениеДокументовСервер.ДобавитьКоманду(КомандыЗаполнения, "ТоварыЗаполнитьПоОснованию",, "Товары", НСтр("ru = 'Заполнить по основанию'"));
	...
	ЗаполнениеДокументовСервер.ДобавитьКоманду(КомандыЗаполнения, "ТоварыЗаполнитьПоКонтрагенту",, "Товары", НСтр("ru = 'Заполнить по контрагенту'"), ПараметрыКоманды);
...
//
Функция ТоварыЗаполнитьПоКонтрагенту(Объект, ПараметрыЗаполнения, ПараметрыДействия=Неопределено) Экспорт
