...
// Обработчик события возникающего при выполнении оповещения данной формы ответ на перезаполнение табличной части в
// контексте сервера.
//
&НаСервере
...
КонецПроцедуры // ОбработчикОповещенияПерезаполнитьТабличнуюЧастьНаСервере()

// Обработчик события возникающего при выполнении оповещения данной формы ответ на перезаполнение табличной части.
//
// Параметры:
...
КонецПроцедуры // Подключаемый_ОбработчикОповещенияПерезаполнитьТабличнуюЧасть()
