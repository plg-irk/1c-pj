...
Процедура УправлениеДиалогомНаСервере()
	...
	УправлениеДиалогомДокументаСервер.УстановитьДоступностьФлагаАвтоЗакрытиеСделок(ЭтотОбъект,Объект,"Сотрудники");
...
// Обработчик события возникающего на клиенте при нажатии на надпись "Документ основание".
//
// Параметры:
//  Элемент - ТаблицаФормы - Элемент управления, в котором возникло данное событие.
//
...
КонецПроцедуры // НадписьДокументОснованиеНажатие()


////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ "Сотрудники"

// Обработчик события возникающего на клиенте при изменении данных реквизита "Сотрудник" в контексте сервера.
//
// Параметры:
//  ПараметрыДействия - Структура - Набор параметров, использующихся при выполнения операции.
//
...
КонецПроцедуры // СотрудникиКонтрагентПриИзмененииНаСервере()
...
КонецПроцедуры //СотрудникиКонтрагентПриИзменении()
...
КонецПроцедуры // СотрудникиДоговорВзаиморасчетовПриИзмененииНаСервере()
...
КонецПроцедуры // СотрудникиПриОкончанииРедактирования()
...
КонецПроцедуры // СотрудникиПослеУдаленияНаСервере()
