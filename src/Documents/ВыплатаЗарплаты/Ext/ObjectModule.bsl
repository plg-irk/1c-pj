...
//
Функция ОбработкаЗаполнения_НачислениеЗарплаты(ДанныеЗаполнения, ТекстЗаполнения="", СтандартнаяОбработка=ИСТИНА) Экспорт
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Запрос=Новый Запрос("ВЫБРАТЬ РАЗРЕШЕННЫЕ
	                    ...
	                    |	ВыплатаЗарплатыСотрудники.АвтоЗакрытиеСделок КАК АвтоЗакрытиеСделок
	                    |ИЗ
