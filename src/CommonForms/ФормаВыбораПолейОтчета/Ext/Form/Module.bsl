...
Процедура ПодборРеквизитов(Команда)
	...
	ОткрытьФорму("ОбщаяФорма.ФормаПодбораПолейОтчета", СтруктураПараметров, ЭтотОбъект,,,,ОписаниеОповещенияВыбораПоля, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ЭЛЕМЕНТОВ ТИБЛИЦЫ "ДОПОЛНИТЕЛЬНЫЕ ПОЛЯ"
...
Процедура ПриОткрытии(Отказ)
	...
	ИначеЕсли ВидПолей = "Ресурсы" ИЛИ ВидПолей = "Показатель" Тогда
		...
		Если НЕ ОбщегоНазначенияКлиентСервер.ЭтоВебКлиент() Тогда
			...
			Если  НЕ ЭтотОбъект.ОписаниеОповещенияОЗакрытии.Модуль.КлючОбъекта = "Отчет.ПечатьРеестра" 
				И НЕ ЭтотОбъект.ОписаниеОповещенияОЗакрытии.Модуль.КлючОбъекта = "Отчет.СтоимостнаяОценкаСкладаВЦенахКомпании" Тогда
