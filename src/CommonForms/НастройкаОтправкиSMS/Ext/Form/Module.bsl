...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// +SMS4B Отключение всех провайдеров, кроме sms4b
	НаборКонстант.ПровайдерSMS = Перечисления.ПровайдерыSMS.смсSMS4B;
	Элементы.ПровайдерИОписание.Видимость = Ложь;
	// -SMS4B
...
// +SMS4B Процедура - обработчик события "Нажатие" элемента формы "ОписаниеУслугиSMS4B".
//
// Параметры:
//	Элемент	- ЭлементФормы	- Элемент формы
//
// На форму добавлена надпись "ОписаниеУслугиSMS4B"
&НаКлиенте
Процедура ОписаниеУслугиSMS4BНажатие(Элемент)
	
	ПерейтиПоНавигационнойСсылке("https://www.sms4b.ru");
	
КонецПроцедуры // ОписаниеУслугиSMS4BНажатие() //-SMS4B
