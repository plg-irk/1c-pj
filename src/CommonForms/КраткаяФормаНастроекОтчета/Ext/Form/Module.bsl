...
Процедура ТаблицаВидДиаграммы(Команда)
	...
	Если СокрЛП(ТекущиеДанные.ТипДиаграммы) = "" Тогда
		...
		Элементы.ДекорацияТипДиаграммы.Картинка = ПолучитьКартинкуДиаграммы(ТекущиеДанные.ТипДиаграммы);
	...
	Если НайденныеСтроки.Количество()> 0 Тогда
		...
		Если СтрокиТаблицы.Количество()>0 Тогда
			...
			Если ТекущаяСтрока.ТипДиаграммы <> "" Тогда
				Элементы.ДекорацияТипДиаграммы.Картинка = ПолучитьКартинкуДиаграммы(ТекущаяСтрока.ТипДиаграммы);
			КонецЕсли;
...
Процедура ТипДиаграммыОтчетаПриИзменении(Элемент)
	...
	Элементы.ДекорацияТипДиаграммы.Картинка = ПолучитьКартинкуДиаграммы(Элементы.СписокТаблиц.ТекущиеДанные.ТипДиаграммы);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Попытка
		ОтчетОбъект.ОпределитьНастройкиФормыНастроек(ЭтотОбъект);
	Исключение
	КонецПопытки;
	...
	Для Каждого ТекущийТипДиаграммы Из ТипДиаграммы Цикл
		...
		СписокВыбора.Добавить(ИмяТипаДиаграммы, СокрЛП(ТекущийТипДиаграммы),, ПолучитьКартинкуДиаграммы(ИмяТипаДиаграммы));
	КонецЦикла;
