...
Функция ШагУдалитьСтроки(ВыборПользователя, Сценарий)
	ТаблицыПолейУдалить(Сценарий.ТаблицаИмя, Сценарий.СтрокиДерева, Ложь);
...
Функция ПараметрыВыбораОтбора(СтрокаТаблицы)
	...
	Результат = Новый Структура("ЗначенияДляВыбора, БыстрыйВыбор, ОграничиватьВыборУказаннымиЗначениями, ОписаниеТипов");
...
Процедура ДобавитьУсловноеОформление()
	...
	Иначе
		...
		Инструкция = СтандартныеПодсистемыСервер.ИнструкцияУсловногоОформления();
		Инструкция.Отборы.Вставить("СтруктураВарианта.ЭтоГруппа", Истина);
		Инструкция.Поля = "СтруктураВариантаПредставление";
		Инструкция.Оформление.Вставить("Шрифт", ШрифтВажнойНадписи);
		СтандартныеПодсистемыСервер.ДобавитьЭлементУсловногоОформления(ЭтотОбъект, Инструкция);
		
		Инструкция = СтандартныеПодсистемыСервер.ИнструкцияУсловногоОформления();
		Инструкция.Отборы.Вставить("СтруктураВарианта.Подсвечивать", Истина);
		Инструкция.Поля = "СтруктураВариантаПредставление";
		Инструкция.Оформление.Вставить("Шрифт", ШрифтВажнойНадписи);
		СтандартныеПодсистемыСервер.ДобавитьЭлементУсловногоОформления(ЭтотОбъект, Инструкция);
		
		Инструкция = СтандартныеПодсистемыСервер.ИнструкцияУсловногоОформления();
		Инструкция.Отборы.Вставить("СтруктураВарианта.ФлажокДоступен", Ложь);
		Инструкция.Поля = "СтруктураВариантаИспользование";
		Инструкция.Оформление.Вставить("Видимость", Ложь);
		Инструкция.Оформление.Вставить("Отображать", Ложь);
		СтандартныеПодсистемыСервер.ДобавитьЭлементУсловногоОформления(ЭтотОбъект, Инструкция);
	КонецЕсли;
