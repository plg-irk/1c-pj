...
//	ПараметрыРегистрации.Наименование = "Отчет: План-факт ассортимента форматов";
//	ПараметрыРегистрации.Версия = "1.0.1";
//	ПараметрыРегистрации.БезопасныйРежим = Ложь;
//	ПараметрыРегистрации.Назначение.Добавить();
//	
//	НоваяКоманда = ПараметрыРегистрации.Команды.Добавить();
//	НоваяКоманда.Представление = НСтр("ru = 'План-факт ассортимента форматов'");
//	НоваяКоманда.Идентификатор = "ПланФактАссортиментаФорматов";
