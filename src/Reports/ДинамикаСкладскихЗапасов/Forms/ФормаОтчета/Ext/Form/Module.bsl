...
Функция СформироватьОтчетВФоне(ОбновитьНастройки = Истина)
	...
	РеквизитыОтчета.Вставить("ИзмерениеКолонки", Отчет.ИзмерениеКолонки);
	РеквизитыОтчета.Вставить("ИзмерениеСтроки", Отчет.ИзмерениеСтроки);
	ПараметрыФормированияОтчета.Вставить("РеквизитыОтчета", РеквизитыОтчета);
...
Процедура ОткрытьНастройкиОтчета(Команда)
	...
	Иначе
		ОткрытьФорму(ИмяФормы+"Настроек", СтруктураПараметров, ЭтотОбъект,,,, ОписаниеОповещенияИзмененияНастроек, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	КонецЕсли;
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "Измерение строки".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
&НаКлиенте
Процедура ИзмерениеСтрокиПриИзменении(Элемент)
	
	Если Отчет.ИзмерениеСтроки = Элемент.СписокВыбора[1].Значение Тогда
		Элементы.ИзмерениеКолонки.СписокВыбора.Очистить();
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодМесяц", НСтр("ru = 'Период месяц'"));
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодНеделя", НСтр("ru = 'Период неделя'"));
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодДень", НСтр("ru = 'Период день'"));
	Иначе
		Элементы.ИзмерениеКолонки.СписокВыбора.Очистить();
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодКвартал", НСтр("ru = 'Период квартал'"));
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодМесяц", НСтр("ru = 'Период месяц'"));
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодНеделя", НСтр("ru = 'Период неделя'"));
		Элементы.ИзмерениеКолонки.СписокВыбора.Добавить("ПериодДень", НСтр("ru = 'Период день'"));
	КонецЕсли;
	
	Отчет.ИзмерениеКолонки = Элементы.ИзмерениеКолонки.СписокВыбора[0].Значение;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.ИзмерениеСтроки = Элементы.ИзмерениеСтроки.СписокВыбора[0].Значение;
	Отчет.ИзмерениеКолонки = Элементы.ИзмерениеКолонки.СписокВыбора[1].Значение;
