...
Функция СформироватьОтчетВФоне(ОбновитьНастройки = Истина)
	...
	//ПараметрыФормированияОтчета.Вставить("НачалоПериода",       Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы[1].Значение);
	//ПараметрыФормированияОтчета.Вставить("КонецПериода",       Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы[0].Значение);
...
// Обработчик события возникающего на клиенте перед удалением строки.
//
// Параметры:
//  Элемент     - ТаблицаФормы - Элемент управления, в котором возникло данное событие.
//  Отказ       - Булево       - Признак отказа от создания формы.
...
// Обработчик события возникающего на клиенте при обработке выбора
//
// Параметры:
//  Элемент				 - 	 - 
//  Расшифровка			 - 	 - 
