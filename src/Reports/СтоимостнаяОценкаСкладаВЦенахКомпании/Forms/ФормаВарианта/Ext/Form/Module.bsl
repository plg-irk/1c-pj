...
Процедура ОткрытьФормуНастроек()
	...
	ОткрытьФорму(СтрЗаменить(ИмяФормы, ".ФормаВарианта", ".ФормаНастроек"), СтруктураПараметров, ЭтотОбъект.ВладелецФормы,,,, ОписаниеОповещенияИзмененияНастроек, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
