...
Процедура ОбновитьНастройкиСКД(ОтсекатьГруппировки = Ложь)
	...
	// Установим значение параметра скд "Валюта"
	ВалютаОтчета=Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы.Получить(1);
	ВалютаОтчета.Значение=Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("Валюта").Значение;
