...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Попытка
		ДокументРезультат.ПовторятьПриПечатиСтроки = ДокументРезультат.Область(ЭтотОбъект.КомпоновщикНастроек.Настройки.ДополнительныеСвойства.МакетФиксОбластьПерваяСтрока,
		ЭтотОбъект.КомпоновщикНастроек.Настройки.ДополнительныеСвойства.МакетФиксОбластьПерваяКолонка,
		ЭтотОбъект.КомпоновщикНастроек.Настройки.ДополнительныеСвойства.МакетФиксОбластьПоследняяСтрока,
		ЭтотОбъект.КомпоновщикНастроек.Настройки.ДополнительныеСвойства.МакетФиксОбластьПоследняяКолонка);
	Исключение
	КонецПопытки;
