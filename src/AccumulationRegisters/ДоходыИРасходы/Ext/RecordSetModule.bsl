...
Функция Приход() Экспорт
	...
	Коэффициент = ПланированиеСервер.ПолучитьКоэффициентПересчетаВалют(ШапкаДокумента.Дата);
	НоваяЗапись.ДоходРег =  НоваяЗапись.ДоходУпр * Коэффициент;
	НоваяЗапись.РасходРег =  НоваяЗапись.РасходУпр * Коэффициент;
