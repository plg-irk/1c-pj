...
Функция СостояниеДокумента(ПараметрыДокумента, СостоянияЭлементовРегламента)
	...
	Если ЗаполнитьСостояниеПоОтказуВПодписи(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
		Или ЗаполнитьСостояниеПоОтклонению(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
...
Функция ЗаполнитьСостояниеПоПредложениюОбАннулировании(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Результат = Истина;
	ТипыОтклонений = РегламентыЭДО.ТипыЭлементовРегламентаЭДОУточнений();
	...
	ИначеЕсли РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыОтклонений, ,ОтклонениеПОА) Тогда
...
Функция ЗаполнитьСостояниеПоОтклонению(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	ТипыУточнений = РегламентыЭДО.ТипыЭлементовРегламентаЭДОУточнений();
	
	ЭлементОтклонения = Неопределено; // СтрокаТаблицыЗначений: См. РегламентыЭДО.НовыеСостоянияЭлементовРегламента
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыУточнений, ,ЭлементОтклонения) Тогда
		Возврат Ложь;
	КонецЕсли;
...
Функция ЗаполнитьСостояниеПоИзвещению(ОписаниеТиповЭлемента, ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Отборы = Новый Массив;
	Отборы.Добавить(Новый Структура("ТипЭлементаРегламента", ОписаниеТиповЭлемента.Извещение));
	Отборы.Добавить(Новый Структура("ТипЭлементаРегламента, ТипЭлементаРегламентаРодителя", 
			Перечисления.ТипыЭлементовРегламентаЭДО.УС_ИОП, ОписаниеТиповЭлемента.ОсновнойЭлемент));
	
	ЭлементИзвещения = Неопределено;
	Для Каждого Отбор Из Отборы Цикл
		СтрокиСостояния = СостоянияЭлементовРегламента.НайтиСтроки(Отбор);
		Если ЗначениеЗаполнено(СтрокиСостояния) Тогда
			ЭлементИзвещения = СтрокиСостояния[0];
		КонецЕсли;
	КонецЦикла;
