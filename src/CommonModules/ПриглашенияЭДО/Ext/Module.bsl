...
Функция ПараметрыСвязиИдентификаторов(ПараметрыПолучения, КонтекстДиагностики = Неопределено, ОбновитьДанныеАбонентов = Ложь) Экспорт	
	...
	ПараметрыСвязиИдентификаторовЦентраЭДО = Неопределено;
	ПараметрыСвязиИдентификаторовВстроенногоЭДО = Неопределено;
	
	Если НастройкиЭДО.ИспользоватьИнтеграциюЦентраЭДО()
		И ЗначениеЗаполнено(ИдентификаторыПоИнтеграциямЭДО.ИдентификаторыДляЦентраЭДО) Тогда
		...
		ПараметрыПолученияДляЦентраЭДО.ИдентификаторыОрганизации =
			ИдентификаторыПоИнтеграциямЭДО.ИдентификаторыДляЦентраЭДО;
		ОбщийМодульПриглашенияЭДОИнтеграцияЦентраЭДО = ОбщегоНазначения.ОбщийМодуль("ПриглашенияЭДОИнтеграцияЦентраЭДО");
		ПараметрыСвязиИдентификаторовЦентраЭДО = ОбщийМодульПриглашенияЭДОИнтеграцияЦентраЭДО.ПараметрыСвязиИдентификаторов(
	...
	Если ЗначениеЗаполнено(ПараметрыСвязиИдентификаторовЦентраЭДО) Тогда
		ПараметрыСвязиИдентификаторов = ПараметрыСвязиИдентификаторовЦентраЭДО;
