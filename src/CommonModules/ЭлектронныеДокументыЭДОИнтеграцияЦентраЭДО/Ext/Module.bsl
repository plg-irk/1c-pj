...
Процедура ПолнаяСинхронизацияДокументовЦентраЭДО() Экспорт
	...
	Текст = СтрШаблон(НСтр("ru = 'Начало операции: %1.'"), ВидОперацииЗадания);
	...
	Текст = СтрШаблон(НСтр("ru = 'Завершение операции: %1.'"), ВидОперацииЗадания);
	ОбщегоНазначенияБЭД.ЗаписатьВЖурналРегистрации(Текст, Подсистема, УровеньЖурналаРегистрации.Информация);
...
Процедура ОтменитьВыгрузкуВЦентрЭДО(ИдентификаторЭДО) Экспорт
	...
	Текст = СтрШаблон(НСтр("ru = '%1 прервана пользователем'"), ВидОперацииВыгрузкаВЦентрЭДО());
	Подсистема = ОбщегоНазначенияБЭДКлиентСервер.ПодсистемыБЭД().ИнтеграцияЦентраЭДО;
	ОбщегоНазначенияБЭД.ЗаписатьВЖурналРегистрации(Текст, Подсистема, УровеньЖурналаРегистрации.Информация);
...
//  * ИдентификаторСервиса - Неопределено,Строка
//  * Данные - Неопределено,Строка - двоичные данные в формате base64.
Функция ДанныеДоверенностейДляВыгрузкиВФорматеСервиса(ПодписанныеОбъекты, УчетнаяЗаписьЦентраЭДО, СсылкиПоИдентификаторамОбъектов) Экспорт
...
Процедура УстановитьПризнакИспользованияЦентраЭДОПоДокументу(ЭлектронныйДокумент)
	...
	ЭлектронныеДокументыЭДО.ЗаблокироватьДанныеДокументаДляИзменения(ЭлектронныйДокумент, ЭтоВходящийЭДО);
...
// Возвращаемое значение:
//  Булево
Функция ВыгрузитьДокументНабораВЦентрЭДО(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
