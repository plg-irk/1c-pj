...
//
// Параметры:
//  ОбластьДанных - Тип значения разделителя - значение разделителя удаляемой области данных.
//
...
//
// Параметры:
//  ИменаПараметров - Массив -- массив строк,содержащий имена параметров, значения которых необходимо получить.
...
Процедура ПриВключенииРазделенияПоОбластямДанных() Экспорт
	...
	ИнтернетПоддержкаПользователей.ПриВключенииРазделенияПоОбластямДанных();
