...
// Возвращаемое значение:
//  Строка
Функция ПредставлениеКомандыЗапроситьУточнение(ПакетСоставной) Экспорт
	
	Если ПакетСоставной Тогда
		Возврат НСтр("ru = 'Запросить уточнение по пакету'");
	Иначе
		Возврат НСтр("ru = 'Запросить уточнение'");
	КонецЕсли;
...
// Возвращаемое значение:
//  Строка
Функция ПредставлениеКомандыОтказатьсяОтПодписания(ПакетСоставной) Экспорт
