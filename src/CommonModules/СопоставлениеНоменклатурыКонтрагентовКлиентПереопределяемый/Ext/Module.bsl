...
// Позволяет переопределить настройки по умолчанию сопоставления номенклатуры
//
// Параметры:
//  НастройкиСопоставления - см. СопоставлениеНоменклатурыКонтрагентовКлиент.НовыеНастройкиСопоставленияНоменклатуры
// 
Процедура ПриОпределенииНастроекСопоставленияНоменклатуры(НастройкиСопоставления) Экспорт
...
Процедура ПриСозданииНоменклатурыПоДаннымКонтрагента(Знач НаборНоменклатурыКонтрагентов, Знач ОповещениеОЗавершении, 
	...
	ТорговыйКомплексСопоставлениеНоменклатурыКонтрагентовЭДОКлиент.ПриСозданииНоменклатурыПоДаннымКонтрагента(НаборНоменклатурыКонтрагентов, ОповещениеОЗавершении, 
		Контекст, СтандартнаяОбработка);
...
Процедура ОткрытьФормуНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность, Знач ОповещениеОЗакрытии) Экспорт
	...
	ТорговыйКомплексСопоставлениеНоменклатурыКонтрагентовЭДОКлиент.ОткрытьФормуНоменклатуры(Параметры, Владелец, Уникальность, ОповещениеОЗакрытии);
...
Процедура ОткрытьФормуВыбораНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность) Экспорт
	...
	ТорговыйКомплексСопоставлениеНоменклатурыКонтрагентовЭДОКлиент.ОткрытьФормуВыбораНоменклатуры(Параметры, Владелец, Уникальность);
