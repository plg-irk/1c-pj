...
Процедура СоздатьСлужебногоПользователяОповещенийЭДО() Экспорт
	...
	Попытка
		...
		НовыйПользователь.ДополнительныеСвойства.Вставить("НеКонтролироватьСоответствиеОрганизацииПодразделения", Истина);
		// -РАРУС
...
// Вызывается при добавлении учетной записи электронного документооборота
//
Процедура ПриСозданииУчетнойЗаписи() Экспорт
	
	Если УчетныеЗаписиЭДО.ЕстьУчетныеЗаписиЛокальногоЭДО() Тогда
...
Процедура ПриУдаленииУчетнойЗаписи(ИдентификаторУчетнойЗаписи) Экспорт
	...
	Если Не УчетныеЗаписиЭДО.ЕстьУчетныеЗаписиЛокальногоЭДО() Тогда
...
Процедура УстановитьАктивностьЗаданияПроверкиНовыхЭлектронныхДокументов(Использование)
	...
	УстановитьПривилегированныйРежим(Истина); 
	ИмяЗадания = СинхронизацияЭДОКлиентСервер.ИмяРегламентногоЗаданияПроверкаНовыхЭлектронныхДокументов();
