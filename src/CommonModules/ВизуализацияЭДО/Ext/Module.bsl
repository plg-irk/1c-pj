...
Процедура ПриПопыткеЗанятьФайл(ДанныеФайла, ОписаниеОшибки) Экспорт
	...
	Если ТипЗнч(ДанныеФайла.Ссылка) = Тип("СправочникСсылка.КэшВизуализацииДокументовЭДОПрисоединенныеФайлы") Тогда
		ОписаниеОшибки = НСтр("ru = 'Кэш визуализации формируется автоматически. Ручное редактирование запрещено'");
	КонецЕсли;
