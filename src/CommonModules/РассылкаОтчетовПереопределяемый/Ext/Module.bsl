...
//  //Смотри также другие примеры использования в РассылкаОтчетовПовтИсп.СписокФорматов()
//
...
//  //Смотри также другие примеры использования в РассылкаОтчетовПовтИсп.ТаблицаТиповПолучателей().
//
...
//
// Параметры:
//   ИсключаемыеОтчеты - Массив - Массив из ОбъектМетаданных: Отчет. Отчеты, подключенные к хранилищу "ВариантыОтчетов",
