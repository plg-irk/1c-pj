...
//
Функция СоседнийЭлемент(ПеремещаемыйЭлемент, Список, Знач Направление)
...
Функция СписокСодержитОтборПоВладельцу(Список)
	...
	Если ТипЗнч(Список) = Тип("НастройкиКомпоновкиДанных") Тогда
		ЭлементыОтбора = Список.Отбор.Элементы;
	Иначе
		ЭлементыОтбора = Список.КомпоновщикНастроек.ПолучитьНастройки().Отбор.Элементы;
	КонецЕсли;
