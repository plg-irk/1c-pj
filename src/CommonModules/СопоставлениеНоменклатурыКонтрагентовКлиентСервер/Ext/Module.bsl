...
//   * ДополнительныеПараметрыПоиска        - Неопределено,Произвольный - структура дополнительных параметров, используемых в переопределяемых процедурах.
...
// Метод-конструктор, возвращает данные сопоставления.
// Второй параметр метода см.СопоставлениеНоменклатурыКонтрагентовПереопределяемый.ПриИзмененииНоменклатурыСопоставления_НоменклатураКонтрагентов.
// 
// Возвращаемое значение:
//  Структура:
//   * Номенклатура                - Неопределено,ОпределяемыйТип.НоменклатураБЭД               - ссылка номенклатуры ИБ.
//   * Характеристика              - Неопределено,ОпределяемыйТип.ХарактеристикаНоменклатурыБЭД - ссылка характеристики ИБ.
//   * Упаковка                    - Неопределено,ОпределяемыйТип.УпаковкаНоменклатурыБЭД       - ссылка упаковка ИБ.
//   * ИспользоватьХарактеристики  - Булево - признак использования характеристик номенклатуры ИБ.
//   * ОбязательноеЗаполнениеХарактеристики - Булево
//   * ЕдиницаИзмеренияПоУмолчанию - Неопределено,ОпределяемыйТип.УпаковкаНоменклатурыБЭД       - ссылка базовой единицы измерения номенклатуры ИБ,
...
//
Функция НовыеДанныеСопоставления() Экспорт
	
	ДанныеСопоставления = Новый Структура;
	ДанныеСопоставления.Вставить("Номенклатура", Неопределено);
	ДанныеСопоставления.Вставить("Характеристика", Неопределено);
	ДанныеСопоставления.Вставить("Упаковка", Неопределено);
	ДанныеСопоставления.Вставить("ИспользоватьХарактеристики", Ложь);
	ДанныеСопоставления.Вставить("ОбязательноеЗаполнениеХарактеристики", Ложь);
	ДанныеСопоставления.Вставить("ЕдиницаИзмеренияПоУмолчанию", Неопределено);
	ДанныеСопоставления.Вставить("ИмяПараметраСвязиХарактеристики", "Отбор.Владелец");
	ДанныеСопоставления.Вставить("ИмяПараметраСвязиУпаковки", "Отбор.Владелец");
	
	Возврат ДанныеСопоставления;
	
КонецФункции

// Метод-конструктор, возвращает структуру имен параметров связи.
//
// Возвращаемое значение:
//  Структура:
//   * ИмяПараметраСвязиХарактеристики - Строка - имя параметра связи выбора характеристики по номенклатуре. По умолчанию "Отбор.Владелец".
//   * ИмяПараметраСвязиУпаковки       - Строка - имя параметра связи выбора упаковки по номенклатуре. По умолчанию "Отбор.Владелец".
//
Функция НовыеИменаПараметровСвязи() Экспорт
	
	ИменаПараметровСвязи = Новый Структура;
	ИменаПараметровСвязи.Вставить("ИмяПараметраСвязиХарактеристики", "Отбор.Владелец");
	ИменаПараметровСвязи.Вставить("ИмяПараметраСвязиУпаковки", "Отбор.Владелец");
	
	Возврат ИменаПараметровСвязи;
...
// 
// Параметры:
//  НоменклатураКонтрагента - См. НоваяНоменклатураКонтрагента
//  НоменклатураИБ          - См. НоваяНоменклатураИнформационнойБазы
//
// Возвращаемое значение:
//  Структура:
...
//   * НоменклатураИБ          - См. НоваяНоменклатураИнформационнойБазы.
//
Функция НовоеСоответствиеНоменклатуры(Знач НоменклатураКонтрагента = Неопределено, 
	Знач НоменклатураИБ = Неопределено) Экспорт
