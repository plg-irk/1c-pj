...
//
// Возвращаемое значение:
//	 Элемент СтруктураНастроекКомпоновкиДанных, Неопределено - последний параметр структуры.
//
...
//
// Возвращаемое значение:
//	Элемент СтруктураНастроекКомпоновкиДанных, Неопределено - ПоследнийЭлементСтруктуры.
//
...
Процедура ОбъединитьОтборКомпоновкиДанных(СхемаПриемник, НастройкиПриемник, НастройкиИсточник) Экспорт
	
	Для Каждого ЭлементОтбора Из НастройкиИсточник.Отбор.Элементы Цикл
		Если НЕ ЭлементОтбора.Использование И (НЕ ЗначениеЗаполнено(ЭлементОтбора.ПравоеЗначение)) Тогда
			Продолжить;
		КонецЕсли;
		
		НайденныйЭлемент = Неопределено;
		Для Каждого ЭлементОтбораИсточника Из НастройкиПриемник.Отбор.Элементы Цикл
			Если ЭлементОтбора.ЛевоеЗначение = ЭлементОтбораИсточника.ЛевоеЗначение Тогда
				НайденныйЭлемент = ЭлементОтбораИсточника;
				Прервать;
			КонецЕсли;
		КонецЦикла;
		...
		Если НайденныйЭлемент = Неопределено Тогда
			...
			КонецЕсли;
		Иначе
			//Если НЕ НайденныйЭлемент.Использование И (НЕ ЗначениеЗаполнено(НайденныйЭлемент.ПравоеЗначение)) Тогда
			Если НЕ НайденныйЭлемент.Использование Тогда
				//ИндексЭлемента = НастройкиПриемник.Отбор.Элементы.Индекс(НайденныйЭлемент);
				//НастройкиПриемник.Отбор.Элементы.Удалить(НайденныйЭлемент);
				Если ТипЗнч(ЭлементОтбора) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда
					ДобавитьВОтборЭлементОтбора(НастройкиПриемник.Отбор,ЭлементОтбора, НайденныйЭлемент);
				Иначе
					ДобавитьВОтборГруппуЭлементовОтбора(НастройкиПриемник.Отбор,ЭлементОтбора, НайденныйЭлемент);
				КонецЕсли;
			Иначе
				Продолжить;
			КонецЕсли;
...
//
Процедура ДобавитьВОтборЭлементОтбора(ОтборПриемник, ЭлементОтбора, НовыйЭлемент = Неопределено) Экспорт
...
//
Процедура ДобавитьВОтборГруппуЭлементовОтбора(ОтборПриемник, ГруппаЭлементов, НоваяГруппа = Неопределено) Экспорт
