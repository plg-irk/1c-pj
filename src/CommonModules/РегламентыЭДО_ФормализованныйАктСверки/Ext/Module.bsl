...
Функция СостояниеВходящегоДокумента(ПараметрыДокумента, СостоянияЭлементовРегламента) Экспорт
	...
	Если ЗаполнитьСостояниеПоОтказуВПодписи(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
		...
		ИЛИ ЗаполнитьСостояниеПоПодтверждениюОператораИнформацииПолучателя(ПараметрыДокумента, СостоянияЭлементовРегламента,
			Перечисления.ТипыЭлементовРегламентаЭДО.ИнформацияПолучателя_ПДП, 
			Перечисления.ТипыЭлементовРегламентаЭДО.ИнформацияПолучателя_ИОП, Состояние)
...
Функция ЗаполнитьСостояниеПоПредложениюОбАннулировании(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	ТипыУОУ = РегламентыЭДО.ТипыЭлементовРегламентаЭДОУточнений();
	...
	ИначеЕсли РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыУОУ) Тогда
...
Функция ЗаполнитьСостояниеПоИсходящемуОтклонению(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыУОУ, , ЭлементРегламента) Тогда
...
//  Булево
//
Функция ЗаполнитьСостояниеПоОтказуВПодписи(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	
	Результат = Истина;
	ЭлементРегламента = Неопределено; // Неопределено,СтрокаТаблицыЗначений: См. РегламентыЭДО.НовыеСостоянияЭлементовРегламента

	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(
		СостоянияЭлементовРегламента,
		ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Перечисления.ТипыЭлементовРегламентаЭДО.УС_ОтказВПодписи),
		,
		ЭлементРегламента,
		Истина) Тогда
	...
	Если ЭлементРегламента.Направление = Перечисления.НаправленияЭДО.Исходящий Тогда
		
		ЭлементРегламентаУОУ = Неопределено; // Неопределено,СтрокаТаблицыЗначений: См. РегламентыЭДО.НовыеСостоянияЭлементовРегламента
		РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(
			СостоянияЭлементовРегламента,
			ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Перечисления.ТипыЭлементовРегламентаЭДО.УОУ),
			,
			ЭлементРегламентаУОУ,
			Истина);
		Если ЭлементРегламентаУОУ <> Неопределено 
			И ЭлементРегламентаУОУ.Состояние = Перечисления.СостоянияСообщенийЭДО.Подписание Тогда
...
Функция ЗаполнитьСостояниеПоИсходящемуИзвещениюОПолучении(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	ТипИОП = РегламентыЭДО.ТипыЭлементовРегламентаЭДОИзвещенийПервыхТитулов();
	
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипИОП, Перечисления.НаправленияЭДО.Исходящий, ЭлементРегламента) Тогда
...
//  Булево
//
Функция ЗаполнитьСостояниеПоПодтверждениюОператора(ПараметрыДокумента, СостоянияЭлементовРегламента, Подтверждение, 
	Извещение, Состояние)
...
// Возвращает признак успешности заполнения состояния по подтверждению оператора информации получателя.
// 
// Параметры:
//  ПараметрыДокумента - См. РегламентыЭДО.НовыеПараметрыДокументаДляОпределенияСостояния
//  СостоянияЭлементовРегламента - См. РегламентыЭДО.НовыеСостоянияЭлементовРегламента
...
//  Булево
//
Функция ЗаполнитьСостояниеПоПодтверждениюОператораИнформацииПолучателя(ПараметрыДокумента, СостоянияЭлементовРегламента, 
	Подтверждение, Извещение, Состояние)
	...
	ТипыИзвещения = Новый Массив; // Массив из ПеречислениеСсылка.ТипыЭлементовРегламентаЭДО
	ТипыИзвещения.Добавить(Извещение);
	Если РегламентыЭДО.ВыполненПереходНаУниверсальныеСообщения() Тогда 
		ТипыИзвещения.Добавить(Перечисления.ТипыЭлементовРегламентаЭДО.УС_ИОП);
	КонецЕсли;
	...
	Если РегламентыЭДО.ЕстьЭлементРегламента(СостоянияЭлементовРегламента, 
		...
		ИначеЕсли ПараметрыДокумента.ТребуетсяИзвещение
			И Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыИзвещения, Перечисления.НаправленияЭДО.Входящий) Тогда
...
Функция ЗаполнитьСостояниеПоВходящемуОтклонению(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыУОУ) Тогда
...
Функция ЗаполнитьСостояниеПоВходящемуИзвещениюОПолучении(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если ПараметрыДокумента.ТребуетсяИзвещение
		И Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипИОП, Перечисления.НаправленияЭДО.Входящий) Тогда
