...
Функция НовыеЭлектронныеДокументы(ДокументыОснования) Экспорт 
	...
	РезультатОбработки = ЭлектронныеДокументыЭДО.ОбработатьРезультатыВыполненияДействийПоИнтеграциямЭДО(
		РезультатыПоИнтеграциямЭДО);
		
	Результат = Новый Массив;
	Для Каждого Ошибка Из РезультатОбработки.ОшибкиФормирования Цикл
...
Функция НачатьЭДОПоОбъектамУчета(ОбъектыУчета, НастройкиОтправкиОбъектовУчета = Неопределено) Экспорт
	...
	КонецЕсли;
	Возврат ЭлектронныеДокументыЭДО.ВыполнитьДействияПоИнтеграциямЭДО(ПараметрыВыполнения);
КонецФункции
...
//   * ДополнительныеДанные - Структура - дополнительные данные для отражения в учете.
//   * СпособОбмена - ПеречислениеСсылка.СпособыОбменаЭД - способ обмена через который отражается электронный документв учете.
...
//  ОбъектыУчета - Массив Из ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО, Неопределено - набор документов, в который
...
Процедура ОтразитьВУчетеЭлектронныйДокумент(Параметры, ОбъектыУчета, Отказ) Экспорт
	...
	ДанныеДокументооборота.СпособОбмена = Параметры.СпособОбмена;
