...
//
// Параметры:
//   ПараметрКоманды            - Массив                     - Передается "как есть" из параметров обработчика команды.
...
//
// Параметры:
//  ДополнительнаяОбработкаСсылка - СправочникСсылка.ДополнительныеОтчетыИОбработки - Передается "как есть"
//                                                                                          из параметров формы.
...
//		ПараметрыКоманды = ДополнительныеОтчетыИОбработкиКлиент.ПараметрыВыполненияКомандыВФоне(
...
Процедура ВыполнитьОткрытиеФормыОбработки(ВыполняемаяКоманда, Форма, ОбъектыНазначения) Экспорт
	ПараметрыОбработки = Новый Структура("ИдентификаторКоманды, ДополнительнаяОбработкаСсылка, ИмяФормы, КлючСессии, ВыполняемаяКоманда");
	...
	ПараметрыОбработки.ВыполняемаяКоманда = ВыполняемаяКоманда;
...
Процедура ВыполнитьОткрытиеПечатнойФормы(ВыполняемаяКоманда, Форма, ОбъектыНазначения) Экспорт
	...
	ПроверкаПроведенияПередПечатью = ПолучитьЗначениеПараметраСтруктуры(ВыполняемаяКоманда, "ПроверкаПроведенияПередПечатью", Истина);
...
Процедура ВыполнитьОткрытиеПечатнойФормыЗавершение(ОбъектыНазначения, ДополнительныеПараметры) Экспорт
	...
	ПараметрыОткрытия.Вставить("ВыполняемаяКоманда", ВыполняемаяКоманда);
