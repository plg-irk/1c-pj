...
// Отправляет приглашения через центр ЭДО.
// 
// Параметры:
...
// Принимает приглашения через центр ЭДО.
// 
// Параметры:
//  ОповещениеОЗавершении - ОписаниеОповещения
...
// Отклоняет приглашения через центр ЭДО.
// 
// Параметры:
//  ОповещениеОЗавершении - ОписаниеОповещения
//  Приглашения - Массив из см. ПриглашенияЭДОКлиент.НовоеВходящееПриглашение
...
Процедура АвторизоватьсяВСервисеЭДОПоПриглашениям(ОповещениеОЗавершении, Приглашения)
	...
	УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент.АвторизоватьсяВСервисеЭДО(ОповещениеОЗавершении, ПараметрыАвторизации);
...
Процедура ОтправитьПриглашенияПослеАвторизацииВСервисеЭДО(РезультатАвторизации, ПараметрыДействия) Экспорт
	...
	ДлительнаяОперация = ПриглашенияЭДОИнтеграцияЦентраЭДОВызовСервера.ОтправитьПриглашенияВФоне(
...
//  РезультатАвторизации - см. УчетныеЗаписиЭДОКлиент.НовыйРезультатАвторизацииВСервисеЭДО
//  ПараметрыДействия - см. НовыеПараметрыДействияСПриглашениями
Процедура ПринятьПриглашенияПослеАвторизацииВСервисеЭДО(РезультатАвторизации, ПараметрыДействия) Экспорт
	
	ДлительнаяОперация = ПриглашенияЭДОИнтеграцияЦентраЭДОВызовСервера.ПринятьПриглашенияВФоне(
		ПараметрыДействия.Приглашения, РезультатАвторизации.РасшифрованныеМаркеры);
...
//  РезультатАвторизации - см. УчетныеЗаписиЭДОКлиент.НовыйРезультатАвторизацииВСервисеЭДО
//  ПараметрыДействия - см. НовыеПараметрыДействияСПриглашениями
Процедура ОтклонитьПриглашенияПослеАвторизацииВСервисеЭДО(РезультатАвторизации, ПараметрыДействия) Экспорт
	
	ДлительнаяОперация = ПриглашенияЭДОИнтеграцияЦентраЭДОВызовСервера.ОтклонитьПриглашенияВФоне(
		ПараметрыДействия.Приглашения, РезультатАвторизации.РасшифрованныеМаркеры);
...
Процедура ОбработатьРезультатДействияСПриглашениями(ДлительнаяОперация, ПараметрыДействия) Экспорт
	...
	Результат = ПриглашенияЭДОИнтеграцияЦентраЭДОВызовСервера.РезультатДействияСПриглашениямиВФоне(ДлительнаяОперация);
