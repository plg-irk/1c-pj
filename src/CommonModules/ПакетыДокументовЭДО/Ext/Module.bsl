...
#Область ЦентрЭДО_ИнтеграцияЦентраЭДО
...
#КонецОбласти // ЦентрЭДО_ИнтеграцияЦентраЭДО
...
Функция ОтобратьПакетыДокументовПоПризнакуЦентраЭДО(ПакетыДокументов, ИспользоватьЦентрЭДО) Экспорт
	...
	Запрос.Текст =
		...
		|	И СоставПакетовДокументовЭДО.ЭлектронныйДокумент.ИспользоватьЦентрЭДО = &ИспользоватьЦентрЭДО";
...
Функция СоздатьПакетДокументов(ЭлектронныеДокументы, КонтекстДиагностики, Идентификатор = Неопределено) Экспорт
	...
	ЭтоДокументыЦентраЭДО = ЭлектронныеДокументыЭДО.ЭтоДокументЦентраЭДО(ЭлектронныеДокументы[0]);
	МенеджерДействий = МенеджерДействийСПакетамиДокументовИнтеграцииЭДО(ЭтоДокументыЦентраЭДО);
...
Функция УдалитьДокументИзПакета(ИдентификаторПакета, ЭлектронныйДокумент, КонтекстДиагностики = Неопределено) Экспорт
	...
	ЭтоДокументЦентраЭДО = ЭлектронныеДокументыЭДО.ЭтоДокументЦентраЭДО(ЭлектронныйДокумент);
	МенеджерДействий = МенеджерДействийСПакетамиДокументовИнтеграцииЭДО(ЭтоДокументЦентраЭДО);
...
// Возвращаемое значение:
//  ОбщийМодуль
Функция МенеджерДействийСПакетамиДокументовИнтеграцииЭДО(ИспользоватьЦентрЭДО = Ложь)
	
	Если ИспользоватьЦентрЭДО Тогда
		ОбщийМодульПакетыДокументовЭДОИнтеграцияЦентраЭДО = ОбщегоНазначения.ОбщийМодуль(
			"ПакетыДокументовЭДОИнтеграцияЦентраЭДО");
		Возврат ОбщийМодульПакетыДокументовЭДОИнтеграцияЦентраЭДО.МенеджерДействийСПакетамиДокументовИнтеграцииЦентраЭДО();
	Иначе
...
Функция ПорядокСостоянияОтклонение(Состояние)
	...
	Если Состояние = Перечисления.СостоянияДокументовЭДО.ТребуетсяПодписаниеОтклонения Тогда
		Порядок = 1;
	ИначеЕсли Состояние = Перечисления.СостоянияДокументовЭДО.ТребуетсяПодготовкаКОтправкеОтклонения 
		Или Состояние = Перечисления.СостоянияДокументовЭДО.ТребуетсяПодготовкаКОтправкеОтказаВПодписи Тогда
		Порядок = 2;
	ИначеЕсли Состояние = Перечисления.СостоянияДокументовЭДО.ТребуетсяОтправкаОтклонения
		Или Состояние = Перечисления.СостоянияДокументовЭДО.ТребуетсяОтправкаОтказаВПодписи Тогда
		Порядок = 3;
