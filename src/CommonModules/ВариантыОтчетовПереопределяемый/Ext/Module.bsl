...
//                   <ЗаголовокПанелиОтчетовНачальнойСтраницы>);
//
...
//               КонецПроцедуры
//               
//   2. Процедура УстановитьРежимВыводаВПанеляхОтчетов позволяет настроить режим группировки
//      вариантов в панелях отчетов:
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// ++ ПервыйБит ШиряеваВ
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.бит_ЯндексЕдаОтчетПоВзаиморасчетам);
	// -- ПервыйБит ШиряеваВ
