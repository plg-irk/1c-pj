...
Функция ПолучитьСтандартныеОбязательныеРеквизиты(Объект) Экспорт
	...
	Для Каждого Измерение Из ОбъектМетаданных.Измерения Цикл
		Если ОбязательныеРеквизиты.Найти(Измерение.Имя) = Неопределено И (Измерение.ЗапрещатьНезаполненныеЗначения ИЛИ Измерение.ПроверкаЗаполнения = ПроверкаЗаполнения.ВыдаватьОшибку) Тогда
			ОбязательныеРеквизиты.Добавить(Измерение.Имя);
		КонецЕсли;
	КонецЦикла;
	
	Для Каждого Ресурс Из ОбъектМетаданных.Ресурсы Цикл
		Если ОбязательныеРеквизиты.Найти(Ресурс.Имя) = Неопределено И Ресурс.ПроверкаЗаполнения = ПроверкаЗаполнения.ВыдаватьОшибку Тогда
			ОбязательныеРеквизиты.Добавить(Ресурс.Имя);
		КонецЕсли;
	КонецЦикла;
	
	Для Каждого Реквизит Из ОбъектМетаданных.Реквизиты Цикл
		Если ОбязательныеРеквизиты.Найти(Реквизит.Имя) = Неопределено И Реквизит.ПроверкаЗаполнения = ПроверкаЗаполнения.ВыдаватьОшибку Тогда
