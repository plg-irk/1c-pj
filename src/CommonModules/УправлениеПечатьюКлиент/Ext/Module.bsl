...
// +РАРУС Реализован выбор наименования принтера
//
// Параметры:
...
//  ИмяПринтера                  - Строка - имя принтера
//
Процедура РаспечататьТабличныеДокументы(ТабличныеДокументы, ОбъектыПечати, Знач ПечататьКомплектами = Неопределено, Знач КоличествоКопийКомплектов = 1, ИмяПринтера = Неопределено) Экспорт
...
//  Форма    - УправляемаяФорма 				   - форма, из которой было вызвана команда.
...
//  ДополнительныеПараметры - Структура             - Набор параметров, использующихся при выполнения операции. // +Рарус
Процедура ВыполнитьПодключаемуюКомандуПечати(Знач Команда, Знач Форма, Знач Источник,ДополнительныеПараметры = Неопределено) Экспорт // +Рарус
	...
	Если ДополнительныеПараметры = Неопределено Тогда
		ДополнительныеПараметры = Новый Структура;
	КонецЕсли; 
	ДополнительныеПараметры.Вставить("Результат", Ложь);
	// -Рарус
...
// Параметры:
//  Handler - СсылкаПечатнаяФорма, СсылкаМакет - ссылка на печатную форму или макет,
...
// Параметры:
//  Handler - СсылкаПечатнаяФорма - ссылка на печатную форму.
//
...
//  Данные			-Структура - ДанныеЗаполнения.
//
...
//  Данные			- Массив - массив структур ДанныеОбъекта
//  ПереходНаСледующуюСтроку - Булево - требуется ли вставлять разрыв после вывода области.
//
