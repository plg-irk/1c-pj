...
Процедура СформироватьКомандыЭДО(ПолноеИмя, КомандыЭДО, НаправлениеЭД = Неопределено, ТолькоВМенюЕще = Ложь) Экспорт
	...
	Если СоставКоманд.Исходящие.Найти(ПолноеИмя) <> Неопределено 
		...
		Если ЗначениеФОИспользоватьОбменЭД И ЕстьПравоВывода И СоставКоманд.БезПодписи.Найти(ПолноеИмя) <> Неопределено Тогда // РАРУС
		...
		Если ЗначениеФОИспользоватьОбменЭД И ЕстьПравоВывода И ЕстьПодсистемаБизнесСеть И СоставКоманд.БезПодписи.Найти(ПолноеИмя) <> Неопределено Тогда // РАРУС
			КомандаЭДО = КомандыЭДО.Добавить();
	...
	Если СоставКоманд.Входящие.Найти(ПолноеИмя) <> Неопределено 
		...
		Если ЗначениеФОИспользоватьОбменЭД И ЕстьПравоОбменаЭД Тогда // РАРУС
