...
// Возвращает свойства субъекта сертификата по ссылке на элемент справочника сертификаты.
//
// Параметры:
...
Функция СвойстваСубъектаСертификатаПоСсылке(Сертификат) Экспорт
	...
	Возврат КриптографияБЭД.СвойстваСубъектаСертификатаПоСсылке(Сертификат);
