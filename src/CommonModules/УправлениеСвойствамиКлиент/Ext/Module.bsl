...
Функция ОбрабатыватьОповещения(Форма, ИмяСобытия, Параметр) Экспорт
	...
	Если НЕ (ЕстьРеквизитНаКлиенте(Форма, "Свойства_ИспользоватьСвойства") И Форма.Свойства_ИспользоватьСвойства)
	 ИЛИ НЕ (ЕстьРеквизитНаКлиенте(Форма, "Свойства_ИспользоватьДопРеквизиты") И Форма.Свойства_ИспользоватьДопРеквизиты) Тогда
