...
Функция ВыгрузкаДокументовДляПередачиВФНС(УчетныеДокументы, УникальныйИдентификатор) Экспорт
	...
	Если НастройкиЭДО.ИспользоватьИнтеграциюЦентраЭДО() Тогда
		АктуальныеЭлектронныеДокументы = ИнтеграцияЭДО.АктуальныеЭлектронныеДокументы(УчетныеДокументы);
		ЭлектронныеДокументы = АктуальныеЭлектронныеДокументы.ВыгрузитьКолонку("ЭлектронныйДокумент");
		...
		ОбщийМодульЭлектронныеДокументыЭДОИнтеграцияЦентраЭДО.ОбновитьПолныеДанныеДокументовЭДО(ЭлектронныеДокументы);
	КонецЕсли;
