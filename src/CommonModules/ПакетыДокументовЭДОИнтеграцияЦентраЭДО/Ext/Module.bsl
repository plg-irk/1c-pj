...
//  ОбщийМодуль
Функция МенеджерДействийСПакетамиДокументовИнтеграцииЦентраЭДО() Экспорт
	Возврат ПакетыДокументовЭДОИнтеграцияЦентраЭДО;
КонецФункции
...
Функция СоздатьПакетДокументов(ЭлектронныеДокументы, КонтекстДиагностики, Идентификатор = Неопределено) Экспорт
	...
	ИдентификаторыДокументовИОрганизаций = ЭлектронныеДокументыЭДОИнтеграцияЦентраЭДО.ИдентификаторыДокументовИОрганизаций(
	...
	Для Каждого УчетнаяЗаписьПоИдентификаторуЭДО Из УчетныеЗаписиПоИдентификаторамЭДО Цикл
		...
		РезультатВыполнения = ИнтеграцияЦентраЭДО.ВыполнитьМетодСервиса(
			ПараметрыВыполнения, ОписаниеМетода, КонтекстДиагностики); // См. ПрограммныйИнтерфейсЦентраЭДОВерсия3.СоздатьПакетДокументовЭДО
...
Функция ДобавитьДокументыВПакет(ИдентификаторПакета, ЭлектронныеДокументы, КонтекстДиагностики = Неопределено) Экспорт
	...
	Для Каждого УчетнаяЗаписьПоИдентификаторуЭДО Из УчетныеЗаписиПоИдентификаторамЭДО Цикл
		...
		РезультатВыполнения = ИнтеграцияЦентраЭДО.ВыполнитьМетодСервиса(ПараметрыВыполнения, ОписаниеМетода,
			КонтекстДиагностики); // См. ПрограммныйИнтерфейсЦентраЭДОВерсия3.ДобавитьДокументыЭДОВПакет
...
Функция УдалитьДокументИзПакета(ИдентификаторПакета, ЭлектронныйДокумент, КонтекстДиагностики = Неопределено) Экспорт
	...
	РезультатВыполнения = ИнтеграцияЦентраЭДО.ВыполнитьМетодСервиса(ПараметрыВыполнения, ОписаниеМетода,
		КонтекстДиагностики); // См. ПрограммныйИнтерфейсЦентраЭДОВерсия3.УдалитьДокументЭДОИзПакета
