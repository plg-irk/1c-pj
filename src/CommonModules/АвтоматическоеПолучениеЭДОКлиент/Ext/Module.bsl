...
Функция НовыеПараметрыФормыСпискаСостояний() Экспорт
...
// Параметры:
//  ПараметрыФормы - См. НовыеПараметрыФормыСпискаСостояний
//  Окно - ОкноКлиентскогоПриложения
//  КлючУникальности - Произвольный
Процедура ОткрытьФормуСпискаСостояний(ПараметрыФормы = Неопределено, Окно = Неопределено,
	КлючУникальности = Неопределено) Экспорт
	
	Если ПараметрыФормы = Неопределено Тогда
		ПараметрыФормы = НовыеПараметрыФормыСпискаСостояний();
	КонецЕсли;
