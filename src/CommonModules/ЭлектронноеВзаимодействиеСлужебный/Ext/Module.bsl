...
Функция НачатьЗамерВремени(КлючеваяОперация) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ОценкаПроизводительности") Тогда
		
		ОбщийМодульПовтИсп = ОбщегоНазначения.ОбщийМодуль("ОценкаПроизводительностиВызовСервераПовтИсп");
		ОбщийМодуль = ОбщегоНазначения.ОбщийМодуль("ОценкаПроизводительности");
		
		Если ОбщийМодульПовтИсп.ВыполнятьЗамерыПроизводительности() Тогда
			ВремяНачала = ОбщийМодуль.НачатьЗамерВремени();
...
Процедура ЗакончитьЗамерВремени(ОписаниеЗамера, КоличествоДанных = 1) Экспорт
	...
	Если ОписаниеЗамера <> Неопределено И ОбщегоНазначения.ПодсистемаСуществует("ОценкаПроизводительности") Тогда
		...
		ОбщийМодуль.ЗакончитьЗамерВремени(ОписаниеЗамера.КлючеваяОперация,
			ВремяНачала,
			ОписаниеЗамера.Вес,
