...
//   ПараметрыВызова - Структура - Параметры команды.
//   Источник  - ДанныеФормыСтруктура, Ссылка - источник.
...
//           Используется при необходимости префиксации групп с командами (в частности,
//           когда в форме несколько таблиц).
...
//           то используются подменю с именами "СкладскиеДокументыПодменюПечать",
//           "СкладскиеДокументыПодменюОтчеты" и т.д.
//
...
Функция ЗарегистрироватьПодменю(Элементы, СведенияОВсехПодменю, ИмяПодменю, ШаблонНового = Неопределено, КоманднаяПанель = Неопределено, ПодменюПоУмолчанию = Неопределено)
	...
	Если ЗначениеЗаполнено(ИмяПодменю) Тогда
		...
		Если Не Группы.Свойство("Важное") Тогда
			...
			ГруппаВажное.Заголовок = НСтр("ru = 'Важное'");
		...
		Если Не Группы.Свойство("Обычное") Тогда
			...
			ГруппаПоУмолчанию.Заголовок = НСтр("ru = 'Обычное'");
		...
		Если Не Группы.Свойство("СмТакже") Тогда
			...
			ГруппаСмТакже.Заголовок = НСтр("ru = 'См. также'");
...
//       * Порядок - Число - Порядок размещения команды в подменю. Используется для настройки
...
//       * ПараметрыФормы - Неопределено, ФиксированнаяСтруктура - Необязательный. Параметры формы,
//                                                                 указанной в ИмяФормы.
...
//       * ДополнительныеПараметры - Неопределено, ФиксированнаяСтруктура - Необязательный. Параметры обработчика,
//                                                                          указанного в Обработчик.
//
