...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа.ТипГруппЗначений   = Тип("СправочникСсылка.ПодразделенияКомпании");
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя           = "ХозОперации";
	ВидДоступа.Представление = НСтр("ru = 'Хозяйственные операции'");
	ВидДоступа.ТипЗначений   = Тип("СправочникСсылка.ХозОперации");
	
	//ВидДоступа = ВидыДоступа.Добавить();
	//ВидДоступа.Имя           = "РегламентированныйУчет";
	//ВидДоступа.Представление = НСтр("ru = 'Регламентированный учет'");
	//ВидДоступа.ТипЗначений   = Тип("Булево");
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// Описание для заполнения предопределенного профиля "Базовые права".
	ОписаниеПрофиляАдминистратор = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиляАдминистратор.Имя           = НСтр("ru = 'Базовые права'");
	ОписаниеПрофиляАдминистратор.Идентификатор = "c467bd9a-7ebe-4eec-9d89-210cc6cb1bb2";
	ОписаниеПрофиляАдминистратор.Наименование  = НСтр("ru = 'Базовые права'");
	ОписаниеПрофиляАдминистратор.Описание      = НСтр("ru = 'Предназначен для настройки базовых прав пользователей. Рекомендуется использовать как минимальный набор прав для работы в информационной системе.'");
	
	ОписаниеПрофиляАдминистратор.Роли.Добавить("БазовыеПрава");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ЗапускТолстогоКлиента");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеЗаметок");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеНапоминаний");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ТехнологическаяПлатформа");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеИнформацииОВерсияхОбъектов");
	ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеБазовыхКлассификаторов");
	
	//// +evkhil
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеСтруктурыКомпании");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеБанкИКассовыеОперации");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеФинансыИПланирование");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеЗарплата");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеПрочиеАктивы");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеРегламентныеДокументы");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеБазовойНСИ");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ПросмотрЖурналаРегистрации");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ЧтениеДополнительныхСведений");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеЗаказыПокупателей");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеЗаказыСнабжения");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеЗакупкаТоваров");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ИзменениеДополнительныхСведений");
	//ОписаниеПрофиляАдминистратор.Роли.Добавить("ДобавлениеИзменениеДокументовРезервированияЗаказовПокупателей");
	//// -evkhil
