...
//  ИмяИндекса      - Строка - одно из значений ИндексДолжнойОсмотрительности,
//                             ИндексПлатежнойДисциплины, ИндексФинансовогоРиска.
//
...
#Область ВыводДанных_Многострочный
		...
		// Если данные есть, то:
		// "1СПАРК Риски|Событие мониторинга %1|Индекс ...: %2 (_%3 риск_)
		// |Индекс ...: %4 (_%5 риск_)|Индекс ...: %6 (_%7 риск_)".
		// В случае других ошибок, вывести их.
		ЕстьОшибкаПодключения = Истина;
		МассивСтрок.Добавить(
			Новый ФорматированнаяСтрока(
...
//  Контрагент - Определяемый тип КонтрагентБИП, Строка - Контрагент или ИНН контрагента;
//  Форма      - УправляемаяФорма - форма, в которой необходимо вывести информацию об индексах СПАРК Риски.
//  ИнициироватьЗагрузкуДанных - Булево - в случае, если данных нет или они просрочены,
//                                        то запустить фоновое задание загрузки данных.
//
// Возвращаемое значение:
