...
Функция НовоеВходящееПриглашение(КлючПриглашения = "") Экспорт
	...
	Приглашение.Вставить("ИспользоватьЦентрЭДО", Ложь);
...
// Возвращает путь к форме приглашения к ЭДО в зависимости от варианта интерфейса.
// 
// Параметры:
//  ВариантИнтерфейса - Строка - См. ОбменСКонтрагентамиКлиентСервер.ВариантыИнтерфейсаПриглашенийЭДО
// 
// Возвращаемое значение:
//  Строка
Функция ФормаПриглашенияПоВариантуИнтерфейса(ВариантИнтерфейса) Экспорт
	
	ФормыПриглашения = ФормыПриглашенийПоВариантамИнтерфейса();
	Возврат ФормыПриглашения[ВариантИнтерфейса];
...
//  * Ключ - Строка - См. ОбменСКонтрагентамиКлиентСервер.ВариантыИнтерфейсаПриглашенийЭДО
//  * Значение - Строка - путь к форме
Функция ФормыПриглашенийПоВариантамИнтерфейса()
	
	ВариантыИнтерфейса = ОбменСКонтрагентамиКлиентСервер.ВариантыИнтерфейсаПриглашенийЭДО();
	
	Результат = Новый Соответствие;
	Результат.Вставить(ВариантыИнтерфейса.Расширенный, 
		"РегистрСведений.ПриглашенияКОбменуЭлектроннымиДокументами.Форма.ПомощникОтправкиПриглашения");
	Результат.Вставить(ВариантыИнтерфейса.ЛегкийКлиентЭДО, 
		"РегистрСведений.ПриглашенияКОбменуЭлектроннымиДокументами.Форма.ПомощникОтправкиПриглашенияЛегкийКлиентЭДО");
