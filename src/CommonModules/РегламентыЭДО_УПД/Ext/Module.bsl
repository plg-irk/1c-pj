...
Функция СостояниеВходящегоДокумента(ПараметрыДокумента, СостоянияЭлементовРегламента) Экспорт
	...
	Если ЗаполнитьСостояниеПоПредложениюОбАннулировании(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние) 
		
		ИЛИ ЗаполнитьСостояниеПоОтказуВПодписи(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
		...
		ИЛИ ЗаполнитьСостояниеПоПодтверждениюОператора(ПараметрыДокумента,СостоянияЭлементовРегламента,
			Перечисления.ТипыЭлементовРегламентаЭДО.ПДО, Состояние)
		...
		ИЛИ ПараметрыДокумента.ТребуетсяПодтверждение
			И ЗаполнитьСостояниеПоПодтверждениюОператора(ПараметрыДокумента, СостоянияЭлементовРегламента,
				Перечисления.ТипыЭлементовРегламентаЭДО.ИнформацияПолучателя_ПДП, Состояние)
...
Функция СостояниеИсходящегоДокумента(ПараметрыДокумента, СостоянияЭлементовРегламента) Экспорт
	...
	Если (ЭтоЭлектронноеАктированиеЕИС
		...
		ИЛИ ЗаполнитьСостояниеПоПодтверждениюОператора(ПараметрыДокумента, СостоянияЭлементовРегламента,
			Перечисления.ТипыЭлементовРегламентаЭДО.ПДП, Состояние)
...
Процедура ДобавитьЭлементыРегламентаПолучателя(СхемаРегламента, НастройкиСхемыРегламента, ЭлементыСхемы)
	...
	Если ЭтоОбменЧерезОператора Тогда
		...
		ИП_ПДП = РегламентыЭДО.ВставитьЭлементСхемыРегламента(ЭлементыСхемы, ИнформацияПолучателя,
			Перечисления.ТипыЭлементовРегламентаЭДО.ИнформацияПолучателя_ПДП);
		...
		РегламентыЭДО.ВставитьЭлементСхемыРегламента(ЭлементыСхемы, ИП_ПДП,
...
Функция ЗаполнитьСостояниеПоПредложениюОбАннулировании(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если РегламентыЭДО.ЕстьАктуальноеОтклонениеАннулирования(СостоянияЭлементовРегламента,
		...
		ИначеЕсли ОтклонениеПОА.Состояние = Перечисления.СостоянияСообщенийЭДО.ПодготовкаКОтправке Тогда
			...
			Если ОтклонениеПОА.ТипЭлементаРегламента = Перечисления.ТипыЭлементовРегламентаЭДО.УС_ОтказВПодписи Тогда
...
Функция ЗаполнитьСостояниеПоИсходящемуОтклонению(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыУОУ, ,
		ЭлементРегламента) Тогда
...
Функция ЗаполнитьСостояниеПоИсходящемуИзвещениюОПолучении(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	ТипыИОП = РегламентыЭДО.ТипыЭлементовРегламентаЭДОИзвещенийПервыхТитулов();
	
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(
		СостоянияЭлементовРегламента, ТипыИОП, Перечисления.НаправленияЭДО.Исходящий, ЭлементРегламента) Тогда
...
Функция ЗаполнитьСостояниеПоИсходящемуИзвещениюОПолученииИнформацииПолучателя(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	ТипыИОПИнформацииПолучателя = РегламентыЭДО.ТипыЭлементовРегламентаЭДОИзвещенийОтветныхТитулов();
	
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, 
		ТипыИОПИнформацииПолучателя, 
...
//  Булево
//
Функция ЗаполнитьСостояниеПоПодтверждениюОператора(ПараметрыДокумента, СостоянияЭлементовРегламента, Подтверждение, Состояние)
...
Функция ЗаполнитьСостояниеПоВходящемуОтклонению(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	ТипыУОУ = РегламентыЭДО.ТипыЭлементовРегламентаЭДОУточнений();
	Если Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипыУОУ) Тогда
...
Функция ЗаполнитьСостояниеПоВходящемуИзвещениюОПолучении(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если ПараметрыДокумента.ТребуетсяИзвещение И Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(
		СостоянияЭлементовРегламента, ТипИОП, Перечисления.НаправленияЭДО.Входящий) Тогда
