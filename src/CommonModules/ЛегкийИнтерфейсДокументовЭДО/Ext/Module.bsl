...
// См. ЛегкийИнтерфейсДокументовЭДОСлужебный.ЗаполнитьДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования
//
Процедура ЗаполнитьДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования(ДанныеКомпонента,
	...
	ЛегкийИнтерфейсДокументовЭДОСлужебный.ЗаполнитьДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования(
		ДанныеКомпонента, ВизуализацияДокумента);
...
Функция НовыеДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования() Экспорт
	Возврат ЛегкийИнтерфейсДокументовЭДОСлужебный.НовыеДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования();
КонецФункции
...
Процедура ЗаполнитьДанныеКомпонентаПанельСообщений(ДанныеКомпонента, СвойстваДокумента) Экспорт
	...
	ЛегкийИнтерфейсДокументовЭДОСлужебный.ЗаполнитьДанныеКомпонентаПанельСообщений(ДанныеКомпонента, СвойстваДокумента);
	
КонецПроцедуры

// Возвращаемое значение:
//  См. ЛегкийИнтерфейсДокументовЭДОСлужебный.НовыеДанныеКомпонентаПанельСообщений
Функция НовыеДанныеКомпонентаПанельСообщений() Экспорт
	Возврат ЛегкийИнтерфейсДокументовЭДОСлужебный.НовыеДанныеКомпонентаПанельСообщений();
КонецФункции
...
#КонецОбласти // ИнтеграцияЦентраЭДО
...
Функция ЗаполнитьДанныеКомпонентовПросмотраДокумента(ДанныеКомпонентов, ПараметрыЗаполнения) Экспорт
	...
	МенеджерДанных = МенеджерДанныхИнтеграцииЭДО(ПараметрыЗаполнения.СвойстваДокумента.ИспользоватьЦентрЭДО);
...
//  * ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО - Неопределено
//                                                    - См. НовыеДанныеКомпонентаПанельКомандНастроекВизуализацииЛегкийКлиентЭДО
...
//  * ПанельРеквизитовВходящегоДокументаДляРедактирования - Неопределено
//                                                        - См. ПанельРеквизитовВходящегоДокументаДляРедактирования
//  * ПанельМаршрута - Неопределено
//                   - См. НовыеДанныеКомпонентаПанельМаршрута
//  * ПанельСообщений - Неопределено
//                   - См. НовыеДанныеКомпонентаПанельСообщений
Функция НовыеДанныеКомпонентовПросмотраДокумента(КомпонентыДляИнициализации = "") Экспорт
	...
	ДанныеКомпонентовПросмотра.Вставить("ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО", Неопределено);
	...
	ДанныеКомпонентовПросмотра.Вставить("ПанельРеквизитовВходящегоДокументаДляРедактирования", Неопределено);
	ДанныеКомпонентовПросмотра.Вставить("ПанельМаршрута", Неопределено);
	ДанныеКомпонентовПросмотра.Вставить("ПанельСообщений", Неопределено);
	...
	Для Каждого ИмяКомпонента Из ИменаКомпонентовДляИнициализации Цикл
		...
		ИначеЕсли ИмяКомпонента = "ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО" Тогда
			ДанныеКомпонентовПросмотра[ИмяКомпонента] = НовыеДанныеКомпонентаПанельКомандНастроекВизуализацииЛегкийКлиентЭДО();
		...
		ИначеЕсли ИмяКомпонента = "ПанельРеквизитовВходящегоДокументаДляРедактирования" Тогда
			ДанныеКомпонентовПросмотра[ИмяКомпонента] = НовыеДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования();
		ИначеЕсли ИмяКомпонента = "ПанельМаршрута" Тогда
			ДанныеКомпонентовПросмотра[ИмяКомпонента] = НовыеДанныеКомпонентаПанельМаршрута();
		ИначеЕсли ИмяКомпонента = "ПанельСообщений" Тогда
			ДанныеКомпонентовПросмотра[ИмяКомпонента] = НовыеДанныеКомпонентаПанельСообщений();	
		КонецЕсли;
	КонецЦикла;
...
Функция НовыеСвойстваДокументаДляПолученияДанныхКомпонентовПросмотра() Экспорт
	...
	СвойстваДокумента.Вставить("ИспользоватьЦентрЭДО", Ложь);
...
//                               - См. РегистрыСведений.ВизуализацииДокументовЦентраЭДО.НовыеСвойстваВизуализации
// * ПредварительныйСоставПакета - Неопределено
//                               - См. НовыйПредварительныйСоставПакета
...
// См. ЛегкийИнтерфейсДокументовЭДОСлужебный.НовыеДанныеКомпонентаПанельКомандНастроекВизуализацииЛегкийКлиентЭДО
//
Функция НовыеДанныеКомпонентаПанельКомандНастроекВизуализацииЛегкийКлиентЭДО() Экспорт
	
	Возврат ЛегкийИнтерфейсДокументовЭДОСлужебный.НовыеДанныеКомпонентаПанельКомандНастроекВизуализацииЛегкийКлиентЭДО();
...
//  ЭлектронныйДокумент - ДокументСсылка.ЭлектронныйДокументИсходящийЭДО,ДокументСсылка.ЭлектронныйДокументВходящийЭДО
//  ИдентификаторФормы - УникальныйИдентификатор
//  ЭтоИнтеграцияЦентраЭДО - Булево
// 
// Возвращаемое значение:
//  См. НовыйРезультатПолученияДанныхФайлаИнформацииОтправителя
Функция ДанныеФайлаИнформацииОтправителяДокументаПоИнтеграциям(ЭлектронныйДокумент, ИдентификаторФормы,
	ЭтоИнтеграцияЦентраЭДО = Ложь) Экспорт

	МенеджерДанных = МенеджерДанныхИнтеграцииЭДО(ЭтоИнтеграцияЦентраЭДО);
...
Процедура НастроитьПанелиПросмотраКарточкиДокумента(Форма, ДанныеКомпонентов) Экспорт
	...
	Если ЗначениеЗаполнено(ДанныеКомпонентов.ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО) Тогда
		НастроитьПанельКомандНастроекВизуализацииКарточкиДокументаЛегкийКлиентЭДО(Форма,
			ДанныеКомпонентов.ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДанныеКомпонентов.ПанельСообщений) Тогда
		НастроитьПанельСообщений(Форма, ДанныеКомпонентов.ПанельСообщений);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДанныеКомпонентов.ПанельРеквизитовВходящегоДокументаДляРедактирования) Тогда
		НастроитьПанельРеквизитовВходящегоДокументаДляРедактирования(Форма,
			ДанныеКомпонентов.ПанельРеквизитовВходящегоДокументаДляРедактирования);
	КонецЕсли;
...
// При использовании легкого варианта интерфейса или интеграции центра ЭДО расширяет структуру параметров
...
Функция ПроверитьВозможностьИзмененияКлючевыхРеквизитовПакета(Форма) Экспорт
	...
	Для Каждого РеквизитыПоДокументуПакета Из РеквизитыДокументовПакета Цикл
		...
		ЭллектронныйДокумент = РеквизитыПоДокументуПакета.Ключ;
...
// Возвращаемое значение:
//  ОбщийМодуль
Функция МенеджерДанныхИнтеграцииЭДО(ИспользоватьЦентрЭДО = Ложь)
	
	Если ИспользоватьЦентрЭДО Тогда
		ОбщийМодульИнтерфейсДокументовЭДОИнтеграцияЦентраЭДО = ОбщегоНазначения.ОбщийМодуль(
			"ИнтерфейсДокументовЭДОИнтеграцияЦентраЭДО");
		Возврат ОбщийМодульИнтерфейсДокументовЭДОИнтеграцияЦентраЭДО.МенеджерДанныхИнтеграцииЦентраЭДО();
	Иначе
...
Функция ЗаполнитьДанныеКомпонентовПросмотраДокументаАсинхронно(ДанныеКомпонентов, ПараметрыЗаполнения) Экспорт
	...
	МенеджерДанныхИнтеграцииЭДО = МенеджерДанныхИнтеграцииЭДО(СвойстваДокумента.ИспользоватьЦентрЭДО);
...
Функция СвойстваДокументаДляПолученияДанныхКомпонентовПросмотраКарточкиДокумента(Форма)
	...
	СвойстваДокумента.ИспользоватьЦентрЭДО = Объект.ИспользоватьЦентрЭДО;
...
Функция ПредставлениеСостоянияПоДаннымСостоянияЭДО(СостояниеЭДО)
	...
	ПредставленияПоСостояниямЭДО.Вставить(
		Перечисления.СостоянияДокументовЭДО.ОтказаноВПодписиКонтрагенту, ВариантыПредставлений.ОтказаноВПодписиКонтрагенту);
	ПредставленияПоСостояниямЭДО.Вставить(
		Перечисления.СостоянияДокументовЭДО.КонтрагентОтказалВПодписи, ВариантыПредставлений.КонтрагентОтказалВПодписи);
	ПредставленияПоСостояниямЭДО.Вставить(
	...
	ПредставленияПоСостояниямЭДО.Вставить(
		Перечисления.СостоянияДокументовЭДО.ТребуетсяОтправкаОтказаВПодписи, ВариантыПредставлений.Отправить);
	ПредставленияПоСостояниямЭДО.Вставить(
	...
	ПредставленияПоСостояниямЭДО.Вставить(
		Перечисления.СостоянияДокументовЭДО.ТребуетсяПодготовкаКОтправкеОтказаВПодписи, ВариантыПредставлений.Отправить);	
	ПредставленияПоСостояниямЭДО.Вставить(
...
Функция ЦветПанелиСостоянияПоПредставлениям(ПредставлениеПоСостояниюЭДО, ПредставлениеПоОтражениюВУчете)
	...
	ЦветаПоСостояниямЭДО.Вставить(ВариантыПредставленийПоСостояниямЭДО.Отменен,
		ВариантыЦвета.Красный);
	ЦветаПоСостояниямЭДО.Вставить(ВариантыПредставленийПоСостояниямЭДО.КонтрагентОтказалВПодписи,
		ВариантыЦвета.Красный);
	ЦветаПоСостояниямЭДО.Вставить(ВариантыПредставленийПоСостояниямЭДО.ОтказаноВПодписиКонтрагенту,
		ВариантыЦвета.Красный);
...
Функция ПредставленияСостоянияПоДаннымСостоянияЭДО()
	...
	Представления.Вставить("КонтрагентОтказалВПодписи", НСтр("ru = 'Контрагент отказал в подписи'"));
	Представления.Вставить("ОтказаноВПодписиКонтрагенту", НСтр("ru = 'Отказано в подписи контрагенту'"));
	Возврат Представления;
...
Процедура НастроитьПанельОтраженияВУчетеКарточкиДокумента(Форма, ДанныеКомпонента)
	...
	ТребуетсяПоказыватьВторойДокументУчета = ДваОбъектаУчета Или МногоОбъектовУчета;
	...
	Форма.Элементы.КнопкаПодобратьДокументУчета1.Видимость = ЭтоВходящийЭДО И НетОбъектовУчета
		И ЕстьВозможностьОтраженияВУчете И ЕстьПравоОбработкиДокументов;
	Форма.Элементы.КнопкаОткрытьДокументУчета1.Видимость = ОдинОбъектУчета Или ТребуетсяПоказыватьВторойДокументУчета;
	Форма.Элементы.КнопкаРазорватьСвязьДокументаУчета1.Видимость = ЭтоВходящийЭДО 
		И (ОдинОбъектУчета Или ТребуетсяПоказыватьВторойДокументУчета) И ЕстьПравоОбработкиДокументов;

	Форма.Элементы.ГруппаДокументУчета2.Видимость = Не НетОбъектовУчета И ЕстьВозможностьОтраженияВУчете 
		Или ТребуетсяПоказыватьВторойДокументУчета;
	...
	Форма.Элементы.КнопкаОткрытьДокументУчета2.Видимость = ТребуетсяПоказыватьВторойДокументУчета;
	Форма.Элементы.КнопкаРазорватьСвязьДокументаУчета2.Видимость = ЭтоВходящийЭДО И ЕстьПравоОбработкиДокументов
		И ТребуетсяПоказыватьВторойДокументУчета;
	...
	Если ТребуетсяПоказыватьВторойДокументУчета Тогда
		Форма.Элементы.КнопкаОткрытьДокументУчета1.Заголовок = Строка(
			ДанныеКомпонента.ОбъектыУчетаДокумента[0].ОбъектУчета);
	...
	ИначеЕсли МногоОбъектовУчета Тогда
		Форма.Элементы.КнопкаПоказатьВсеДокументыУчета.Заголовок =
			СтрШаблон(НСтр("ru = 'и еще (%1)'"), КоличествоОбъектовУчета - 2);
	Иначе
		Форма.Элементы.КнопкаПоказатьВсеДокументыУчета.Заголовок = НСтр("ru = 'Все документы'");
	КонецЕсли;

	Форма.Элементы.НадписьДокументыУчета.Заголовок = ?(ТребуетсяПоказыватьВторойДокументУчета,
	...
	Форма.Элементы.ДекорацияОтступОтражениеВУчете.Видимость = Не НетОбъектовУчета
		И Не ТребуетсяПоказыватьВторойДокументУчета;
...
Процедура НастроитьПанельЗакладокВходящегоДокумента(Форма, ДанныеКомпонента)
	...
	Если ДанныеКомпонента.ИспользоватьУниверсальныеСообщения Тогда
		Форма.Элементы.СтраницаСопроводительнаяЗаписка.Видимость = Ложь;
		Форма.Элементы.СтраницаСообщения.Видимость = Истина;
	Иначе
		...
		Форма.Элементы.СтраницаСообщения.Видимость = Ложь;
	КонецЕсли;
...
Процедура НастроитьПанельКомандНастроекВизуализацииКарточкиДокумента(Форма, ДанныеКомпонента)
	...
	Если ЭтоВходящийЭДО Тогда
		...
		Форма.Элементы.ВключитьРедактированиеРеквизитовНеформализованныхДокументов.Видимость = Ложь;
	КонецЕсли;
	...
	Если ЭтоВходящийЭДО Тогда
		Форма.Элементы.КнопкаЗаписатьДокумент.Видимость =
			...
			И ДанныеКомпонента.ДоступноРедактированиеРеквизитовДокумента;
		Форма.Элементы.ВключитьРедактированиеРеквизитовНеформализованныхДокументов.Видимость = 
			ДанныеКомпонента.ДоступноРедактированиеРеквизитовДокумента;
		Форма.Элементы.ВключитьРедактированиеРеквизитовНеформализованныхДокументов.Пометка =
			ДанныеКомпонента.ИспользуетсяРедактированиеРеквизитовВходящихНеформализованныхДокументов;
	КонецЕсли;
...
Процедура НастроитьПанельКомандНастроекВизуализацииКарточкиДокументаЛегкийКлиентЭДО(Форма, ДанныеКомпонента)
...
//  Форма - ФормаКлиентскогоПриложения - форма просмотра входящего электронного документа легкого интерфейса:
//  * Элементы - ВсеЭлементыФормы:
//  ** ГруппаПанельРеквизитовВходящегоДокументаДляРедактирования - ГруппаФормы
//  ** ВидДокументаДляРедактирования - ПолеВвода
//  ДанныеКомпонента - См. ЛегкийИнтерфейсДокументовЭДОСлужебный.НовыеДанныеКомпонентаПанельРеквизитовВходящегоДокументаДляРедактирования
Процедура НастроитьПанельРеквизитовВходящегоДокументаДляРедактирования(Форма, ДанныеКомпонента)

	Если Не ДанныеКомпонента.ДоступноРедактированиеРеквизитовДокумента Тогда
		Форма.Элементы.ГруппаНеДоступныеРеквизитыФайлПраво.Видимость = Истина;
		Форма.Элементы.ГруппаПанельРеквизитовВходящегоДокументаДляРедактирования.Видимость = Ложь;
		Возврат;
	КонецЕсли;
	
	Форма.Элементы.ГруппаНеДоступныеРеквизитыФайлПраво.Видимость = Ложь;
	Форма.Элементы.ГруппаПанельРеквизитовВходящегоДокументаДляРедактирования.Видимость = Истина;
	Форма.Элементы.ВидДокументаДляРедактирования.СписокВыбора.ЗагрузитьЗначения(
		ДанныеКомпонента.ВидыДокументовДоступныеДляВыбора);
...
Процедура НастроитьПанельКомандВыполнениеДействийПоЭДОКарточкиДокумента(Форма, ДанныеКомпонента)
	...
	ЗаполнитьЗначенияСвойств(ПараметрыОпределенияИспользованияУС, Форма.Объект);
	ИспользоватьУниверсальныеСообщения = РегламентыЭДО.ИспользоватьУниверсальныеСообщения(ПараметрыОпределенияИспользованияУС);
	...
	ОтклонениеДоступно = Не ИспользоватьУниверсальныеСообщения И ЕстьДействиеПоЭДО(ДействияНаЭтапе, Перечисления.ДействияПоЭДО.Отклонить);
	ОтклонениеДокументаПакетаДоступно =  Не ИспользоватьУниверсальныеСообщения И ЕстьДействиеПоЭДО(ДействияНаЭтапеДляДокументаПакета,
	...
	УточнениеДоступно = ИспользоватьУниверсальныеСообщения И ЕстьДействиеПоЭДО(ДействияНаЭтапе, Перечисления.ДействияПоЭДО.ЗапроситьУточнение);
	УточнениеДоступноПакетаДоступно = ИспользоватьУниверсальныеСообщения И ЕстьДействиеПоЭДО(ДействияНаЭтапеДляДокументаПакета,
		Перечисления.ДействияПоЭДО.ЗапроситьУточнение); 
	Форма.Элементы.КнопкаЗапроситьУточнениеПакет.Видимость = УточнениеДоступно;
	Форма.Элементы.КнопкаЗапроситьУточнениеДокументПакета.Видимость = УточнениеДоступноПакетаДоступно;
	Форма.Элементы.КнопкаСоставПакетаЗапроситьУточнениеДокумент.Видимость = 
		Форма.Элементы.КнопкаЗапроситьУточнениеДокументПакета.Видимость;
	...
	Если ЭтоИсходящийЭДО Тогда
		...
		Форма.Элементы.КнопкаОтклонитьПодписание.Заголовок = 
			ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыОтказатьсяОтПодписания(ЭтоПакетДокументов);
		Форма.Элементы.КнопкаОтклонитьПодписаниеПакет.Заголовок = 
			ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыОтказатьсяОтПодписания(ЭтоПакетДокументов);
		Форма.Элементы.КнопкаОтклонитьПодписаниеДокументПакета.Заголовок = 
			ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыОтказатьсяОтПодписания(Ложь);
		Форма.Элементы.КнопкаСоставПакетаОтклонитьПодписаниеДокумент.Заголовок = 
			ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыОтказатьсяОтПодписания(ЭтоПакетДокументов);
	Иначе
		ОтказДоступен =  ИспользоватьУниверсальныеСообщения И ЕстьДействиеПоЭДО(ДействияНаЭтапе, Перечисления.ДействияПоЭДО.Отклонить);
		ОтказатьсяОтПодписанияПакетаДоступно = ИспользоватьУниверсальныеСообщения И ЕстьДействиеПоЭДО(ДействияНаЭтапеДляДокументаПакета,
			Перечисления.ДействияПоЭДО.Отклонить); 
		Форма.Элементы.КнопкаОтказатьсяОтПодписания.Видимость = ОтказДоступен;
		Форма.Элементы.КнопкаОтказатьсяОтПодписанияПакет.Видимость = ОтказатьсяОтПодписанияПакетаДоступно;
		
		Форма.Элементы.КнопкаСоставПакетаОтказатьсяОтПодписанияДокумент.Видимость = ОтказатьсяОтПодписанияПакетаДоступно;
		Форма.Элементы.КнопкаОтказатьсяОтПодписанияДокументПакета.Видимость = ОтказатьсяОтПодписанияПакетаДоступно;
			
		Форма.Элементы.КнопкаОтказатьсяОтПодписания.Заголовок = 
			ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыОтказатьсяОтПодписания(ЭтоПакетДокументов);
	КонецЕсли;
...
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма просмотра электронного документа легкого интерфейса:
//  * ВсеСообщения - ФорматированнаяСтрока
//  * ТекстСообщения - Строка
//  ДанныеКомпонента - См. НовыеДанныеКомпонентаПанельСообщений
Процедура НастроитьПанельСообщений(Форма, ДанныеКомпонента)
	
	Форма.Элементы.ОтправитьСообщение.Доступность = ДанныеКомпонента.ДоступнаОтправка;
	Форма.Элементы.ТекстСообщения.Доступность = ДанныеКомпонента.ДоступнаОтправка;
	Форма.ТекстСообщения = "";
	
	ПредставлениеЧата = РегистрыСведений.ТекстовыеСообщенияДокументовЭДО.ПредставлениеЧата(ДанныеКомпонента.Сообщения);
	Форма.ВсеСообщения.УстановитьФорматированнуюСтроку(ПредставлениеЧата);
...
Функция РеквизитыАктуальныхДокументовДляПросмотраСтатусов(ОбъектыУчета)
	...
	Запрос.Текст =
		...
		|	ОбъектыУчетаДокументовЭДО.ОбъектУчета,
		|	ЛОЖЬ,
		|	ЭлектронныйДокументИсходящийЭДО.ИспользоватьЦентрЭДО,
