...
Функция ДеревоРолей(ПоПодсистемам = Истина, Назначение = "ДляПользователей") Экспорт
	...
	// +РАРУС
	Дерево.Строки.Сортировать("Порядок Возр, ЭтоРоль Убыв, Синоним Возр", Истина);
	// -РАРУС
...
// +РАРУС
Процедура ЗаполнитьПодсистемыИРоли(КоллекцияСтрокДерева, Подсистемы, НедоступныеРоли, ВсеРоли = Неопределено, ТекущийИндекс = 0) // -РАРУС
