...
Функция ПроверяемыеСервисыИнтернетСоединение(РезультатДиагностики, УчетныеЗаписи)
	...
	ДобавитьСервисыЦентровЭДО(Сервисы, УчетныеЗаписи);
...
// Параметры:
//  Сервисы - Соответствие из КлючИЗначение:
//  * Ключ - Строка
//  * Значение - Строка
//  УчетныеЗаписи - Массив из Строка
Процедура ДобавитьСервисыЦентровЭДО(Сервисы, УчетныеЗаписи)
	...
	ОписанияСервисов = МодульИнтеграцияЦентраЭДО.ОписанияСервисовУчетныхЗаписейЭДО(УчетныеЗаписи);
	Для Каждого ОписаниеСервиса Из ОписанияСервисов Цикл
		Сервисы.Вставить(ОписаниеСервиса.АдресРесурса, ПредставлениеСервисаЭДО(ОписаниеСервиса.АдресСервиса));
	КонецЦикла;
