...
// Определяет максимальное количество непрерывных запросов к Национальному каталогу.
//
// Возвращаемое значение:
//   Число - лимит запросов.
//
Функция ПолучитьЛимитЗапросовНациональногоКаталога() Экспорт
...
Функция ПараметрыПоискаКатегорийПоСтроке() Экспорт
	...
	Результат.Вставить("ПоискПоТНВЭД",                   Ложь);
