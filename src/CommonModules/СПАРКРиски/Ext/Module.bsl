...
//  ПризнакЗагрузкиДанных - Булево, УникальныйИдентификатор - если ИСТИНА, то в случае, если данных нет
//            или они просрочены, то запустить фоновое задание загрузки данных. Если передан УникальныйИдентификатор,
//            то это идентификатор фонового задания.
//
// Возвращаемое значение:
	...
	Если (НеобходимоЗагрузитьИнформацию = Истина) Тогда
		...
		Если НЕ ПустаяСтрока(КонтрагентИНН) Тогда
			...
			Если СПАРКРискиКлиентСервер.ИННСоответствуетТребованиям(КонтрагентИНН, ТекстОшибки) Тогда
				...
				// Ограничение: в один момент времени нельзя запустить несколько фоновых заданий
				// по получению индексов для одинакового ИНН.
...
//  ПризнакЗагрузкиДанных - Булево, УникальныйИдентификатор - если ИСТИНА, то в случае, если данных нет
//             или они просрочены, то запустить фоновое задание загрузки данных. Если передан
//             УникальныйИдентификатор, то это идентификатор фонового задания.
//
...
//
// Параметры:
//  ПроверяемыеФоновыеЗадания - Массив - массив структур, описанных 
//                                       в СПАРКРискиКлиент.НовыйПроверкаЗавершенностиФоновогоЗадания.
//
// Возвращаемое значение:
