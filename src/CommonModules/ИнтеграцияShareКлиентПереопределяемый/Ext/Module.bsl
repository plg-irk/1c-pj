...
//              при закрытии формы. В дополнительные параметры необходимо передать результат с типом
...
// Переопределяет обработку навигационной ссылки на форме обработки СервисShare
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма обработки СервисShare
//  НавигационнаяСсылка - Строка - значение гиперссылки форматированной строки.
//  СтандартнаяОбработка - Булево - признак выполнения стандартной обработки события ОбработкаНавигационнойСсылки.
Процедура ПриОпределенииОбработкиНавигационнойСсылкиНаФорме(Знач Форма, НавигационнаяСсылка, СтандартнаяОбработка) Экспорт
