...
//  
// 
Процедура ВывестиСообщениеПоКоду(Знач Код, Знач Объект=Неопределено, Знач Поле="", НомерСтроки=Неопределено, Отказ=ЛОЖЬ, Знач Параметр1=Неопределено, Знач Параметр2=Неопределено, Знач Параметр3=Неопределено, Знач Параметр4=Неопределено, Знач Параметр5=Неопределено, Знач Параметр6=Неопределено, Знач Параметр7=Неопределено, Знач Параметр8=Неопределено, Знач Параметр9=Неопределено) Экспорт
