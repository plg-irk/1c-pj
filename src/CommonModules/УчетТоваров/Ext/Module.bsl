...
Функция ПодготовитьТаблицыСписанныеТоварыИВыпущеннаяПродукция(ТаблицаТовары, ТаблицаРеквизиты, Отказ) Экспорт
...
Функция ПодготовитьТаблицыСписанныеМатериалыДляВыпускаПродукции(ТаблицаМатериаловДляСписания, Реквизиты) Экспорт
	
	СтруктураТаблицСписания = Новый Структура;
	СтруктураТаблицСписания.Вставить("СписанныеТовары", ТаблицаМатериаловДляСписания);
	
	ТаблицаОстатки = ПодготовитьТаблицуОстатковДляСписания(СтруктураТаблицСписания, Неопределено, Реквизиты);
	ТаблицаСписанныеТовары = ПолучитьПустуюТаблицуСписанныеТовары();
	ТаблицаОшибок = ТаблицаОшибокСписанияТоваров();
	
	СписатьОстаткиТоваров(ТаблицаМатериаловДляСписания, ТаблицаОстатки, ТаблицаСписанныеТовары, Неопределено, ТаблицаОшибок, Реквизиты);
	
	ТаблицыСписанныеМатериалы = Новый Структура;
	ТаблицыСписанныеМатериалы.Вставить("СписанныеТовары", ТаблицаСписанныеТовары);
	ТаблицыСписанныеМатериалы.Вставить("НедостаточноДляСписания", ТаблицаОшибок);
	
	Возврат ТаблицыСписанныеМатериалы;
...
Функция НовыйТаблицаТоварыДляСписания() Экспорт
	
	ТоварыДляСписания = Новый ТаблицаЗначений; 
	ТоварыДляСписания.Колонки.Добавить("ИмяСписка", ОбщегоНазначения.ОписаниеТипаСтрока(0));
	ТоварыДляСписания.Колонки.Добавить("СинонимСписка", ОбщегоНазначения.ОписаниеТипаСтрока(0));
	ТоварыДляСписания.Колонки.Добавить("Период", ОбщегоНазначения.ОписаниеТипаДата(ЧастиДаты.ДатаВремя));
	ТоварыДляСписания.Колонки.Добавить("НомерСтроки");
	ТоварыДляСписания.Колонки.Добавить("СчетУчета", Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТоварыДляСписания.Колонки.Добавить("Номенклатура", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
	ТоварыДляСписания.Колонки.Добавить("Склад", Новый ОписаниеТипов("СправочникСсылка.Склады"));
	ТоварыДляСписания.Колонки.Добавить("ДокументОприходования", ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Партии.ТипЗначения);
	ТоварыДляСписания.Колонки.Добавить("Себестоимость", Метаданные.РегистрыБухгалтерии.Хозрасчетный.Ресурсы.Сумма.Тип);
	ТоварыДляСписания.Колонки.Добавить("Количество", Метаданные.РегистрыБухгалтерии.Хозрасчетный.Ресурсы.Количество.Тип);
	
	ТоварыДляСписания.Колонки.Добавить("КорСчетСписания", Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТоварыДляСписания.Колонки.Добавить("ВидКорСубконто1", Новый ОписаниеТипов("ПланВидовХарактеристикСсылка.ВидыСубконтоХозрасчетные"));
	ТоварыДляСписания.Колонки.Добавить("ВидКорСубконто2", Новый ОписаниеТипов("ПланВидовХарактеристикСсылка.ВидыСубконтоХозрасчетные"));
	ТоварыДляСписания.Колонки.Добавить("ВидКорСубконто3", Новый ОписаниеТипов("ПланВидовХарактеристикСсылка.ВидыСубконтоХозрасчетные"));
	ТоварыДляСписания.Колонки.Добавить("КорСубконто1", Метаданные.ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Тип);
	ТоварыДляСписания.Колонки.Добавить("КорСубконто2", Метаданные.ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Тип);
	ТоварыДляСписания.Колонки.Добавить("КорСубконто3", Метаданные.ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Тип);
	ТоварыДляСписания.Колонки.Добавить("КорПодразделение", Новый ОписаниеТипов("СправочникСсылка.ПодразделенияОрганизаций"));
	
	ТоварыДляСписания.Колонки.Добавить("Комитент", Новый ОписаниеТипов("СправочникСсылка.Контрагенты"));
	ТоварыДляСписания.Колонки.Добавить("ДоговорКомиссии", Новый ОписаниеТипов("СправочникСсылка.ДоговорыКонтрагентов"));
	ТоварыДляСписания.Колонки.Добавить("СчетАвансовСКомитентом",  Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТоварыДляСписания.Колонки.Добавить("СчетРасчетовСКомитентом",  Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТоварыДляСписания.Колонки.Добавить("ВалютаРасчетовСКомитентом", Новый ОписаниеТипов("СправочникСсылка.Валюты"));
	ТоварыДляСписания.Колонки.Добавить("СуммаРасчетовСКомитентом", Метаданные.РегистрыБухгалтерии.Хозрасчетный.Ресурсы.Сумма.Тип);
	
	Возврат ТоварыДляСписания;
...
Функция ПодготовитьТаблицыСписанныеТоварыСУчетомВозврата(ТаблицыТовары, ТаблицаРеквизиты, ТаблицаВозвраты, Отказ) Экспорт
	...
	Для Каждого КлючИЗначение Из ТаблицыТовары Цикл
		...
		Если ИспользуетсяОтложенноеПроведение Тогда
			...
			СчетаРассчитываемыеОперативно = СчетаРассчитываемыеОперативно(Реквизиты.Организация, Реквизиты.Период);
		КонецЕсли;
		...
		Для Каждого СтрокаТаблицыТовары Из ТаблицаТовары Цикл
			...
			Если СтрокаТаблицыТовары.Себестоимость > 0 Тогда
				...
				Если ЭтоВозвратПоставщику Тогда
					НоваяСтрока.СуммаВзаиморасчетов = СтрокаТаблицыТовары.СуммаВзаиморасчетов;
					НоваяСтрока.СуммаРуб            = СтрокаТаблицыТовары.СуммаРуб;
				КонецЕсли;
...
Процедура СписатьОстаткиТоваровИСообщитьОбОшибке(ТаблицаСписаниеПоОстаткам, ТаблицаОстатки, ТаблицаСписанныеТовары, ТаблицаВыпущеннаяПродукция, СпособОценкиМПЗПоСредней, КонтролироватьОстаток, Реквизиты, Отказ)
	...
	Если БухгалтерскийУчетПереопределяемый.ДокументЯвляетсяРазукомплектацией(Реквизиты.Регистратор) Тогда
		...
		Для Каждого СтрокаОшибки Из ТаблицаОшибок Цикл
			...
			Количество = Количество + СтрокаОшибки.Количество;
			КоличествоОсталосьПогасить = КоличествоОсталосьПогасить + СтрокаОшибки.КоличествоОсталосьПогасить;
			
		КонецЦикла;
		
		Если Количество <> 0 Или КоличествоОсталосьПогасить <> 0 Тогда
	...
	Иначе
		...
		Для Каждого СтрокаОшибки Из ТаблицаОшибок Цикл
			...
			ВывестиСообщениеОбОшибке(
				...
				СтрокаОшибки.КоличествоОсталосьПогасить,
				Реквизиты.Регистратор,
				СтрокаОшибки.ИмяСписка,
				СтрокаОшибки.СинонимСписка,
...
Функция НовыйПараметрыСписанияТоваров() Экспорт
	
	ПараметрыСписания = Новый Структура;
	ПараметрыСписания.Вставить("Регистратор", Неопределено);
	ПараметрыСписания.Вставить("Организация", Справочники.Организации.ПустаяСсылка());
	ПараметрыСписания.Вставить("Период", '00010101');
	ПараметрыСписания.Вставить("Подразделение", Справочники.ПодразделенияОрганизаций.ПустаяСсылка());
	ПараметрыСписания.Вставить("СпособОценкиМПЗПоСредней", Истина);
	Возврат ПараметрыСписания;
	
КонецФункции

Функция ТаблицаОшибокСписанияТоваров()
	
	ТаблицаОшибок = Новый ТаблицаЗначений;
	
	ТаблицаОшибок.Колонки.Добавить("ИмяСписка", ОбщегоНазначения.ОписаниеТипаСтрока(0));
	ТаблицаОшибок.Колонки.Добавить("СинонимСписка", ОбщегоНазначения.ОписаниеТипаСтрока(0));
	ТаблицаОшибок.Колонки.Добавить("НомерСтроки",  ОбщегоНазначения.ОписаниеТипаЧисло(15, 0));
	...
	ТаблицаОшибок.Колонки.Добавить("СчетУчета", Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТаблицаОшибок.Колонки.Добавить("Количество", ОбщегоНазначения.ОписаниеТипаЧисло(15, 3));
	ТаблицаОшибок.Колонки.Добавить("КоличествоОсталосьПогасить",  ОбщегоНазначения.ОписаниеТипаЧисло(15, 3));
...
Процедура СписатьОстаткиТоваров(ТаблицаСписаниеПоОстаткам, ТаблицаОстатки, ТаблицаСписанныеТовары, ТаблицаВыпущеннаяПродукция, ТаблицаОшибок, ПараметрыСписания)
	...
	Для каждого СтрокаДокумента Из ТаблицаСписаниеПоОстаткам Цикл
		...
		Если ТаблицаОстатки.Количество() <> 0 Тогда
			...
			Если ЗначениеЗаполнено(СтрокаДокумента.Комитент) 
			   И БухгалтерскийУчетПовтИсп.СчетУчетаКомиссионногоТовара(СтрокаДокумента.СчетУчета) Тогда
				// При отгрузке прослеживаемых товаров комитента-продавца важно списать со счета 004 
				// товары того же комитента, чьи РНПТ указаны в первичном документе.
				ПараметрыОтбора.Вставить("Комитент", СтрокаДокумента.Комитент);
			КонецЕсли; 

			Если БухгалтерскийУчетПовтИсп.СчетУчетаДавальческогоСырьяНаСкладе(СтрокаДокумента.СчетУчета)
				И СтрокаДокумента.СчетУчета = СтрокаДокумента.КорСчетСписания Тогда
				ПараметрыОтбора.Вставить("Контрагент", СтрокаДокумента.КорСубконто1);	
			КонецЕсли;	
...
Функция ПодготовитьПараметрыТаблицыСписанныеТовары(ТаблицаТовары, ТаблицаРеквизиты)
	...
	Если ТаблицаТовары.Колонки.Найти("ИдентификаторСтроки") <> Неопределено Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ", ИдентификаторСтроки";
	КонецЕсли;
	
	Если ТаблицаТовары <> Неопределено И ТаблицаТовары.Колонки.Найти("СуммаВзаиморасчетов") <> Неопределено
		И ТаблицаТовары.Колонки.Найти("СуммаРуб") <> Неопределено Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ", СуммаВзаиморасчетов, СуммаРуб"; //<Число(15,2)>
	КонецЕсли;
...
Функция ПодготовитьРеквизитыСписанныеТовары(ТаблицаРеквизиты, ТаблицаВозвраты)
	...
	Если ТаблицаВозвраты <> Неопределено И ТаблицаВозвраты.Колонки.Найти("СуммаВзаиморасчетов") <> Неопределено
		И ТаблицаВозвраты.Колонки.Найти("СуммаРуб") <> Неопределено Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ", СуммаВзаиморасчетов, СуммаРуб"; //<Число(15,2)>
...
Функция ПодготовитьПараметрыТаблицыСписанныеТоварыНТТ(ТаблицаТоварыНТТ, ТаблицаРеквизиты)
	...
	Если ТаблицаТоварыНТТ <> Неопределено И ТаблицаТоварыНТТ.Колонки.Найти("СуммаВзаиморасчетов") <> Неопределено
		И ТаблицаТоварыНТТ.Колонки.Найти("СуммаРуб") <> Неопределено Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ", СуммаВзаиморасчетов, СуммаРуб"; //<Число(15,2)>
	КонецЕсли;
...
Процедура СформироватьДвиженияСписаниеТоваров(ТаблицаСписанныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	ВидСубконтоПродукция = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Продукция;
	ВидСубконтоДокументыРасчетовСКонтрагентом = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ДокументыРасчетовСКонтрагентами;
	...
	Для каждого СтрокаПартии Из Параметры.ТаблицаСписанныеТовары Цикл
			...
			Для НомерСубконто = 1 По 3 Цикл
				...
				Если ЗначениеЗаполнено(ВидСубконто) Тогда
					...
					Если ТипЗначенияВидаСубконто.СодержитТип(Тип("СправочникСсылка.Номенклатура")) Тогда
						...
						ВидСубконто = СвойстваСчетаДт["ВидСубконто" + НомерСубконто];
						Если ВидСубконто <> ВидСубконтоПродукция Тогда
					...
					ИначеЕсли ВидСубконто = ВидСубконтоДокументыРасчетовСКонтрагентом
		...
		Проводка.НеКорректироватьСтоимостьАвтоматически = СтрокаПартии.Себестоимость <> 0
			 Или Реквизиты.ПрошлыйПериод = Истина И СтрокаПартии.КорСчетСписания = ПланыСчетов.Хозрасчетный.КорректировкаТоваровПрошлогоПериода;
...
Функция ПодготовитьПараметрыСписаниеТоваров(ТаблицаСписанныеТовары, ТаблицаРеквизиты)
	...
	ВозможныДвиженияПрошлогоПериода = (ТаблицаРеквизиты <> Неопределено И ТаблицаРеквизиты.Колонки.Найти("ПрошлыйПериод") <> Неопределено);
	
	СписокОбязательныхКолонок = ""
	+ "Регистратор," // <ДокументСсылка.*> - документ-регистратор движений
	+ "Период,"      // <Дата> - период движений - дата документа
	+ ?(ВозможныДвиженияПрошлогоПериода, "ПрошлыйПериод,", "") // <Булево> - признак корректировки документа из прошлого периода
	+ "Организация," // <СправочникСсылка.Организации>
	+ "Контрагент,"  // <СправочникСсылка.Контрагенты>
	+ "Содержание";  // <Строка,150>
	...
	Если Не ВозможныДвиженияПрошлогоПериода Тогда
		Параметры.Реквизиты.Колонки.Добавить("ПрошлыйПериод", Новый ОписаниеТипов("Булево"));
	КонецЕсли;
...
Процедура СформироватьДвиженияПеремещениеТоваров(ТаблицаСписанныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Для каждого СтрокаПартии Из Параметры.ТаблицаСписанныеТовары Цикл
		...
		Если ЗначениеЗаполнено(Реквизиты.Контрагент) Тогда
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт, "Контрагенты", Реквизиты.Контрагент);
		ИначеЕсли ТипЗнч(СтрокаПартии.КорСубконто1) = Тип("СправочникСсылка.Контрагенты")
			И БухгалтерскийУчетПовтИсп.СчетУчетаДавальческогоСырьяНаСкладе(Проводка.СчетКт) Тогда
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт, "Контрагенты", СтрокаПартии.КорСубконто1);
		КонецЕсли;
	...
	Для каждого СтрокаПартии Из Параметры.ТаблицаСписанныеТовары Цикл
		...
		Если СвойстваСчетаДт.Забалансовый = СвойстваСчетаКт.Забалансовый Тогда
			...
			Если СвойстваСчетаДт.Валютный Тогда
				...
				Если ЭтоВозвратПоставщику И СтрокаТаблицыТовары.СуммаБезНДСРуб = СтрокаПартии.СуммаСписания Тогда
					Проводка.ВалютнаяСуммаДт = СтрокаТаблицыТовары.СуммаВзаиморасчетовБезНДС;
				Иначе
...
Функция ПодготовитьПараметрыВозвратТоваровПоставщику(ТаблицаТовары, ТаблицаСписанныеТовары, ТаблицаРеквизиты)
	...
	Если ТаблицаТовары <> Неопределено И ТаблицаТовары.Колонки.Найти("СуммаВзаиморасчетовБезНДС") <> Неопределено Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ", СуммаВзаиморасчетовБезНДС, СуммаБезНДСРуб";
	КонецЕсли;
...
Функция ПодготовитьТаблицуВозвращенныеСписанныеТовары(ТаблицаТовары, ТаблицаСчетаУчетаТоваров, ТаблицаСписокНоменклатуры, ТаблицаРеквизиты, Отказ) Экспорт
	...
	ИспользоватьОтборПоКомиссионеру 
		= ТипЗнч(Реквизиты.Сделка) = Тип("ДокументСсылка.ОтчетКомиссионераОПродажах");
	
	РеквизитыСделки = Новый Структура();
	Если ЕстьСкладОтгрузки Тогда
		РеквизитыСделки.Вставить("Склад");
	ИначеЕсли ИспользоватьОтборПоКомиссионеру Тогда
		РеквизитыСделки.Вставить("Контрагент");
	КонецЕсли;
	...
	ИначеЕсли ИспользоватьОтборПоКомиссионеру Тогда
		Комиссионер   = РеквизитыСделки.Контрагент;
	КонецЕсли;
	...
	ИспользоватьОтборПоСкладуОтгрузки = ВедетсяСуммовойУчетПоСкладам 
		И Справочники.Склады.ИспользуетсяНесколькоСкладов()
		И ЕстьСкладОтгрузки 
		И ЗначениеЗаполнено(РеквизитыСделки.Склад)
		И НЕ ИспользоватьОтборПоКомиссионеру;
	...
	Запрос.УстановитьПараметр("СчетНаценкиВРознице",  ПланыСчетов.Хозрасчетный.ТорговаяНаценкаАТТ);
	...
	ИначеЕсли ИспользоватьОтборПоКомиссионеру Тогда
		ВидыСубконтоБезПартий.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
	КонецЕсли;
	...
	Если ИспользоватьОтборПоКомиссионеру Тогда
		ВидыСубконтоБезПартийСклады.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
	Иначе
	...
	Если ИспользоватьОтборПоКомиссионеру Тогда
		ВидыСубконтоПартий.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
	ИначеЕсли ИспользоватьОтборПоСкладуОтгрузки Тогда
	...
	Если ИспользоватьОтборПоКомиссионеру Тогда
		ВидыСубконтоПартийСклады.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
	Иначе
...
Функция ТекстЗапросаВозвращенныеСписанныеТоварыДокументыОтгрузки()
	...
	|ГДЕ
	|	КорректировкаРеализации.ИсходныйДокументРеализации = &Регистратор
	|	И КорректировкаРеализации.Ссылка <> &ЭтотВозврат
	|	И КорректировкаРеализации.Дата <= &КонДата";
...
Функция ТекстЗапросаВозвращенныеСписанныеТоварыПартии()
	...
	// Если партионный учет был включен уже после проведения документа, 
	// то в таблице субконто партий может не быть. Для этого добавим Неопределено
	// в разрешенные партии чтобы корректно отработал запрос к остаткам
	
	ТекстЗапроса =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЕСТЬNULL(ХозрасчетныйСубконто.Значение, НЕОПРЕДЕЛЕНО) КАК Партия
	|ПОМЕСТИТЬ ВТ_Партии
	|ИЗ
...
Функция ТекстЗапросаВозвращенныеСписанныеТоварыПрошлогоМесяца(
	ЕстьСчетаНеПартионные, ЕстьСчетаПартионные, ИспользоватьОтборПоСкладуОтгрузки, ИспользоватьОтборПоКомиссионеру, ИспользоватьОтборПоПодразделениюОтгрузки)
	...
	|				И ЕСТЬNULL(Субконто2, НЕОПРЕДЕЛЕНО) В
	|					(ВЫБРАТЬ
	|						ВТ_Партии.Партия
	|					ИЗ
	|						ВТ_Партии)
	...
	|			&КонДата,
	|			Организация = &Организация
	|				И Регистратор В (ВЫБРАТЬ ВТ_ДокументыОтгрузки.Ссылка ИЗ ВТ_ДокументыОтгрузки)
	...
	|	&НачМесяцаРеализации, // Возвраты ставим в первый месяц чтобы перебирать при обработке
	|	0,
	|	0,
	|	0,
	|	0,
	...
	ИначеЕсли ИспользоватьОтборПоКомиссионеру Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоСкладуСубконтоКт2", "СубконтоКт2 = &Комиссионер");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоСкладуСубконтоКт3", "СубконтоКт3 = &Комиссионер");
	
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоСкладуСубконто2", "Субконто2 = &Комиссионер");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоСкладуСубконто3", "Субконто3 = &Комиссионер");

		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоСкладуДвиженияССубконто2", "
			|	ВидСубконтоКт2 = ЗНАЧЕНИЕ(ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты)
			|			И СубконтоКт2 = &Комиссионер");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоСкладуДвиженияССубконто3", "
			|	ВидСубконтоКт3 = ЗНАЧЕНИЕ(ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты)
			|			И СубконтоКт3 = &Комиссионер");
	...
	Если ИспользоватьОтборПоПодразделениюОтгрузки Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоПодразделениюКт", "ЕстьNULL(ПодразделениеКт, &ПодразделениеОтгрузки) = &ПодразделениеОтгрузки");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеПоПодразделению", "ЕстьNULL(Подразделение, &ПодразделениеОтгрузки) = &ПодразделениеОтгрузки");
	Иначе
...
Функция ТекстЗапросаВозвращенныеСписанныеТоварыТекущегоМесяца(ЕстьСчетаНеПартионные, ЕстьСчетаПартионные)
	...
	|	ЕСТЬNULL(ХозрасчетныйДвиженияССубконто.СуммаПРКт, 0) КАК СуммаПР,
	|	ЕСТЬNULL(ХозрасчетныйДвиженияССубконто.СуммаВРКт, 0) КАК СуммаВР,
	...
	|			&НачТекущегоМесяца,
	|			&КонДата,
	|			СчетДт В (&СчетКтПартионный, &СчетКтНеПартионный)
	|				И СчетКт = &СчетНаценкиВРознице
	|				И Регистратор В
	|					(ВЫБРАТЬ
	|						ВТ_ДокументыОтгрузки.Ссылка
	|					ИЗ
...
Процедура СформироватьДвиженияКорректировкаПоступлениеТоваров(ТаблицаВозвращенныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Если НЕ Реквизиты.ПрошлыйПериод
		...
		СформироватьДвиженияСписанияТоваровВозвратОтПокупателя(Параметры.ТаблицаВозвращенныеТовары, 
...
Функция ПодготовитьПараметрыКорректировкаПоступлениеТоваров( ТаблицаВозвращенныеТовары, ТаблицаРеквизиты)
	...
	+ "Склад,"            // <СправочникСсылка.Склад> - склад, с которого списывается номенклатура
	+ "Партия,"           // <ДокументСсылка.*> - документ поступления номенклатуры (партия)
	+ "Сделка,"           // <ДокументСсылка.*> - документ по которому производится возврат
	+ "Себестоимость,"    // <Число,15,2> - сумма списываемой номенклатуры, указанная в документе списания
	+ "Количество,"       // <Число,15,3> - количество списываемой номенклатуры
	+ "КорСчетСписания,"  // <ПланСчетовСсылка.Хозрасчетный> - счет учета, на который списывается номенклатура
	+ "ВидКорСубконто1,"  // <Число/Строка/ПланВидовХарактеристикСсылка.ВидыСубконтоХозрасчетные> - вид субконто счета, на который списывается номенклатура
...
Процедура СформироватьДвиженияПоступлениеТары(ТаблицаТара, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	СпособОценкиМПЗ = УчетнаяПолитика.СпособОценкиМПЗ(Реквизиты.Организация, Реквизиты.Период);
	УчитыватьТаруЗаБалансом = УчетнаяПолитика.УчитыватьТаруЗаБалансом(Реквизиты.Организация, Реквизиты.Период);
	ВедетсяУчетПоПартиям = СпособОценкиМПЗ <> Перечисления.СпособыОценки.ПоСредней;

	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТара Цикл
		
		Если УчитыватьТаруЗаБалансом Тогда
...
Функция ПодготовитьПараметрыПоступлениеТары(ТаблицаТара, ТаблицаРеквизиты)
	...
	+ "Склад";               // <СправочникСсылка.Склады> - склад в табличной части 
...
Процедура СформироватьДвиженияКорректировкаСтоимостиТары(ТаблицаТара, ТаблицаСписанныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Реквизиты = Параметры.Реквизиты[0];
	НужнаПереоценка = Ложь;	
	//Определим вид договора
	Если ЗначениеЗаполнено(Реквизиты.ДоговорКонтрагента) Тогда
		ВидДоговора = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Реквизиты.ДоговорКонтрагента, "ВидДоговора");
		НужнаПереоценка = (ВидДоговора = Перечисления.ВидыДоговоровКонтрагентов.СПокупателем);		
	КонецЕсли;
	
	//Для передачи товаров переоценка не зависит от договора
	Если ТипЗнч(Реквизиты.Регистратор) = Тип("ДокументСсылка.ПередачаТоваров") Тогда
		НужнаПереоценка = Истина;
	КонецЕсли;
		...
		Для каждого СтрокаПартии Из СтрокиТаблицыСписаннаяТара Цикл
			...
			Если СвойстваСчетаУчета.Забалансовый Тогда 
				Если НужнаПереоценка Тогда
					...
					Проводка.СчетДт = СтрокаПартии.КорСчетСписания;
					БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, СтрокаПартии.ВидКорСубконто1, СтрокаПартии.КорСубконто1);
					БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, СтрокаПартии.ВидКорСубконто2, СтрокаПартии.КорСубконто2);
					БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, СтрокаПартии.ВидКорСубконто3, СтрокаПартии.КорСубконто3);
...
Функция ПодготовитьПараметрыКорректировкаСтоимостиТары(ТаблицаТара, ТаблицаСписанныеТовары, ТаблицаРеквизиты)
	...
	+ "Номенклатура,"   // <СправочникСсылка.Номенклатура> - номенклатура тары
	+ "Партия,"         // <ДокументСсылка.*> - документ партии
	+ "СчетУчета,"      // <ПланСчетовСсылка.Хозрасчетный> - счет учета тары
	+ "КорСчетСписания,"// <ПланСчетовСсылка.Хозрасчетный> - счет, на который передается тара
	+ "ВидКорСубконто1,"
	+ "ВидКорСубконто2,"
	+ "ВидКорСубконто3,"
	+ "КорСубконто1,"
...
Функция УстановитьВалютныеСуммыСписанияКорректировкаСтоимости(Знач ТаблицаСписанныеТовары, Реквизиты)
	...
	Для Каждого СтрокаТаблицы Из ТаблицаСписанныеТовары Цикл
		...
		Если Реквизиты.РасчетКорректировокСУчетомРекомендацийПоНДС Тогда
			СтрокаТаблицы.СуммаСписанияВал = ?(СтрокаТаблицы.СуммаРуб = 0,
			СтрокаТаблицы.СуммаСписания,
			СтрокаТаблицы.СуммаСписания * СтрокаТаблицы.СуммаВзаиморасчетов / СтрокаТаблицы.СуммаРуб)
		Иначе
...
Процедура СформироватьДвиженияИзменениеСебестоимостиОстатковТоваров(ТаблицаТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	ЕстьКолонкаСчетУчетаЗабалансовый = Ложь;
	Если ТаблицаТовары.Колонки.Найти("СчетУчетаЗабалансовый") <> Неопределено Тогда
		ЕстьКолонкаСчетУчетаЗабалансовый = Истина;
	КонецЕсли;
	
	ЕстьКолонкаДатаПринятияНаУчет = Ложь;
	Если ТаблицаТовары.Колонки.Найти("ДатаПринятияНаУчет") <> Неопределено Тогда
		ЕстьКолонкаДатаПринятияНаУчет = Истина;
	КонецЕсли;
	
	Параметры = ПодготовитьПараметрыИзменениеСебестоимостиОстатковТоваров(ТаблицаТовары,
		ТаблицаРеквизиты, ЕстьКолонкаСчетУчетаЗабалансовый, ЕстьКолонкаДатаПринятияНаУчет);
	...
	ПоддержкаПБУ18 = УчетнаяПолитика.ПоддержкаПБУ18(Реквизиты.Организация, Реквизиты.Период);
	ОтражатьВНалоговомУчете = УчетнаяПолитика.ПлательщикНалогаНаПрибыль(Реквизиты.Организация, Реквизиты.Период);
	// Начисляем ЕНП при ввозе товаров из ЕАЭС неплательщиком НДС.
	НачислятьЕНП = ТипЗнч(Реквизиты.Регистратор) = Тип("ДокументСсылка.ЗаявлениеОВвозеТоваров")
		И НЕ УчетнаяПолитика.ПлательщикНДС(Реквизиты.Организация, Реквизиты.Период)
		И УчетНДСПереопределяемый.ВедетсяПростойУчетЕНП(Реквизиты.Период, Реквизиты.Организация)
		И ЕстьКолонкаДатаПринятияНаУчет;
	...
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТовары Цикл
		...
		Если ЕстьКолонкаСчетУчетаЗабалансовый Тогда
			Если СтрокаТаблицы.СчетУчетаЗабалансовый Тогда
				Проводка.СчетДт = СтрокаТаблицы.СчетУчетаНДС;
				СчетУчетаЗабалансовый = Истина;
			КонецЕсли;
		КонецЕсли;
		
		Если СчетУчетаЗабалансовый Тогда
			
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт,
				"Контрагенты", СтрокаТаблицы.Комитент);
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт,
				"Договоры", СтрокаТаблицы.ДоговорКомитента);
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт,
		...
		Иначе
			...
			Если ВедетсяУчетПоПартиям Тогда
				БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт,
					"Партии", СтрокаТаблицы.ДокументОприходования);
			КонецЕсли;
			
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт,
				"ПрочиеДоходыИРасходы", СтрокаТаблицы.СтатьяЗатратНУ);
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт,
				"СтатьиЗатрат", СтрокаТаблицы.СтатьяЗатратНУ);
		...
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт,
			СтрокаТаблицы.ВидКорСубконто1, СтрокаТаблицы.КорСубконто1);
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт,
			СтрокаТаблицы.ВидКорСубконто2, СтрокаТаблицы.КорСубконто2);
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт,
			СтрокаТаблицы.ВидКорСубконто3, СтрокаТаблицы.КорСубконто3);
			...
			Иначе
				...
				Если СтрокаТаблицы.ЗатратыПринимаютсяКНУ Тогда
					...
					Если СтрокаТаблицы.ВидСубконтоСтатьиНУ <> Неопределено Тогда
						БухгалтерскийУчет.УстановитьСубконто(ПроводкаНУ.СчетДт, ПроводкаНУ.СубконтоДт,
							СтрокаТаблицы.ВидСубконтоСтатьиНУ, СтрокаТаблицы.СтатьяЗатратНУ);
					КонецЕсли;
					Если СвойстваСчетаДт.УчетПоПодразделениям Тогда
					...
					БухгалтерскийУчет.УстановитьСубконто(ПроводкаНУ.СчетКт, ПроводкаНУ.СубконтоКт,
						СтрокаТаблицы.ВидКорСубконто1, СтрокаТаблицы.КорСубконто1);
					БухгалтерскийУчет.УстановитьСубконто(ПроводкаНУ.СчетКт, ПроводкаНУ.СубконтоКт,
						СтрокаТаблицы.ВидКорСубконто2, СтрокаТаблицы.КорСубконто2);
					БухгалтерскийУчет.УстановитьСубконто(ПроводкаНУ.СчетКт, ПроводкаНУ.СубконтоКт,
		...
		Если НачислятьЕНП Тогда
			УчетНДСПереопределяемый.НачислитьЕНППриВвозеТоваровИзЕАЭС(Реквизиты, СтрокаТаблицы, НачислениеНалоговНаЕНС);
		КонецЕсли;
...
Функция ПодготовитьПараметрыИзменениеСебестоимостиОстатковТоваров(ТаблицаТовары,
			ТаблицаРеквизиты, ЕстьКолонкаСчетУчетаЗабалансовый, ЕстьКолонкаДатаПринятияНаУчет)
	...
	Если ЕстьКолонкаСчетУчетаЗабалансовый Тогда
		...
		+ ",СчетУчетаЗабалансовый"  // <Булево> - нужен, чтобы отфильтовать проводки забалансовых счетов
		+ ",СчетУчетаНДС"           // <ПланСчетовСсылка.Хозрасчетный> - счет для проводки по забалансовым счетам
		+ ",Комитент"               // <СправочникСсылка.Контрагенты> - аналитика по контрагентам проводки забалансовых счетов
		+ ",ДоговорКомитента"       // <СправочникСсылка.ДоговорыКонтрагентов> - аналитика по договорам проводки забалансовых счетов
	КонецЕсли;
	
	Если ЕстьКолонкаДатаПринятияНаУчет Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок
			+ ",ДатаПринятияНаУчет"; // <Дата> - для корректного начисления ЕНП при включении НДС в стоимость
	КонецЕсли;
...
Функция ПодготовитьПараметрыПоступлениеТоваров(ТаблицаТовары, ТаблицаРеквизиты)
	...
	+ "Склад,"               // <СправочникСсылка.Склады> 		- склад в табличной части если поступление на несколько складов 
	+ "Содержание";          // <Строка,150> - содержание проводки
...
// Формирует новую таблицу для оприходования товаров.
// Таблица передается в УчетТоваров.СформироватьДвиженияОприходованиеТоваров()
// 
// Возвращаемое значение:
//   - ТаблицаЗначений
//
Функция НовыйТаблицаОприходованияТоваров() Экспорт
	
	ТаблицаТовары = Новый ТаблицаЗначений;
	ТаблицаТовары.Колонки.Добавить("НомерСтроки", ОбщегоНазначения.ОписаниеТипаЧисло(15));
	ТаблицаТовары.Колонки.Добавить("Номенклатура", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
	ТаблицаТовары.Колонки.Добавить("СтавкаНДСВРознице", Новый ОписаниеТипов("ПеречислениеСсылка.СтавкиНДС"));
	ТаблицаТовары.Колонки.Добавить("Сумма", Метаданные.РегистрыБухгалтерии.Хозрасчетный.Ресурсы.Сумма.Тип);
	ТаблицаТовары.Колонки.Добавить("СуммаНУ", Метаданные.РегистрыБухгалтерии.Хозрасчетный.Ресурсы.СуммаНУ.Тип);
	ТаблицаТовары.Колонки.Добавить("Количество", Метаданные.РегистрыБухгалтерии.Хозрасчетный.Ресурсы.Количество.Тип);
	ТаблицаТовары.Колонки.Добавить("СчетУчета", Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТаблицаТовары.Колонки.Добавить("Содержание", ОбщегоНазначения.ОписаниеТипаСтрока(0));
	ТаблицаТовары.Колонки.Добавить("СчетДоходов", Новый ОписаниеТипов("ПланСчетовСсылка.Хозрасчетный"));
	ТаблицаТовары.Колонки.Добавить("ПодразделениеДоходов", Новый ОписаниеТипов("СправочникСсылка.ПодразделенияОрганизаций"));
	ТаблицаТовары.Колонки.Добавить("СубконтоДоходов1", Метаданные.ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Тип);
	ТаблицаТовары.Колонки.Добавить("СубконтоДоходов2", Метаданные.ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Тип);
	ТаблицаТовары.Колонки.Добавить("СубконтоДоходов3", Метаданные.ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Тип);
	
	Возврат ТаблицаТовары;
	
КонецФункции

// Формирует проводки по оприходованию товаров.
//
// Параметры:
//  ТаблицаТовары	 - ТаблицаЗначений - Товары, которые необходимо оприходовать. Поля см. в НовыйТаблицаОприходованияТоваров().
//  ТаблицаРеквизиты - ТаблицаЗначений - Реквизиты для формирования проводок. Поля см. в ПодготовитьПараметрыОприходованиеТоваров().
//  Движения		 - НаборДвижений - Набор движений документа, в который будут записаны проводки.
//  Отказ			 - Булево - Признак отказа, проводки сформироваться не смогли.
//
Процедура СформироватьДвиженияОприходованиеТоваров(ТаблицаТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТовары Цикл
		...
		Для НомерСубконто = 1 По СвойстваСчетаКт.КоличествоСубконто Цикл
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт,
				СвойстваСчетаКт["ВидСубконто" + Строка(НомерСубконто)], СтрокаТаблицы["СубконтоДоходов" + Строка(НомерСубконто)]);
		КонецЦикла;
		...
		НалоговыйУчет.ЗаполнитьНалоговыеСуммыПроводки(
			...
			0, 0,
			СтрокаТаблицы.Сумма - СтрокаТаблицы.СуммаНУ, СтрокаТаблицы.Сумма - СтрокаТаблицы.СуммаНУ,
			Проводка, СтрокаТаблицы.Сумма <> СтрокаТаблицы.СуммаНУ);
...
Функция ПодготовитьПараметрыОприходованиеТоваров(ТаблицаТовары, ТаблицаРеквизиты)
	...
	+ "СчетУчета,"         // <ПланСчетовСсылка.Хозрасчетный> - счет учета, на который приходуется товар
	+ "СчетДоходов,"       // <ПланСчетовСсылка.Хозрасчетный> - счет учета, на котором учитывается доход от оприходоваемого товара.
	+ "ПодразделениеДоходов," // Подразделение, по которому будут отражаться доходы от оприходования товаров.
	+ "СубконтоДоходов1,"  // Значение субконто доходов от оприходования товара.
	+ "СубконтоДоходов2,"  // Значение субконто доходов от оприходования товара.
	+ "СубконтоДоходов3,"  // Значение субконто доходов от оприходования товара.
	+ "Содержание";        // <Строка,150> - содержание проводки
...
Процедура СформироватьДвиженияНачислениеТорговойНаценкиПоступлениеТоваров(ТаблицаТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Реквизиты = ТаблицаРеквизиты[0]; 
	СкладВСписке = БухгалтерскийУчетПереопределяемый.СкладВТабличнойЧасти(Реквизиты);
    ...
    Если СкладВСписке Тогда
		ТаблицаНоменклатура = Параметры.ТаблицаТовары.Скопировать(,"Номенклатура, Склад");
		ТаблицаНоменклатура.Колонки.Добавить("ТипЦен", Новый ОписаниеТипов("СправочникСсылка.ТипыЦенНоменклатуры"));
		Для Каждого СтрокаТаблицы Из ТаблицаНоменклатура Цикл
			СтрокаТаблицы.ТипЦен = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтрокаТаблицы.Склад, "ТипЦенРозничнойТорговли");	
		КонецЦикла;
		ПараметрыРозничныхЦен.Вставить("Номенклатура", ТаблицаНоменклатура);
        СоответствиеРозничныхЦен = БухгалтерскийУчетПереопределяемый.ПодготовитьСоответствиеНоменклатураЦенаПоСкладам(ПараметрыРозничныхЦен);
	Иначе
		МассивНоменклатуры = Параметры.ТаблицаТовары.ВыгрузитьКолонку("Номенклатура");
		МассивНоменклатуры = ОбщегоНазначенияБПВызовСервера.УдалитьПовторяющиесяЭлементыМассива(МассивНоменклатуры);
		ПараметрыРозничныхЦен.Вставить("ТипЦен", Реквизиты.ТипЦенРозничнойТорговли);
	...
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТовары Цикл
		...
		ОптовыйСклад = (СтрокаТаблицы.Склад.ТипСклада = Перечисления.ТипыСкладов.ОптовыйСклад); 
		Если ОптовыйСклад Тогда
			Продолжить;
		КонецЕсли;
		
		РозничныйМагазин = ?(СтрокаТаблицы.Склад.ТипСклада = Перечисления.ТипыСкладов.РозничныйМагазин, Истина, Ложь);
		
		Если РозничныйМагазин Тогда
...
Функция ПодготовитьПараметрыНачислениеТорговойНаценкиПоступлениеТоваров(ТаблицаТовары, ТаблицаРеквизиты)
	...
	+ "Склад,"             // <СправочникСсылка.Склад> - склад в табличной части 
	+ "Содержание";        // <Строка,150> - содержание проводки
		...
		Если СтрокаТаблицы.СуммаНаценки <> 0
		 ИЛИ (ОтражатьВНалоговомУчете
			...
			Если СвойстваСчетаДт.Валютный Тогда
				...
				Проводка.ВалютнаяСуммаДт = -СтрокаТаблицы.СуммаНаценкиВал;
			КонецЕсли;
...
Функция ПодготовитьТаблицуСписанияТорговойНаценкиАТТ(ТаблицаСписанныеТовары, ТаблицаРеквизиты) Экспорт
	...
	Параметры.ТаблицаСписанияТорговойНаценкиАТТ.Колонки.Добавить("Валюта",          Новый ОписаниеТипов("СправочникСсылка.Валюты"));
	Параметры.ТаблицаСписанияТорговойНаценкиАТТ.Колонки.Добавить("СуммаНаценкиВал", ТипСуммыСписания);
	...
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаСписанияТорговойНаценкиАТТ Цикл
		...
		СтрокаТаблицы.Валюта          = Реквизиты.Валюта;
		
		Если Реквизиты.КурсВзаиморасчетов = 0 Тогда
			СтрокаТаблицы.СуммаНаценкиВал = СтрокаТаблицы.СуммаНаценки;
		Иначе
			СтрокаТаблицы.СуммаНаценкиВал = СтрокаТаблицы.СуммаНаценки * Реквизиты.КратностьВзаиморасчетов / Реквизиты.КурсВзаиморасчетов;
		КонецЕсли;
...
Функция ПодготовитьПараметрыТаблицыСписанияТорговойНаценкиАТТ(ТаблицаСписанныеТовары, ТаблицаРеквизиты)
	...
	Если ТаблицаСписанныеТовары <> Неопределено И ТаблицаСписанныеТовары.Колонки.Найти("СуммаВзаиморасчетов") <> Неопределено
		И ТаблицаСписанныеТовары.Колонки.Найти("СуммаРуб") <> Неопределено Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ", СуммаВзаиморасчетов, СуммаРуб"; //<Число(15,2)>
	КонецЕсли;
	...
	+ "Организация,"             // <СправочникСсылка.Организация> - организация, в которой списывается торговая наценка
	+ "Подразделение,"           // <Ссылка на справочник подразделений> - подразделение, в котором списывается торговая наценка
	+ "Валюта,"                  // <СправочникСсылка.Валюты> - валюта в случае возврата товара поставщику
	+ "КурсВзаиморасчетов,"      // <СправочникСсылка.Валюты> - валюта в случае возврата товара поставщику
	+ "КратностьВзаиморасчетов," // <СправочникСсылка.Валюты> - валюта в случае возврата товара поставщику
	+ "ТипСклада,"               // <ПеречислениеСсылка.ТипыСкладов> - вид склада, в котором списывается торговая наценка
	+ "ТипЦенРозничнойТорговли"; // <СправочникСсылка.ПрочиеДоходыИРасходы> - тип цен для опеределения розничной цены
...
Процедура СформироватьДвиженияСписаниеТоваровНТТ(ТаблицаТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТовары Цикл
		...
		Если ОтражатьВНалоговомУчете Тогда
			Если СвойстваСчетаДт.НалоговыйУчет Тогда
				Проводка.СуммаНУДт = Сумма;
			КонецЕсли;
			Если СвойстваСчетаКт.НалоговыйУчет Тогда
				Проводка.СуммаНУКт = Сумма;
			КонецЕсли;
		КонецЕсли;
...
Функция ПодготовитьПараметрыПоступлениеТоваровНаКомиссию(ТаблицаТовары, ТаблицаРеквизиты)
	...
	+ "СчетУчета,"    // <ПланСчетовСсылка.Хозрасчетный> - счет учета, на который приходуется товар
	+ "Содержание,"   // <Строка,150> - содержание проводки
	+ "Склад";        // <СправочникСсылка.Склады> - склад в списке
...
Процедура СформироватьДвиженияПересортицаТоваровПоСебестоимостиСписания(ТаблицаСписанныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Параметры = ПодготовитьПараметрыПересортицаТоваров(ТаблицаСписанныеТовары, ТаблицаРеквизиты);
	...
	Для Каждого СтрокаПартии Из Параметры.ТаблицаСписанныеТовары Цикл
		...
		Проводка.СчетДт = СтрокаПартии.СчетУчета;
		СвойстваСчетаДт = БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьСвойстваСчета(Проводка.СчетДт);
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Номенклатура", СтрокаПартии.КорСубконто1);
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Склады", СтрокаПартии.Склад);
		Если ВедетсяУчетПоПартиям Тогда
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Партии", Реквизиты.Регистратор);
		КонецЕсли;
...
Процедура СформироватьДвиженияПересортицаТоваров(ТаблицаСписанныеТовары, ТаблицаОприходованныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Реквизиты = Параметры.Реквизиты[0];
	Если Реквизиты.ПриходоватьТоварыПоСебестоимостиСписания Тогда
		Возврат;
	КонецЕсли;	
	...
	// 1. Дт СчетУчета - Кт 91.01
	Для Каждого СтрокаПартии Из ТаблицаОприходованныеТовары Цикл
		
		Проводка = Движения.Хозрасчетный.Добавить();
		Проводка.Период      = СтрокаПартии.Период;
		Проводка.Организация = Реквизиты.Организация;
		
		Содержание = НСтр("ru = 'Оприходование излишков %1'");
		
		Если НазваниеОбъектаВСодержании Тогда
			Проводка.Содержание  = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Содержание,
				БухгалтерскийУчетПовтИсп.НазваниеОбъектаПоСчетуУчета(СтрокаПартии.СчетУчета));
		Иначе
			Проводка.Содержание  = СокрЛП(Содержание);
		КонецЕсли;
		
		Проводка.СчетДт = СтрокаПартии.СчетУчета;
		СвойстваСчетаДт = БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьСвойстваСчета(Проводка.СчетДт);
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Номенклатура", СтрокаПартии.НоменклатураОприходование);
		БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Склады", СтрокаПартии.Склад);
		Если ВедетсяУчетПоПартиям Тогда
			БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетДт, Проводка.СубконтоДт, "Партии", Реквизиты.Регистратор);
		КонецЕсли;
		...
		Проводка.СубконтоКт.ПрочиеДоходыИРасходы = КлассификаторыДоходовРасходов.ПредопределенныйЭлементГрупповойОперации(
													"ПересортицаТоваровОприходование",
		...
		Если СвойстваСчетаДт.НалоговыйУчет Тогда
			Проводка.СуммаНУДт = СтрокаПартии.Сумма;
			Если ПоддержкаПБУ18 Тогда
				Проводка.СуммаПРДт = 0;
				Проводка.СуммаВРДт = 0;
			КонецЕсли;
		...
		Если СвойстваСчетаКт.НалоговыйУчет Тогда
			Проводка.СуммаНУКт = СтрокаПартии.Сумма;
			Если ПоддержкаПБУ18 Тогда
				Проводка.СуммаПРКт = 0;
				Проводка.СуммаВРКт = 0;
			КонецЕсли;
	...
	Для Каждого СтрокаПартии Из Параметры.ТаблицаСписанныеТовары Цикл
		...
		Содержание = НСтр("ru = 'Списание недостачи %1'");
...
Функция ПодготовитьПараметрыПересортицаТоваров(ТаблицаСписанныеТовары, ТаблицаРеквизиты)
		...
		Если Коэффициент1 <> 0 Тогда
			...
			Если СтрКоличество <> 0 ИЛИ СтрСуммаБУ <> 0 ИЛИ СтрНДС <> 0 Тогда
				...
				Если СтрокаТовары.Малоценка Тогда
					...
					БухгалтерскийУчет.УстановитьСубконто(Проводка.СчетКт, Проводка.СубконтоКт, "Склады", СтрокаТовары.Склад);
			...
			Если Реквизиты.РаздельныйУчетНДСНаСчете19 Тогда
				...
				НТТ = Реквизиты.РозницаВПродажныхЦенах И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтрокаТовары.Склад, "ТипСклада") = Перечисления.ТипыСкладов.НеавтоматизированнаяТорговаяТочка;	
				
				Если НЕ НТТ И НЕ СтрокаТовары.КомиссияПоЗакупке И (СтрКоличество <> 0 ИЛИ СтрСуммаБУ <> 0 ИЛИ СтрНДС <> 0)
					...
					КонецЕсли;
					Для Ном = 1 По СвойстваСчетаУчета.КоличествоСубконто Цикл
						Если СвойстваСчетаУчета["ВидСубконто" + Ном] = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Номенклатура Тогда
						 	АналитикаУчетаЗатрат["Субконто" + Ном] = СтрокаТовары.Номенклатура;
						ИначеЕсли СвойстваСчетаУчета["ВидСубконто" + Ном] = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Склады Тогда
							Если БухгалтерскийУчет.ВедетсяСуммовойУчетПоСкладам(АналитикаУчетаЗатрат.СчетЗатрат) Тогда
								АналитикаУчетаЗатрат["Субконто" + Ном] = СтрокаТовары.Склад;
							КонецЕсли;
						ИначеЕсли СвойстваСчетаУчета["ВидСубконто" + Ном] = ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Партии Тогда
					...
					АналитикаУчетаНДС = Новый Структура("Организация,СчетФактура,ВидЦенности,СчетУчетаНДС,
						...
						Поставщик,
						?(Реквизиты.ЭтоКорректировкаИсправления, Реквизиты.КорректируемыйДокументИсправления, Неопределено));
			...
			Если Реквизиты.РозницаВПродажныхЦенах Тогда
				АТТ = Реквизиты.РозницаВПродажныхЦенах И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтрокаТовары.Склад, "ТипСклада") = Перечисления.ТипыСкладов.РозничныйМагазин;
				НТТ = Реквизиты.РозницаВПродажныхЦенах И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтрокаТовары.Склад, "ТипСклада") = Перечисления.ТипыСкладов.НеавтоматизированнаяТорговаяТочка;
				Если АТТ Тогда
...
Функция ПолучитьРеквизитыКорректировкиПоступленияТоваров(РеквизитыДокумента)
	...
	+ "ЭтоКорректировкаИсправления,"
	+ "КорректируемыйДокументИсправления";
...
Процедура СформироватьДвиженияКорректировкиПоступленияУслуг(РеквизитыДокумента, ТаблицаПоУслугам, Движения, Отказ) Экспорт
	...
	КорректировкаПоступленияДопРасходов = 
		ТипЗнч(Реквизиты.ДокументПоступленияСсылка) = Тип("ДокументСсылка.ПоступлениеДопРасходов");
	...
	Для Каждого СтрокаУслуги Из ТаблицаПоУслугам Цикл
		...
		Если Год(Реквизиты.ДокументПоступленияДата) < Год(Реквизиты.Период) Тогда
			...
			Если СтрСуммаБУ < 0 Тогда // Доходы
				...
				Если КорректировкаПоступленияДопРасходов Тогда
					БухгалтерскийУчет.УстановитьПодразделенияПроводки(
						Проводка, СтрокаУслуги.ПодразделениеЗатрат, СтрокаУслуги.ПодразделениеЗатрат);
				Иначе
					БухгалтерскийУчет.УстановитьПодразделенияПроводки(Проводка, Реквизиты.Подразделение, Реквизиты.Подразделение);
				КонецЕсли;
		...
		Иначе
			Если СтрСуммаБУ <> 0 Тогда
				...
				Если НЕ СвойстваСчетаДт.Забалансовый Тогда
					...
					СвойстваСчетаКт = БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьСвойстваСчета(Проводка.СчетКт);
					Если СвойстваСчетаКт.УчетПоПодразделениям Тогда
						Проводка.ПодразделениеКт = ?(КорректировкаПоступленияДопРасходов,
							СтрокаУслуги.ПодразделениеЗатрат, Реквизиты.Подразделение);
					КонецЕсли;
...
Процедура СформироватьДвиженияКорректировкаПоступленияПоЗакупленнымТоварамКомитента(СписанныеТоварыКомитента, ОстаткиЗакупленныеТоварыКомитентов, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТовары Цикл
		...
		Если НайденныеСтроки.Количество() = 0 
			...
			Движение.ДоговорКонтрагента	= СтрокаТаблицы.ДоговорКомиссии;
			Движение.Номенклатура 		= СтрокаТаблицы.Номенклатура;
			Движение.Партия				= Реквизиты.Сделка;
...
Процедура ДвиженияРегистровПодсистемыНДСБУ(Реквизиты, СтрокаТаблицы, ТаблицаКоэффициентов, СуммаНДССписанного, СуммаНДССписанногоВал, СуммаНДС0, Движения, Отказ)
	...
	КорректировкаПоПоступлениюДопРасходов = ТипЗнч(Реквизиты.ДокументПоступленияСсылка) = Тип("ДокументСсылка.ПоступлениеДопРасходов");
	...
	Если Реквизиты.ЭтоКорректировочныйСчетФактура Тогда
		Если НДС < 0
		   ...
		   И Движения.НДСЗаписиКнигиПродаж.Количество() = 0 Тогда // Уменьшение НДС по исходному документу
			СубконтоСФПолученные = Реквизиты.ДокументПоступленияСсылка;
	...
	Если КорректировкаПоПоступлениюДопРасходов Тогда
		БухгалтерскийУчет.УстановитьПодразделенияПроводки(
			Проводка, СтрокаТаблицы.ПодразделениеЗатрат, СтрокаТаблицы.ПодразделениеЗатрат);
	Иначе
		БухгалтерскийУчет.УстановитьПодразделенияПроводки(Проводка, Реквизиты.Подразделение, Реквизиты.Подразделение);
	КонецЕсли;
...
Функция ТекстЗапросаАлкоПриложение25ФормаОтчета2019Кв1Раздел1_ИсточникиДанных(ВестиУчетПоПодразделениям)
	...
	|			ТОГДА 1
	|		КОГДА ХозрасчетныйОбороты.Регистратор ССЫЛКА Документ.ОтчетОРозничныхПродажах
	|				ИЛИ (ХозрасчетныйОбороты.Регистратор ССЫЛКА Документ.КомплектацияНоменклатуры И КорАлкогольнаяПродукция.Номенклатура ЕСТЬ NULL)
	|			ТОГДА 2
	|		КОГДА ХозрасчетныйОбороты.Регистратор ССЫЛКА Документ.ВозвратТоваровПоставщику
	...
	|			,
	|			) КАК ХозрасчетныйОбороты
	|	ЛЕВОЕ СОЕДИНЕНИЕ АлкогольнаяПродукция КАК КорАлкогольнаяПродукция
	|		ПО КорАлкогольнаяПродукция.Номенклатура = ХозрасчетныйОбороты.КорСубконто1
	|ГДЕ
	|	(НЕ ХозрасчетныйОбороты.КорСчет В (&Субсчета41)
...
Функция ПолучитьПустуюТаблицуСписанныеТовары() Экспорт
	...
	ТаблицаСписанныеТовары.Колонки.Добавить("ИдентификаторСтроки",             ОбщегоНазначения.ОписаниеТипаСтрока(0));
	ТаблицаСписанныеТовары.Колонки.Добавить("СуммаВзаиморасчетов",             ОбщегоНазначения.ОписаниеТипаЧисло(15,2));
	ТаблицаСписанныеТовары.Колонки.Добавить("СуммаРуб",                        ОбщегоНазначения.ОписаниеТипаЧисло(15,2));
...
Функция ПодготовитьТаблицуОстатковДляСписания(ТоварыДляРасчета, ТаблицаВозвратов, Реквизиты)
	...
	Для Каждого КлючИЗначение Из ТоварыДляРасчета Цикл
		Для Каждого СтрокаТаблицы Из КлючИЗначение.Значение Цикл
			НоваяСтрока = ОтборОстатков.Добавить();
			ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаТаблицы);
			Если СтрокаТаблицы.СчетУчета <> ПланыСчетов.Хозрасчетный.ТоварыПереданныеНаКомиссию
			   И ЗначениеЗаполнено(СтрокаТаблицы.Комитент) Тогда
				НоваяСтрока.Контрагент = СтрокаТаблицы.Комитент;
			Иначе
...
Функция ПолучитьОстаткиТоваров(МоментВремени, Организация, ПодразделениеОрганизации, ТаблицаСписания, ТаблицаВозвраты = Неопределено) Экспорт
	...
	Если ТаблицаВозвраты <> Неопределено И ТаблицаВозвраты.Количество() > 0 Тогда
		...
		|	ТаблицаВозвраты.Количество КАК КоличествоПоСкладу,
		|	ТаблицаВозвраты.Количество КАК Количество,
		|	ТаблицаВозвраты.СуммаСписания КАК Стоимость,
		|	ТаблицаВозвраты.СуммаСписанияНУ КАК СтоимостьНУ,
		|	ТаблицаВозвраты.СуммаСписанияПР КАК СтоимостьПР,
		|	ТаблицаВозвраты.СуммаСписанияВР КАК СтоимостьВР
		|ИЗ
		|	ТаблицаВозвраты КАК ТаблицаВозвраты");
	...
	Если СчетаУчетаН.Количество() > 0 И СчетаУчетаН_Склад.Количество() = 0 Тогда
		...
		|	Остатки.КоличествоОстатокДт КАК КоличествоПоСкладу,
		|	Остатки.КоличествоОстатокДт КАК Количество,
		|	Остатки.СуммаОстатокДт КАК Стоимость,
		|	Остатки.СуммаНУОстатокДт КАК СтоимостьНУ,
		|	Остатки.СуммаПРОстатокДт КАК СтоимостьПР,
		|	Остатки.СуммаВРОстатокДт КАК СтоимостьВР
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.Остатки(
		|			&МоментВремени,
		|			Счет В (&СчетаУчетаН),
	...
	ИначеЕсли СчетаУчетаН.Количество() > 0 Тогда
		...
		ЗапросыСумм.Добавить(
		"ВЫБРАТЬ
		|	ОстаткиПоСкладам.СчетУчета КАК СчетУчета,
		...
		|	&ПустойКонтрагент КАК Контрагент,
		|	&Организация КАК Организация,
		|	ОстаткиПоСкладам.КоличествоОстатокДт КАК КоличествоПоСкладу,
		|	СуммовыеОстатки.Количество КАК Количество,
		|	СуммовыеОстатки.Стоимость КАК Стоимость,
		|	СуммовыеОстатки.СтоимостьНУ КАК СтоимостьНУ,
		|	СуммовыеОстатки.СтоимостьПР КАК СтоимостьПР,
		|	СуммовыеОстатки.СтоимостьВР КАК СтоимостьВР
		|ИЗ
	...
	ИначеЕсли СчетаУчетаНП.Количество() > 0 Тогда
		...
		|	ОстаткиПоСкладам.Подразделение КАК Подразделение,
		|	ОстаткиПоСкладам.Номенклатура КАК Номенклатура,
		|	ОстаткиПоСкладам.ДокументОприходования КАК ДокументОприходования,
		|	ОстаткиПоСкладам.Склад КАК Склад,
		|	&ПустойКонтрагент КАК Контрагент,
		|	&Организация КАК Организация,
		|	ОстаткиПоСкладам.КоличествоОстатокДт КАК КоличествоПоСкладу,
	...
	ИначеЕсли СчетаУчетаНК.Количество() > 0 Тогда
		...
		|	&ПустаяПартия КАК ДокументОприходования,
		|	ОстаткиПоСкладам.Склад КАК Склад,
		|	ОстаткиПоСкладам.Контрагент КАК Контрагент,
		|	&Организация КАК Организация,
		|	ОстаткиПоСкладам.КоличествоОстатокДт КАК КоличествоПоСкладу,
		|	СуммовыеОстатки.Количество КАК Количество,
		|	СуммовыеОстатки.Стоимость КАК Стоимость,
	...
	// Добавляем помещение во временную таблицу.
	ПозицияПоиска = СтрНайти(ЗапросыСумм[0], Символы.ПС + "ИЗ");
	ЗапросыСумм[0] = Лев(ЗапросыСумм[0], ПозицияПоиска - 1) + Символы.ПС + "ПОМЕСТИТЬ ОстаткиТоваров" + Сред(ЗапросыСумм[0], ПозицияПоиска);
	ЗапросыСумм[ЗапросыСумм.ВГраница()] = ЗапросыСумм[ЗапросыСумм.ВГраница()] + "
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ДокументОприходования";
	
	// Остатки упорядочиваем по дате документа.
	ЗапросыПоКоличественнымСкладам.Добавить(СтрСоединить(ЗапросыСумм, "
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|"));
	ЗапросыПоКоличественнымСкладам.Добавить(
		...
		|	ОстаткиТоваров.Контрагент КАК Контрагент,
		|	ЕСТЬNULL(ДанныеПервичныхДокументов.ДатаРегистратора, ДАТАВРЕМЯ(1, 1, 1)) КАК ДокументОприходованияДата,
		|	ЕСТЬNULL(ОстаткиТоваров.ДокументОприходования, &ПустаяПартия) КАК ДокументОприходования,
		|	ОстаткиТоваров.Склад КАК Склад,
		|	ОстаткиТоваров.Организация КАК Организация,
		|	СУММА(ЕСТЬNULL(ОстаткиТоваров.КоличествоПоСкладу, 0)) КАК КоличествоПоСкладу,
		|	СУММА(ЕСТЬNULL(ОстаткиТоваров.Количество, 0)) КАК Количество,
		|	СУММА(ЕСТЬNULL(ОстаткиТоваров.Стоимость, 0)) КАК Стоимость,
		|	СУММА(ЕСТЬNULL(ОстаткиТоваров.СтоимостьНУ, 0)) КАК СтоимостьНУ,
		|	СУММА(ЕСТЬNULL(ОстаткиТоваров.СтоимостьПР, 0)) КАК СтоимостьПР,
		|	СУММА(ЕСТЬNULL(ОстаткиТоваров.СтоимостьВР, 0)) КАК СтоимостьВР
		|ИЗ
		|	ОстаткиТоваров КАК ОстаткиТоваров
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеПервичныхДокументов
		|		ПО (ДанныеПервичныхДокументов.Организация = &Организация)
		|			И ОстаткиТоваров.ДокументОприходования = ДанныеПервичныхДокументов.Документ
		|
		|СГРУППИРОВАТЬ ПО
		|	ОстаткиТоваров.СчетУчета,
		|	ОстаткиТоваров.Подразделение,
		|	ОстаткиТоваров.Номенклатура,
		|	ОстаткиТоваров.Контрагент,
		|	ЕСТЬNULL(ДанныеПервичныхДокументов.ДатаРегистратора, ДАТАВРЕМЯ(1, 1, 1)),
		|	ЕСТЬNULL(ОстаткиТоваров.ДокументОприходования, &ПустаяПартия),
		|	ОстаткиТоваров.Склад,
		|	ОстаткиТоваров.Организация");
	Текст = СтрСоединить(ЗапросыПоКоличественнымСкладам, ОбщегоНазначения.РазделительПакетаЗапросов());
	
	Если БухгалтерскийУчетПереопределяемый.ВестиУчетПоПодразделениям() Тогда
		Текст = СтрЗаменить(Текст, "&УсловиеПоПодразделению", "ЕСТЬNULL(Подразделение, &Подразделение) = &Подразделение");
	Иначе
	...
	Если СчетаУчетаНПК.Количество() + СчетаУчетаНПС.Количество() + СчетаУчетаНП.Количество() <> 0 Тогда
		// Если по документу не было данных в ДанныеПервичныхДокументов и дата пустая, то возьмем ее напрямую из документа.
		ОбщегоНазначенияБПВызовСервера.ЗаполнитьДатыВТаблице(Результат, "ДокументОприходования", "ДокументОприходованияДата");
	КонецЕсли;
...
//
// Параметры:
//  Организация	 - СправочникСсылка.Организации - организация, для которой нужно получить признак оперативности расчета остатков.
//  Дата		 - Дата - Дата, на которую нужно получить признак оперативности расчета остатков.
// 
// Возвращаемое значение:
//  Массив - Массив счетов.
//
Функция СчетаРассчитываемыеОперативно(Организация, Дата) Экспорт
	...
	СписокСчетов.Добавить(ПланыСчетов.Хозрасчетный.ВозвратнаяТара);                         // 012
	...
	// При включенном автоматическом выпуске продукции по данным продаж нужно отключить механизм отложенного проведения
	// для счетов учета продукции. Так как при автоматическом выпуске нужно точно знать, сколько продукции не хватает,
	// то для нее нужно рассчитывать оперативные остатки, расчет остатков в отложенном проведении не подходит.
	// Признак включенности автоматического выпуска по данным продаж нужно проверять на конец месяца,
	// т.к. нельзя допустить, чтобы часть месяца рассчитывались остатки оперативно, часть - отложенно.
	Если УчетнаяПолитика.УчетВыпускаПродукцииПоДаннымПродаж(Организация, КонецМесяца(Дата)) Тогда
		СчетаУчетаПродукцииДляВыпуска = РасчетВыпускаПоДаннымПродаж.СчетаУчетаПродукцииДляВыпуска(); // 43
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(СписокСчетов, СчетаУчетаПродукцииДляВыпуска, Истина);
	КонецЕсли;
...
//
Функция ОперативныйРасчетПоСчету(СтрокаТовара, СчетаРассчитываемыеОперативно) Экспорт
...
Функция ВыполнитьРасчетСтоимостиСУчетомВозврата(НадоОценить, НадоРассчитать, Реквизиты, СписанныеТовары, 
	...
	ТаблицаОстатки = ПодготовитьТаблицуОстатковДляСписания(НадоРассчитать, Параметры.ТаблицаВозвраты, Реквизиты);
	...
	ТаблицаВыпущеннаяПродукция = УчетПроизводства.НовыйТаблицаВыпущеннойПродукции();
	...
	Для Каждого КлючИЗначение Из НадоРассчитать Цикл
		...
		СписатьОстаткиТоваровИСообщитьОбОшибке(
	...
	СписанныеТовары.Вставить("ВыпущеннаяПродукция", ТаблицаВыпущеннаяПродукция);
...
#Область ВыпускПродукцииПоДаннымПродаж

Функция МожноВыпуститьПродукциюПриСписании(ДокументРегистратор, СтрокаДокумента, СчетаУчетаПродукцииДляВыпуска)
	
	Если Не РасчетВыпускаПоДаннымПродаж.ДокументПоддерживаетАвтоматическийВыпускПродукции(ДокументРегистратор) Тогда
		Возврат Ложь;
	КонецЕсли;
	
	Если СчетаУчетаПродукцииДляВыпуска.Найти(СтрокаДокумента.СчетУчета) <> Неопределено Тогда
		Возврат Истина;
	КонецЕсли;
...
Процедура ВыпуститьПродукциюИСписать(СтрокаДокумента, СведенияОПродукции, ТаблицаСписанныеТовары, ТаблицаВыпущеннаяПродукция, ПараметрыСписания)
	
	ВедетсяУчетПоСкладам = БухгалтерскийУчет.ВедетсяУчетПоСкладам(СтрокаДокумента.СчетУчета);
	Склад = ?(ВедетсяУчетПоСкладам, СтрокаДокумента.Склад, Справочники.Склады.ПустаяСсылка());
	
	ВедетсяУчетПоПартиям = Не ПараметрыСписания.СпособОценкиМПЗПоСредней;
	
	// Подразделение для выпуска и для списания оставляяем пустым, т.к. обычно при выпуске продукции его не заполняют.
	// И оно не обязательно должно совпадать с подразделением, которое продало эту продукцию.
	ПодразделениеСклада = Справочники.ПодразделенияОрганизаций.ПустаяСсылка();
	
	СписаннаяПартия = ТаблицаСписанныеТовары.Добавить();
	ЗаполнитьЗначенияСвойств(СписаннаяПартия, СтрокаДокумента);
	СписаннаяПартия.Подразделение       = ПодразделениеСклада;
	Если ВедетсяУчетПоПартиям Тогда
		СписаннаяПартия.Партия          = ПараметрыСписания.Регистратор;
	КонецЕсли;
	СписаннаяПартия.Склад               = Склад;
	СписаннаяПартия.Количество          = СведенияОПродукции.КоличествоПродукции;
	СписаннаяПартия.СуммаСписания       = СведенияОПродукции.ПлановаяСебестоимость;
	СписаннаяПартия.СуммаСписанияНУ     = СведенияОПродукции.ПлановаяСебестоимость;
	СписаннаяПартия.СуммаСписанияПР     = 0;
	СписаннаяПартия.СуммаСписанияВР     = 0;
	СписаннаяПартия.СуммаКорСписанияНУ  = СведенияОПродукции.ПлановаяСебестоимость;
	СписаннаяПартия.СуммаКорСписанияПР  = 0;
	СписаннаяПартия.СуммаКорСписанияВР  = 0;
	
	ПартияВыпущеннойПродукции = ТаблицаВыпущеннаяПродукция.Добавить();
	ПартияВыпущеннойПродукции.ИмяСписка = СтрокаДокумента.ИмяСписка;
	ПартияВыпущеннойПродукции.НомерСтроки = СтрокаДокумента.НомерСтроки;
	ПартияВыпущеннойПродукции.Номенклатура = СтрокаДокумента.Номенклатура;
	ПартияВыпущеннойПродукции.Спецификация = СведенияОПродукции.Спецификация;
	Если ВедетсяУчетПоПартиям Тогда
		ПартияВыпущеннойПродукции.Партия = ПараметрыСписания.Регистратор;
	КонецЕсли;
	ПартияВыпущеннойПродукции.СчетЗатрат = РасчетВыпускаПоДаннымПродаж.СчетВыпускаПродукции(
		ПараметрыСписания.Организация, ПараметрыСписания.Период);
	ПартияВыпущеннойПродукции.ПодразделениеЗатрат = РасчетВыпускаПоДаннымПродаж.ПодразделениеЗатратДляВыпущеннойПродукции(
		ПараметрыСписания.Организация);
	ПартияВыпущеннойПродукции.НоменклатурнаяГруппаЗатрат = СведенияОПродукции.НоменклатурнаяГруппа;
	ПартияВыпущеннойПродукции.СчетУчета = СтрокаДокумента.СчетУчета;
	ПартияВыпущеннойПродукции.Подразделение = ПодразделениеСклада;
	ПартияВыпущеннойПродукции.Склад = Склад;
	ПартияВыпущеннойПродукции.Количество = СведенияОПродукции.КоличествоПродукции;
	ПартияВыпущеннойПродукции.СуммаПлановая = СведенияОПродукции.ПлановаяСебестоимость;
	ПартияВыпущеннойПродукции.СуммаПлановаяНУ = СведенияОПродукции.ПлановаяСебестоимость;
	
КонецПроцедуры

Функция СведенияОПродукцииДляВыпуска(Номенклатура, Количество, Период)
	
	ДанныеНоменклатуры = РасчетВыпускаПоДаннымПродаж.ДанныеНоменклатурыДляВыпущеннойПродукции(Номенклатура);
	
	СведенияОПродукции = Новый Структура();
	СведенияОПродукции.Вставить("КоличествоПродукции", Количество);
	СведенияОПродукции.Вставить("НоменклатурнаяГруппа", ДанныеНоменклатуры.НоменклатурнаяГруппа);
	СведенияОПродукции.Вставить("ПлановаяСебестоимость", 0);
	СведенияОПродукции.Вставить("Спецификация", ДанныеНоменклатуры.Спецификация);
	
	ТипЦенПлановойСебестоимости = Константы.ТипЦенПлановойСебестоимостиНоменклатуры.Получить();
	Если ЗначениеЗаполнено(ТипЦенПлановойСебестоимости) Тогда
		СведенияОПродукции.ПлановаяСебестоимость = Количество
			* Ценообразование.ПолучитьЦенуНоменклатуры(Номенклатура, ТипЦенПлановойСебестоимости, Период);
	КонецЕсли;
	
	Возврат СведенияОПродукции;
...
Процедура СформироватьДвиженияСписанияТоваровВозвратОтПокупателя(ТаблицаСписанныеТовары, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	...
	СформироватьДвиженияСписаниеТоваров(ТаблицаСписанныеТовары, ТаблицаРеквизиты, Движения, Отказ);
...
Процедура СформироватьДвиженияПоступлениеТарыВЭксплуатацию(ТаблицаСписанныеМатериалы, ТаблицаТара, ТаблицаРеквизиты, Движения, Отказ) Экспорт
	
	Если Не ЗначениеЗаполнено(ТаблицаСписанныеМатериалы)
	 Или Не ЗначениеЗаполнено(ТаблицаТара)
	 Или Не ЗначениеЗаполнено(ТаблицаРеквизиты) Тогда
		Возврат;
	КонецЕсли;
	
	Параметры = ПодготовитьПараметрыПоступлениеТарыВЭксплуатацию(ТаблицаСписанныеМатериалы, ТаблицаТара, ТаблицаРеквизиты);
	Реквизиты = Параметры.Реквизиты[0];
	
	Для каждого СтрокаТаблицы Из Параметры.ТаблицаТара Цикл

		Отбор = Новый Структура("НомерСтроки", СтрокаТаблицы.НомерСтроки);
		СтрокиТаблицыСписаннаяТара = Параметры.ТаблицаСписанныеМатериалы.НайтиСтроки(Отбор);
		...
		Для каждого СтрокаПартии Из СтрокиТаблицыСписаннаяТара Цикл
			...
			Если СвойстваСчетаДт.НалоговыйУчет Тогда
				Проводка.СуммаНУДт = СтрокаПартии.СуммаСписания;
			КонецЕсли;
...
Функция ПодготовитьПараметрыПоступлениеТарыВЭксплуатацию(ТаблицаСписанныеМатериалы, ТаблицаТара, ТаблицаРеквизиты)
	...
	+ "НомерСтроки,"         // <Число> - номер строки в списке
	+ "Номенклатура,"        // <СправочникСсылка.Номенклатура> - поступающая тара
	+ "Склад,"      		 // <Число,15,2> - сумма в валюте взаиморасчетов с поставщиком
	+ "СуммаСписания," 		 // <Число,15,2> - сумма в валюте взаиморасчетов с поставщиком
	+ "Количество";          // <Число,15,3> - количество поступающей тары
...
Функция ПодготовитьТаблицуПоступленияТарыПоДаннымСписания(ТаблицаСписанныеТовары, Отказ) Экспорт

	Если Не ЗначениеЗаполнено(ТаблицаСписанныеТовары) Тогда
	    Возврат Неопределено;
	КонецЕсли;
	
	ТаблицаРезультата = ТаблицаСписанныеТовары.Скопировать();
		
	СуммаСписания = ТаблицаРезультата.Колонки.Найти("СуммаСписания");
	Если СуммаСписания = Неопределено Тогда
		Возврат Неопределено;		
	КонецЕсли;
	
	СуммаСписания.Имя = "СуммаРуб";
	
	ТаблицаРезультата.ЗаполнитьЗначения(ПланыСчетов.Хозрасчетный.ВозвратнаяТараНаСкладе, "СчетУчета");
	
	Возврат ТаблицаРезультата;

КонецФункции

Функция ДополнитьТаблицуСписанияИнформациейОКомитенте(ТаблицаОстатков)
	...
	|	ТаблицаОстатков.ДокументОприходованияДата КАК ДокументОприходованияДата,
	|	ТаблицаОстатков.ДокументОприходования КАК ДокументОприходования,
	|	ТаблицаОстатков.Склад КАК Склад,
	|	ТаблицаОстатков.Организация КАК Организация,
	|	ТаблицаОстатков.КоличествоПоСкладу КАК КоличествоПоСкладу,
	|	ТаблицаОстатков.Количество КАК Количество,
	|	ТаблицаОстатков.Стоимость КАК Стоимость,
	|	ТаблицаОстатков.СтоимостьНУ КАК СтоимостьНУ,
	|	ТаблицаОстатков.СтоимостьПР КАК СтоимостьПР,
	|	ТаблицаОстатков.СтоимостьВР КАК СтоимостьВР
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЕСТЬNULL(ПоступлениеТоваровУслуг.Контрагент, НЕОПРЕДЕЛЕНО) КАК Комитент,
	|	ТаблицаОстатков.СчетУчета КАК СчетУчета,
	|	ТаблицаОстатков.Подразделение КАК Подразделение,
	|	ТаблицаОстатков.Номенклатура КАК Номенклатура,
	|	ТаблицаОстатков.ДокументОприходованияДата КАК ДокументОприходованияДата,
	...
	|	ТаблицаОстатков КАК ТаблицаОстатков
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровУслуг КАК ПоступлениеТоваровУслуг
	|		ПО ТаблицаОстатков.ДокументОприходования = ПоступлениеТоваровУслуг.Ссылка
	|			И (ТаблицаОстатков.СчетУчета В (&ТоварыПринятыеНаКомиссию))";
	
	Возврат Запрос.Выполнить().Выгрузить();
	
КонецФункции

Функция ЕстьСписаниеПрослеживаемыхТоваровКомитента(ТаблицаСписания)
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ТаблицаСписания.СчетУчета КАК СчетУчета,
	|	ТаблицаСписания.Контрагент КАК Комитент
	...
	|	ТаблицаСписания КАК ТаблицаСписания
	|ГДЕ
	|	ТаблицаСписания.СчетУчета В (&ТоварыПринятыеНаКомиссию)
	|	И ТаблицаСписания.Комитент <> ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)";
	Результат = Запрос.Выполнить();
...
//Определяет поступление в продажных ценах
//Параметры:  
//			СпособОценкиТоваровВРознице - Тип("ПеречислениеССылка.СпособыОценкиТоваровВРознице")
//			Склад 						- Тип("СправочникСсылка.Склады")
//			ЭтоКомиссия 				- Тип("Булево")
//			ТипСклада 					- Тип("ПеречисленияСсылка.ТипыСкладов") - выходной параметр
//			ВидОперации 				- Тип(ПеречисленияСсылка.ВидыОперацийПоступленияТоваровУслуг) - необяз.
//
//Возвращаемое значение: РозницаВПродажныхЦенах Тип("Булево")
//
Функция РозницаВПродажныхЦенах(СпособОценкиТоваровВРознице, Склад, ЭтоКомиссия, ТипСклада = Неопределено, ВидОперации = Неопределено) Экспорт
	
	ТипСклада = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Склад, "ТипСклада");
	
	Возврат ?(ЗначениеЗаполнено(ВидОперации), (ВидОперации = Перечисления.ВидыОперацийПоступлениеТоваровУслуг.ПокупкаКомиссия
			ИЛИ ВидОперации = Перечисления.ВидыОперацийПоступлениеТоваровУслуг.Товары
			ИЛИ ВидОперации = Перечисления.ВидыОперацийПоступлениеТоваровУслуг.Оборудование), Истина)
			И СпособОценкиТоваровВРознице = Перечисления.СпособыОценкиТоваровВРознице.ПоПродажнойСтоимости
			И ТипСклада <> Перечисления.ТипыСкладов.ОптовыйСклад И НЕ ЭтоКомиссия;
