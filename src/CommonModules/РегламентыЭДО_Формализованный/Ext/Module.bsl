...
Функция ЗаполнитьСостояниеПоИсходящемуИзвещениюОПолучении(ПараметрыДокумента, СостоянияЭлементовРегламента, Состояние)
	...
	Если ПараметрыДокумента.ТребуетсяИзвещение
		И Не РегламентыЭДО.ОдинИзЭлементовРегламентаВходитВКоллекцию(СостоянияЭлементовРегламента, ТипИОП, Перечисления.НаправленияЭДО.Исходящий, ЭлементРегламента) Тогда
