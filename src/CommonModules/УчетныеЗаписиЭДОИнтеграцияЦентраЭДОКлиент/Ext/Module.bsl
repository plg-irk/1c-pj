...
// Параметры:
//  ОповещениеОЗавершении - ОписаниеОповещения - результат: см. НовыйРезультатАвторизацииВСервисеЭДО
...
Процедура АвторизоватьсяВСервисеЭДО(ОповещениеОЗавершении, ПараметрыАвторизации,
	...
	КонтекстАвторизации.УчетнаяЗаписьЦентраЭДО = УчетнаяЗаписьЦентраЭДО;
	
	Оповещение = Новый ОписаниеОповещения("АвторизоватьсяВСервисеЭДОПослеПолученияОтпечатков",
		УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент, КонтекстАвторизации);
...
Процедура ОткрытьФормуУчетнойЗаписиЭДО(ИдентификаторЭДО) Экспорт
	...
	КлючЗаписи = УчетныеЗаписиЭДОСлужебныйВызовСервера.ПолучитьКлючУчетнойЗаписиЭДО(ИдентификаторЭДО);
	ПараметрыОткрытия.Вставить("Ключ", КлючЗаписи);
	Попытка
		ОткрытьФорму("РегистрСведений.УчетныеЗаписиЭДО.Форма.УчетнаяЗапись", ПараметрыОткрытия);
	Исключение
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Учетная запись ЭДО <%1> была удалена.'"), ИдентификаторЭДО);
	КонецПопытки;
...
// См. УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиентСервер.НовыеПараметрыРегистрацииСертификатовВЭДО
Функция НовыеПараметрыРегистрацииСертификатовВЭДО() Экспорт
	Возврат УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиентСервер.НовыеПараметрыРегистрацииСертификатовВЭДО();
КонецФункции
...
Процедура НачатьОтправкуСертификатовДляРегистрацииВЭДО(ОповещениеОЗавершении, ПараметрыРегистрации, ФормаВладелец) Экспорт
	...
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.ПодготовитьДанныеДляПодписанияНаРегистрациюВЭДОВФоне(
	...
	КонтекстРегистрации.УчетнаяЗаписьЦентраЭДО = ПараметрыРегистрации.УчетнаяЗаписьЦентраЭДО;
	
	Оповещение = Новый ОписаниеОповещения("ПодписатьДанныеНаРегистрациюВЭДОПослеПодготовки",
		УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент, КонтекстРегистрации);
...
Функция НовыйРезультатОтправкиСертификатовДляРегистрацииВЭДО() Экспорт
	...
	РезультатОтправки.Вставить("ВыбранныйСертификат", Неопределено);
...
Процедура НачатьПолучениеРезультатаРегистрацииСертификатовЭДО(ОповещениеОЗавершении,
	ИдентификаторыЗаявокПоУчетнымЗаписямЦентраЭДО, ФормаВладелец) Экспорт
	
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.ПроверитьОбработкуРегистрационныхПакетовЭДОВФоне(
		ИдентификаторыЗаявокПоУчетнымЗаписямЦентраЭДО, ФормаВладелец.УникальныйИдентификатор);
	
	Оповещение = Новый ОписаниеОповещения("ОбработатьРезультатыРегистрацииСертификатовЭДО",
		УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент, ОповещениеОЗавершении);
...
Процедура ОбновитьНастройкиУведомленийУчетнойЗаписиЭДО(ПараметрыОбновления) Экспорт
	...
	Оповещение = Новый ОписаниеОповещения("ОбновитьНастройкиУведомленийУчетнойЗаписиЭДОПослеАвторизацииВСервисеЭДО",
		УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент, ПараметрыОбновления);
	...
	Если ЗначениеЗаполнено(ПараметрыОбновления.ВыбранныйСертификат) Тогда
	...
	УчетныеЗаписиЭДОКлиент.АвторизоватьсяВСервисеЭДО(Оповещение, ПараметрыАвторизации);
...
Процедура ПолучитьНастройкиУведомленийУчетнойЗаписиЭДО(ПараметрыПолучения) Экспорт
	...
	Если ЗначениеЗаполнено(ПараметрыПолучения.ВыбранныйСертификат) Тогда
		ПараметрыАвторизации.ВыбранныеСертификаты.Добавить(ПараметрыПолучения.ВыбранныйСертификат);
	КонецЕсли;
	ПараметрыАвторизации.ФормаВладелец = ПараметрыПолучения.ФормаВладелец;
	
	АвторизоватьсяВСервисеЭДО(Оповещение, ПараметрыАвторизации, ПараметрыПолучения.УчетнаяЗаписьЦентраЭДО);
...
Процедура ОбновитьИнформациюОбУчетнойЗаписиЭДО(ИнформацияОбУчетнойЗаписи, ОповещениеОЗавершении, ФормаВладелец) Экспорт
	...
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.ОбновитьИнформациюОбУчетнойЗаписиЭДОВФоне(
...
Функция НовыйКонтекстАвторизацииВСервисеЭДО() Экспорт
	...
	Контекст.Вставить("УчетнаяЗаписьЦентраЭДО", Неопределено);
	Возврат Контекст;
...
Процедура АвторизоватьсяВСервисеЭДОПослеПолученияОтпечатков(РезультатыПолученияОтпечатков, КонтекстАвторизации) Экспорт
	...
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.АвторизоватьсяВСервисеЭДОВФоне(
		РезультатыПолученияОтпечатков, ПараметрыАвторизации.ИдентификаторыЭДО,
		ПараметрыАвторизации.ВыбранныеСертификаты, КонтекстАвторизации.УчетнаяЗаписьЦентраЭДО, ИдентификаторФормы);
...
Функция РезультатОтправкиСертификатовДляРегистрацииВЭДО(КонтекстРегистрации)
	...
	Результат.ВыбранныйСертификат = КонтекстРегистрации.ВыбранныйСертификат;
...
Процедура ПодписатьДанныеНаРегистрациюВЭДОПослеПодготовки(ДлительнаяОперация, КонтекстРегистрации) Экспорт
	...
	Если ДлительнаяОперация = Неопределено
		...
		ТекстОшибки = ?(ДлительнаяОперация = Неопределено, 
			НСтр("ru = 'Не удалось подготовить данные регистрационного пакета.'"),
			НСтр("ru = 'Не удалось подготовить данные регистрационного пакета.'")
	...
	Иначе
		РезультатПодготовкиДанных = ПолучитьИзВременногоХранилища(ДлительнаяОперация.АдресРезультата); // См. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.ПодготовитьДанныеДляПодписанияНаРегистрациюВЭДО
	...
	ДанныеДляПодписания = РезультатПодготовкиДанных.ДанныеДляПодписания;// См. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.НовыеДанныеДляПодписанияНаРегистрациюВЭДО
...
// Параметры:
//  ДанныеДляПодписания - см. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.НовыеДанныеДляПодписанияНаРегистрациюВЭДО
//  КонтекстРегистрации - см. НовыйКонтекстРегистрацииСертификатовВЭДО
// 
// Возвращаемое значение:
//  Структура:
...
Функция ОписаниеДанныхДляИнтерактивногоПодписанияНаРегистрациюВЭДО(ДанныеДляПодписания, КонтекстРегистрации)
	...
	ОбработчикВизуализацииЗаявки = Новый ОписаниеОповещения("ПоказатьДанныеДляРегистрацииВЭДО",
		УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент, ПараметрыВизуализацииДанных);
...
//  ДанныеДляПодписания - см. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.НовыеДанныеДляПодписанияНаРегистрациюВЭДО
Процедура ОбновитьДанныеПодписанияВОписаниеДанных(ОписаниеДанных, ДанныеДляПодписания)
	Для Каждого ДанныеНабора Из ОписаниеДанных.НаборДанных Цикл
		Если ДанныеНабора.Идентификатор = ИдентификаторДанныхДляРегистрацииЭДО() Тогда
			ДанныеНабора.Данные = ДанныеДляПодписания.ДанныеДляРегистрации;
		КонецЕсли;
		Если ДанныеНабора.Идентификатор = ИдентификаторДанныхСоглашенияНаПодключениеЭДО() Тогда
			ДанныеНабора.Данные = ДанныеДляПодписания.ДанныеСоглашения;
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
Процедура ЗаполнитьПодписантаДанныхНаРегистрациюВЭДО(РезультатВыбораСертификата, КонтекстРегистрации) Экспорт
	...
	РезультатЗаполнения = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.ЗаполнитьДанныеДляПодписанияНаРегистрациюВЭДОПоСертификату(
		КонтекстРегистрации.УчетнаяЗаписьЦентраЭДО, КонтекстРегистрации.ИдентификаторЗаявки, ВыбранныйСертификат);
	Если РезультатЗаполнения.ДанныеДляПодписания = Неопределено Тогда
		МассивОшибки = ОбработкаНеисправностейБЭДКлиентСервер.ПолучитьОшибки(РезультатЗаполнения.КонтекстДиагностики);
		ТекстОшибки = СтрСоединить(МассивОшибки, Символы.ПС);
		ОписаниеДанных.Вставить("ОписаниеОшибки", ТекстОшибки);
	Иначе
		//@skip-check invocation-parameter-type-intersect
		ОбновитьДанныеПодписанияВОписаниеДанных(РезультатВыбораСертификата.ОписаниеДанных, 
			РезультатЗаполнения.ДанныеДляПодписания);
	КонецЕсли;
...
Процедура ОтправитьРегистрационныйПакетЭДОПослеПодписания(РезультатПодписания, КонтекстРегистрации) Экспорт
	...
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.ОтправитьРегистрационныйПакетЭДОВФоне(
		КонтекстРегистрации.УчетнаяЗаписьЦентраЭДО, ИдентификаторЗаявки, Подписи, ФормаВладелец.УникальныйИдентификатор);
...
Функция ОбработатьРезультатПодписанияРегистрационногоПакетаЭДО(РезультатПодписания, КонтекстРегистрации)
	...
	КонтекстРегистрации.ВыбранныйСертификат = ВыбранныйСертификат;
...
Процедура ОбработатьРезультатОтправкиРегистрационногоПакетаЭДО(ДлительнаяОперация, КонтекстРегистрации) Экспорт
	...
	Иначе
		РезультатОперации = ПолучитьИзВременногоХранилища(ДлительнаяОперация.АдресРезультата); // см. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.ОтправитьРегистрационныйПакетЭДО
		ОбработкаНеисправностейБЭДКлиентСервер.ДополнитьКонтекстДиагностики(РезультатОтправки.КонтекстДиагностики,
			РезультатОперации.КонтекстДиагностики);
...
Процедура ОбновитьНастройкиУведомленийУчетнойЗаписиЭДОПослеАвторизацииВСервисеЭДО(РезультатАвторизации, ПараметрыОбновления) Экспорт
	...
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.ОбновитьНастройкиУведомленийУчетнойЗаписиЭДОВФоне(
...
Процедура ОбновитьНастройкиУведомленийУчетнойЗаписиЭДОЗавершение(ДлительнаяОперация, ПараметрыОбновления) Экспорт
	...
	Иначе
		Результат = ПолучитьИзВременногоХранилища(ДлительнаяОперация.АдресРезультата); // см. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.ОбновитьНастройкиУведомленийУчетнойЗаписиЭДО
	КонецЕсли;
...
Процедура ПолучитьНастройкиУведомленийУчетнойЗаписиЭДОПослеАвторизацииВСервисеЭДО(РезультатАвторизации, ПараметрыПолучения) Экспорт
	...
	ДлительнаяОперация = УчетныеЗаписиЭДОИнтеграцияЦентраЭДОВызовСервера.НастройкиУведомленийУчетнойЗаписиЭДОВФоне(
		ПараметрыПолучения.ИдентификаторУчетнойЗаписиЭДО,
		РезультатАвторизации.РасшифрованныеМаркеры,
		ПараметрыПолучения.УчетнаяЗаписьЦентраЭДО,
		ИдентификаторФормы);
	
	Оповещение = Новый ОписаниеОповещения("ПолучитьНастройкиУведомленийУчетнойЗаписиЭДОЗавершение",
		УчетныеЗаписиЭДОИнтеграцияЦентраЭДОКлиент, ПараметрыПолучения);
...
Процедура ПолучитьНастройкиУведомленийУчетнойЗаписиЭДОЗавершение(ДлительнаяОперация, ПараметрыПолучения) Экспорт
	...
	Иначе
		Результат = ПолучитьИзВременногоХранилища(ДлительнаяОперация.АдресРезультата); // см. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.НастройкиУведомленийУчетнойЗаписиЭДО
	КонецЕсли;
...
Процедура ОбновитьИнформациюОбУчетнойЗаписиЭДОЗавершение(ДлительнаяОперация, ОповещениеОЗавершении) Экспорт
	...
	Иначе
		РезультатОбновления = ПолучитьИзВременногоХранилища(ДлительнаяОперация.АдресРезультата); // см. УчетныеЗаписиЭДОИнтеграцияЦентраЭДО.ОбновитьИнформациюОбУчетнойЗаписиЭДО
	КонецЕсли;
