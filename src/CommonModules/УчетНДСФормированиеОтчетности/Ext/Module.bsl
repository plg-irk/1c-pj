...
// Заполняет контейнер с показателями декларации по НДС.
// Для версии отчета ФормаОтчета2026Кв1.
Процедура ЗаполнитьОтчетНДСФормаОтчета2026Кв1(ПараметрыОтчета, Контейнер) Экспорт
	
	ПараметрыОтчета.Вставить("ПравилаЗаполнения", "2026Кв1");
	ЗаполнитьДекларациюНДС(ПараметрыОтчета, Контейнер);
...
Процедура ПолучитьСведенияОПоказателяхОтчетаНДСФормаОтчета2020Кв4(ПоказателиОтчета) Экспорт
	...
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000300010005", Истина, Истина);
	
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000300012003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000300012503", Истина, Истина);
	...
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500001003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500002003", Истина, Истина);
	
	// Многострочные Начало
	
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500003003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500004003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500005003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500006003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500007003", Истина, Истина);
	
	// Многострочные Окончание

	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500008003", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000500009003", Истина, Истина);
...
// Создает список показателей декларации по НДС, которые будут автоматически заполняться.
// Для версии отчета ФормаОтчета2026Кв1.
Процедура ПолучитьСведенияОПоказателяхОтчетаНДСФормаОтчета2026Кв1(ПоказателиОтчета) Экспорт
	...
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000300000303", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000300000503", Истина, Истина);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000300000703", Истина, Истина);
...
Функция ПоказателиДекларацииНДС(Организация, ГруппаОрганизаций, НачалоПериода, КонецПериода, ВесьОборотЗаПериод = Истина) Экспорт
	...
	Иначе
		...
		ИначеЕсли КонецПериода < '20250101' Тогда
			ПараметрыОтчета.Вставить("ПравилаЗаполнения", "2023Кв1");
		ИначеЕсли КонецПериода < '20260101' Тогда
			ПараметрыОтчета.Вставить("ПравилаЗаполнения", "2025Кв1");
		Иначе
			ПараметрыОтчета.Вставить("ПравилаЗаполнения", "2026Кв1");
		КонецЕсли;
...
#Область ПереченьЗаявленийОВвозеТоваров

// Создает список автоматически заполняемых показателей переченя заявлений о ввозе товаров и уплате косвенных налогов.
// Для версии отчета ФормаОтчета2015Кв2.
...
Процедура ЗаполнитьОтчетПереченьЗаявленийОВвозеТоваровФормаОтчета2015Кв2(ПараметрыОтчета, Контейнер) Экспорт
	...
	ЗаполнитьПереченьЗаявленийОВвозеТоваровФормаОтчета(ПараметрыОтчета, Контейнер);
	
КонецПроцедуры

Процедура ЗаполнитьПереченьЗаявленийОВвозеТоваровФормаОтчета(ПараметрыОтчета, Контейнер)
	...
	Запрос.Текст = ТекстЗапросаПереченьЗаявленийОВвозеТоваров();
...
Функция ТекстЗапросаПереченьЗаявленийОВвозеТоваров()
	
	Возврат
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЕСТЬNULL(ЗаявлениеОВвозеТоваровПолученноеДокументыОтгрузки.Ссылка, ЗНАЧЕНИЕ(Документ.ЗаявлениеОВвозеТоваровПолученное.ПустаяСсылка)) КАК Ссылка,
	|	ЕСТЬNULL(ЗаявлениеОВвозеТоваровПолученноеДокументыОтгрузки.ДокументОтгрузки, ЗНАЧЕНИЕ(Документ.РеализацияТоваровУслуг.ПустаяСсылка)) КАК ДокументОтгрузки
	|ПОМЕСТИТЬ ЗаяленияОВвозеДокументыОтгрузки
	|ИЗ
	...
	|		ПО НДСЗаписиКнигиПродаж.СчетФактура = ЗаявлениеОВвозеТоваровПолученноеДокументыОтгрузки.ДокументОтгрузки
	|ГДЕ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЗаявлениеОВвозеТоваровПолученное.НомерВходящегоДокумента КАК П000010001001,
	|	ЗаявлениеОВвозеТоваровПолученное.Дата КАК П000010001002,
	|	ВЫБОР
	|		КОГДА ЗаяленияОВвозеДокументыОтгрузки.ДокументОтгрузки ССЫЛКА Документ.СчетФактураВыданный
	|			ТОГДА ""3""
	|		ИНАЧЕ ""1""
	|	КОНЕЦ КАК П000010001003,
	|	ЗаявлениеОВвозеТоваровПолученное.Контрагент.НалоговыйНомер КАК П000010001004,
	|	ЗаявлениеОВвозеТоваровПолученное.Контрагент.СтранаРегистрации.Код КАК П000010001005
	|ИЗ
	|	ЗаяленияОВвозеДокументыОтгрузки КАК ЗаяленияОВвозеДокументыОтгрузки
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаявлениеОВвозеТоваровПолученное КАК ЗаявлениеОВвозеТоваровПолученное
	|		ПО ЗаяленияОВвозеДокументыОтгрузки.Ссылка = ЗаявлениеОВвозеТоваровПолученное.Ссылка
	|ГДЕ
	|	ЗаявлениеОВвозеТоваровПолученное.Проведен
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ЗаяленияОВвозеДокументыОтгрузки";

КонецФункции

#КонецОбласти

#Область СтатистикаФормаУчетаПеремещенияТоваровТС

// Создает список показателей для автоматического заполнения статистической формы учета перемещения товаров.
// Для версии отчета ФормаАналогЛК.
Процедура ПолучитьСведенияОПоказателяхОтчетаСтатистикаФормаУчетаПеремещенияТоваровТСФормаАналогЛК(ПоказателиОтчета) Экспорт
	
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "ЭК", Ложь, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "ИМ", Ложь, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "ДоступенПодборНоменклатурыИзСправочника", Ложь, Ложь);
	
	ПоказателиОтчета.Вставить("ИмяФормыПодбораОснований", "ОбщаяФорма.ПодборОснованийСтатформы");
	
КонецПроцедуры

Процедура ЗаполнитьОтчетСтатистикаФормаУчетаПеремещенияТоваровТСФормаАналогЛК(ПараметрыОтчета, Контейнер) Экспорт
	
	ЗаполнитьСтатистическуюФормуУчетаПеремещенияТоваров(ПараметрыОтчета, Контейнер);
	
КонецПроцедуры

Процедура ЗаполнитьСтатистическуюФормуУчетаПеремещенияТоваров(ПараметрыОтчета, Контейнер)
	
	Контейнер = ТаблицыСтатистическойФормыУчетаПеремещенияТоваров(ПараметрыОтчета.МассивДокументов, ПараметрыОтчета.НаправлениеПеремещения);
	
КонецПроцедуры

// Определяет Структуру таблиц значений для заполнения отчета "Статистическая форма учета перемещения товаров"
// Параметры
// МассивДокументов       - массив документов отгрузки (РеализацияТоваровУслуг.Ссылка)
//......................... или массив структур со значениением Ссылка (ОтчетКомиссионераОПродажах.Ссылка)
//                                при экспорте товаров в страны ЕАЭС,
//                          либо массив заявлений о ввозе товаров (ЗаявлениеОВвозеТоваров.Ссылка)
...
//    РеквизитыШапка                      - Структура
//    ТаблицаДокументы                    - ТаблицаЗначений
//    ТаблицаТоварыДляВыгрузки            - ТаблицаЗначений
//    ШтрихкодыУпаковок                   - ТаблицаЗначений
//    КурсыВалютыНаДатыДокументовОтгрузки - ТаблицаЗначений
Функция ТаблицыСтатистическойФормыУчетаПеремещенияТоваров(МассивДокументов, НаправлениеПеремещения) Экспорт
	
	//Инициализация структуры результата для возврата значения функции
	
	РеквизитыШапка = Новый Структура;
	ТаблицаТоварыДляВыгрузки = Новый ТаблицаЗначений;
	ШтрихкодыУпаковок = Неопределено;
	КурсыВалютыНаДатыДокументовОтгрузки = Новый ТаблицаЗначений;
	...
	ТаблицаДопСведения.Колонки.Добавить("ДокументСсылка");
	ТаблицаДопСведения.Колонки.Добавить("Номенклатура");
	ТаблицаДопСведения.Колонки.Добавить("Код");
	ТаблицаДопСведения.Колонки.Добавить("ДополнительнаяИнформация");
	
	Результат = Новый Структура(
		"РеквизитыШапка, ТаблицаДокументы, ТаблицаТоварыДляВыгрузки,
		|ТаблицаДопСведения, ШтрихкодыУпаковок, КурсыВалютыНаДатыДокументовОтгрузки",
		РеквизитыШапка, ТаблицаДокументы, ТаблицаТоварыДляВыгрузки,
		ТаблицаДопСведения, ШтрихкодыУпаковок, КурсыВалютыНаДатыДокументовОтгрузки);
	...
	ДопСведенияТоварыФизЛицамЭлектронныеТорговыеПлощадки = "";
	
	// Нумерация начинается со 2-й строки, т.к. 1-я строка в макете содержит пустое значение
	Для Ном = 2 По СписокЗначенийГрафы19.ВысотаТаблицы Цикл
		
		Если СокрЛП(СписокЗначенийГрафы19.Область(Ном,1).Текст) = "07" Тогда
			ДопСведенияТоварыФизЛицамЭлектронныеТорговыеПлощадки = СокрЛП(СписокЗначенийГрафы19.Область(Ном,2).Текст);
		КонецЕсли;
	...
	ДокументОтгрузки = МассивДокументов[0];
	
	Если ТипЗнч(ДокументОтгрузки) = Тип("Структура") Тогда
		ИмяДокумента = "ОтчетКомиссионераОПродажах";
		ДокументСсылка = ДокументОтгрузки.ДокументСсылка;
		МассивДокументов.Очистить();
		МассивДокументов.Добавить(ДокументСсылка);
	КонецЕсли;
	
	ВалютаРеглУчета = ОбщегоНазначенияБПВызовСервераПовтИсп.ПолучитьВалютуРегламентированногоУчета();
	ДолларСША = Справочники.Валюты.НайтиПоНаименованию("USD",Истина);
	
	КурсыВалютыНаДатыДокументовОтгрузки = КурсыВалютыНаДатыДокументовОтгрузки(МассивДокументов, ДолларСША, ИмяДокумента);
	
	Шапка = Неопределено;
	ЗапросШапка = Новый Запрос;
	ЗапросШапка.УстановитьПараметр("МассивДокументов", МассивДокументов);
	ЗапросШапка.УстановитьПараметр("ВалютаРеглУчета", ВалютаРеглУчета);
	
	ЗапросТовары = Новый Запрос;
	ЗапросТовары.УстановитьПараметр("МассивДокументов", МассивДокументов);
	ЗапросТовары.УстановитьПараметр("ВалютаРеглУчета", ВалютаРеглУчета);
	ЗапросТовары.УстановитьПараметр("ДолларСША", ДолларСША);
	ЗапросТовары.УстановитьПараметр("ДопСведенияПрослеживаемыеТовары", ДопСведенияПрослеживаемыеТовары);
	ЗапросТовары.УстановитьПараметр("КурсыВалютыНаДатыДокументовОтгрузки", КурсыВалютыНаДатыДокументовОтгрузки);
	
	// Информация о товарах, подлежащих обязательной маркировке
	ЗапросШтрихкодыУпаковок = Новый Запрос;
	ЗапросШтрихкодыУпаковок.УстановитьПараметр("МассивДокументов", МассивДокументов);
	
	// Статформа подается ежемесячно всегда по одной организации
	Если НаправлениеПеремещения = "ЭК" Тогда
		
		Если ИмяДокумента = "РеализацияТоваровУслуг" Тогда
			
			ЗапросШапка.Текст = ТекстЗапросаШапкаСтатформаЭкспорт();
			
			ЗапросТовары.Текст = ТекстЗапросаТоварыСтатформаЭкспорт(ИмяДокумента);
			ЗапросТовары.УстановитьПараметр("КлючСтроки", Истина);
			
			ЗапросШтрихкодыУпаковок.Текст = ТекстЗапросаМаркировкаШтрихкодыУпаковокСтатформаЭкспорт();
			
			Шапка = ЗапросШапка.Выполнить().Выгрузить();
			ШтрихкодыУпаковок = ЗапросШтрихкодыУпаковок.Выполнить().Выгрузить();
			СведенияОСчетеФактуреВыданномЭкспорт(МассивДокументов, ТаблицаДокументы);
			
		Иначе
			РеквизитыШапка = ДокументОтгрузки;
			РеквизитыШапкаСтатформаЭкспортПоОтчетуКомиссионера(РеквизитыШапка, ВалютаРеглУчета);
			
			ЗапросТовары.Текст = ТекстЗапросаТоварыСтатформаЭкспорт(ИмяДокумента);
			ЗапросТовары.УстановитьПараметр("КлючСтроки", РеквизитыШапка.КлючСтроки);
			
			НоваяСтрока = ТаблицаДокументы.Добавить();
			НоваяСтрока.НаименованиеДокумента = "Договор";
			НоваяСтрока.НомерДокумента = ДокументОтгрузки.НомерДоговора;
			НоваяСтрока.ДатаДокумента = ДокументОтгрузки.ДатаДоговора;
			
			НоваяСтрока = ТаблицаДокументы.Добавить();
			НоваяСтрока.НаименованиеДокумента = "Счет-фактура (инвойс)";
			НоваяСтрока.НомерДокумента = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
				ДокументОтгрузки.НомерСчетаФактурыОтКомиссионера, Истина, Ложь);
			НоваяСтрока.ДатаДокумента = ДокументОтгрузки.ДатаСчетаФактурыОтКомиссионера;
			
			НоваяСтрока = ТаблицаДокументы.Добавить();
			НоваяСтрока.НаименованиеДокумента = "Счет-фактура (инвойс)";
			НоваяСтрока.НомерДокумента = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(
				ДокументОтгрузки.НомерСчетаФактурыВыданного, Истина, Ложь);
			НоваяСтрока.ДатаДокумента = ДокументОтгрузки.ДатаСчетаФактурыВыданного;
			
		КонецЕсли;
		
	Иначе
		
		ЗапросШапка.Текст = ТекстЗапросаШапкаСтатформаИмпорт();
		ЗапросТовары.Текст = ТекстЗапросаТоварыСтатформаИмпорт();
		ЗапросШтрихкодыУпаковок.Текст = ТекстЗапросаМаркировкаШтрихкодыУпаковокСтатформаИмпорт();
		
		Шапка = ЗапросШапка.Выполнить().Выгрузить();
		ШтрихкодыУпаковок = ЗапросШтрихкодыУпаковок.Выполнить().Выгрузить();
		СведенияОДокументахСтатформаИмпорт(МассивДокументов, ТаблицаДокументы);
		
	КонецЕсли;
	
	ТаблицаТоварыДляВыгрузки = ЗапросТовары.Выполнить().Выгрузить();
	
	Для каждого Документ Из МассивДокументов Цикл
		
		Если НаправлениеПеремещения = "ЭК"
			И ИмяДокумента = "РеализацияТоваровУслуг" Тогда
			
			Отбор = Новый Структура;
			Отбор.Вставить("ДокументСсылка", Документ);
			Отбор.Вставить("ПродажаФизлицуЧерезЭлектроннуюТорговуюПлощадку", Истина);
			РезультатПоиска = Шапка.НайтиСтроки(Отбор);
			
			Если РезультатПоиска.Количество() > 0 Тогда
				
				Отбор = Новый Структура;
				Отбор.Вставить("ДокументСсылка", Документ);
				ТоварыФизлицуЧерезЭлектроннуюТорговуюПлощадку = ТаблицаТоварыДляВыгрузки.НайтиСтроки(Отбор);
				
				Для каждого Товар Из ТоварыФизлицуЧерезЭлектроннуюТорговуюПлощадку Цикл
					ДопСведения = ТаблицаДопСведения.Добавить();
					ДопСведения.ДокументСсылка = Товар.ДокументСсылка;
					ДопСведения.Номенклатура = Товар.Номенклатура;
					ДопСведения.Код = "07";
					ДопСведения.ДополнительнаяИнформация = ДопСведенияТоварыФизЛицамЭлектронныеТорговыеПлощадки;
				КонецЦикла;
		...
		Отбор = Новый Структура;
		Отбор.Вставить("ДокументСсылка", Документ);
		Отбор.Вставить("ПрослеживаемыйТовар", Истина);
		ПрослеживаемыеТовары = ТаблицаТоварыДляВыгрузки.НайтиСтроки(Отбор);
		
		Для каждого Товар Из ПрослеживаемыеТовары Цикл
			ДопСведения = ТаблицаДопСведения.Добавить();
			ДопСведения.ДокументСсылка = Товар.ДокументСсылка;
			ДопСведения.Номенклатура = Товар.Номенклатура;
			ДопСведения.Код = "08";
			ДопСведения.ДополнительнаяИнформация = ДопСведенияПрослеживаемыеТовары;
		КонецЦикла;
		
	КонецЦикла;

	ПараметрыРазбораКодаМаркировки = РазборКодаМаркировкиИССлужебныйКлиентСервер.ИнициализироватьПараметрыРазбораКодаМаркировки();
	ПараметрыРазбораКодаМаркировки.НачинаетсяСоСкобки = Ложь;
	
	// Табличная часть документов ШтрихкодыУпаковок содержит информацию только о штрихкодах упаковок товаров,
	// подлежащих обязательной маркировке
	// Для правильного определения единичного кода в табличной части ШтрихкодыУпаковок колонка ЕдиничныйКод
	// должна иметь тип НЕОПРЕДЕЛЕНО или строгую типизацию
	Если ШтрихкодыУпаковок <> Неопределено Тогда
		
		Для каждого СтрокаШтрихкодыУпаковок Из ШтрихкодыУпаковок Цикл
			
			РезультатРазбора = РазборКодаМаркировкиИССлужебный.РазобратьКодМаркировки(СтрокаШтрихкодыУпаковок.ШтрихкодУпаковки);
			ШтрихкодыEAN = Новый Массив;
			ШтрихкодыEAN.Добавить(РезультатРазбора.СоставКодаМаркировки.EAN);
			ДанныеПоШтрихкодамEAN = ШтрихкодированиеОбщегоНазначенияИС.ДанныеПоШтрихкодамEAN(ШтрихкодыEAN);
			
			СтрокаШтрихкодыУпаковок.ЕдиничныйКод = РазборКодаМаркировкиИССлужебныйКлиентСервер.НормализоватьКодМаркировки(
													РезультатРазбора, ,ПараметрыРазбораКодаМаркировки);
													
			// Значения КодУровняМаркировки и КодВидаСтредстваИдентификации взяты из макета СпискиАналогЛК
			// отчета РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС
			
			Если ДанныеПоШтрихкодамEAN.Количество() > 0 Тогда
				
				ВидУпаковки = ДанныеПоШтрихкодамEAN[0].ВидУпаковкиИС;
				
				Если ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
					
					СтрокаШтрихкодыУпаковок.КодУровняМаркировки = "0 - Товарная упаковка (КМ, КИ, sGTIN)";
					
				ИначеЕсли ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая
					ИЛИ ВидУпаковки = Перечисления.ВидыУпаковокИС.Набор Тогда
					
					СтрокаШтрихкодыУпаковок.КодУровняМаркировки = "1 - Групповая упаковка (КИГУ)";
					
				ИначеЕсли ВидУпаковки = Перечисления.ВидыУпаковокИС.Логистическая Тогда
					
					СтрокаШтрихкодыУпаковок.КодУровняМаркировки = "2 - Транспортная упаковка (КИТУ, 35СС)";
	...
	УчетНДСКлиентСервер.ЗаполнитьСписокВыбораВидовТранспорта(СписокВидовТранспорта);
	
	Если Шапка <> Неопределено
		И Шапка.Количество() > 0 Тогда
		...
		Для каждого СтрокаШапки Из Шапка Цикл
			...
			НоваяСтрокаВыгрузки.НомерДокумента = СтрокаШапки.НомерДоговора;
			НоваяСтрокаВыгрузки.ДатаДокумента = СтрокаШапки.ДатаДоговора;
			
			Если НаправлениеПеремещения = "ЭК" Тогда
				НоваяСтрокаВыгрузки = ТаблицаДокументы.Добавить();
				НоваяСтрокаВыгрузки.НаименованиеДокумента = "Товарная накладная";
				НоваяСтрокаВыгрузки.НомерДокумента = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(СтрокаШапки.СистемныйНомер, Истина, Ложь);
				НоваяСтрокаВыгрузки.ДатаДокумента = СтрокаШапки.Дата;
			КонецЕсли;
		...
		РеквизитыШапкаСтатформа(
			РеквизитыШапка,
			РеквизитыШапка.СистемныйНомер,
			РеквизитыШапка.Дата,
			РеквизитыШапка.ДокументСсылка);
			
	КонецЕсли;
	
	// Для графы 3 сведения о лице, ответственное за финансовое урегулирование:
	// 1. в случае экспорта заполняются из организации,
	// 2. в случае импорта тоже из организации
	// Ограничение из БРО:
	// Считается заявитель и лицо ответственное за финансовое урегулирование - это одно и тоже лицо.
	// При экспорте получателем является всегда иностранное государство, а отправителем является РФ.
	// При импорте получателем является всегда РФ, а отправителем является иностранное государство.
	
	ТаблицаОКАТО = ЗаполнитьТаблицуОКАТО();
	Если ЗначениеЗаполнено(РеквизитыШапка.Организация) Тогда
		ОКАТООрганизации = Справочники.РегистрацииВНалоговомОргане.КодТерритории(РеквизитыШапка.РегистрацияВНалоговомОргане, "ОКАТО");
		Если ОКАТООрганизации = "" Тогда
			ОКТМООрганизации = Справочники.РегистрацииВНалоговомОргане.КодТерритории(РеквизитыШапка.РегистрацияВНалоговомОргане, "ОКТМО");
			Если ОКТМООрганизации = "" Тогда
				РегионОКАТО = "";
			Иначе
				Регион = СтрШаблон("%1%2", Лев(ОКТМООрганизации, 4), "0");
				
				ОтбСтроки = ТаблицаОКАТО.НайтиСтроки(Новый Структура("Код", Регион));
				РегионОКАТО = ?(ЗначениеЗаполнено(ОтбСтроки), ОтбСтроки[0].Код, "");
				Если РегионОКАТО = "" Тогда
					Регион = СтрШаблон("%1%2", Лев(ОКТМООрганизации, 2), "000");
		...
		Иначе
			Регион = СтрШаблон("%1%2", Лев(ОКАТООрганизации, 4), "0");
			
			ОтбСтроки = ТаблицаОКАТО.НайтиСтроки(Новый Структура("Код", Регион));
			РегионОКАТО = ?(ЗначениеЗаполнено(ОтбСтроки), ОтбСтроки[0].Код, "");
			Если РегионОКАТО = "" Тогда
				Регион = СтрШаблон("%1%2", Лев(ОКАТООрганизации, 2), "000");
	...
	Если ЗначениеЗаполнено(РеквизитыШапка.Организация) И ЗначениеЗаполнено(РеквизитыШапка.Контрагент) Тогда
		...
		Если НаправлениеПеремещения = "ЭК" Тогда
			...
			СведенияОПродавце = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(
				РеквизитыШапка.Организация, РеквизитыШапка.Дата);
			СведенияОПродавце.Телефоны = СтрЗаменить(СведенияОПродавце.Телефоны, "+7", "8");
			
			ПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров(РеквизитыШапка.Отправитель_ФормаСобственности,
				РеквизитыШапка.СтатусФизическогоЛица);
			
			СведенияОПокупателе = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(
				РеквизитыШапка.Контрагент, РеквизитыШапка.Дата);
			СведенияОПокупателе.Телефоны = СтрЗаменить(СведенияОПокупателе.Телефоны, "+7", "8");
			
			ОтправительАдрес = УчетНДСВызовСервера.ПолучитьАдресВВидеСоответствия(
				РеквизитыШапка.Организация,
				Справочники.ВидыКонтактнойИнформации.ЮрАдресОрганизации,
				РеквизитыШапка.Дата);
			
			ПолучательАдрес = УчетНДСВызовСервера.ПолучитьАдресВВидеСоответствия(
				РеквизитыШапка.Контрагент,
				Справочники.ВидыКонтактнойИнформации.ЮрАдресКонтрагента,
				РеквизитыШапка.Дата);
			
			РеквизитыШапка.ПолучательКоды = РеквизитыШапка.НалоговыйНомер;
			
			// Реквизиты подписи - сокращенное наименование заявителя статформы
			РеквизитыШапка.Вставить("ПолнСокрНаим", СведенияОПродавце.СокращенноеНаименование);
			
			Если ЗначениеЗаполнено(РеквизитыШапка.ОтправительРФ_КПП) Тогда
				ИННКППОГРН = РеквизитыШапка.ОтправительРФ_ИНН+ "/" + РеквизитыШапка.ОтправительРФ_КПП + "/"
							+ РеквизитыШапка.ОтправительРФ_ОГРН;
			Иначе
				ИННКППОГРН = РеквизитыШапка.ОтправительРФ_ИНН+ "/" + РеквизитыШапка.ОтправительРФ_ОГРН;
			КонецЕсли;
			
			ЗаявительЮридическоеФизическоеЛицо = РеквизитыШапка.ОтправительЮридическоеФизическоеЛицо;
			
			РеквизитыШапка.Вставить("ОтправительОКАТО", РегионОКАТО);
		...
		Иначе
			...
			ПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров(РеквизитыШапка.Получатель_ФормаСобственности, 
				РеквизитыШапка.СтатусФизическогоЛица);
			...
			Если ЗначениеЗаполнено(РеквизитыШапка.ПокупательКПП) Тогда
				РеквизитыШапка.ПолучательКоды = РеквизитыШапка.ПокупательИНН + "/" + РеквизитыШапка.ПокупательКПП;
			Иначе
				РеквизитыШапка.ПолучательКоды = РеквизитыШапка.ПокупательИНН;
			КонецЕсли;
			...
			Если ЗначениеЗаполнено(РеквизитыШапка.ПокупательКПП) Тогда
				ИННКППОГРН = РеквизитыШапка.ПокупательИНН + "/" + РеквизитыШапка.ПокупательКПП + "/"
							+ РеквизитыШапка.ОГРН;
			Иначе
				ИННКППОГРН = РеквизитыШапка.ПокупательИНН + "/" + РеквизитыШапка.ОГРН;
			КонецЕсли;
			
			ЗаявительЮридическоеФизическоеЛицо = РеквизитыШапка.ПолучательЮридическоеФизическоеЛицо;
			
			// Заполняем код вида транспорта на границе
			Если ТаблицаТоварыДляВыгрузки.Количество() > 0 Тогда
				РеквизитыШапка.ВидТранспортаКод = ТаблицаТоварыДляВыгрузки[0].КодВидаТранспорта;
			КонецЕсли;
		...
		Если РеквизитыШапка.Дата >= '20200701' Тогда
			ПочтовыйАдресОрганизации = СтрШаблон("%1, %2", РеквизитыШапка.СтранаОтправленияНаименование, СведенияОПродавце.ПочтовыйАдрес);
		Иначе
			ПочтовыйАдресОрганизации = СтрШаблон("643, %1", СведенияОПродавце.ПочтовыйАдрес);
		КонецЕсли;
		...
		РеквизитыШапка.ОтправительРеквизиты = ОбщегоНазначенияБПВызовСервера.ОписаниеОрганизации(СведенияОПродавце, "ПолноеНаименование,СтранаРегистрации,ЮридическийАдрес,");
		РеквизитыШапка.ПолучательРеквизиты = ОбщегоНазначенияБПВызовСервера.ОписаниеОрганизации(
			СведенияОПокупателе, "ПолноеНаименование,СтранаРегистрации,ЮридическийАдрес,");
		
		Если НаправлениеПеремещения = "ЭК" Тогда
			
			РеквизитыШапка.ОтвЛицоФинУрРеквизиты = РеквизитыШапка.ОтправительРеквизиты;
			
			Если ЗначениеЗаполнено(РеквизитыШапка.ОтправительРФ_КПП) Тогда
				РеквизитыШапка.ОтвЛицоФинУрКоды = РеквизитыШапка.ОтправительРФ_ИНН + "/" + РеквизитыШапка.ОтправительРФ_КПП;
			Иначе
				РеквизитыШапка.ОтвЛицоФинУрКоды = РеквизитыШапка.ОтправительРФ_ИНН;
			КонецЕсли;
		...
		Если НаправлениеПеремещения = "ИМ" Тогда
		...
		РеквизитыШапка.Вставить("ПолучательУлицаНомерДома", 
			ПолучательАдрес.Получить("Улица") + ", " 
		...
		Если НаправлениеПеремещения = "ЭК" Тогда
			...
			Если РеквизитыШапка.ПродажаФизлицуЧерезЭлектроннуюТорговуюПлощадку = Истина Тогда
				РеквизитыШапка.Вставить("ПолучательНаименование", "Физические лица");
				РеквизитыШапка.Вставить("ПолучательИндекс", "-");
				РеквизитыШапка.Вставить("ПолучательНаселенныйПункт", "-");
				РеквизитыШапка.Вставить("ПолучательОбласть", "-");
				РеквизитыШапка.Вставить("ПолучательУлицаНомерДома","-");
			КонецЕсли;
			
			Если РеквизитыШапка.СтранаНазначения = "РБ" Тогда
				РеквизитыШапка.Вставить("ПолучательРБ_УНП", РеквизитыШапка.НалоговыйНомер);
			ИначеЕсли РеквизитыШапка.СтранаНазначения = "РК" Тогда
				Если РеквизитыШапка.ПолучательЮридическоеФизическоеЛицо = Перечисления.ЮридическоеФизическоеЛицо.ЮридическоеЛицо Тогда
					РеквизитыШапка.Вставить("ПолучательРК_БИН", РеквизитыШапка.НалоговыйНомер);
				Иначе
					РеквизитыШапка.Вставить("ПолучательРК_ИИН", РеквизитыШапка.НалоговыйНомер);
				КонецЕсли;
			ИначеЕсли РеквизитыШапка.СтранаНазначения = "АМ" Тогда
				РеквизитыШапка.Вставить("ПолучательРА_УНН", РеквизитыШапка.НалоговыйНомер);
			ИначеЕсли РеквизитыШапка.СтранаНазначения = "КГ" Тогда
				Если РеквизитыШапка.ПолучательЮридическоеФизическоеЛицо = Перечисления.ЮридическоеФизическоеЛицо.ЮридическоеЛицо Тогда
					РеквизитыШапка.Вставить("ПолучательКГ_ИНН", РеквизитыШапка.НалоговыйНомер);
				Иначе
					РеквизитыШапка.Вставить("ПолучательКГ_ОКПО", РеквизитыШапка.НалоговыйНомер);
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
		
		Если НаправлениеПеремещения = "ЭК" Тогда
			РеквизитыШапка.Вставить("ПолучательРФ_ИНН", "");
			РеквизитыШапка.Вставить("ПолучательРФ_КПП", "");
			РеквизитыШапка.Вставить("ПолучательРФ_ОГРН", "");
			РеквизитыШапка.Вставить("ПолучательОКАТО", "");
		Иначе
			...
			РеквизитыШапка.Вставить("ПолучательОКАТО", РегионОКАТО);
		КонецЕсли;
		...
		РеквизитыШапка.Вставить("Получатель_ДатаДокСтр", "");
		РеквизитыШапка.Вставить("Получатель_ВидДокКод", "");
		РеквизитыШапка.Вставить("Получатель_ВидДокНаим", "");
		РеквизитыШапка.Вставить("Получатель_СерДок", "");
		РеквизитыШапка.Вставить("Получатель_НомДок", "");
		РеквизитыШапка.Вставить("Получатель_ДатаДок", "");
		РеквизитыШапка.Вставить("Получатель_ОргДок", );
		
		РеквизитыШапка.Вставить("Получатель_Тел", СведенияОПокупателе.Телефоны);
		РеквизитыШапка.Вставить("Получатель_Факс", СведенияОПокупателе.Телефоны);
		РеквизитыШапка.Вставить("Получатель_Телекс", "");
		РеквизитыШапка.Вставить("Получатель_Почта", СведенияОПокупателе.Email);
		...
		Если НаправлениеПеремещения = "ЭК" Тогда
			...
			РеквизитыШапка.Вставить("ОтвЛицоФинУрНаименование", РеквизитыШапка.ОтправительНаименование);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрРФ_ИНН", РеквизитыШапка.ОтправительРФ_ИНН);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрРФ_КПП", РеквизитыШапка.ОтправительРФ_КПП);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрРФ_ОГРН", РеквизитыШапка.ОтправительРФ_ОГРН);
			
			РеквизитыШапка.Вставить("ОтвЛицоФинУрИндекс", ОтправительАдрес.Получить("Индекс"));
			РеквизитыШапка.Вставить("ОтвЛицоФинУрСтранаКод", РеквизитыШапка.СтранаОтправленияКод);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрСтранаНаименование", РеквизитыШапка.СтранаОтправленияНаименование);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрОбласть", ОтправительАдрес.Получить("Регион"));
			РеквизитыШапка.Вставить("ОтвЛицоФинУрНаселенныйПункт", ОтправительАдрес.Получить("НаселенныйПункт"));
			РеквизитыШапка.Вставить("ОтвЛицоФинУрУлицаНомерДома", ОтправительАдрес.Получить("Улица")
			+ ", "
			+ ОтправительАдрес.Получить("Дом") + ", "
			+ ОтправительАдрес.Получить("Корпус") + ", " + ОтправительАдрес.Получить("Квартира"));
			РеквизитыШапка.Вставить("ОтвЛицоФинУрОКАТО", РегионОКАТО);
			
		Иначе
			
			РеквизитыШапка.Вставить("ОтвЛицоФинУрНаименование", ПолучательНаименование);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрРФ_ИНН", РеквизитыШапка.ПокупательИНН);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрРФ_КПП", РеквизитыШапка.ПокупательКПП);
			РеквизитыШапка.Вставить("ОтвЛицоФинУрРФ_ОГРН", РеквизитыШапка.ОГРН);
		...
		Если ЗаявительЮридическоеФизическоеЛицо = Перечисления.ЮридическоеФизическоеЛицо.ФизическоеЛицо Тогда
			
			// Заявитель статформы физ лицо
			...
			Если ЗначениеЗаполнено(РеквизитыШапка.ИндивидуальныйПредприниматель) Тогда
				...
				Если ЗначениеЗаполнено(ДанныеДокумента) Тогда
					...
					ВидДокументаВСтатформе = ВидДокументаФизическогоЛицаВСтатформе(ДанныеДокумента.ВидДокумента, "RU");
					
					РеквизитыШапка.ОтвЛицоФинУрПасВидДок        = ВидДокументаВСтатформе.Код;
					...
					РеквизитыШапка.ОтвЛицоФинУрПасНаименование  = ВидДокументаВСтатформе.Наименование;
				...
				ФИО = Строка(РеквизитыШапка.ИндивидуальныйПредприниматель);
				РеквизитыШапка.ОтвЛицоФинУрНаименование = ФИО;
				
				Если НаправлениеПеремещения = "ЭК" Тогда
					РеквизитыШапка.ОтправительНаименование = ФИО;
				Иначе
					РеквизитыШапка.ПолучательНаименование = ФИО;
				КонецЕсли;
			...
			РеквизитыШапка.ОтвЛицоФинУрРеквизиты = СтрШаблон("%1, %2", РеквизитыШапка.ОтправительРеквизиты, ДанныеДокументаПредставление);
		
		ИначеЕсли РеквизитыШапка.ОбособленноеПодразделение Тогда
			
			// Заявитель статформы обособленное подразделение
			
			РеквизитыШапка.ОтвЛицоФинУрПодРФ_ИНН = РеквизитыШапка.ОтвЛицоФинУрРФ_ИНН;
			РеквизитыШапка.ОтвЛицоФинУрПодРФ_КПП = РеквизитыШапка.ОтвЛицоФинУрРФ_КПП;
			РеквизитыШапка.ОтвЛицоФинУрПодРФ_ОГРН = РеквизитыШапка.ОтвЛицоФинУрРФ_ОГРН;
			
			РеквизитыШапка.ОтвЛицоФинУрПодСтранаКод = РеквизитыШапка.ОтвЛицоФинУрСтранаКод;
			РеквизитыШапка.ОтвЛицоФинУрПодСтранаНаименование = РеквизитыШапка.ОтвЛицоФинУрСтранаНаименование;
			РеквизитыШапка.ОтвЛицоФинУрПодНаименование = РеквизитыШапка.ОтвЛицоФинУрНаименование;
			РеквизитыШапка.ОтвЛицоФинУрПодИндекс = РеквизитыШапка.ОтвЛицоФинУрИндекс;
			РеквизитыШапка.ОтвЛицоФинУрПодОбласть = РеквизитыШапка.ОтвЛицоФинУрОбласть;
			РеквизитыШапка.ОтвЛицоФинУрПодНаселенныйПункт = РеквизитыШапка.ОтвЛицоФинУрНаселенныйПункт;
			РеквизитыШапка.ОтвЛицоФинУрПодУлицаНомерДома = РеквизитыШапка.ОтвЛицоФинУрУлицаНомерДома;
			
		Иначе
			
			// Заявитель статформы юридическое лицо
			
			РеквизитыШапка.ОтвЛицоФинУр = РеквизитыШапка.ОтвЛицоФинУрНаименование;
			
		КонецЕсли;
		
		РеквизитыШапка.Вставить("ОргСтранаКод",          РеквизитыШапка.ОтвЛицоФинУрСтранаКод);
		РеквизитыШапка.Вставить("ОргСтранаНаименование", РеквизитыШапка.ОтвЛицоФинУрСтранаНаименование);
		РеквизитыШапка.Вставить("ОргИндекс",             РеквизитыШапка.ОтвЛицоФинУрИндекс);
		РеквизитыШапка.Вставить("ОргОбласть",            РеквизитыШапка.ОтвЛицоФинУрОбласть);
		РеквизитыШапка.Вставить("ОргНаселенныйПункт",    РеквизитыШапка.ОтвЛицоФинУрНаселенныйПункт);
		РеквизитыШапка.Вставить("ОргУлицаНомерДома",     РеквизитыШапка.ОтвЛицоФинУрУлицаНомерДома);
		
	КонецЕсли;
	
	ВидТранспорта = СписокВидовТранспорта.НайтиПоЗначению(РеквизитыШапка.ВидТранспортаКод);
	...
	РеквизитыШапка.Вставить("ОбщаяЦенаТоваров", ТаблицаТоварыДляВыгрузки.Итог("ЦенаТовараВыбВал"));
	
	// Реквизиты подписи - ИНН/КПП/ОГРН заявителя статформы.
	// В форме БРО собирается по отдельным значениям ИНН, КПП, ОГРН
	РеквизитыШапка.Вставить("ИннКппОгрн", ИННКППОГРН);
	
	Для каждого СтрокаТовары Из ТаблицаТоварыДляВыгрузки Цикл
		...
		// НомерДекларацииНаТовары - Номер декларации на товары (без порядкового номера товара) для печатной формы
		ЗаполнитьРеквизитыТаможеннойДекларации(СтрокаТовары, СтрокаТовары);
		
		СтрокаТовары.ЕдИзмТовараКратко = ВРег(СтрокаТовары.ЕдИзмТовараКратко);
		
		Если НаправлениеПеремещения = "ИМ" Тогда
			// Экспорт
			// Товаросопроводительные документы не хранятся в реализации в структурированном виде
			
			// Импорт
			// Товаросопроводительные документы отображаются в статформе как "Счет-проформа (проформа-инвойс)"
			Если ЗначениеЗаполнено(СтрокаТовары.СерияНомерТСД) Тогда
				
				НоваяСтрокаВыгрузки = ТаблицаДокументы.Добавить();
				НоваяСтрокаВыгрузки.НаименованиеДокумента = "Счет-проформа (проформа-инвойс)";
				НоваяСтрокаВыгрузки.НомерДокумента = СтрокаТовары.СерияНомерТСД;
				НоваяСтрокаВыгрузки.ДатаДокумента = СтрокаТовары.ДатаТСД;
				
			КонецЕсли;
				
			// Вычисляются реквизиты счетов фактур
			Если ЗначениеЗаполнено(СтрокаТовары.НомерСчетаФактуры) Тогда
				
				НоваяСтрокаВыгрузки = ТаблицаДокументы.Добавить();
				НоваяСтрокаВыгрузки.НаименованиеДокумента = "Счет-фактура (инвойс)";
				НоваяСтрокаВыгрузки.НомерДокумента = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(СтрокаТовары.НомерСчетаФактуры, Истина, Ложь);
		...
		Если НаправлениеПеремещения = "ЭК" Тогда
			...
			Если СтрокаТовары.ПроизводительСтранаРегистрацииКод = "RU" И Не ЗначениеЗаполнено(СтрокаТовары.ПроизводительОКАТО) Тогда
				Если ЗначениеЗаполнено(СтрокаТовары.ПроизводительКПП) Тогда
					КодРегиона = Лев(СтрокаТовары.ПроизводительКПП, 2);
				ИначеЕсли ЗначениеЗаполнено(СтрокаТовары.ПроизводительИНН) Тогда
					КодРегиона = Лев(СтрокаТовары.ПроизводительИНН, 2);
				Иначе
					КодРегиона = "";
				КонецЕсли;
				Если КодРегиона = "" Тогда
					ПроизводительОКАТО = "";
				Иначе
					ОтбСтроки = ТаблицаОКАТО.НайтиСтроки(Новый Структура("КодРегиона", КодРегиона));
					ПроизводительОКАТО = ?(ЗначениеЗаполнено(ОтбСтроки), ОтбСтроки[0].Код, "");
				КонецЕсли;
				СтрокаТовары.ПроизводительОКАТО = ПроизводительОКАТО;
			КонецЕсли;
		КонецЕсли;
		
	КонецЦикла;
	
	Если РеквизитыШапка.ВалютаТовараКод <> "RUB" Тогда
		
		ДанныеВалютногоКонтроля = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(РеквизитыШапка.Договор,
			"УникальныйНомерВалютногоКонтроля,ДатаПостановкиНаВалютныйКонтроль");
		
		Если ЗначениеЗаполнено(ДанныеВалютногоКонтроля.УникальныйНомерВалютногоКонтроля) Тогда
			
			НоваяСтрокаВыгрузки = ТаблицаДокументы.Добавить();
			НоваяСтрокаВыгрузки.НаименованиеДокумента = "Уникальный номер договора (паспорт сделки)";
			НоваяСтрокаВыгрузки.НомерДокумента = ДанныеВалютногоКонтроля.УникальныйНомерВалютногоКонтроля;
			НоваяСтрокаВыгрузки.ДатаДокумента = ДанныеВалютногоКонтроля.ДатаПостановкиНаВалютныйКонтроль;
	...
	Если ТаблицаТоварыДляВыгрузки <> Неопределено
		И НаправлениеПеремещения = "ИМ" Тогда
	...
	Результат.РеквизитыШапка = РеквизитыШапка;
	Результат.ТаблицаДокументы = ТаблицаДокументы;
	Результат.ТаблицаТоварыДляВыгрузки = ТаблицаТоварыДляВыгрузки;
	Результат.ТаблицаДопСведения = ТаблицаДопСведения;
	Результат.ШтрихкодыУпаковок = ШтрихкодыУпаковок;
	Результат.КурсыВалютыНаДатыДокументовОтгрузки = КурсыВалютыНаДатыДокументовОтгрузки;
	
	Возврат Результат;
	
КонецФункции

// Устанавливает список выбора типов документов, используемых в отчете "Статистическая форма учета перемещения товаров"
// Параметры
// СписокЗначений - СписокЗначений - список значений для выбора типов документов, используемых для
//                                   заполнения отчета "Статистическая форма учета перемещения товаров"
Процедура СписокДокументовСтатистическойФормыУчетаПеремещенияТоваров(СписокЗначений) Экспорт
	
	МакетПоказателей = Отчеты.РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС.ПолучитьМакет("СпискиАналогЛК");
	СписокДокументов = МакетПоказателей.ПолучитьОбласть("СписокДокументов");
	
	СписокЗначений.Очистить();
	
	Для Ном = 2 По СписокДокументов.ВысотаТаблицы Цикл
		
		СписокЗначений.Добавить(СписокДокументов.Область(Ном,2).Текст, СписокДокументов.Область(Ном,2).Текст);
...
Функция КурсыВалютыНаДатыДокументовОтгрузки(Знач МассивДокументов, Валюта, ИмяДокумента)
	...
	Запрос.Текст = 
		...
		|	ДатыОтгрузок.Дата КАК Дата,
		|	МАКСИМУМ(КурсыВалют.Период) КАК Период,
		|	ДатыОтгрузок.ДокументОтгрузки КАК ДокументОтгрузки
		|ПОМЕСТИТЬ ДатаКурса
		|ИЗ
		|	РегистрСведений.КурсыВалют КАК КурсыВалют
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ДатыОтгрузок КАК ДатыОтгрузок
		|		ПО КурсыВалют.Валюта = ДатыОтгрузок.Валюта
		|			И КурсыВалют.Период <= ДатыОтгрузок.Дата
		|
		|СГРУППИРОВАТЬ ПО
		|	КурсыВалют.Валюта,
		|	ДатыОтгрузок.Дата,
		|	ДатыОтгрузок.ДокументОтгрузки
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|	ДатаКурса.ДокументОтгрузки КАК ДокументОтгрузки
		|ИЗ
		|	РегистрСведений.КурсыВалют КАК КурсыВалют
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ДатаКурса КАК ДатаКурса
		|		ПО КурсыВалют.Валюта = ДатаКурса.Валюта
		|			И КурсыВалют.Период = ДатаКурса.Период";
...
Процедура СведенияОСчетеФактуреВыданномЭкспорт(Знач МассивДокументов, ТаблицаДокументы)
	...
	|ГДЕ
	|	СчетФактураВыданный.ДокументОснование В(&МассивДокументов)
	...
	Пока Выборка.Следующий() Цикл
		...
		Строка = ТаблицаДокументы.Добавить();
		Строка.НаименованиеДокумента = "Счет-фактура (инвойс)";
		Строка.НомерДокумента = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(Выборка.Номер, Истина, Ложь);
		Строка.ДатаДокумента = Выборка.Дата;
		
	КонецЦикла;

КонецПроцедуры

Функция ТекстЗапросаШапкаСтатформаЭкспорт()
	Возврат
	"ВЫБРАТЬ
	|	РеализацияТоваровУслуг.Ссылка КАК ДокументСсылка,
	|	РеализацияТоваровУслуг.Номер КАК СистемныйНомер,
	|	РеализацияТоваровУслуг.Дата КАК Дата,
	|	РеализацияТоваровУслуг.Организация.ИНН КАК ОтправительКоды,
	|	НЕОПРЕДЕЛЕНО КАК ОтправительРеквизиты,
	|	РеализацияТоваровУслуг.Организация.НаименованиеПолное КАК ОтправительНаименование,
	...
	|	РеализацияТоваровУслуг.Контрагент.ИНН КАК ПокупательИНН,
	|	РеализацияТоваровУслуг.Контрагент.КПП КАК ПокупательКПП,
	...
	|	ВЫБОР
	|		КОГДА РеализацияТоваровУслуг.ВалютаДокумента = &ВалютаРеглУчета
	|			ТОГДА ""RUB""
	|		ИНАЧЕ РеализацияТоваровУслуг.ВалютаДокумента.Наименование
	|	КОНЕЦ КАК ВалютаТовараКод,
	|	РеализацияТоваровУслуг.Организация КАК Организация,
	|	РеализацияТоваровУслуг.Организация.ОбособленноеПодразделение КАК ОбособленноеПодразделение,
	|	РеализацияТоваровУслуг.Контрагент.ЮридическоеФизическоеЛицо КАК ПолучательЮридическоеФизическоеЛицо,
	|	РеализацияТоваровУслуг.Контрагент.НалоговыйНомер КАК НалоговыйНомер,
	|	РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.КодАльфа2 КАК ТоргующаяСтранаКод,
	|	РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.Наименование КАК ТоргующаяСтранаНаименование,
	|	""RU"" КАК СтранаОтправленияКод,
	|	""РОССИЯ"" КАК СтранаОтправленияНаименование,
	|	РеализацияТоваровУслуг.ВидТранспортаНаГранице КАК ВидТранспортаКод,
	|	НЕОПРЕДЕЛЕНО КАК ВидТранспортаНаименование,
	|	НЕОПРЕДЕЛЕНО КАК ОтвЛицоФинУрКоды,
	|	НЕОПРЕДЕЛЕНО КАК ОтвЛицоФинУрРеквизиты,
	|	""ЭК"" КАК НаправлениеПеремещения,
	|	""ЭК"" КАК НапрПеремещения,
	|	ВЫБОР
	...
	|			ТОГДА РеализацияТоваровУслуг.СтранаРеализации.Наименование
	|		ИНАЧЕ РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.Наименование
	|	КОНЕЦ КАК СтранаНазначенияНаименование,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(РеализацияТоваровУслуг.СтранаРеализации, ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)) <> ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)
	|			ТОГДА РеализацияТоваровУслуг.СтранаРеализации.КодАльфа2
	|		ИНАЧЕ РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.КодАльфа2
	|	КОНЕЦ КАК СтранаНазначенияКод,
	...
	|	""РФ"" КАК СтранаОтправления,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(РеализацияТоваровУслуг.СтранаРеализации, ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)) <> ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)
	|			ТОГДА ВЫБОР
	|					КОГДА РеализацияТоваровУслуг.СтранаРеализации.КодАльфа2 = ""KZ""
	|						ТОГДА ""РК""
	|					КОГДА РеализацияТоваровУслуг.СтранаРеализации.КодАльфа2 = ""BY""
	|						ТОГДА ""РБ""
	|					КОГДА РеализацияТоваровУслуг.СтранаРеализации.КодАльфа2 = ""AM""
	|						ТОГДА ""АМ""
	|					КОГДА РеализацияТоваровУслуг.СтранаРеализации.КодАльфа2 = ""KG""
	|						ТОГДА ""КГ""
	|					ИНАЧЕ """"
	|				КОНЕЦ
	|		ИНАЧЕ ВЫБОР
	|				КОГДА РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.КодАльфа2 = ""KZ""
	|					ТОГДА ""РК""
	|				КОГДА РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.КодАльфа2 = ""BY""
	|					ТОГДА ""РБ""
	|				КОГДА РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.КодАльфа2 = ""AM""
	|					ТОГДА ""АМ""
	|				КОГДА РеализацияТоваровУслуг.Контрагент.СтранаРегистрации.КодАльфа2 = ""KG""
	|					ТОГДА ""КГ""
	|				ИНАЧЕ """"
	|			КОНЕЦ
	|	КОНЕЦ КАК СтранаНазначения,
	|	РеализацияТоваровУслуг.Организация.ЮридическоеФизическоеЛицо КАК ОтправительЮридическоеФизическоеЛицо,
	|	РеализацияТоваровУслуг.Организация.ИндивидуальныйПредприниматель КАК ИндивидуальныйПредприниматель,
	|	РеализацияТоваровУслуг.Организация.СтатусФизическогоЛица КАК СтатусФизическогоЛица,
	|	РеализацияТоваровУслуг.Организация.ИмяИП КАК ИмяИП,
	|	РеализацияТоваровУслуг.Организация.ОтчествоИП КАК ОтчествоИП,
	|	РеализацияТоваровУслуг.Организация.ФамилияИП КАК ФамилияИП,
	|	РеализацияТоваровУслуг.Организация.НаименованиеОКОПФ КАК Отправитель_ФормаСобственности,
	|	РеализацияТоваровУслуг.Организация.ИНН КАК ОтправительРФ_ИНН,
	|	РеализацияТоваровУслуг.Организация.КПП КАК ОтправительРФ_КПП,
	|	РеализацияТоваровУслуг.Организация.ОГРН КАК ОтправительРФ_ОГРН,
	|	"""" КАК Получатель_ФормаСобственности,
	|	РеализацияТоваровУслуг.ЭлектроннаяТорговаяПлощадка КАК ПродажаФизлицуЧерезЭлектроннуюТорговуюПлощадку,
	|	РеализацияТоваровУслуг.Организация.РегистрацияВНалоговомОргане КАК РегистрацияВНалоговомОргане
	|ИЗ
	|	Документ.РеализацияТоваровУслуг КАК РеализацияТоваровУслуг
	|ГДЕ
	|	РеализацияТоваровУслуг.Ссылка В(&МассивДокументов)";
...
Функция ТекстЗапросаШапкаСтатформаИмпорт()
	Возврат
	"ВЫБРАТЬ
	...
	|	НЕОПРЕДЕЛЕНО КАК ОтправительРеквизиты,
	|	ЗаявлениеОВвозеТоваров.Контрагент.НаименованиеПолное КАК ОтправительНаименование,
	...
	|	ЗаявлениеОВвозеТоваров.ДоговорКонтрагента КАК Договор,
	...
	|	ЗаявлениеОВвозеТоваров.Организация.СтатусФизическогоЛица КАК СтатусФизическогоЛица,
	|	ЗаявлениеОВвозеТоваров.Организация.ИмяИП КАК ИмяИП,
	|	ЗаявлениеОВвозеТоваров.Организация.ОтчествоИП КАК ОтчествоИП,
	|	ЗаявлениеОВвозеТоваров.Организация.ФамилияИП КАК ФамилияИП,
	|	ЗаявлениеОВвозеТоваров.Организация.ОГРН КАК ОГРН,
	|	"""" КАК Отправитель_ФормаСобственности,
	|	"""" КАК ОтправительРФ_ИНН,
	|	"""" КАК ОтправительРФ_КПП,
	|	"""" КАК ОтправительРФ_ОГРН,
	|	ЗаявлениеОВвозеТоваров.Организация.НаименованиеОКОПФ КАК Получатель_ФормаСобственности,
	|	ЗаявлениеОВвозеТоваров.Организация.РегистрацияВНалоговомОргане КАК РегистрацияВНалоговомОргане
	|ИЗ
...
Функция ТекстЗапросаТоварыСтатформаЭкспорт(ИмяДокумента)
	ТекстЗапроса =
	"ВЫБРАТЬ
	...
	|	Товары.Сумма КАК ЦенаТовараВыбВал,
	|	ВЫБОР
	|		КОГДА Товары.Ссылка.ВалютаДокумента = &ВалютаРеглУчета
	|			ТОГДА Товары.Сумма
	|		ИНАЧЕ -1
	|	КОНЕЦ КАК ЦенаТовараВалРубль,
	|	ВЫБОР
	|		КОГДА Товары.Ссылка.ВалютаДокумента = &ВалютаРеглУчета
	|			ТОГДА ""RUB""
	...
	|	КОНЕЦ КАК ВалютаТовараКод,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(Товары.СтранаПроисхождения, ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)) = ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)
	|			ТОГДА ""РОССИЯ""
	|		ИНАЧЕ ЕСТЬNULL(Товары.СтранаПроисхождения.Наименование, """")
	|	КОНЕЦ КАК СтранаТовараНаименование,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(Товары.СтранаПроисхождения, ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)) = ЗНАЧЕНИЕ(Справочник.СтраныМира.ПустаяСсылка)
	|			ТОГДА ""RU""
	|		ИНАЧЕ ЕСТЬNULL(Товары.СтранаПроисхождения.КодАльфа2, """")
	|	КОНЕЦ КАК СтранаТовараКод,
	|	Товары.Количество * ЕСТЬNULL(Товары.Номенклатура.ВесПоСертификатуТовара, 0) КАК ВесТовара,
	|	Товары.Ссылка КАК ДокументСсылка,
	|	ВЫБОР
	|		КОГДА КлассификаторТНВЭД.ЕдиницаИзмерения.Код = ""166""
	|			ТОГДА 0
	|		ИНАЧЕ ВЫБОР
	|				КОГДА Товары.ЕдиницаИзмерения = КлассификаторТНВЭД.ЕдиницаИзмерения
	...
	|	ВЫБОР
	|		КОГДА НЕ Товары.ПрослеживаемыйТовар
	|			ТОГДА ЕСТЬNULL(Товары.НомерГТД.Код, """")
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК НомерТаможеннойДекларации,
	|	ЕСТЬNULL(СправочникНоменклатура.Производитель, ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)) КАК Производитель,
	...
	|	ЕСТЬNULL(СправочникНоменклатура.Производитель.РегистрационныйНомер, """") КАК ПроизводительОГРН,
	|	ЕСТЬNULL(СправочникНоменклатура.Производитель.СтранаРегистрации.КодАльфа2, """") КАК ПроизводительСтранаРегистрацииКод,
	|	ЕСТЬNULL(СправочникНоменклатура.Производитель.НалоговыйНомер, """") КАК ПроизводительИностранныйНалоговыйНомер,
	|	СправочникНоменклатура.Производитель.КодОКАТОДляТаможни КАК ПроизводительОКАТО,
	|	Товары.Номенклатура КАК Номенклатура,
	|	ВЫБОР
	|		КОГДА Товары.ПрослеживаемыйТовар
	|				И Товары.ЕдиницаИзмерения = КлассификаторТНВЭД.ЕдиницаИзмерения
	|			ТОГДА Товары.Количество
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК КолвоПрослеживаемогоТовараВЕдИзмеренияТНВЭД,
	|	ВЫБОР
	|		КОГДА Товары.ПрослеживаемыйТовар
	|			ТОГДА КлассификаторТНВЭД.ЕдиницаИзмерения.Наименование
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК ЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	ВЫБОР
	|		КОГДА Товары.ПрослеживаемыйТовар
	|			ТОГДА КлассификаторТНВЭД.ЕдиницаИзмерения.Код
	|		ИНАЧЕ """"
	...
	|	Отгрузки.НаименованиеТовара КАК НаименованиеТовара,
	|	Отгрузки.КодТовара КАК КодТовара,
	|	Отгрузки.ЦенаТовараВыбВал КАК ЦенаТовараВыбВал,
	|	Отгрузки.ВалютаТовараКод КАК ВалютаТовараКод,
	|	Отгрузки.СтранаТовараНаименование КАК СтранаТовараНаименование,
	|	Отгрузки.СтранаТовараКод КАК СтранаТовараКод,
	|	Отгрузки.ВесТовара КАК ВесТовара,
	|	Отгрузки.ДокументСсылка КАК ДокументСсылка,
	|	Отгрузки.ЕдИзмТовараКво КАК ЕдИзмТовараКво,
	|	Отгрузки.ЕдИзмТовараКратко КАК ЕдИзмТовараКратко,
	|	Отгрузки.ЕдИзмТовараКод КАК ЕдИзмТовараКод,
	|	Отгрузки.НомерТаможеннойДекларации КАК НомерТаможеннойДекларации,
	|	Отгрузки.Производитель КАК Производитель,
	|	Отгрузки.ПроизводительИНН КАК ПроизводительИНН,
	|	Отгрузки.ПроизводительКПП КАК ПроизводительКПП,
	|	Отгрузки.ПроизводительОГРН КАК ПроизводительОГРН,
	|	Отгрузки.ПроизводительСтранаРегистрацииКод КАК ПроизводительСтранаРегистрацииКод,
	|	Отгрузки.ПроизводительИностранныйНалоговыйНомер КАК ПроизводительИностранныйНалоговыйНомер,
	|	Отгрузки.ПроизводительОКАТО КАК ПроизводительОКАТО,
	|	Отгрузки.Номенклатура КАК Номенклатура,
	|	Отгрузки.КолвоПрослеживаемогоТовараВЕдИзмеренияТНВЭД КАК КолвоПрослеживаемогоТовараВЕдИзмеренияТНВЭД,
	|	Отгрузки.ЕдИзмеренияТНВЭДПрослеживаемогоТовара КАК ЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	Отгрузки.КодЕдИзмеренияТНВЭДПрослеживаемогоТовара КАК КодЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	Отгрузки.ПрослеживаемыйТовар КАК ПрослеживаемыйТовар,
	|	РублевыеСуммыДокументовВВалюте.НалоговаяБазаНДС КАК ЦенаТовараВалРубль
	|ПОМЕСТИТЬ ДляРасчетаСтоимостиТовараВДолларахСША
	|ИЗ
	|	Отгрузки КАК Отгрузки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РублевыеСуммыДокументовВВалюте КАК РублевыеСуммыДокументовВВалюте
	|		ПО Отгрузки.ДокументСсылка = РублевыеСуммыДокументовВВалюте.Регистратор
	|			И Отгрузки.НомерСтроки = РублевыеСуммыДокументовВВалюте.НомерСтроки
	|ГДЕ
	...
	|
	|ВЫБРАТЬ
	|	Отгрузки.НомерСтроки,
	|	Отгрузки.НаименованиеТовара,
	|	Отгрузки.КодТовара,
	|	Отгрузки.ЦенаТовараВыбВал,
	|	Отгрузки.ВалютаТовараКод,
	|	Отгрузки.СтранаТовараНаименование,
	|	Отгрузки.СтранаТовараКод,
	|	Отгрузки.ВесТовара,
	|	Отгрузки.ДокументСсылка,
	|	Отгрузки.ЕдИзмТовараКво,
	|	Отгрузки.ЕдИзмТовараКратко,
	|	Отгрузки.ЕдИзмТовараКод,
	|	Отгрузки.НомерТаможеннойДекларации,
	|	Отгрузки.Производитель,
	|	Отгрузки.ПроизводительИНН,
	|	Отгрузки.ПроизводительКПП,
	|	Отгрузки.ПроизводительОГРН,
	|	Отгрузки.ПроизводительСтранаРегистрацииКод,
	|	Отгрузки.ПроизводительИностранныйНалоговыйНомер,
	|	Отгрузки.ПроизводительОКАТО,
	|	Отгрузки.Номенклатура,
	|	Отгрузки.КолвоПрослеживаемогоТовараВЕдИзмеренияТНВЭД,
	|	Отгрузки.ЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	Отгрузки.КодЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	Отгрузки.ПрослеживаемыйТовар,
	|	Отгрузки.ЦенаТовараВалРубль
	|ИЗ
	|	Отгрузки КАК Отгрузки
	|ГДЕ
	|	Отгрузки.ЦенаТовараВалРубль <> -1
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ДокументСсылка
	|;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	КурсыВалютыНаДатыДокументовОтгрузки.ДокументОтгрузки КАК ДокументОтгрузки,
	|	КурсыВалютыНаДатыДокументовОтгрузки.Курс КАК Курс,
	|	КурсыВалютыНаДатыДокументовОтгрузки.Кратность КАК Кратность
	|ПОМЕСТИТЬ КурсыВалюты
	|ИЗ
	|	&КурсыВалютыНаДатыДокументовОтгрузки КАК КурсыВалютыНаДатыДокументовОтгрузки
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ДокументОтгрузки
	|;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ДляРасчетаСтоимостиТовараВДолларахСША.НомерСтроки КАК НомерСтроки,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.НаименованиеТовара КАК НаименованиеТовара,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.КодТовара КАК КодТовара,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ЦенаТовараВыбВал КАК ЦенаТовараВыбВал,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ВалютаТовараКод КАК ВалютаТовараКод,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.СтранаТовараНаименование КАК СтранаТовараНаименование,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.СтранаТовараКод КАК СтранаТовараКод,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ВесТовара КАК ВесТовара,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ДокументСсылка КАК ДокументСсылка,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ЕдИзмТовараКво КАК ЕдИзмТовараКво,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ЕдИзмТовараКратко КАК ЕдИзмТовараКратко,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ЕдИзмТовараКод КАК ЕдИзмТовараКод,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.НомерТаможеннойДекларации КАК НомерТаможеннойДекларации,
	|	НЕОПРЕДЕЛЕНО КАК КодТО,
	|	НЕОПРЕДЕЛЕНО КАК ДатаРегистрацииСтр,
	|	НЕОПРЕДЕЛЕНО КАК НомерДок,
	|	НЕОПРЕДЕЛЕНО КАК ДекларацияНом,
	|	НЕОПРЕДЕЛЕНО КАК НомерДекларацииНаТовары,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.Производитель КАК Производитель,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПроизводительИНН КАК ПроизводительИНН,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПроизводительКПП КАК ПроизводительКПП,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПроизводительОГРН КАК ПроизводительОГРН,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПроизводительСтранаРегистрацииКод КАК ПроизводительСтранаРегистрацииКод,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПроизводительИностранныйНалоговыйНомер КАК ПроизводительИностранныйНалоговыйНомер,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПроизводительОКАТО КАК ПроизводительОКАТО,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.Номенклатура КАК Номенклатура,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.КолвоПрослеживаемогоТовараВЕдИзмеренияТНВЭД КАК КолвоПрослеживаемогоТовараВЕдИзмеренияТНВЭД,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ЕдИзмеренияТНВЭДПрослеживаемогоТовара КАК ЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.КодЕдИзмеренияТНВЭДПрослеживаемогоТовара КАК КодЕдИзмеренияТНВЭДПрослеживаемогоТовара,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ПрослеживаемыйТовар КАК ПрослеживаемыйТовар,
	|	ДляРасчетаСтоимостиТовараВДолларахСША.ЦенаТовараВалРубль КАК ЦенаТовараВалРубль,
	|	ВЫБОР
	|		КОГДА ДляРасчетаСтоимостиТовараВДолларахСША.ВалютаТовараКод = ""USD""
	|			ТОГДА ДляРасчетаСтоимостиТовараВДолларахСША.ЦенаТовараВыбВал
	|		ИНАЧЕ ВЫРАЗИТЬ(ДляРасчетаСтоимостиТовараВДолларахСША.ЦенаТовараВалРубль * КурсыВалюты.Кратность / КурсыВалюты.Курс КАК ЧИСЛО(15, 2))
	|	КОНЕЦ КАК ЦенаТовараВалДоллар
	|ИЗ
	|	ДляРасчетаСтоимостиТовараВДолларахСША КАК ДляРасчетаСтоимостиТовараВДолларахСША
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ КурсыВалюты КАК КурсыВалюты
	|		ПО ДляРасчетаСтоимостиТовараВДолларахСША.ДокументСсылка = КурсыВалюты.ДокументОтгрузки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ДляРасчетаСтоимостиТовараВДолларахСША
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ КурсыВалюты";
	
	Если ИмяДокумента <> "РеализацияТоваровУслуг" Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "РеализацияТоваровУслуг", ИмяДокумента);
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&КлючСтроки", "Товары.КлючСтроки = &КлючСтроки");
	КонецЕсли;
...
Функция ТекстЗапросаТоварыСтатформаИмпорт()
	Возврат
	"ВЫБРАТЬ
	|	Товары.НомерСтроки КАК НомерСтроки,
	|	ВЫБОР
	...
	|	Товары.СерияНомерТСД КАК СерияНомерТСД,
	...
	|	Товары.КодВидаТранспорта КАК КодВидаТранспорта,
	|	Товары.Ссылка КАК ДокументСсылка,
...
Функция ТекстЗапросаМаркировкаШтрихкодыУпаковокСтатформаЭкспорт()
	Возврат
	"ВЫБРАТЬ
	|	Товары.Ссылка КАК ДокументСсылка,
	|	Товары.Номенклатура КАК Номенклатура,
	|	ШтрихкодыУпаковок.ШтрихкодУпаковки.ЗначениеШтрихкода КАК ШтрихкодУпаковки,
	|	НЕОПРЕДЕЛЕНО КАК КодУровняМаркировки,
	|	ВЫБОР
	|		КОГДА ШтрихкодыУпаковок.ШтрихкодУпаковки.ТипШтрихкода = ЗНАЧЕНИЕ(Перечисление.ТипыШтрихкодов.Code128)
	|				ИЛИ ШтрихкодыУпаковок.ШтрихкодУпаковки.ТипШтрихкода = ЗНАЧЕНИЕ(Перечисление.ТипыШтрихкодов.GS1_128)
	|			ТОГДА ""101 - линейный штриховой код Code 128""
	|		КОГДА ШтрихкодыУпаковок.ШтрихкодУпаковки.ТипШтрихкода = ЗНАЧЕНИЕ(Перечисление.ТипыШтрихкодов.DataMatrix)
	|				ИЛИ ШтрихкодыУпаковок.ШтрихкодУпаковки.ТипШтрихкода = ЗНАЧЕНИЕ(Перечисление.ТипыШтрихкодов.GS1_DataMatrix)
	|			ТОГДА ""301 - двумерный матричный штриховой код DataMatrix код""
	|		КОГДА ШтрихкодыУпаковок.ШтрихкодУпаковки.ТипШтрихкода = ЗНАЧЕНИЕ(Перечисление.ТипыШтрихкодов.QR)
	|			ТОГДА ""302 - двумерный матричный штриховой код QR код""
	|		КОГДА ШтрихкодыУпаковок.ШтрихкодУпаковки.ТипШтрихкода = ЗНАЧЕНИЕ(Перечисление.ТипыШтрихкодов.ПустаяСсылка)
	|			ТОГДА """"
	|		ИНАЧЕ ""999 - прочее""
	|	КОНЕЦ КАК КодВидаСтредстваИдентификации,
	|	НЕОПРЕДЕЛЕНО КАК ЕдиничныйКод
	|ИЗ
	|	Документ.РеализацияТоваровУслуг.Товары КАК Товары
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.РеализацияТоваровУслуг.ШтрихкодыУпаковок КАК ШтрихкодыУпаковок
...
Функция ТекстЗапросаМаркировкаШтрихкодыУпаковокСтатформаИмпорт()
	Возврат
	"ВЫБРАТЬ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровУслуг.ШтрихкодыУпаковок КАК ШтрихкодыУпаковок
	|		ПО ЗаявлениеОВвозе.ДокументПартии = ШтрихкодыУпаковок.Ссылка
...
Процедура СведенияОДокументахСтатформаИмпорт(Знач МассивДокументов, ТаблицаДокументы)
	
	Запрос = Новый Запрос;
	
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЗаявлениеОВвозеТоваровСведенияОДокументах.Наименование КАК НаименованиеДокумента,
	|	ЗаявлениеОВвозеТоваровСведенияОДокументах.Номер КАК НомерДокумента,
	|	ЗаявлениеОВвозеТоваровСведенияОДокументах.Дата КАК ДатаДокумента
	|ИЗ
...
Процедура РеквизитыШапкаСтатформа(РеквизитыШапка, Знач СистемныйНомер, Знач Дата, Знач ДокументСсылка)
	
	РеквизитыШапка.Вставить("СистемныйНомер", ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(СистемныйНомер, Истина, Ложь));
	
	РеквизитыШапка.Вставить("ДатаЗаполнения", Формат(Дата, "ДФ=yyyy-MM-dd"));
	РеквизитыШапка.Вставить("ДатаЗаполненияД1", Лев(Формат(Дата, "ДФ=""дд"""), 1));
	РеквизитыШапка.Вставить("ДатаЗаполненияД2", Прав(Формат(Дата, "ДФ=""дд"""), 1));
	
	РеквизитыШапка.Вставить("ДатаЗаполненияД", Лев(Формат(Дата, "ДФ=""дд"""), 2));
	
	РеквизитыШапка.Вставить("ДатаЗаполненияМ1", Сред(Формат(Дата, "ДФ=dd.MM.yyyy"), 4, 1));
	РеквизитыШапка.Вставить("ДатаЗаполненияМ2", Сред(Формат(Дата, "ДФ=dd.MM.yyyy"), 5, 1));
	
	РеквизитыШапка.Вставить("ДатаЗаполненияМ", Сред(Формат(Дата, "ДФ=dd.MM.yyyy"), 4, 2));

	РеквизитыШапка.Вставить("ДатаЗаполненияГ1", Лев(Формат(Дата, "ДФ=""гггг"""), 1));
	РеквизитыШапка.Вставить("ДатаЗаполненияГ2", Сред(Формат(Дата, "ДФ=""гггг"""), 2, 1));
	РеквизитыШапка.Вставить("ДатаЗаполненияГ3", Сред(Формат(Дата, "ДФ=""гггг"""), 3, 1));
	РеквизитыШапка.Вставить("ДатаЗаполненияГ4", Прав(Формат(Дата, "ДФ=""гггг"""), 1));
	
	РеквизитыШапка.Вставить("ДатаЗаполненияГ", Формат(Дата, "ДФ=""гггг"""));
	
	РеквизитыШапка.Вставить("ОтчетныйМесяцМ1", Сред(Формат(Дата, "ДФ=dd.MM.yyyy"), 4, 1));
	РеквизитыШапка.Вставить("ОтчетныйМесяцМ2", Сред(Формат(Дата, "ДФ=dd.MM.yyyy"), 5, 1));
	
	РеквизитыШапка.Вставить("ОтчетныйМесяцМ", Сред(Формат(Дата, "ДФ=dd.MM.yyyy"), 4, 2));
	
	РеквизитыШапка.Вставить("ОтчетныйМесяцГ1", Лев(Формат(Дата, "ДФ=""гггг"""), 1));
	РеквизитыШапка.Вставить("ОтчетныйМесяцГ2", Сред(Формат(Дата, "ДФ=""гггг"""), 2, 1));
	РеквизитыШапка.Вставить("ОтчетныйМесяцГ3", Сред(Формат(Дата, "ДФ=""гггг"""), 3, 1));
	РеквизитыШапка.Вставить("ОтчетныйМесяцГ4", Прав(Формат(Дата, "ДФ=""гггг"""), 1));
	
	РеквизитыШапка.Вставить("ОтчетныйМесяцГ", Формат(Дата, "ДФ=""гггг"""));
	РеквизитыШапка.Вставить("ОтчетныйМесяц", Формат(Дата, "ДФ=yyyy-MM"));
	РеквизитыШапка.Вставить("УникальныйИД", ДокументСсылка.УникальныйИдентификатор());
	
КонецПроцедуры

Процедура РеквизитыШапкаСтатформаЭкспортПоОтчетуКомиссионера(РеквизитыШапка, ВалютаРеглУчета)
	
	РеквизитыШапка.Вставить("ОтправительРеквизиты", "");
	РеквизитыШапка.Вставить("ПолучательКоды", "");
	РеквизитыШапка.Вставить("ПолучательРеквизиты", "");
	РеквизитыШапка.Вставить("ВидТранспортаКод", "");
	РеквизитыШапка.Вставить("ВидТранспортаНаименование", "");
	РеквизитыШапка.Вставить("ОтвЛицоФинУрКоды", "");
	РеквизитыШапка.Вставить("ОтвЛицоФинУрРеквизиты", "");
	РеквизитыШапка.Вставить("ОргПочтовыйАдресСоответствие", "");
	РеквизитыШапка.Вставить("Получатель_ФормаСобственности", "");
	РеквизитыШапка.Вставить("НапрПеремещения", "ЭК");
	РеквизитыШапка.Вставить("НаправлениеПеремещения", "ЭК");
	РеквизитыШапка.Вставить("СтранаОтправления", "РФ");
	РеквизитыШапка.Вставить("СтранаОтправленияКод", "RU");
	РеквизитыШапка.Вставить("СтранаОтправленияНаименование", "РОССИЯ");
	РеквизитыШапка.Вставить("ПродажаФизлицуЧерезЭлектроннуюТорговуюПлощадку", Ложь);
	
	РеквизитыОрганизации = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(РеквизитыШапка.Организация,
		"ИНН, КПП, ОГРН, НаименованиеОКОПФ, НаименованиеПолное, ЮридическоеФизическоеЛицо, ОбособленноеПодразделение,
		|ИндивидуальныйПредприниматель, СтатусФизическогоЛица, ФамилияИП, ИмяИП, ОтчествоИП, РегистрацияВНалоговомОргане");
	
	РеквизитыШапка.Вставить("ОтправительРФ_ИНН",                    РеквизитыОрганизации.ИНН);
	РеквизитыШапка.Вставить("ОтправительРФ_КПП",                    РеквизитыОрганизации.КПП);
	РеквизитыШапка.Вставить("ОтправительРФ_ОГРН",                   РеквизитыОрганизации.ОГРН);
	РеквизитыШапка.Вставить("Отправитель_ФормаСобственности",       РеквизитыОрганизации.НаименованиеОКОПФ);
	РеквизитыШапка.Вставить("ОтправительНаименование",              РеквизитыОрганизации.НаименованиеПолное);
	РеквизитыШапка.Вставить("ОтправительЮридическоеФизическоеЛицо", РеквизитыОрганизации.ЮридическоеФизическоеЛицо);
	РеквизитыШапка.Вставить("ОбособленноеПодразделение",            РеквизитыОрганизации.ОбособленноеПодразделение);
	РеквизитыШапка.Вставить("ИндивидуальныйПредприниматель",        РеквизитыОрганизации.ИндивидуальныйПредприниматель);
	РеквизитыШапка.Вставить("СтатусФизическогоЛица",                РеквизитыОрганизации.СтатусФизическогоЛица);
	РеквизитыШапка.Вставить("ФамилияИП",                            РеквизитыОрганизации.ФамилияИП);
	РеквизитыШапка.Вставить("ИмяИП",                                РеквизитыОрганизации.ИмяИП);
	РеквизитыШапка.Вставить("ОтчествоИП",                           РеквизитыОрганизации.ОтчествоИП);
	РеквизитыШапка.Вставить("РегистрацияВНалоговомОргане",          РеквизитыОрганизации.РегистрацияВНалоговомОргане);
	
	РеквизитыПокупателя = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(РеквизитыШапка.Покупатель,
		"ИНН, КПП, НалоговыйНомер, ЮридическоеФизическоеЛицо");
	
	РеквизитыШапка.Вставить("Контрагент",                          РеквизитыШапка.Покупатель);
	РеквизитыШапка.Вставить("ПокупательИНН",                       РеквизитыПокупателя.ИНН);
	РеквизитыШапка.Вставить("ПокупательКПП",                       РеквизитыПокупателя.КПП);
	РеквизитыШапка.Вставить("НалоговыйНомер",                      РеквизитыПокупателя.НалоговыйНомер);
	РеквизитыШапка.Вставить("ПолучательЮридическоеФизическоеЛицо", РеквизитыПокупателя.ЮридическоеФизическоеЛицо);
	
	РеквизитыСтраны = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(РеквизитыШапка.СтранаРеализации,
		"КодАльфа2, Наименование");
	
	РеквизитыШапка.Вставить("СтранаНазначения", "");
	РеквизитыШапка.Вставить("ТоргующаяСтранаКод",           РеквизитыСтраны.КодАльфа2);
	РеквизитыШапка.Вставить("ТоргующаяСтранаНаименование",  РеквизитыСтраны.Наименование);
	РеквизитыШапка.Вставить("СтранаНазначенияКод",          РеквизитыСтраны.КодАльфа2);
	РеквизитыШапка.Вставить("СтранаНазначенияНаименование", РеквизитыСтраны.Наименование);
	
	Если РеквизитыСтраны.КодАльфа2 = "KZ" Тогда
		РеквизитыШапка.СтранаНазначения = "РК";
	ИначеЕсли РеквизитыСтраны.КодАльфа2 = "BY" Тогда
		РеквизитыШапка.СтранаНазначения = "РБ";
	ИначеЕсли РеквизитыСтраны.КодАльфа2 = "AM" Тогда
		РеквизитыШапка.СтранаНазначения = "АМ";
	ИначеЕсли РеквизитыСтраны.КодАльфа2 = "KG" Тогда
		РеквизитыШапка.СтранаНазначения = "КГ";
	КонецЕсли;
	
	Если РеквизитыШапка.ВалютаДокумента = ВалютаРеглУчета Тогда
		РеквизитыШапка.Вставить("ВалютаТовараКод", "RUB");
		РеквизитыШапка.Вставить("КодВалютыЦеныТовара", "RUB");
	Иначе
		КодВалютыЦеныТовара = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(РеквизитыШапка.ВалютаДокумента, "Наименование");
		РеквизитыШапка.Вставить("ВалютаТовараКод", КодВалютыЦеныТовара);
		РеквизитыШапка.Вставить("КодВалютыЦеныТовара", КодВалютыЦеныТовара);
	КонецЕсли;
	
КонецПроцедуры

// Приводит значение организационно-правовой формы справочника "Организации" к используемому
// в отчете "Статистическая форма учета перемещения товаров" виду организационно-правовой формы.
// Если соответствующее значение не было найдено, то приваивает пустую строку.
// Параметры:
//  ПравоваяФормаОрганизации - Строка - организационно-правовая форма организации
//  СтатусФизическогоЛица    - ПеречислениеСсылка.СтатусыФизическихЛиц - определяет статусы для 
//                             индивидуальных предпринимателей и самозянятых
Процедура ПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров(ПравоваяФормаОрганизации, Знач СтатусФизическогоЛица)
	
	Если СтатусФизическогоЛица = Перечисления.СтатусыФизическихЛиц.ИндивидуальныйПредприниматель Тогда
		
		Если ЕстьПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров("Индивидуальный предприниматель") Тогда
			ПравоваяФормаОрганизации = "Индивидуальный предприниматель";
		Иначе
			ПравоваяФормаОрганизации = "";
		КонецЕсли;
		
		Возврат;
		
	ИначеЕсли СтатусФизическогоЛица = Перечисления.СтатусыФизическихЛиц.Самозанятый Тогда
		
		Если ЕстьПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров("Самозанятый гражданин") Тогда
			ПравоваяФормаОрганизации = "Самозанятый гражданин";
		Иначе
			ПравоваяФормаОрганизации = "";
		КонецЕсли;
	...
	ИначеЕсли НЕ ЗначениеЗаполнено(ПравоваяФормаОрганизации) Тогда
		
		Возврат;
		
	КонецЕсли;
	
	Если ПравоваяФормаОрганизации = "Общества с ограниченной ответственностью" Тогда
		
		ПравоваяФормаОрганизации = "Общество с ограниченной ответственностью";
		
	ИначеЕсли ПравоваяФормаОрганизации = "Непубличные акционерные общества" Тогда
		
		ПравоваяФормаОрганизации = "Непубличное акционерное общество";
		
	ИначеЕсли ПравоваяФормаОрганизации = "Публичные акционерные общества" Тогда
		
		ПравоваяФормаОрганизации = "Публичное акционерное общество";
		
	ИначеЕсли ПравоваяФормаОрганизации = "Акционерные общества" Тогда
		
		ПравоваяФормаОрганизации = "Акционерное общество";
		
	ИначеЕсли СтрНайти(ПравоваяФормаОрганизации, "унитар") > 0
		И СтрНайти(ПравоваяФормаОрганизации, "предприят") > 0 Тогда
		
		ПравоваяФормаОрганизации = "Унитарное предприятие";
		
	ИначеЕсли СтрНайти(ПравоваяФормаОрганизации, "роизводств") > 0
		И СтрНайти(ПравоваяФормаОрганизации, "кооператив") > 0 Тогда
		
		ПравоваяФормаОрганизации = "Производственный кооператив (артель)";
		
	ИначеЕсли СтрНайти(ПравоваяФормаОрганизации, "Открыт") > 0
		И СтрНайти(ПравоваяФормаОрганизации, "акционер") > 0 Тогда
		
		ПравоваяФормаОрганизации = "Открытое акционерное общество";
		
	ИначеЕсли СтрНайти(ПравоваяФормаОрганизации, "Закрыт") > 0
		И СтрНайти(ПравоваяФормаОрганизации, "акционер") > 0 Тогда
		
		ПравоваяФормаОрганизации = "Закрытое акционерное общество";
	...
	Если НЕ ЕстьПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров(ПравоваяФормаОрганизации) Тогда
		ПравоваяФормаОрганизации = "";
	КонецЕсли;
	
КонецПроцедуры

// Проверяет есть ли заначение организационно-правовой формы в макете, используемом в отчете
// "Статистическая форма учета перемещения товаров"
//  ПравоваяФорма - Строка - организационно-правовая форма
//Возвращаемое значение:
//  Булево - Истина, если значение организационно-правовой формы найдено в макете для отчета
//           "Статистическая форма учета перемещения товаров"
Функция ЕстьПравоваяФормаВСтатистическойФормеУчетаПеремещенияТоваров(Знач ПравоваяФорма)
	МакетПоказателей = Отчеты.РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС.ПолучитьМакет("СпискиАналогЛК");
	СписокПравовыхФорм = МакетПоказателей.ПолучитьОбласть("ОрганизационноПравовыеФормы");
	
	// Нумерация начинается со 2-й строки, т.к. 1-я строка в макете содержит пустое значение
	Для Ном = 2 По СписокПравовыхФорм.ВысотаТаблицы Цикл
		
		Если ПравоваяФорма = СокрЛП(СписокПравовыхФорм.Область(Ном,2).Текст) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
...
// По значению вида докумета из справочника "ВидыДокументовФизическихЛиц"
// возвращает структуру с полями вид и наименование документа физического лица, используемого
// в отчете "Статистическая форма учета перемещения товаров".
// Параметры:
//  ВидДокумента           - СправочникСсылка.ВидыДокументовФизическихЛиц - вид документа физического лица
//  КодСтраныАльфа2        - Строка - двухзначный код страны физлица из справочника "СтраныМира"
// Возвращаемое значение:
//  ВидДокументаВСтатформе - Структура
//  поля структуры:
//    Код                  - Строка
//    Наименование         - Строка
Функция ВидДокументаФизическогоЛицаВСтатформе(Знач ВидДокумента, Знач КодСтраныАльфа2)
	
	Если ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ПаспортРФ Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU01001", КодСтраныАльфа2);
	ИначеЕсли ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ЗагранпаспортРФ Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU01004", КодСтраныАльфа2);
	ИначеЕсли ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ВоенныйБилет Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU07016", КодСтраныАльфа2);
	ИначеЕсли ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ВременноеУдостоверениеВзаменВоенногоБилетаОфицераЗапаса Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU02010", КодСтраныАльфа2);
	ИначеЕсли ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ПаспортМоряка Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU02005", КодСтраныАльфа2);
	ИначеЕсли ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.УдостоверениеОфицера Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU02016", КодСтраныАльфа2);
	КонецЕсли;
	
	КодМВД = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВидДокумента, "КодМВД");
	
	Если КодМВД = "15" Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU99024", КодСтраныАльфа2);
	ИначеЕсли КодМВД = "11" Тогда
		Возврат НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы("RU03022", КодСтраныАльфа2);
	КонецЕсли;
	
	Если ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ВодительскоеУдостоверение
		ИЛИ ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ВоенныйБилетОфицераЗапаса
		ИЛИ ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ПаспортМинморфлота
		ИЛИ ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.СправкаВзаменВоенногоБилета
		ИЛИ ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.УдостоверениеГражданинаПодлежащегоПризыву
		ИЛИ КодМВД = "24"
		ИЛИ КодМВД = "91" Тогда
		
		Возврат НайтиПоНаименованиюВидДокументаФизическогоЛицаВМакетеСтатформы("ИНОЙ", КодСтраныАльфа2);
		
	ИначеЕсли ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ЗагранпаспортСССР
		ИЛИ ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ПаспортСССР
		ИЛИ КодМВД = "10"
		ИЛИ КодМВД = "23" Тогда
	...
	Возврат НайтиПоНаименованиюВидДокументаФизическогоЛицаВМакетеСтатформы(
				СтрЗаменить(Строка(ВидДокумента),"РФ",""), КодСтраныАльфа2);
	
КонецФункции

// Поиск вида документа физического лица по коду и двухзначнмому коду страны в макете, используемом
// в отчете "Статистическая форма учета перемещения товаров".
// Параметры:
//  Код - Строка           - код, который нужно найти в макете
//  КодСтраныАльфа2        - Строка - двухзначный код страны физлица из справочника "СтраныМира"
// Возвращаемое значение:
//  ВидДокументаВСтатформе - Структура
//  поля структуры:
//    Код                  - Строка
//    Наименование         - Строка
Функция НайтиПоКодуВидДокументаФизическогоЛицаВМакетеСтатформы(Знач Код, Знач КодСтраныАльфа2)
	
	МакетПоказателей = Отчеты.РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС.ПолучитьМакет("СпискиАналогЛК");
	ВидыДокументов = МакетПоказателей.ПолучитьОбласть("КодыДокументов");
	
	ВидДокументаВСтатформе = Новый Структура("Код, Наименование", "", "");
	// Нумерация начинается со 2-й строки, т.к. 1-я строка в макете содержит пустое значение
	Для Ном = 2 По ВидыДокументов.ВысотаТаблицы Цикл
		
		Если КодСтраныАльфа2 = СокрЛП(ВидыДокументов.Область(Ном,4).Текст)
			И Код = СокрЛП(ВидыДокументов.Область(Ном,1).Текст) Тогда
			
			ВидДокументаВСтатформе.Код = Код;
			ВидДокументаВСтатформе.Наименование = СокрЛП(ВидыДокументов.Область(Ном,3).Текст);
			Прервать;
	...
	Возврат ВидДокументаВСтатформе;
	
КонецФункции

// Поиск вида документа физического лица по наименованию и двухзначнмому коду страны в макете, используемом
// в отчете "Статистическая форма учета перемещения товаров".
// Параметры:
//  Наименование           - Строка - наименование, которое нужно найти в макете
//  КодСтраныАльфа2        - Строка - двухзначный код страны физлица из справочника "СтраныМира"
// Возвращаемое значение:
//  ВидДокументаВСтатформе - Структура
//  поля структуры:
//    Код                  - Строка
//    Наименование         - Строка
Функция НайтиПоНаименованиюВидДокументаФизическогоЛицаВМакетеСтатформы(Наименование, КодСтраныАльфа2)
	...
	Для Ном = 2 По ВидыДокументов.ВысотаТаблицы Цикл
		...
		Если КодСтраныАльфа2 = СокрЛП(ВидыДокументов.Область(Ном,4).Текст)
			И СтрНайти(ВРег(СокрЛП(ВидыДокументов.Область(Ном,2).Текст)), ВРег(Наименование)) > 0 Тогда
			
			ВидДокументаВСтатформе.Код = СокрЛП(ВидыДокументов.Область(Ном,1).Текст);
			ВидДокументаВСтатформе.Наименование = СокрЛП(ВидыДокументов.Область(Ном,3).Текст);
			Прервать;
...
Процедура ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2017Кв4(ПараметрыОтчета, Контейнер) Экспорт
	...
	ЗаполнитьДекларациюПоКосвеннымНалогам(ПараметрыОтчета, Контейнер);
...
Процедура ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3(ПараметрыОтчета, Контейнер) Экспорт
	
	ЗаполнитьДекларациюПоКосвеннымНалогам(ПараметрыОтчета, Контейнер);
	
КонецПроцедуры

// Код заполнения для версий отчета за 2017 и 2023 год не отличаются.
Процедура ЗаполнитьДекларациюПоКосвеннымНалогам(ПараметрыОтчета, Контейнер)
...
// Создает список показателей декларации по косвенным налогам при импорте товаров, которые будут автоматически заполняться.
// Для версии отчета ФормаОтчета2023Кв3.
Процедура ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3(ПоказателиОтчета) Экспорт
				...
				Пока ВыборкаПоОперациям.Следующий() Цикл
					...
					Пока ВыборкаЗаписи.Следующий() Цикл
						Если ПерваяСтрока Тогда
							...
							Иначе
								ФИО = ОбщегоНазначенияБПКлиентСервер.ФамилияИмяОтчествоПоНаименованиюИП(ВыборкаЗаписи.НаименованиеКонтрагента);
...
#Область ПодготовкаОбщихДанных
	...
	ОбщиеПараметрыЗапросов.Вставить("КодОперацииПоУмолчанию",
		УчетНДСВызовСервера.КодОперацииПоСтавке0ПоУмолчанию(
	...
	ИначеЕсли ПараметрыОтчета.ПравилаЗаполнения = "2023Кв1"
	 ...
	 ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1" Тогда
	...
	ПрименяетсяСтавка20 = ПараметрыОтчета.ПравилаЗаполнения = "2019Кв1"
		...
		ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2025Кв1"
		ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1";
	СтавкаНДССтрока003 = Перечисления.СтавкиНДС.НДС22;
	СтавкаНДССтрока005 = Перечисления.СтавкиНДС.НДС22_122;
	СтавкаНДССтрока010 = Перечисления.СтавкиНДС.НДС20;
	СтавкаНДССтрока030 = Перечисления.СтавкиНДС.НДС20_120;
	...
	// Применяется декларация, где 20% в строке 010, а 18% в строке 041
	Запрос.УстановитьПараметр("ПрименяетсяСтавка20",     ПрименяетсяСтавка20);
	Запрос.УстановитьПараметр("СтавкаНДССтрока003",      СтавкаНДССтрока003);
	Запрос.УстановитьПараметр("СтавкаНДССтрока005",      СтавкаНДССтрока005);
	Запрос.УстановитьПараметр("СтавкаНДССтрока010",      СтавкаНДССтрока010);
	Запрос.УстановитьПараметр("СтавкаНДССтрока030",      СтавкаНДССтрока030);
	...
	ИначеЕсли ПараметрыОтчета.ПравилаЗаполнения = "2025Кв1" Тогда
		МакетыРасшифровкиПолей = МакетыРасшифровкиПолей2025Кв1(
			ПараметрыОтчета.Организация, ПараметрыОтчета.мДатаКонцаПериодаОтчета);
	ИначеЕсли ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1" Тогда
		МакетыРасшифровкиПолей = МакетыРасшифровкиПолей2026Кв1(
			ПараметрыОтчета.Организация, ПараметрыОтчета.мДатаКонцаПериодаОтчета);
	КонецЕсли;
...
#Область Раздел3
	...
	Если Контейнер.Свойство("Раздел3")
		...
		Если ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1" Тогда
		
			#Область Расшифровка_П000300000303_и_П000300000305
			
				ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
					МакетыРасшифровкиПолей.Получить("П000300000303"));
				...
				ЗаполнениеРасшифровкаРегламентированнойОтчетности.ДобавитьСтрокуРасшифровки(
					...
					"",
					"",
					Раздел3.П000300000305,
					"Раздел3",
					ДополнительныеПараметрыИОтбор.ДополнительныеПараметры);
				
			#КонецОбласти
			
			#Область Расшифровка_П000300000503_и_П000300000505
			
				ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
					МакетыРасшифровкиПолей.Получить("П000300000503"));
...
#Область Раздел5
	...
	Если Контейнер.Свойство("Раздел5") Тогда
		
		ОчиститьРаздел5(Контейнер);
		
		Запрос = Новый Запрос;
		УстановитьОбщиеПараметрыЗапроса(Запрос, ОбщиеПараметрыЗапросов);
		Запрос.УстановитьПараметр("СобытиеВычетПредъявленНДСКВычету0", Перечисления.СобытияПоНДСПокупки.ПредъявленНДСКВычетуВПоследующихПериодахПодтвержденаСтавка0);
		Запрос.УстановитьПараметр("СобытиеНачислениеПодтвержденаСтавка0", Перечисления.СобытияПоНДСПродажи.ПодтвержденаСтавка0);
		Запрос.УстановитьПараметр("СобытиеВычетНеПодтвержденаСтавка0", Перечисления.СобытияПоНДСПокупки.ПредъявленНДСКВычетуВПоследующихПериодахНеПодтвержденаСтавка0);
		Запрос.УстановитьПараметр("СобытиеНачислениеНеПодтвержденаСтавка0", Перечисления.СобытияПоНДСПродажи.НеПодтвержденаСтавка0);
		
		Запрос.Текст = УчетНДСПереопределяемый.ТекстЗапросаРаздел5(ПараметрыОтчета);
		...
		Если НЕ Результат.Пустой() Тогда
			...
			ПараметрыРасшифровки.Вставить("ПолеКомпоновкиДанныхСобытие", ПолеКомпоновкиДанныхСобытие);
			ПараметрыРасшифровки.Вставить("ПолеКомпоновкиДанныхКодВидаОперации", ПолеКомпоновкиДанныхКодВидаОперации);
			ПараметрыРасшифровки.Вставить("СобытиеНеПодтвержденаСтавка0", СобытиеНеПодтвержденаСтавка0);
			ПараметрыРасшифровки.Вставить("СобытиеПодтвержденаСтавка0", СобытиеПодтвержденаСтавка0);
			ПараметрыРасшифровки.Вставить("СобытиеПредъявленКВычетуВПоследующихПериодахНеПодтвержденНДС0", Перечисления.СобытияПоНДСПокупки.ПредъявленНДСКВычетуВПоследующихПериодахНеПодтвержденаСтавка0);
			ПараметрыРасшифровки.Вставить("СобытиеПредъявленКВычетуВПоследующихПериодахНДС0", Перечисления.СобытияПоНДСПокупки.ПредъявленНДСКВычетуВПоследующихПериодахПодтвержденаСтавка0); 
			ПараметрыРасшифровки.Вставить("ПолеКомпоновкиДанныхСобытиеПодтвержденияСтавки0", ПолеКомпоновкиДанныхСобытиеПодтвержденияСтавки0);
			ПараметрыРасшифровки.Вставить("ПолеКомпоновкиДанныхНалоговыйПериод", ПолеКомпоновкиДанныхНалоговыйПериод);
			ПараметрыРасшифровки.Вставить("НачалоПериодаОтчета", НачалоПериодаОтчета);
			
			Пока ВыборкаПоКварталу.Следующий() Цикл
				
				НомерСтраницы = НомерСтраницы + 1;
				
				НомерСтраницыТипСтрока = Формат(НомерСтраницы, "ЧГ=0");
				
				ДобавитьСтраницуРаздел5(Контейнер, НомерСтраницыТипСтрока, ВыборкаПоКварталу,
					МакетыРасшифровкиПолей, ТаблицаРасшифровки, ПараметрыРасшифровки);
				
			КонецЦикла;
			
		Иначе
			// Добавляем одну пустую страницу
			
			ДобавитьПустуюСтраницуРаздел5(Контейнер);
...
#Область СоблюдениеКонтрольныхСоотношений
	...
	Если ПараметрыОтчета.Свойство("ДанныеПомощникаЗаполнения")
		...
		СтавкаНДССтрока010Число     = УчетНДСПереопределяемый.ПолучитьСтавкуНДС(СтавкаНДССтрока010);
		...
		СтавкаНДССтрока003Число     = УчетНДСПереопределяемый.ПолучитьСтавкуНДС(СтавкаНДССтрока003);
		...
		НачисленияПоРазделу3 = Окр(Окр(Раздел3Начисления.П000300001003)*СтавкаНДССтрока010Число/100)
			...
			+ Окр(Окр(Раздел3Начисления.П000300003003)*СтавкаНДССтрока010Число/(СтавкаНДССтрока010Число + 100))
		...
		Если ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1" Тогда
			НачисленияПоКнигеПродаж = НачисленияПоКнигеПродаж
				+ Раздел3Начисления.СуммаНДССтрока003
				+ Раздел3Начисления.СуммаНДССтрока005;
			НачисленияПоРазделу3 = НачисленияПоРазделу3
				+ Окр(Окр(Раздел3Начисления.П000300000303)*СтавкаНДССтрока003Число/100)
				+ Окр(Окр(Раздел3Начисления.П000300000503)*СтавкаНДССтрока003Число/(СтавкаНДССтрока003Число + 100));
		КонецЕсли;
		...
		Если НачисленияПоРазделу3 < НачисленияПоКнигеПродаж Тогда // Не выполняется КС 1.27
			...
			Раздел3.П000300001003 = Окр(Окр(Раздел3Начисления.СуммаНДССтрока010)/СтавкаНДССтрока010Число*100);
			Раздел3.П000300002003 = Окр(Окр(Раздел3Начисления.СуммаНДССтрока020)/ПониженнаяСтавкаНДСЧисло*100);
			Раздел3.П000300003003 = Окр(Окр(Раздел3Начисления.СуммаНДССтрока030)/СтавкаНДССтрока010Число*(СтавкаНДССтрока010Число + 100));
			...
			Если ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1" Тогда
				Раздел3.П000300000303 = Окр(Окр(Раздел3Начисления.СуммаНДССтрока003)/СтавкаНДССтрока003Число*100);
				Раздел3.П000300000503 = Окр(Окр(Раздел3Начисления.СуммаНДССтрока005)/СтавкаНДССтрока003Число*(СтавкаНДССтрока003Число + 100));
			КонецЕсли;
...
Функция ТекстЗапросаРаздел3Начисления()
	...
	|ВЫБРАТЬ
	|	ВЫБОР
	|		КОГДА ТаблицаМежценоваяРазница.СтавкаНДС = &СтавкаНДССтрока005
	|			ТОГДА ТаблицаМежценоваяРазница.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаСтрока005,
	|	ВЫБОР
	|		КОГДА ТаблицаМежценоваяРазница.СтавкаНДС = &СтавкаНДССтрока030
	|			ТОГДА ТаблицаМежценоваяРазница.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаСтрока030,
	|	ВЫБОР
	|		КОГДА ТаблицаМежценоваяРазница.СтавкаНДС = &СтавкаНДС7_107
	|			ТОГДА ТаблицаМежценоваяРазница.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаСтрока033,
	|	ВЫБОР
	|		КОГДА ТаблицаМежценоваяРазница.СтавкаНДС = &СтавкаНДС5_105
	|			ТОГДА ТаблицаМежценоваяРазница.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаСтрока034,
	|	ВЫБОР
	|		КОГДА ТаблицаМежценоваяРазница.СтавкаНДС = &СтавкаНДС10_110
	|			ТОГДА ТаблицаМежценоваяРазница.СуммаНДС
	|	КОНЕЦ КАК СуммаНДСМежценоваяРазницаСтрока040
	|ПОМЕСТИТЬ НДССМежценовойРазницыПредварительная
	|ИЗ
	|	Документ.РеализацияТоваровУслуг.Товары КАК ТаблицаМежценоваяРазница
	|ГДЕ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаСтрока005) КАК СуммаНДСМежценоваяРазницаСтрока005,
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаСтрока030) КАК СуммаНДСМежценоваяРазницаСтрока030,
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаСтрока033) КАК СуммаНДСМежценоваяРазницаСтрока033,
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаСтрока034) КАК СуммаНДСМежценоваяРазницаСтрока034,
	|	СУММА(НДССМежценовойРазницыПредварительная.СуммаНДСМежценоваяРазницаСтрока040) КАК СуммаНДСМежценоваяРазницаСтрока040
	...
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока003)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности В (&ВидыЦенностейСтр010_040)
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.СуммаБезНДСОборот
	|					ИНАЧЕ 0
	|				КОНЕЦ КАК ЧИСЛО(31, 2))), 0) КАК П000300000303,
	|	ЕСТЬNULL(СУММА(ВЫРАЗИТЬ(ВЫБОР
	|					КОГДА НДСЗаписиКнигиПродажОбороты.Событие В (&СобытиеРеализация)
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока005)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности В (&ВидыЦенностейСтр010_040)
	...
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока003, &СтавкаНДССтрока005)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности = ЗНАЧЕНИЕ(Перечисление.ВидыЦенностей.ТоварыНалоговыйАгент)
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.СуммаБезНДСОборот + НДСЗаписиКнигиПродажОбороты.НДСОборот
	|					ИНАЧЕ 0
	|				КОНЕЦ КАК ЧИСЛО(31, 2))), 0) КАК П000300000503,
	|	0 КАК П000300000703,
	|	ЕСТЬNULL(СУММА(ВЫРАЗИТЬ(ВЫБОР
	|					КОГДА НДСЗаписиКнигиПродажОбороты.Событие В (&СобытиеРеализация)
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока010)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности В (&ВидыЦенностейСтр010_040)
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.СуммаБезНДСОборот
	|					ИНАЧЕ 0
	...
	|	ЕСТЬNULL(СУММА(ВЫРАЗИТЬ(ВЫБОР
	|					КОГДА НДСЗаписиКнигиПродажОбороты.Событие В (&СобытиеРеализация)
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока030)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности В (&ВидыЦенностейСтр010_040)
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.СуммаБезНДСОборот + НДСЗаписиКнигиПродажОбороты.НДСОборот
	|					КОГДА НДСЗаписиКнигиПродажОбороты.Событие В (&СобытиеНачисленНДС)
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока030, &СтавкаНДССтрока010)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности = ЗНАЧЕНИЕ(Перечисление.ВидыЦенностей.ТоварыНалоговыйАгент)
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.СуммаБезНДСОборот + НДСЗаписиКнигиПродажОбороты.НДСОборот
	|					ИНАЧЕ 0
	...
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.НДСОборот
	|					ИНАЧЕ 0
	|				КОНЕЦ КАК ЧИСЛО(31, 2))), 0) КАК СуммаНДССтрока003,
	|	ЕСТЬNULL(СУММА(ВЫРАЗИТЬ(ВЫБОР
	|					КОГДА НДСЗаписиКнигиПродажОбороты.Событие В (&СобытиеРеализация)
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока005)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности В (&ВидыЦенностейСтр010_040)
	...
	|						ТОГДА НДСЗаписиКнигиПродажОбороты.НДСОборот
	|					ИНАЧЕ 0
	|				КОНЕЦ КАК ЧИСЛО(31, 2))), 0) КАК СуммаНДССтрока005,
	|	ЕСТЬNULL(СУММА(ВЫРАЗИТЬ(ВЫБОР
	|					КОГДА НДСЗаписиКнигиПродажОбороты.Событие В (&СобытиеРеализация)
	|							И НДСЗаписиКнигиПродажОбороты.СтавкаНДС В (&СтавкаНДССтрока010)
	|							И НДСЗаписиКнигиПродажОбороты.ВидЦенности В (&ВидыЦенностейСтр010_040)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПредварительныеНачисленияРаздел3.П000300000303 КАК П000300000303,
	|	ПредварительныеНачисленияРаздел3.П000300000503 - ЕСТЬNULL(НДССМежценовойРазницы.СуммаНДСМежценоваяРазницаСтрока005, 0) КАК П000300000503,
	|	ПредварительныеНачисленияРаздел3.П000300000703 КАК П000300000703,
	...
	|	ПредварительныеНачисленияРаздел3.П000300003003 - ЕСТЬNULL(НДССМежценовойРазницы.СуммаНДСМежценоваяРазницаСтрока030, 0) КАК П000300003003,
	...
	|	ПредварительныеНачисленияРаздел3.П000300003303 - ЕСТЬNULL(НДССМежценовойРазницы.СуммаНДСМежценоваяРазницаСтрока033, 0) КАК П000300003303,
	|	ПредварительныеНачисленияРаздел3.П000300003403 - ЕСТЬNULL(НДССМежценовойРазницы.СуммаНДСМежценоваяРазницаСтрока034, 0) КАК П000300003403,
	|	ПредварительныеНачисленияРаздел3.П000300004003 - ЕСТЬNULL(НДССМежценовойРазницы.СуммаНДСМежценоваяРазницаСтрока040, 0) КАК П000300004003,
	...
	|	ПредварительныеНачисленияРаздел3.СуммаНДССтрока003 КАК СуммаНДССтрока003,
	|	ПредварительныеНачисленияРаздел3.СуммаНДССтрока005 КАК СуммаНДССтрока005,
...
Функция ТекстЗапросаРаздел3Приложение1()
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.%ИмяРегистра%.КонтактнаяИнформация КАК КонтактнаяИнформация
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "%ИмяРегистра%", 
		БухгалтерскийУчетПереопределяемый.ИмяРегистраМестоНахожденияОС());
...
Процедура ОчиститьРаздел4(Контейнер, ПараметрыОтчета)
	...
	Если ПараметрыОтчета.ПравилаЗаполнения = "2026Кв1"
	 ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2025Кв1"
	 ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2023Кв1"
	 ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2021Кв3"
	 ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2020Кв4"
...
Процедура ОчиститьРаздел5(Контейнер)
	
	Контейнер.Раздел5.Очистить();
	Контейнер.Раздел5_ДанныеДопСтрок.Очистить();

КонецПроцедуры

Процедура ДобавитьПустуюСтраницуРаздел5(Контейнер)
	
	Страница = Контейнер.Раздел5.Добавить();
	Страница.АктивнаяСтраница = Ложь;
	Страница.Данные = Новый Структура("П000500001003,П000500002003,П000500003003_1,П000500004003_1,П000500005003_1,П000500006003_1,П000500007003_1,П000500008003,П000500009003",
								"","","",0,0,0,0,0,0);
	Страница.Представление = "Лист N 1";
	
	//Определяем таблицу значений ДанныеДопСтрок
	ТЗДанныеДопСтрок = Новый ТаблицаЗначений;
	ТЗДанныеДопСтрок.Колонки.Добавить("П000500003003");
	ТЗДанныеДопСтрок.Колонки.Добавить("П000500004003");
	ТЗДанныеДопСтрок.Колонки.Добавить("П000500005003");
	ТЗДанныеДопСтрок.Колонки.Добавить("П000500006003");
	ТЗДанныеДопСтрок.Колонки.Добавить("П000500007003");
	
	СтрокаТЗДанныеДопСтрок = ТЗДанныеДопСтрок.Добавить();
	СтрокаТЗДанныеДопСтрок.П000500003003 = "";
	СтрокаТЗДанныеДопСтрок.П000500004003 = 0;
	СтрокаТЗДанныеДопСтрок.П000500005003 = 0;
	СтрокаТЗДанныеДопСтрок.П000500006003 =0 ;
	СтрокаТЗДанныеДопСтрок.П000500007003 = 0;

	Страница.ДанныеДопСтрок = ТЗДанныеДопСтрок;
	
	СтраницаДанныеДопСтрок = Контейнер.Раздел5_ДанныеДопСтрок.Добавить();

КонецПроцедуры

Процедура ДобавитьСтраницуРаздел5(Контейнер, НомерСтраницы, ДанныеЗаполнения, МакетыРасшифровкиПолей, ТаблицаРасшифровки, ПараметрыРасшифровки)
	
	Страница = Контейнер.Раздел5.Добавить();
	Страница.АктивнаяСтраница=Ложь;
	Страница.Данные = Новый Структура;
	Страница.Данные.Вставить("П000500001003", Формат(ДанныеЗаполнения.НачалоКвартала, "ДФ=yyyy"));
	
	Если Месяц(ДанныеЗаполнения.НачалоКвартала) = 1 Тогда
		
		Страница.Данные.Вставить("П000500002003", "21");

	ИначеЕсли Месяц(ДанныеЗаполнения.НачалоКвартала) = 4 Тогда
		
		Страница.Данные.Вставить("П000500002003", "22");

	ИначеЕсли Месяц(ДанныеЗаполнения.НачалоКвартала) = 7 Тогда
		
		Страница.Данные.Вставить("П000500002003", "23");
		
	ИначеЕсли Месяц(ДанныеЗаполнения.НачалоКвартала) = 10 Тогда
		
		Страница.Данные.Вставить("П000500002003", "24");
		
	Иначе
		// Сообщить об ошибке неизвестный месяц
		ОписаниеОшибки = НСтр("ru = 'Неизвестное начало квартала.'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	// Итоговые показатели
	Страница.Данные.Вставить("П000500008003", 0);
	Страница.Данные.Вставить("П000500009003", 0);

	Страница.Представление = "Лист N " + НомерСтраницы;
	...
	ПараметрыРасшифровки.Вставить("ДатаНачала", ДанныеЗаполнения.НачалоКвартала);
	
	Пока Выборка.Следующий() Цикл
		
		НомерСтроки = НомерСтроки + 1;
		НомерСтрокиБезГруппировки = "_" + Формат(НомерСтроки, "ЧГ=0");
		ЗаполнитьСтрокуСтраницыРаздел5(Страница, НомерСтрокиБезГруппировки, НомерСтраницы, Выборка,
				МакетыРасшифровкиПолей , ТаблицаРасшифровки, ПараметрыРасшифровки);
...
Процедура ЗаполнитьСтрокуСтраницыРаздел5(Страница, НомерСтрокиБезГруппировки, НомерСтраницы, ДанныеЗаполнения, МакетыРасшифровкиПолей, ТаблицаРасшифровки, ПараметрыРасшифровки)
	
	Строка030 = "П000500003003"; // Код операции
	Строка040 = "П000500004003"; // Налоговая база по ранее подтвержденным операциям по ставке 0%
	Строка050 = "П000500005003"; // Налоговый вычет по ранее подтвержденным операциям по ставке 0%
	Строка060 = "П000500006003"; // Налоговая база по ранее неподтвержденным операциям по ставке 0%
	Строка070 = "П000500007003"; // Налоговый вычет по ранее неподтвержденным операциям по ставке 0%
	
	ИмяКлюча030 = Строка030 + НомерСтрокиБезГруппировки;
	Страница.Данные.Вставить(ИмяКлюча030, ДанныеЗаполнения.КодОперации);

	ИмяКлюча040 = Строка040 + НомерСтрокиБезГруппировки;
	Страница.Данные.Вставить(ИмяКлюча040, ДанныеЗаполнения.НалоговаяБазаПоРанееПодтвержденнойНулевойСтавке);

	ИмяКлюча050 = Строка050 + НомерСтрокиБезГруппировки;
	Страница.Данные.Вставить(ИмяКлюча050, ДанныеЗаполнения.ВычетНДСПоРанееПодтвержденнойНулевойСтавке);

	ИмяКлюча060 = Строка060 + НомерСтрокиБезГруппировки;
	Страница.Данные.Вставить(ИмяКлюча060, ДанныеЗаполнения.НалоговаяБазаПоРанееНеПодтвержденнойНулевойСтавке);

	ИмяКлюча070 = Строка070 + НомерСтрокиБезГруппировки;
	Страница.Данные.Вставить(ИмяКлюча070, ДанныеЗаполнения.ВычетНДСПоРанееНеПодтвержденнойНулевойСтавке);
	
	СтрокаТЗДанныеДопСтрок = Страница.ДанныеДопСтрок.Добавить();
	СтрокаТЗДанныеДопСтрок.П000500003003 = Страница.Данные[ИмяКлюча030];
	СтрокаТЗДанныеДопСтрок.П000500004003 = Страница.Данные[ИмяКлюча040];
	СтрокаТЗДанныеДопСтрок.П000500005003 = Страница.Данные[ИмяКлюча050];
	СтрокаТЗДанныеДопСтрок.П000500006003 = Страница.Данные[ИмяКлюча060];
	СтрокаТЗДанныеДопСтрок.П000500007003 = Страница.Данные[ИмяКлюча070];
	
	#Область РасшифровкаРаздел5

	// Строка 040
	
	ИдентификаторПоказателя = ИмяКлюча040 + "_" + НомерСтраницы;
	
	ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
		МакетыРасшифровкиПолей.Получить(Строка040));
	
	ДополнительныеПараметрыИОтбор.ДополнительныеПараметры.Вставить("ДатаНачала", ПараметрыРасшифровки.ДатаНачала);
	
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытие,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеПодтвержденаСтавка0);
		
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхКодВидаОперации,
		ВидСравненияКомпоновкиДанных.Равно,
		СтрокаТЗДанныеДопСтрок.П000500003003); // Код операции
		
	НаименованиеПоказателя = НСтр("ru='Налоговая база по операциям, обоснованность применения налоговой ставки
		|0 процентов по которым документально подтверждена в предыдущих налоговых периодах'");
	...
	ЗаполнениеРасшифровкаРегламентированнойОтчетности.ДобавитьСтрокуРасшифровки(
		...
		"",
		"",
		СтрокаТЗДанныеДопСтрок.П000500004003, // Налоговая база по ранее подтвержденным операциям по ставке 0%
		"Раздел5",
		ДополнительныеПараметрыИОтбор.ДополнительныеПараметры);
	
	// Строка 050
	
	ИдентификаторПоказателя = ИмяКлюча050 + "_" + НомерСтраницы;
	
	ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
		МакетыРасшифровкиПолей.Получить(Строка050));
	
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытие,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеПредъявленКВычетуВПоследующихПериодахНДС0); // События перечисления СобытияПоНДСПокупки
	...
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытиеПодтвержденияСтавки0,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеПодтвержденаСтавка0); // События перечисления СобытияПоНДСПродажи
		
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхНалоговыйПериод,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.ДатаНачала); // налоговой период, в котором ранее было отражено подтверждение нулевой ставки
		
	НаимПоказателя = НСтр(
		"ru='Налоговые вычеты по операциям, обоснованность применения налоговой ставки
		|0 процентов по которым документально подтверждена в предыдущих налоговых периодах'");
	
	ДополнительныеПараметрыИОтбор.ДополнительныеПараметры.Вставить("ДатаНачала", ПараметрыРасшифровки.НачалоПериодаОтчета);
	...
	ЗаполнениеРасшифровкаРегламентированнойОтчетности.ДобавитьСтрокуРасшифровки(
		...
		"",
		"",
		СтрокаТЗДанныеДопСтрок.П000500005003, // Налоговый вычет по ранее подтвержденным операциям по ставке 0%
		"Раздел5",
		ДополнительныеПараметрыИОтбор.ДополнительныеПараметры);
		
	// Строка 060
	
	ИдентификаторПоказателя = ИмяКлюча060 + "_" + НомерСтраницы;
	
	ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
	МакетыРасшифровкиПолей.Получить(Строка060));
	
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытие,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеНеПодтвержденаСтавка0);
	...
	НаименованиеПоказателя = НСтр("ru='Налоговая база по операциям, обоснованность применения налоговой ставки
		|0 процентов по которым документально не подтверждена в предыдущих налоговых периодах'");
	...
	ЗаполнениеРасшифровкаРегламентированнойОтчетности.ДобавитьСтрокуРасшифровки(
		...
		"",
		"",
		СтрокаТЗДанныеДопСтрок.П000500006003, // Налоговая база по ранее неподтвержденным операциям по ставке 0%
		"Раздел5",
		ДополнительныеПараметрыИОтбор.ДополнительныеПараметры);
	
	// Строка 070
	
	ИдентификаторПоказателя = ИмяКлюча070 + "_" + НомерСтраницы;
	
	ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
		МакетыРасшифровкиПолей.Получить(Строка070));
		
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытие,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеПредъявленКВычетуВПоследующихПериодахНеПодтвержденНДС0); // События перечисления СобытияПоНДСПокупки
	...
	ДобавитьЗначениеВОтбор(
		...
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытиеПодтвержденияСтавки0,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеНеПодтвержденаСтавка0); // События перечисления СобытияПоНДСПродажи
		
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхНалоговыйПериод,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.ДатаНачала); // налоговой период, в котором ранее было отражено не подтверждение нулевой ставки
	...
	ЗаполнениеРасшифровкаРегламентированнойОтчетности.ДобавитьСтрокуРасшифровки(
		...
		"",
		"",
		СтрокаТЗДанныеДопСтрок.П000500007003, // Налоговый вычет по ранее не подтвержденным операциям по ставке 0%
		"Раздел5",
		ДополнительныеПараметрыИОтбор.ДополнительныеПараметры);
		
	// Строка 080
	
	ИдентификаторПоказателя = "П000500008003" + "_" + НомерСтраницы;
	
	НаимПоказателя = НСтр(
		"ru='Сумма налога, принимаемая к вычету, по операциям, обоснованность
		|применения налоговой ставки 0 процентов по которым документально
		|подтверждена в предыдущих налоговых периодах, исчисленная
		|к возмещению по разделу 5'");
	
	ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
		МакетыРасшифровкиПолей.Получить("П000500008003"));
		
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытие,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеПредъявленКВычетуВПоследующихПериодахНДС0);
	...
	ИдентификаторПоказателя = "П000500009003" + "_" + НомерСтраницы;
	
	НаимПоказателя = НСтр(
		"ru='Сумма налога, принимаемая к вычету, по операциям, обоснованность
		|применения налоговой ставки 0 процентов по которым документально
		|не подтверждена в предыдущих налоговых периодах, исчисленная
		|к возмещению по разделу 5'");
	
	ДополнительныеПараметрыИОтбор = НовыйДополнительныеПараметрыРасшифровкиИОтбор(
		МакетыРасшифровкиПолей.Получить("П000500009003"));
		
	ДобавитьЗначениеВОтбор(
		ДополнительныеПараметрыИОтбор.Отбор,
		ПараметрыРасшифровки.ПолеКомпоновкиДанныхСобытие,
		ВидСравненияКомпоновкиДанных.Равно,
		ПараметрыРасшифровки.СобытиеПредъявленКВычетуВПоследующихПериодахНеПодтвержденНДС0);
...
Функция СтруктураПоказателейРаздела3Декларации(ПараметрыЗаполнения)
	...
	Если ПараметрыЗаполнения = "2026Кв1" Тогда
		Возврат СтруктураПоказателейРаздела3Декларации2026Кв1();
	ИначеЕсли ПараметрыЗаполнения = "2025Кв1" Тогда
...
Функция СтруктураПоказателейРаздела3Декларации2026Кв1()
	
	СтруктураПоказателейРаздела3 = Новый Структура;
	
	// Показатели 22% и 22/122
	СтруктураПоказателейРаздела3.Вставить("П000300000303", 0);
	СтруктураПоказателейРаздела3.Вставить("П000300000305", 0);
	СтруктураПоказателейРаздела3.Вставить("П000300000503", 0);
	СтруктураПоказателейРаздела3.Вставить("П000300000505", 0);
...
Процедура РассчитатьПоказателиРаздела3Декларации(СтруктураПоказателей, ПараметрыЗаполнения)
	...
	Если ПараметрыЗаполнения = "2026Кв1" Тогда
		СтруктураПоказателей.П000300000303 = Окр(СтруктураПоказателей.П000300000303);
		СтруктураПоказателей.П000300000305 = СтруктураПоказателей.П000300000303 * 22 / 100;
		СтруктураПоказателей.П000300000503 = Окр(СтруктураПоказателей.П000300000503);
		СтруктураПоказателей.П000300000505 = СтруктураПоказателей.П000300000503 * 22 / 122;
	КонецЕсли;
	...
	Если ПараметрыЗаполнения = "2025Кв1"
	 ИЛИ ПараметрыЗаполнения = "2026Кв1" Тогда
	...
	Если ПараметрыЗаполнения = "2026Кв1" Тогда
		СтруктураПоказателей.П000300011805 = СтруктураПоказателей.П000300000305
			+ СтруктураПоказателей.П000300000505
			+ СтруктураПоказателей.П000300001005
...
Функция МакетыРасшифровкиПолей2015Кв1(Организация, Период)
	...
	МакетыРасшифровки.Вставить("П000300008005", "РасшифровкаВосстановлениеНДС");
	...
	МакетыРасшифровки.Вставить("П000300010005", "РасшифровкаВосстановлениеНДС");
	...
	Если РаздельныйУчетНДС Тогда
		...
		// Раздел 5
		МакетыРасшифровки.Вставить("П000500004003", "РасшифровкаНачислениеРеализация0"); 
		МакетыРасшифровки.Вставить("П000500005003", "РасшифровкаВычетПоПриобретеннымЦенностям0");
		МакетыРасшифровки.Вставить("П000500006003", "РасшифровкаНачислениеРеализация0"); 
		МакетыРасшифровки.Вставить("П000500007003", "РасшифровкаВычетПоПриобретеннымЦенностям0");
...
Функция МакетыРасшифровкиПолей2017Кв1(Организация, Период)
	...
	// который расшифровывает строку 130 прежней формы декларации.
	МакетыРасшифровки.Вставить("П000300012003", "РасшифровкаСтроки130Декларации");
	МакетыРасшифровки.Вставить("П000300012503", "РасшифровкаСтроки125Декларации");
	// Вычет с авансов выданных.
	МакетыРасшифровки.Вставить("П000300013003", "РасшифровкаВычетАвансыВыданныеУпрощенныйУчетНДС");
	// Вычет по СМР хоз. способом.
	МакетыРасшифровки.Вставить("П000300014003", "РасшифровкаВычетПриобретенныеЦенности");
...
Функция МакетыРасшифровкиПолей2019Кв1(Организация, Период)
	...
	МакетыРасшифровки.Вставить("П000500006003", "РасшифровкаНачислениеРеализация0"); 
	МакетыРасшифровки.Вставить("П000500007003", "РасшифровкаВычетПоПриобретеннымЦенностям0");
	МакетыРасшифровки.Вставить("П000500008003", "РасшифровкаВычетПоПриобретеннымЦенностям0");
	МакетыРасшифровки.Вставить("П000500009003", "РасшифровкаВычетПоПриобретеннымЦенностям0");
...
Функция МакетыРасшифровкиПолей2025Кв1(Организация, Период)
	...
	Иначе
		...
		МакетыРасшифровки.Вставить("П000300002103", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300002105", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300002203", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300002205", "РасшифровкаНачислениеРеализация");
		
		МакетыРасшифровки.Вставить("П000300003003", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300003005", "РасшифровкаНачислениеРеализация");
		
		МакетыРасшифровки.Вставить("П000300003303", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300003305", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300003403", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300003405", "РасшифровкаНачислениеРеализация");
...
Функция МакетыРасшифровкиПолей2026Кв1(Организация, Период)
	...
	Если РаздельныйУчетНДС Тогда
		...
		МакетыРасшифровки.Вставить("П000300000303", "РасшифровкаНачислениеРеализацияСложныйУчетНДС");
		МакетыРасшифровки.Вставить("П000300000503", "РасшифровкаНачислениеРеализацияСложныйУчетНДС");
		МакетыРасшифровки.Вставить("П000300000703", "РасшифровкаНачислениеРеализацияСложныйУчетНДС");
	...
	Иначе
		...
		МакетыРасшифровки.Вставить("П000300000303", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300000503", "РасшифровкаНачислениеРеализация");
		МакетыРасшифровки.Вставить("П000300000703", "РасшифровкаНачислениеРеализация");
...
#Область ОтченостьИмпортЭкспортТоваров

Процедура ЗаполнитьРеквизитыТаможеннойДекларации(СтрокаДокумента, СтрокаВыгрузки) Экспорт
	...
	Если МассивСлов.Количество() = 4 Тогда
		...
		СтрокаВыгрузки.НомерДекларацииНаТовары = СтрЗаменить(СтрокаДокумента.НомерТаможеннойДекларации, "/" + МассивСлов[3], "");
	ИначеЕсли ЗначениеЗаполнено(СтрокаВыгрузки.КодТО)
		...
		СтрокаВыгрузки.НомерДекларацииНаТовары = СтрокаДокумента.НомерТаможеннойДекларации;
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьСведенияОПроизводителе(СтрокаДокумента, СтрокаВыгрузки, Правила891, Дата) Экспорт
...
Процедура ЗаполнитьСведенияОМаркируемыхТоварах(СтрокаДокумента, СтрокаВыгрузки, Правила891, ШтрихкодыУпаковок) Экспорт
	
	Если Не Правила891 Тогда
		Возврат;
	КонецЕсли;

	СтруктураПоиска = Новый Структура("ДокументСсылка,Номенклатура,НомерСтроки",
		СтрокаДокумента.ДокументСсылка, СтрокаДокумента.Номенклатура, СтрокаДокумента.НомерСтроки);
...
Функция ЗаполнитьТаблицуОКАТО(ДляОтчета = Истина) Экспорт
	
	МакетПоказателей = Отчеты.РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС.ПолучитьМакет("СпискиАналогЛК");
	ОбластьОКАТО = МакетПоказателей.ПолучитьОбласть("ОКАТО");
	
	Если ДляОтчета Тогда
		ТаблицаОКАТО = Новый ТаблицаЗначений;
		ТаблицаОКАТО.Колонки.Добавить("Код");
		ТаблицаОКАТО.Колонки.Добавить("КодРегиона");
	Иначе
		ТаблицаОКАТО = Новый ТаблицаЗначений;
		ТаблицаОКАТО.Колонки.Добавить("Код");
		ТаблицаОКАТО.Колонки.Добавить("Наименование");
	КонецЕсли;
	
	КолвоСтрок = ОбластьОКАТО.ВысотаТаблицы;
	Для Стр = 2 По КолВоСтрок Цикл
		НоваяСтрока = ТаблицаОКАТО.Добавить();
		НоваяСтрока.Код = ОбластьОКАТО.Область(Стр, 1).Текст;
		Если ДляОтчета Тогда 
			НоваяСтрока.КодРегиона = ОбластьОКАТО.Область(Стр, 3).Текст;
		Иначе
			НоваяСтрока.Наименование = ОбластьОКАТО.Область(Стр, 2).Текст;
		КонецЕсли;
	КонецЦикла;
	
	Если Не ДляОтчета Тогда
		ТаблицаОКАТО.Сортировать("Код");
		Для Каждого Строка Из ТаблицаОКАТО Цикл
			Дубли = ТаблицаОКАТО.НайтиСтроки(Новый Структура ("Код", Строка.Код));
			КоличествоДублей = Дубли.Количество();
			Если КоличествоДублей > 0 Тогда
				Сч = 0;
				Пока Сч < КоличествоДублей -1 Цикл
					ТаблицаОКАТО.Удалить(Дубли[Сч]);
					Сч = Сч +1;
				КонецЦикла;
			КонецЕсли;
		КонецЦикла;
		...
		Пока ВыборкаКодОперации.Следующий() Цикл
			...
			Пока ВыборкаДекларация.Следующий() Цикл
				...
				ИначеЕсли ВключатьСведенияОКонтракте Тогда
					...
					ВыборкаКонтракт = ВыборкаДекларация.Выбрать();
					Пока ВыборкаКонтракт.Следующий() Цикл
						...
						ВыборкаКонтракт.НомерКонтракта, ВыборкаКонтракт.ДатаКонтракта);
...
Функция ОсновныеСведенияЭлектронногоПредставления(ВыгружаемыйДокумент, КНД)
	...
	Если ЭтоПБОЮЛ Тогда
		...
		СведенияОЮрФизЛице  = БухгалтерскийУчетПереопределяемый.СведенияОЮрФизЛице(
			...
			НалоговыйПериод);
		СвидетельствоОРегистрации = БухгалтерскийУчетПереопределяемый.СвидетельствоОРегистрации(
			СведенияОЮрФизЛице,
			НалоговыйПериод);
