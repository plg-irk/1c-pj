...
//	Если выбранный график не заполнен, и ВызыватьИсключение = Ложь, возвращается Неопределено.
//
Функция ДатыБлижайшихРабочихДней(График, НачальныеДаты, ПолучатьПредшествующие = Ложь, ВызыватьИсключение = Истина, ИгнорироватьНезаполненностьГрафика = Ложь) Экспорт
...
// Устарела. См. функцию ДатыПоКалендарю
//
...
// Устарела. См. функцию ДатаПоКалендарю.
//
...
// Устарела. См. функцию РазностьДатПоКалендарю
//
...
// Устарела. См. функцию ДатыБлижайшихРабочихДней
//
