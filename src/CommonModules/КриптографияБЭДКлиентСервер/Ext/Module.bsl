...
Функция ПроверитьКритерииКвалификацииСертификатаСотрудника(Сертификат, Контекст)
	...
	Если ЭтоСертификатСотрудника(Сертификат, Контекст) Тогда
		//Заглушка для тестовых сертификатов
		Попытка
			ТестовыйСертификат = Сертификат.Субъект.E = "testtaxcom@testtaxcom.ru";
		Исключение
			ТестовыйСертификат = Ложь;
		КонецПопытки;
		Если ТестовыйСертификат Тогда
			КритерииСертификатаСотрудника.Вставить("ВыданДо31082023", Истина);
			КритерииСертификатаСотрудника.Вставить("ИспользуетсяДо01092024", Истина);
		Иначе
...
// Возвращаемое значение:
//  Булево
Функция ВсеКритерииКвалификацииПройдены(Протокол) Экспорт
...
Функция НовыеСвойстваПодписи() Экспорт
	...
	СвойстваПодписи.Вставить("Протокол", Неопределено);
...
Функция ВидОшибкиКриптография() Экспорт
	...
	ВидОшибки.Идентификатор = ИдентификаторВидаОшибкиКриптография();
...
// Возвращаемое значение:
//  Строка
Функция ИдентификаторВидаОшибкиКриптография() Экспорт
	
	Возврат "ОшибкаКриптографии";
	
КонецФункции

// Возвращает вид ошибки, описывающий ситуацию, когда сертификатом нельзя подписать документ данного вида (без решения).
// (В списке "Подписываемые виды документов" нет данного вида документа).
// 
// Возвращаемое значение:
// 	См. ОбработкаНеисправностейБЭДКлиентСервер.НовоеОписаниеВидаОшибки
Функция ВидОшибкиДляСертификатаНетПодписываемогоВидаДокументаБезРешения() Экспорт
	
	ВидОшибки = ОбработкаНеисправностейБЭДКлиентСервер.НовоеОписаниеВидаОшибки();
	ВидОшибки.Идентификатор = ИдентификаторОшибкиДляСертификатаНетПодписываемогоВидаДокумента();
...
// Возвращаемое значение:
//  Строка
Функция ИдентификаторОшибкиДляСертификатаНетПодписываемогоВидаДокумента() Экспорт
