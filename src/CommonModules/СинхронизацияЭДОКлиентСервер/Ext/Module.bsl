...
Функция НовыйКлючСинхронизации() Экспорт
	...
	КлючСинхронизации.Вставить("ДатаОкончанияДействияМаркера", Дата(1, 1, 1));
...
Функция ВидОшибкиЕстьУчетныеЗаписиБезСертификатов(Операция = "") Экспорт
	...
	ВидОшибки = ОбработкаНеисправностейБЭДКлиентСервер.НовоеОписаниеВидаОшибки();
	ВидОшибки.Идентификатор = ИдентификаторОшибкиЕстьУчетныеЗаписиБезСертификатов();
...
// Возвращает вид ошибки, при отсутствии сертификатов у учетной записи (без решения).
// 
// Возвращаемое значение:
// 	См. ОбработкаНеисправностейБЭДКлиентСервер.НовоеОписаниеВидаОшибки
Функция ВидОшибкиЕстьУчетныеЗаписиБезСертификатовБезРешения() Экспорт
...
// Возвращаемое значение:
//  Строка
Функция ИдентификаторОшибкиЕстьУчетныеЗаписиБезСертификатов() Экспорт
