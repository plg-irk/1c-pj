...
//  * ВидОперацииЭДО - Строка - см. УчетныеЗаписиЭДОКлиентСервер.ДействиеОбновлениеСертификата,
//                              см. УчетныеЗаписиЭДОКлиентСервер.ДействиеПодключениеЭДО
Функция НовыеПараметрыРегистрацииВСервисе1СЭДО() Экспорт
	...
	ПараметрыРегистрации.Вставить("ВидОперацииЭДО", "");
