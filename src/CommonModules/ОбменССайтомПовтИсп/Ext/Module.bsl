...
//
// Параметры:
//	Объект - СправочникСсылка, ДокументСсылка - произвольный ссылочный тип.
...
//
// Параметры:
//  Узел - ПланОбменаСсылка - ссылка на план обмена.
//  ИмяРеквизита - Строка - имя реквизита, добавленного на форму.
//
// Возвращаемое значение:
//  ПараметрПрикладногоРешения - Значение реквизита, которое было выбрано в форме узла.
//
