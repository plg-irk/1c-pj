...
Процедура ОтразитьДокументВУчете(ОповещениеОкончанияОтраженияВУчете, ОписаниеПакета, ОбъектыУчета, Контрагент, СпособОбработки,
	СпособОбмена = Неопределено) Экспорт
	...
	ДанныеДокументооборота.СпособОбмена = СпособОбмена;
