...
Функция ДанныеПредварительногоПросмотра(ОписаниеОбъектаУчета, НастройкиФормированияПоОбъектуУчета,
	...
	НастройкиОтправкиОбъектов = ЭлектронныеДокументыЭДО.НовыеНастройкиОтправкиОбъектовУчетаСМножественнымиОписаниями();
	Для Каждого Описание Из ОписаниеОбъектаУчета Цикл
		ЕстьОписаниеОбъектаУчета = Истина;
		НастройкиОтправкиОбъекта = НастройкиОтправкиОбъектов.Добавить();
		ЗаполнитьЗначенияСвойств(НастройкиОтправкиОбъекта, Описание);
		ЗаполнитьЗначенияСвойств(НастройкиОтправкиОбъекта, НастройкиФормированияПоОбъектуУчета.НастройкиОтправки);
	КонецЦикла;
	
	КонтекстДиагностики = ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики();
	
	ДанныеДляСозданияДокументовЭДО = ЭлектронныеДокументыЭДОИнтеграцияЦентраЭДО.ДанныеДляФормированияДокументовЭДО(
		НастройкиОтправкиОбъектов, КонтекстДиагностики, ПараметрыОткрытия);
	...
	Если Не ЗначениеЗаполнено(ДанныеДляСозданияДокументовЭДО.ДанныеДокументовЦентраЭДО) Тогда
	...
	ДанныеДокументаЦентраЭДО = ДанныеДляСозданияДокументовЭДО.ДанныеДокументовЦентраЭДО[0];
	
	УчетнаяЗаписьЦентраЭДО = РегистрыСведений.НастройкиИнтеграцииЦентраЭДО.УчетнаяЗаписьЦентраЭДО(
		ДанныеДокументаЦентраЭДО.ИдентификаторОтправителя);
	...
	ОписаниеМетода = ИнтеграцияЦентраЭДО.ОписаниеМетодаСервиса("СформироватьФайлыИВизуализациюДокументаЭДО",
		ДанныеДокументаЦентраЭДО, ПараметрыВизуализации);

	РезультатВыполнения = ИнтеграцияЦентраЭДО.ВыполнитьМетодСервиса(ПараметрыВыполнения, ОписаниеМетода,
		КонтекстДиагностики); // См. ПрограммныйИнтерфейсЦентраЭДОВерсия3.СформироватьФайлыИВизуализациюДокументаЭДО
	...
	Если Не ЗначениеЗаполнено(РезультатВыполнения) 
		...
		РезультатПодготовкиДанных.ОписанияОшибок.Добавить(ОписаниеОшибки);
		Если ОписаниеОшибки.ОшибкаПодготовкиДанныхВИнтеграцииЦентраЭДО 
...
//
// Параметры:
//  СвойстваВизуализацииВФорматеСервиса - См. ПрограммныйИнтерфейсЦентраЭДОВерсия3.ВизуализацияДокументаЭДО
// 
// Возвращаемое значение:
...
//  * ОписаниеДокументаЭДО - см. ЭлектронныеДокументыЭДОИнтеграцияЦентраЭДО.НовоеОписаниеДокументаЭДО
...
//  * Визуализация - см. РегистрыСведений.ВизуализацииДокументовЦентраЭДО.НовыеСвойстваВизуализации
...
//  					- см. ИнтерфейсДокументовЭДОЦентрЭДО.СформироватьФайлыИВизуализациюДокументаЭДО
//  ОписаниеДокументаЭДО - см. ЭлектронныеДокументыЭДОИнтеграцияЦентраЭДО.НовоеОписаниеДокументаЭДО
// 
// Возвращаемое значение:
...
Функция ОбработатьОшибкуПодготовкиДанных(РезультатВыполнения, ОписаниеДокументаЭДО)
	...
	ОписаниеОшибки.ОшибкаПодготовкиДанныхВИнтеграцииЦентраЭДО = Истина;
	...
	Если ЭтоОшибкаЗаполненияУчетногоДокумента Тогда
		...
		ОписаниеОшибки.ОшибкаПодготовкиДанныхВИнтеграцииЦентраЭДО = Ложь;
	КонецЕсли;
	Возврат ОписаниеОшибки;
КонецФункции
