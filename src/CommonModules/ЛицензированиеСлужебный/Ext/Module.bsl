...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("РежимОтладкиЗащиты",                "ЛицензированиеСлужебный.УстановкаПараметровСеанса");
...
Процедура УстановкаПараметровСеанса(Знач ИмяПараметра, УстановленныеПараметры) Экспорт
	...
	Если НЕ(ИмяПараметра="ТекущийАдресСервераЛицензирования" ИЛИ ИмяПараметра="АдресСервераЛицензирования" ИЛИ ИмяПараметра="СписокСертификатов" ИЛИ ИмяПараметра="МестоХраненияКомпоненты" ИЛИ ИмяПараметра="ВключенаЗащитаОтОпасныхДействий" ИЛИ ИмяПараметра="РежимОтладкиЗащиты") Тогда
		Возврат;
	КонецЕсли;
	...
	УстановленныеПараметры.Добавить("РежимОтладкиЗащиты");
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Для Каждого АдресСервера Из ЛицензированиеСервер.СписокАдресовСервераЛицензирования() Цикл
