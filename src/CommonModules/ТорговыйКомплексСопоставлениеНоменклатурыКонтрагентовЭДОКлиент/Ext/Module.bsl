...
// ОбщийМодуль.ТорговыйКомплексСопоставлениеНоменклатурыКонтрагентовЭДОКлиент.
////////////////////////////////////////////////////////////////////////////////
...
Процедура ПриСозданииНоменклатурыПоДаннымКонтрагента(Знач НаборНоменклатурыКонтрагентов, Знач ОповещениеОЗавершении, 
	Контекст, СтандартнаяОбработка = Истина) Экспорт
...
Процедура ОткрытьФормуВыбораНоменклатурыКонтрагента(ВладелецФормы, Контрагент, ТекущаяСтрока, 
	...
	ПараметрыОтбора.Вставить("Характеристика"      , ТекущаяСтрока.ХарактеристикаНоменклатуры);
...
Процедура ПриИзмененииНоменклатурыКонтрагента(СтрокаТовара, ИзмененныеРеквизиты = Неопределено) Экспорт
	...
	ДанныеНоменклатурыКонтрагента = ТорговыйКомплексСопоставлениеНоменклатурыКонтрагентовЭДОВызовСервера.ДанныеНоменклатурыКонтрагента(
	...
	Если Не СтрокаТовара.ХарактеристикаНоменклатуры = ДанныеНоменклатурыКонтрагента.Характеристика Тогда
		СтрокаТовара.ХарактеристикаНоменклатуры = ДанныеНоменклатурыКонтрагента.Характеристика;
...
Процедура ВыполнитьСозданиеНоменклатурыПоДаннымКонтрагента(Знач ПроцессВыполнения, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	СозданнаяНоменклатура = ТорговыйКомплексОбменСКонтрагентамиЭДОВызовСервера.СоздатьНоменклатуруПоДаннымКонтрагента(
		ПроцессВыполнения.Параметры.НаборНоменклатурыКонтрагентов, ВыбранныеЗначения,
		ПроцессВыполнения.Параметры.Контекст);
...
Процедура НачатьВыборЗначенийДляСозданияНоменклатуры(Знач Значения, ПроцессВыполнения)
	...
	ОткрытьФорму("Справочник.Номенклатура.Форма.ФормаПолейДобавления",
