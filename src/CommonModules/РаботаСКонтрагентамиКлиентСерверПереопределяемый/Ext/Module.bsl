...
Процедура ОпределитьСвойстваСправочникаКонтрагенты(СвойстваСправочника) Экспорт
	...
	// +РАРУС
	Если ТипЗнч(СвойстваСправочника) = Тип("Структура") Тогда
...
//  ПредставлениеРезультатаПроверки - ФорматированнаяСтрока, ПустаяСтрока - представление результата проверки
//                                    контрагента.
