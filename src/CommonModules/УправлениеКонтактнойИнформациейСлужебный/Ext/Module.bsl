...
Функция НайтиПодстрокуЦифр(Текст, ПозицияНачала = Неопределено, ДопустимоКромеЦифр = "")
	...
	Пока ПозицияНачала <= ПозицияКонца Цикл
		...
		Если ПозицияНачала = 2 Тогда
			Если НЕ ЭтоЦифра Тогда
				ПозицияНачала = 5;
				Прервать;
			КонецЕсли;
		ИначеЕсли ПозицияНачала = 5 И НЕ Символ = "(" И НЕ Символ = " " Тогда // РАРУС
			Если НЕ ЭтоЦифра Тогда
				ПозицияНачала = 10;
				Прервать;
			КонецЕсли;
		ИначеЕсли ПозицияНачала = 10 И НЕ Символ = ")" И НЕ Символ = " " Тогда // РАРУС
			Если НЕ ЭтоЦифра Тогда
				ПозицияНачала = 23;
				Прервать;
			КонецЕсли;
		ИначеЕсли ПозицияНачала = 23 Тогда
			Если НЕ ЭтоЦифра Тогда
				Прервать;
			КонецЕсли;
		КонецЕсли;
...
//
// +РАРУС
Функция ЭтоСтрокаXML(Текст) Экспорт // -РАРУС
