...
Функция ДанныеАбонентовИзСервисаНастроек(Отбор, КонтекстДиагностики, Отказ = Ложь) Экспорт
	...
	ТребуетсяЗагружатьПоддерживаемыеФорматыАбонентов =
		НастройкиЭДО.ИспользоватьПроверкуПоддерживаемыхАбонентамиФорматовЭДО();
	...
	Если ЗначениеЗаполнено(Абоненты) Тогда
		...
		Для Каждого СтрокаАбонент Из Абоненты Цикл
			...
			Попытка
				...
				Если ТребуетсяЗагружатьПоддерживаемыеФорматыАбонентов Тогда
					ЗаписатьФорматыПоддерживаемыеАбонентом(СтрокаАбонент);
				КонецЕсли;
...
// Параметры:
//  СтрокаАбонент - Строка Из См. СервисНастроекЭДО.ДанныеАбонентовИзСервисаНастроек
Процедура ЗаписатьФорматыПоддерживаемыеАбонентом(СтрокаАбонент)
