...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если ЕстьИнтеграцияСЯндексКассой
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ПолучениеУведомленийОтЯндексКассы", "Видимость", 
...
Процедура УстановитьНастройкиЗаданий()
	...
	Если Не ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		...
		Если ЕстьИнтеграцияСЯндексКассой Тогда
			...
			ЗаданиеПолучениеУведомленийОтЯндексКассы = Метаданные.РегламентныеЗадания.Найти("ПолучениеУведомленийОтЯндексКассы");
			ИспользоватьПолучениеУведомленийОтЯндексКассы = РегламентныеЗаданияСервер.РегламентноеЗаданиеИспользуется(ЗаданиеПолучениеУведомленийОтЯндексКассы);
			РасписаниеПолученияУведомленийОтЯндексКассы = РегламентныеЗаданияСервер.РасписаниеРегламентногоЗадания(ЗаданиеПолучениеУведомленийОтЯндексКассы);
			Элементы.ПолучениеУведомленийОтЯндексКассы.Доступность = ИспользоватьПолучениеУведомленийОтЯндексКассы;
	...
	Иначе
		...
		Элементы.ГруппаНастройкиИнтеграцияСЯндексКассой.Видимость = Ложь;
	КонецЕсли;
