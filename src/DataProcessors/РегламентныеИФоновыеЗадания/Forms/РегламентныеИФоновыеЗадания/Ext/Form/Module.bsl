...
Процедура ТаблицаРегламентныеЗаданияПриАктивизацииСтроки(Элемент)
	...
	Если НЕ Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные = Неопределено Тогда
		Элементы.ТаблицаРегламентныеЗадания.КоманднаяПанель.ПодчиненныеЭлементы.ТаблицаРегламентныеЗаданияНастройкаРегламентногоЗадания.Доступность = Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные.ЕстьФормаНастройки;
	КонецЕсли;
...
// +РАРУС
&НаКлиенте
Процедура НастройкаРегламентногоЗадания(Команда)
	
	ПараметрыФормы         = Новый Структура;
	ТекРегламентноеЗадание = Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные.Имя;
	ПараметрыФормы.Вставить("ИдентификаторЗадания",     Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные.Идентификатор);
	ПараметрыФормы.Вставить("НаименованиеОборудования", Элементы.ТаблицаРегламентныеЗадания.ТекущиеДанные.Наименование);
	
	ОткрытьФорму("Обработка.РегламентныеИФоновыеЗадания.Форма.НастройкаРегламентногоЗадания" + ТекРегламентноеЗадание, ПараметрыФормы, ЭтаФорма, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
