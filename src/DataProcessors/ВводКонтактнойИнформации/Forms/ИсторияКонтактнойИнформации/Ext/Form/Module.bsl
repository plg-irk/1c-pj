...
Процедура ИсторияАдресНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	Если РежимВыбора Тогда
		СформироватьДанные();
	ИначеЕсли ИмяФормыРедактирования = "ВводАдреса" Тогда
...
Процедура ИсторияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если РежимВыбора Тогда
		СформироватьДанные();
	ИначеЕсли Элемент.ТекущийЭлемент.Имя = "ИсторияПредставление" 
		И РедактированиеТолькоВДиалоге
		И ИмяФормыРедактирования = "ВводАдреса" Тогда
			ОткрытьФормуРедактированияАдреса(Элементы.История.ТекущаяСтрока);
	КонецЕсли;
