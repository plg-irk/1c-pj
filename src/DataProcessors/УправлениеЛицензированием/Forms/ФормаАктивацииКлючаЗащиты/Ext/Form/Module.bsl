...
Процедура КомандаАктивироватьВручнуюЗавершение(Существует, ДополнительныеПараметры) Экспорт
	...
	ПотокЧтения.НачатьЧтение(Новый ОписаниеОповещения("КомандаАктивироватьВручнуюЗавершениеЗавершение", ЭтотОбъект, Новый Структура("ПотокЧтения", ПотокЧтения)), ИмяФайлаОтветаАктивации,КодировкаТекста.ANSI);
