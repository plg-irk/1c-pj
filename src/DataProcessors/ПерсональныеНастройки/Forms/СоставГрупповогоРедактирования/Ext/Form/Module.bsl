...
Процедура ПодобратьПользователейГруппы(Команда)
	...
	Иначе
		ОткрытьФорму("Справочник.ГруппыДоступа.ФормаВыбора", ПараметрыФормы,Элементы.ГрупповаяНастройкаПользователиГруппы);
	КонецЕсли;
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ "ГРУППОВАЯ НАСТРОЙКА ПОЛЬЗОВАТЕЛИ ГРУППЫ"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Заголовок = НСтр("ru = 'Редактирование состава групп доступа для групповой настройки прав и настроек'");
	КонецЕсли;
