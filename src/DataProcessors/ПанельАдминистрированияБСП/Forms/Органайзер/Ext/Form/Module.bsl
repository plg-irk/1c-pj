...
&НаКлиенте
Процедура ИспользоватьНапоминанияПоЗаказамОРезервированииПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
...
// +Рарус
// Обработчик события возникающего на клиенте при нажатии на кнопку "Настроить СФ".
//
// Параметры:
//  Команда - КомандаФормы - Команда, в которой возникло данное событие.
//
&НаКлиенте
Процедура НастроитьСФ(Команда)
	
	ОткрытьФорму("ОбщаяФорма.сфпОбщиеНастройки");
	
КонецПроцедуры //НастроитьСФ()
// -Рарус
