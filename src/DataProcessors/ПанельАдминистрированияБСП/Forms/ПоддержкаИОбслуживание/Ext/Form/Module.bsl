...
// +Рарус
// Обработчик события возникающего на клиенте при нажатии на надпись "Настройка выгрузки во внешнюю БД".
//
// Параметры:
//  Элемент - ТаблицаФормы - Элемент управления, в котором возникло данное событие.
//
&НаКлиенте
Процедура НастройкаВыгрузкиВоВнешнююБДНажатие(Элемент)
	
	ОткрытьФорму("Обработка.ЖурналВерсийОбъектов.Форма.НастройкаПараметровВерсионирования");
	
КонецПроцедуры //НастройкаВыгрузкиВоВнешнююБДНажатие()

// Обработчик события возникающего на клиенте при нажатии на надпись "Ссылка на журнал версий".
//
// Параметры:
//  Элемент - ТаблицаФормы - Элемент управления, в котором возникло данное событие.
//
&НаКлиенте
Процедура СсылкаНаЖурналВерсийНажатие(Элемент)
	
	ОткрытьФорму("Обработка.ЖурналВерсийОбъектов.Форма.ФормаОсновная");
	
КонецПроцедуры //СсылкаНаЖурналВерсийНажатие()

// Обработчик события возникающего на клиенте при нажатии на кнопку "Настроить подключаемое оборудование".
//
// Параметры:
...
Процедура НастроитьПодключаемоеОборудование(Команда)
	...
	ОткрытьФорму("Справочник.ПодключаемоеОборудование.ФормаСписка", ПараметрыФормы, ЭтотОбъект, ЭтотОбъект.УникальныйИдентификатор);
	
КонецПроцедуры //НастроитьПодключаемоеОборудование()

// Обработчик события возникающего на клиенте при нажатии на кнопку "Электронные чеки".
//
// Параметры:
//  Команда - КомандаФормы - Команда, в которой возникло данное событие.
//
&НаКлиенте
Процедура ЭлектронныеЧеки(Команда)
		
	ПараметрыФормы = Новый Структура();
	ОткрытьФорму("Обработка.ПанельАдминистрированияБСП.Форма.ФЗ54", ПараметрыФормы, ЭтотОбъект, ЭтотОбъект.УникальныйИдентификатор);

КонецПроцедуры //ЭлектронныеЧеки()

// Обработчик события возникающего на клиенте при нажатии на кнопку "Настроить значимые события".
//
// Параметры:
//  Команда - КомандаФормы - Команда, в которой возникло данное событие.
//
&НаКлиенте
Процедура НастроитьЗначимыеСобытия(Команда)
	
	ОткрытьФорму("Справочник.ЗначимыеСобытия.ФормаСписка");
	
КонецПроцедуры //НастроитьЗначимыеСобытия()
// -Рарус
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	// +Рарус
	Элементы.ЭлектронныеЧеки.Доступность = НаборКонстант.ИспользоватьПодключаемоеОборудование;
	Элементы.ГруппаПодключаемоеОборудованиеПраво.Доступность = НаборКонстант.ИспользоватьПодключаемоеОборудование;	
	// -Рарус
				...
				Если ТипЗнч(Прогресс) = ТипСтруктура Тогда
					...
					Если Прогресс.Свойство("ДополнительныеПараметры")
						...
						Если Прогресс.ДополнительныеПараметры.Свойство("КодСостояния") Тогда
							Если Прогресс.ДополнительныеПараметры.КодСостояния = НСтр("ru = 'Завершено без ошибок'") Тогда // Идентификатор.
							...
							ИначеЕсли Прогресс.ДополнительныеПараметры.КодСостояния = НСтр("ru = 'Завершено с ошибками'") Тогда // Идентификатор.
