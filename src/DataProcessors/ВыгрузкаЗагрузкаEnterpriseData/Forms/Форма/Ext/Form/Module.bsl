...
Процедура УстановитьВидимость()
	...
	Если ВидОперации = "Выгрузка" Тогда
		...
		Элементы.ПутьКМенеджеруОбменаВыгрузки.Видимость = РежимРазработчика И НЕ РежимРаботы.МодельСервиса;
	...
	Иначе
		Элементы.ПутьКМенеджеруОбменаЗагрузки.Видимость = РежимРазработчика И НЕ РежимРаботы.МодельСервиса;
