...
//           ** Родитель     - Произвольный - Родитель группы дублей. Если Родитель пустой,
//                                            то элемент является родителем группы дублей.
...
Функция ОбъектВТаблицуЗначений(Знач ОбъектДанных, Знач РасшифровкаДополнительныхПолей)
	...
	Для Каждого МетаРеквизит Из Метаданные.ОбщиеРеквизиты Цикл
		ЗначениеСостава = МетаРеквизит.Состав.Найти(МетаОбъект);
