...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПолноеИмяФайлаЖурнала  = ФайлТехнологическийЖурнал(ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "ИдентификаторПроцессаОС"),
														ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Параметры, "КаталогСЛогФайлами"));
...
Функция ДанныеИзТехнологическогоЖурналаПрочитаны(ПолноеИмяФайлаЖурнала)
	...
	Если ТипСУБД = "DBMSSQL" Тогда 
		...
		Элементы.ГруппаПланВыполненияЗапроса.ТекущаяСтраница = Элементы.ГруппаПланВыполненияЗапросаСКЛСервер;
