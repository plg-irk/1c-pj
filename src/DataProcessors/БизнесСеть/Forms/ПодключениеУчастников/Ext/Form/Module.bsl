...
Процедура ПодключитьПослеПроверкиАутентификации(Знач ПараметрыАутентификации, Контекст) Экспорт
	...
	ПодключитьОрганизации(ТребуетсяОбновитьИнтерфейс, Отказ);
...
&НаСервере
Процедура ПодключитьОрганизации(ТребуетсяОбновитьИнтерфейс, Отказ)
	...
	БизнесСеть.ПодключитьОрганизации(МассивСсылок, Отказ, ТребуетсяОбновитьИнтерфейс);
