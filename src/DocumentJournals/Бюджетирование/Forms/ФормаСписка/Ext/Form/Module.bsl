// Модуль формы списка документа "Бюджетирование"


////////////////////////////////////////////////////////////////////////////////
// СЛУЖЕБНЫЕ ПРОЦЕДУРЫ И ФУНКЦИИ

// Установка отборов при выборе документа основания с дополнительных форм бюджетных документов.
//
&НаСервере
Процедура УстановитьОтборыДляВыбораДокументаОснование()
	
	// установим отборы по списку для выбора документа основания бюджета закупок
	Если Параметры.Свойство("ОтборДатаКонца") Тогда
		НовыйЭлементОтбора = ЭтотОбъект.Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		НовыйЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ДатаПланирования");
		НовыйЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.МеньшеИлиРавно;
		НовыйЭлементОтбора.Использование = Истина;
		НовыйЭлементОтбора.ПравоеЗначение = Параметры.ОтборДатаКонца;
	КонецЕсли;
	...
	Если Параметры.Свойство("ОтборДокументИсключение") Тогда
		...
		НовыйЭлементОтбора.Использование = Истина;
		НовыйЭлементОтбора.ПравоеЗначение = Параметры.ОтборДокументИсключение;
	КонецЕсли;
	
	Если Параметры.Свойство("ОтборПоСценариюПланирования") Тогда
		НовыйЭлементОтбора = ЭтотОбъект.Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		НовыйЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("СценарийПланирования");
		НовыйЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
		НовыйЭлементОтбора.Использование = Истина;
		НовыйЭлементОтбора.РежимОтображения = РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный;
		НовыйЭлементОтбора.ПравоеЗначение = Параметры.ОтборПоСценариюПланирования;
	КонецЕсли;
	
	Если Параметры.Свойство("ОтборПоХозОперации") Тогда
		НовыйЭлементОтбора = ЭтотОбъект.Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		НовыйЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ХозОперация");
		НовыйЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
		НовыйЭлементОтбора.Использование = Истина;
		НовыйЭлементОтбора.РежимОтображения = РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Обычный;
		НовыйЭлементОтбора.ПравоеЗначение = Параметры.ОтборПоХозОперации;
	КонецЕсли;
	
КонецПроцедуры // УстановитьОтборыДляВыбораДокументаОснование()
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Установим отборы при вызове данной формы из дополнительных форм выбора документа основания.
	УстановитьОтборыДляВыбораДокументаОснование();
