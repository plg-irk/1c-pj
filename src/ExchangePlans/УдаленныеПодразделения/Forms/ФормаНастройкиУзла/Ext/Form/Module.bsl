...
Процедура КомандаОК(Команда)
	...
	Если СписокНайденныхДублей.Количество() > 0 Тогда
		...
		ВывестиСообщение(НСтр("ru = 'Строки таблицы ""Подразделения"" не уникальны по значению поля ""Подразделение компании""'"),Подразделения, "ПодразделениеКомпании",, Отказ);
	...
	Если НайденныеСтроки.Количество() > 0 Тогда
		...
		// Информируем пользователя о найденной коллизии
		ВывестиСообщение(НСтр("ru = 'Не заполнена колонка ""Подразделения компании"" в списке ""Подразделения""'"),Подразделения, "ПодразделениеКомпании",, Отказ);
