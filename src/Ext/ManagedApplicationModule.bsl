...
Процедура ПриВыбореДействияСообщенияСистемыВзаимодействия(Сообщение, Действие)
	...
	ОповещенияПлатформыСамозанятыеКлиент.ПриВыбореДействияСообщенияСистемыВзаимодействия(Сообщение, Действие);
...
Процедура ОбработкаФормированияКомандВходящегоЗапросаПоделиться(ДанныеЗапросаПоделиться, Команды)
	...
	ОбработчикКоманды = Новый ОписаниеОповещения("ОбработкаЗагрузитьВыпискуПоделиться", ВходящиеПоделитьсяКлиент, ДанныеЗапросаПоделиться);
	
	//Удалим стандартные команды
	Команды.Очистить();
	
	Команда = Новый ОписаниеКомандыВходящегоЗапросаПоделиться(ОбработчикКоманды, "Загрузить выписку");
