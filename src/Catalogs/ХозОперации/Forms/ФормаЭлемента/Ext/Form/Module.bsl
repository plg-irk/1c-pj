// Модуль формы элемента справочника "Хоз операции"
...
Процедура ПриОткрытии(Отказ)
	...
	// Произведем настройку параметров отображения кнопок командной панели списка Виды номенклатуры И Виды договоров.
	ЗащищенныеФункцииКлиент.НастроитьЭлементФормыТабличнойЧасти(ЭтотОбъект, "ВидыНоменклатуры");
	ЗащищенныеФункцииКлиент.НастроитьЭлементФормыТабличнойЧасти(ЭтотОбъект, "ВидыДоговоров");
