...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПравоДоступа("ИнтерактивноеДобавление", Метаданные.Справочники.ит_КлассификаторОКПД2) Тогда
...
Процедура ПодборИзКлассификатора(Команда)
	...
	ОткрытьФорму("Справочник.ит_КлассификаторОКПД2.Форма.ФормаПодбораКлассификатора", ПараметрыФормы, , , , , ОповещениеОЗакрытии);
...
Функция ДобавитьЭлементКлассификатора(Код, Наименование)
	...
	Если НЕ ЗначениеЗаполнено(Код) Тогда
		Возврат Справочники.ит_КлассификаторОКПД2.ПустаяСсылка();
	КонецЕсли;
