...
Функция ЗаполнитьКодыРазделов()
	...
	Разделы.Загрузить(Справочники.ит_КлассификаторОКПД2.ТаблицаРазделов());
...
Функция ТаблицаКлассификатора(Раздел, ДобавитьДанныеПоиска)
	...
	Иначе
		ТекстКлассификатора = Справочники.ит_КлассификаторОКПД2.ТекстКлассификатора();
	...
	Возврат Справочники.ит_КлассификаторОКПД2.ТаблицаКлассификатора(ТекстКлассификатора, КодыГруппРаздела, ДобавитьДанныеПоиска);
...
Процедура ОтобразитьНайденные()
	...
	Если ОтобразитьНайденные Тогда
		...
		КлассификаторСОтбором = Справочники.ит_КлассификаторОКПД2.НайтиВКлассификаторе(СтрокаПоиска, ТаблицаПоиска);
