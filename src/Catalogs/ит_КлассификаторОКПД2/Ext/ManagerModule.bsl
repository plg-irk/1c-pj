...
//  КлассификаторОКПД2   - ТаблицаЗначений - Таблица классификатора ОКПД2. Структуру см. в Справочники.ит_КлассификаторОКПД2.ТаблицаКлассификатора().
// 
...
Функция НайтиВКлассификаторе(СтрокаПоиска, КлассификаторОКПД2) Экспорт
	...
	СхемаКомпоновки = Справочники.ит_КлассификаторОКПД2.ПолучитьМакет("ОтборОКПД2");
...
// 
// Возвращаемое значение:
//   - СправочникСсылка.ит_КлассификаторОКПД2Сп
//
Функция НайтиСоздатьПоКоду(КодКлассификатора) Экспорт
	...
	|ИЗ
	|	Справочник.ит_КлассификаторОКПД2 КАК КлассификаторОКПД2
	|ГДЕ
	...
	НовыйЭлемент = Справочники.ит_КлассификаторОКПД2.СоздатьЭлемент();
...
Функция ТекстКлассификатора() Экспорт
	...
	Возврат Справочники.ит_КлассификаторОКПД2.ПолучитьМакет("КлассификаторОКПД2").ПолучитьТекст();
...
// 
// Параметры:
//  ТекстКлассификатора  - Строка - Данные классификатора в формате XML. См. Справочники.ит_КлассификаторОКПД2.ТекстКлассификатора().
...
Функция ТаблицаКонвертацииОКП_ОКПД2() Экспорт
	...
	ТекстКонвертации = Справочники.ит_КлассификаторОКПД2.ПолучитьМакет("КонвертацияОКП_ОКПД2").ПолучитьТекст();
