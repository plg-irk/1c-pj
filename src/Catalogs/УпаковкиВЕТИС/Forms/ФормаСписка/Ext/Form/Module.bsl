// Модуль формы списка справочника "Упаковки ВЕТИС"
...
Процедура ЗагрузитьУпаковкиНаСервере()
	ИнтеграцияВЕТИС.ЗагрузитьУпаковки();
КонецПроцедуры

&НаКлиенте
Процедура ЗагрузитьУпаковки(Команда)
	ЗагрузитьУпаковкиНаСервере();
	ОповеститьОбИзменении(Тип("СправочникСсылка.УпаковкиВЕТИС"));
КонецПроцедуры
