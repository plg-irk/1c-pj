// Модуль объекта справочника "Правила миграции и доступа"
...
Процедура ПередЗаписью(Отказ)
	...
	Если ВариантНастройки = Перечисления.СпособыМиграцииОбъектов.ИндивидуальнаяНастройкаПоПодразделениямИУзлам 
		И ПодразделенияИнформационныхБаз.Количество() = 0 Тогда
			ВывестиСообщение(НСтр("ru='Не заполнена табличная часть ""Подразделения"".'"),,,,Истина);
	КонецЕсли;
