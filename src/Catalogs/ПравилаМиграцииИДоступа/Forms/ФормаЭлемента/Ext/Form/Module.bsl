// Модуль формы элемента справочника "Правила миграции и доступа"
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "Вариант настройки" в контексте сервера.
//
// Параметры:
//  ПараметрыДействия - Структура - Набор параметров, использующихся при выполнения операции.
//
&НаСервере
Процедура ВариантНастройкиПриИзмененииНаСервере(ПараметрыДействия=Неопределено)
	
	// Вызываем обработчик изменения данных объекта
	Справочники.ПравилаМиграцииИДоступа.ВариантНастройкиПриИзменении(ЭтотОбъект, ПараметрыДействия);
	
КонецПроцедуры // ВариантНастройкиПриИзмененииНаСервере()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Вариант настройки".
//
// Параметры:
...
Процедура ПриОткрытии(Отказ)
	...
	// Произведем настройку параметров отображения кнопок командной панели списка ПрефиксыШК.
	ЗащищенныеФункцииКлиент.НастроитьЭлементФормыТабличнойЧасти(ЭтотОбъект, "ПодразделенияИнформационныхБаз");
	
	// Произведем отображение описания варианта настройки
	ВариантНастройкиПриИзмененииНаСервере();
