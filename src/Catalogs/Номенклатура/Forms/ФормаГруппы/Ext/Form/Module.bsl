...
// Процедура для вывода рекомендуемых наценок для номенклатурной группы
&НаКлиенте
...
КонецПроцедуры // ЗаполнитьНаценки()
// тк-
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//Мальцев А.Ю. +++	
	ПравоИзменения = ИТ_СпециальныйМодульСервер.ПроверитьПравоНаСервере("итРазрешитьОтключатьАвтоВводВыводИзАссортимента");
	Элементы.итОтключитьАвтоВводВыводАссортимент.Доступность = ПравоИзменения;
	//Мальцев А.Ю. ---
...
Процедура СтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	Если ТекущаяСтраница.Имя = "СтраницаНаценки" Тогда
		ЗаполнитьНаценки();
	КонецЕсли;
КонецПроцедуры
