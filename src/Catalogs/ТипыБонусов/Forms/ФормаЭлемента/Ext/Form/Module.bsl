// Модуль формы элемента справочника "Статусы прайс-листов".
...
Процедура УправлениеДиалогомНаСервере()
	...
	Элементы.ВалютаНачисления.Доступность = НЕ Объект.ВВалютеДоговора;
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "ВВалютеДоговора" в контексте сервера.
//
&НаСервере
Процедура ВВалютеДоговораПриИзмененииНаСервере()
	
	Если Объект.ВВалютеДоговора Тогда
		Объект.ВалютаНачисления = Неопределено;
	КонецЕсли;
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "ВВалютеДоговора".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
&НаКлиенте
Процедура ВВалютеДоговораПриИзменении(Элемент)
	
	ВВалютеДоговораПриИзмененииНаСервере();
