// Модуль объекта справочника "Классификатор единиц измерения"
...
Процедура ПередЗаписью(Отказ)
	...
	Если ПустаяСтрока(ЕРПМастерКлюч) И (НЕ ПометкаУдаления) Тогда
		Отказ = Истина;
		ЗаписьЖурналаРегистрации("Запись классификатора единицы измерения", УровеньЖурналаРегистрации.Ошибка, Метаданные.Справочники.КлассификаторЕдиницИзмерения, ЭтотОбъект, "Не заполнен ЕРПМастерКлюч");
	КонецЕсли;
