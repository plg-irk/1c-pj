// Модуль формы списка справочника "Классификатор единиц измерения"
...
Процедура ПодобратьИзКлассификатора(Команда)
	...
	ОткрытьФорму("Справочник.КлассификаторЕдиницИзмерения.Форма.ФормаПодборИзКлассификатора", ПараметрыФормы, ЭтотОбъект);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ОбновитьЕдиницыИзмерения" Тогда
