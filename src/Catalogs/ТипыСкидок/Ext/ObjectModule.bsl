// Модуль объекта справочника "Типы скидок"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если НЕ ЭтотОбъект.ЭтоГруппа Тогда
		Наименование = Справочники.ТипыСкидок.СформироватьНаименованиеПоУмолчанию(ЭтотОбъект);
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ЭтоГруппа Тогда
		Если НЕ ИспользоватьДляФронтОфиса И НЕ ИспользоватьДляБэкОфиса И НЕ ИспользоватьДляТерминалов Тогда
			ВывестиСообщение(НСтр("ru='Для скидки не задано использование.'"), ЭтотОбъект, "ИспользоватьДляФронтОфиса",, Отказ);
		КонецЕсли;
	КонецЕсли;
