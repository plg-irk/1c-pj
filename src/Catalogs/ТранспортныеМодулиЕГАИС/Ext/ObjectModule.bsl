// Модуль объекта справочника "Транспортные модули ЕГАИС"
...
Процедура ПередЗаписью(Отказ)
	...
	Если ОбщийТранспортныйМодуль И ЗначениеЗаполнено(РабочееМесто) Тогда
		РабочееМесто = Справочники.РабочиеМеста.ПустаяСсылка();
	КонецЕсли;
	
	Если ВерсияУТМ<3 ИЛИ ВерсияУТМ>4 Тогда
		ВерсияУТМ = 3;
	КонецЕсли;
