// Модуль формы списка справочника "Транспортные модули ЕГАИС"
...
Процедура ОбновитьПараметрыРабочегоМеста()
	...
	Если ОтборРабочееМесто = Неопределено Тогда
		ОтборРабочееМесто = Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		ОтборРабочееМесто.ЛевоеЗначение = ЛевоеЗначение;
	КонецЕсли;
	
	ЗначениеОтбора = Новый СписокЗначений;
	ЗначениеОтбора.Добавить(ТекущееРабочееМесто);
	ЗначениеОтбора.Добавить(Справочники.РабочиеМеста.ПустаяСсылка());
	
	ОтборРабочееМесто.ВидСравнения   = ВидСравненияКомпоновкиДанных.ВСписке;
	ОтборРабочееМесто.ПравоеЗначение = ЗначениеОтбора;
	ОтборРабочееМесто.Использование  = Истина;
	
	Элементы.ФормаВсеРабочиеМеста.Пометка = Ложь;
...
&НаКлиенте
Процедура ВсеРабочиеМеста(Команда)
	
	Элементы.ФормаВсеРабочиеМеста.Пометка = (НЕ Элементы.ФормаВсеРабочиеМеста.Пометка);
	...
	Если НЕ ОтборРабочееМесто = Неопределено Тогда
		ОтборРабочееМесто.Использование  = (Не Элементы.ФормаВсеРабочиеМеста.Пометка);
	КонецЕсли;
