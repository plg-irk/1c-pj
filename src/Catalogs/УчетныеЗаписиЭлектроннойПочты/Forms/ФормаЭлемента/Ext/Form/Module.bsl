...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если РазрешенияПолучены <> Истина Тогда
		...
		ДанныеУчетнойЗаписи.Вставить("Ссылка");
		ДанныеУчетнойЗаписи.Вставить("ИспользоватьДляОтправки");
		ДанныеУчетнойЗаписи.Вставить("СерверИсходящейПочты");
		ДанныеУчетнойЗаписи.Вставить("ПортСервераИсходящейПочты");
		ДанныеУчетнойЗаписи.Вставить("ИспользоватьДляПолучения");
		ДанныеУчетнойЗаписи.Вставить("ПротоколВходящейПочты");
		ДанныеУчетнойЗаписи.Вставить("СерверВходящейПочты");
		ДанныеУчетнойЗаписи.Вставить("ПортСервераВходящейПочты");
		
		ЗаполнитьЗначенияСвойств(ДанныеУчетнойЗаписи, Объект);
		
		Запрос = СоздатьЗапросНаИспользованиеВнешнихРесурсов(ДанныеУчетнойЗаписи);
		// -РАРУС
...
Функция СоздатьЗапросНаИспользованиеВнешнихРесурсов(УчетнаяЗапись)
	
	Возврат РаботаВБезопасномРежиме.ЗапросНаИспользованиеВнешнихРесурсов(
		Разрешения(УчетнаяЗапись), УчетнаяЗапись);
