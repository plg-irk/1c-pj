...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	|	ЛОЖЬ КАК Пометка,
	// +РАРУС
	|	ВЫРАЗИТЬ(ГруппыДоступа.Описание КАК Строка(1000)) КАК Описание
	// -РАРУС
	|ИЗ
	...
	|				ТОГДА ЛОЖЬ
	// +РАРУС
	|			КОГДА ГруппыДоступаПрофили.Профиль.ПометкаУдаления
	|				ТОГДА ЛОЖЬ
	// -РАРУС
	...
	|									ГДЕ
	// +РАРУС
	|										ПрофилиГруппДоступаНазначение.Ссылка = ГруппыДоступаПрофили.Профиль
	// -РАРУС
	...
	// +РАРУС
	|										И ПрофилиГруппДоступаНазначение.Ссылка = ГруппыДоступаПрофили.Профиль
	// -РАРУС
