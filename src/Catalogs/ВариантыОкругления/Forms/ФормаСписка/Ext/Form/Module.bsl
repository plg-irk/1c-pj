// Модуль формы списка справочника "Должности"
...
Процедура Подключаемый_ОбработкаКомандыФормы(Команда) Экспорт
	...
	// Вызываем общий обработчик события
	Если НЕ УправлениеСпискомСправочникаКлиент.ОбработкаКомандыФормы(ЭтотОбъект, Команда, Элементы.ВариантыОкругления.ТекущиеДанные, ЭтотОбъект.Окно, ПараметрыДействия) Тогда
		Возврат;
	КонецЕсли;
...
//
&НаКлиенте
Процедура ВариантыОкругленияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
...
Процедура СписокПриАктивизацииСтрокиНаСервере()
	...
	// Вызываем общий обработчик события
	УправлениеСпискомСправочникаСервер.СписокПриАктивизацииСтроки(ЭтотОбъект, Элементы.ВариантыОкругления);
...
Процедура Подключаемый_СписокПриАктивизацииСтроки()
	...
	// Вызываем общий обработчик события
	Если НЕ УправлениеСпискомСправочникаКлиент.СписокПриАктивизацииСтроки(ЭтотОбъект, Элементы.ВариантыОкругления, ИСТИНА) Тогда
		Возврат;
	КонецЕсли;
...
//
&НаКлиенте
Процедура ВариантыОкругленияПриАктивизацииСтроки(Элемент)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПриАктивизацииЯчейки(Элемент)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПередНачаломИзменения(Элемент, Отказ)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПослеУдаления(Элемент)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПриСменеТекущегоРодителя(Элемент)
...
//
&НаСервере
Процедура ВариантыОкругленияПриСохраненииПользовательскихНастроекНаСервере(Элемент, Настройки)
...
//
&НаСервере
Процедура ВариантыОкругленияПриЗагрузкеПользовательскихНастроекНаСервере(Элемент, Настройки)
...
//
&НаСервере
Процедура ВариантыОкругленияПриОбновленииСоставаПользовательскихНастроекНаСервере(СтандартнаяОбработка)
...
Процедура ВариантыОкругленияПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПроверкаПеретаскивания(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
...
//
&НаКлиенте
Процедура ВариантыОкругленияПеретаскивание(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
