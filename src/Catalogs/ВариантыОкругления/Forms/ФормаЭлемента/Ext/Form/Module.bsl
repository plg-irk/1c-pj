// Модуль формы элемента справочника "Варианты округления"
...
//
&НаСервере
Процедура ЦенаДляПроверкиПриИзмененииНаСервере(ПараметрыДействия=Неопределено)
	
	// Вызываем обработчик изменения данных объекта
	Результат = Справочники.ВариантыОкругления.ОкруглитьЦену(Объект, ЦенаДляПроверки);
	
	НадписьОкругленнаяЦена = Формат(Результат, "ЧДЦ=2");
	
КонецПроцедуры // ЦенаДляПроверкиПриИзмененииНаСервере()
...
//
&НаКлиенте
Процедура ЦенаДляПроверкиПриИзменении(Элемент)
	
	// Обработаем событие в контексте сервера
	ЦенаДляПроверкиПриИзмененииНаСервере();
	
КонецПроцедуры // ЦенаДляПроверкиПриИзменении()

&НаСервере
Процедура ПравилаОкругленияПередОкончаниемРедактированияНаСервере()
...
&НаКлиенте
Процедура ПравилаОкругленияПередОкончаниемРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования, Отказ)
	ПравилаОкругленияПередОкончаниемРедактированияНаСервере();
КонецПроцедуры
