...
Процедура УправлениеДиалогомНаСервере()
	...
	Если ПустаяСтрока(Объект.SMSТекстСообщенияПроизвольныйКод) Тогда;
...
Процедура ПроизвольнаяТемаПисьмаНаСервере()
	...
	Объект.SMSТекстСообщения = Справочники.ДействияНаЗначимыеСобытия.ОчиститьСодержимоеРедактора("ТекстСообщения");
...
Процедура ПроизвольнаяТемаПисьма(Команда)
	...
	Если ПустаяСтрока(Объект.SMSТекстСообщения) Тогда
	...
	Элементы.ПроизвольнаяТемаПисьма.Пометка = Истина;
	Элементы.ТочнаяТемаПисьма.Пометка = Ложь;
	Объект.SMSТекстСообщенияПроизвольныйКод = Объект.SMSТекстСообщения;
...
Процедура ТочнаяТемаПисьма(Команда)
	...
	Элементы.ПроизвольнаяТемаПисьма.Пометка = Ложь;
	Элементы.ТочнаяТемаПисьма.Пометка = Истина;
	Объект.SMSТекстСообщения = Объект.SMSТекстСообщенияПроизвольныйКод;
...
// Обработчик события возникающего на клиенте при начале выбора данных реквизита "Представление контакта".
//
// Параметры:
//  Элемент              - ПолеФормы - Элемент управления, в котором возникло данное событие.
//  ВыбранноеЗначение    - Выбранное значение.
...
КонецПроцедуры //ПолучателиSMSПредставлениеКонтактаНачалоВыбора()
...
КонецПроцедуры //ПолучателиSMSПредставлениеКонтактаОбработкаВыбора()
