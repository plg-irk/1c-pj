...
Процедура РеквизитыПриАктивизацииСтроки(Элемент)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		Если ТекущиеДанные.ПолучитьЭлементы().Количество() > 0 Тогда
			Элементы.РеквизитыКонтекстноеМенюДобавитьПараметрВТекстСообщения.Доступность = Ложь;
			Элементы.РеквизитыКонтекстноеМенюДобавитьПараметрВТему.Доступность = Ложь;
			Элементы.ДобавитьПараметрВТему.Доступность = Ложь;
			Элементы.РеквизитыДобавитьПараметрВТекстСообщения.Доступность = Ложь;
		...
		Иначе
			Элементы.РеквизитыКонтекстноеМенюДобавитьПараметрВТекстСообщения.Доступность = Истина;
			Элементы.РеквизитыКонтекстноеМенюДобавитьПараметрВТему.Доступность = Истина;
			Элементы.ДобавитьПараметрВТему.Доступность = Истина;
			Элементы.РеквизитыДобавитьПараметрВТекстСообщения.Доступность = Истина;
