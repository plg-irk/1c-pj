// Модуль объекта справочника "Банковские счета"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Наименование = Справочники.БанковскиеСчета.СформироватьНаименованиеПоУмолчанию(ЭтотОбъект);
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	// Копировать БИК не имеет смысла
	ЭтотОбъект.Код = Неопределено;
