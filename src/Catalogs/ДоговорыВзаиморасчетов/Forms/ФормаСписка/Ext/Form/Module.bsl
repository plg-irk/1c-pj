// Модуль формы списка справочника "Договоры взаиморасчетов"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//при подборе из Выписки, зачем-то устанавливается отбор по подразделению, не нашел как отключить TruA
	Для Каждого текЭлемент Из Список.КомпоновщикНастроек.Настройки.Отбор.Элементы Цикл
		Если текЭлемент.ИдентификаторПользовательскойНастройки="ПодразделениеКомпании" Тогда
