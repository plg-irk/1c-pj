// Модуль формы списка справочника "Назначения груза ВЕТИС"
...
//
&НаКлиенте
Процедура ЗагрузитьНазначенияГрузаИзФормыСпискаПродолжение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе		
		...
		ОткрытьФорму("Обработка.МодульОбменаВЕТИС.Форма.ФормаЗагрузкиНазначенийГруза", ПараметрыОткрытия, ДополнительныеПараметры.ФормаСписка,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	КонецЕсли;
	
КонецПроцедуры // ЗагрузитьНазначенияГрузаИзФормыСпискаПродолжение()
...
// Обработчик события возникающего на клиенте при выполнении команды "Подбор назначений груза".
//
// Параметры:
//   Команда   (КомандаФормы)     Команда, которая была вызвана.
//
&НаКлиенте
Процедура ПодборНазначенийГруза(Команда)
	...
	Если НЕ ЗначениеЗаполнено(ХозяйствующийСубъект) Тогда
		...
		Оповещение = Новый ОписаниеОповещения("ЗагрузитьНазначенияГрузаИзФормыСпискаПродолжение", ЭтотОбъект,ДополнительныеПараметры);
	...
	Иначе
		...
		ОткрытьФорму("Обработка.МодульОбменаВЕТИС.Форма.ФормаЗагрузкиНазначенийГруза", ПараметрыОткрытия, ЭтотОбъект,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		
	КонецЕсли;

КонецПроцедуры //ПодборНазначенийГруза();
