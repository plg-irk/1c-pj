// Модуль формы элемента справочника "Объекты сравнения"
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	СписокТоваров.ЗагрузитьЗначения(ТекущийОбъект.Товары.ВыгрузитьКолонку("Номенклатура"));
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Для Каждого СтрокаСписка Из СписокТоваров Цикл
		...
		НоваяСтрока.Номенклатура = СтрокаСписка.Значение;
	КонецЦикла;
	ТекущийОбъект.Товары.Свернуть("Номенклатура");
