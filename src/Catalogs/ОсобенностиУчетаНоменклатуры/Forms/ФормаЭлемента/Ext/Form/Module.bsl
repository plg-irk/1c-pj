// Модуль формы элемента справочника "Особенности учета номенклатуры"
...
Процедура ТоварнаяГруппаПриИзменении(Элемент)
	Если НЕ ЗначениеЗаполнено(Объект.ТоварнаяГруппа) Тогда
		Объект.КодТоварнойГруппы = "";
		Объект.ТоварнаяГруппаСУЗ = "";
		Возврат;
	КонецЕсли;	
...
Процедура УправлениеДиалогомНаСервере()
	...
	Если Объект.Ссылка = Справочники.ОсобенностиУчетаНоменклатуры.ЛегкаяПромышленность
		ИЛИ Объект.Ссылка = Справочники.ОсобенностиУчетаНоменклатуры.ИзделияИзМеха Тогда
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоддерживаемыеТоварныеГруппы = Справочники.ОсобенностиУчетаНоменклатуры.ПоддерживаемыеТоварныеГруппы();
...
&НаКлиенте
Процедура ТоварнаяГруппаОчистка(Элемент, СтандартнаяОбработка)
	ТоварнаяГруппаПриИзменении(Элемент);
КонецПроцедуры
