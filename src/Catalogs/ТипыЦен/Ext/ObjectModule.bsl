// Модуль объекта справочника "Типы цен"
...
Процедура ПередЗаписью(Отказ)
	...
	// Обработка должна быть выполнена перед ОбработкаСобытийСправочникаСервер.ПередЗаписью()
	// так как может произойти очистка обязательного реквизита БазовыйТипЦен.
	Если НЕ ЭтоГруппа Тогда//++siniko
		Справочники.ТипыЦен.БазовыйТипЦенПриИзменении(ЭтотОбъект);
	КонецЕсли;
