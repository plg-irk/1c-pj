...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЦЫ ФОРМЫ "ПРОЦЕНТЫ СКИДКИ/НАЦЕНКИ"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.Заголовок = ?(Параметры.Владелец.Ссылка.Наименование = "","",Параметры.Владелец.Ссылка.Наименование +":")
