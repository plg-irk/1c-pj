// Модуль формы списка справочника "Предприятия ВЕТИС"
...
//
&НаКлиенте
Процедура ЗагрузитьЕдиницыИзмеренияПродолжение(РезультатОповещения, ДополнительныеПараметры) Экспорт
...
КонецПроцедуры // ЗагрузитьЕдиницыИзмеренияПродолжение()
...
Процедура ЗагрузитьДанные(Команда)
	...
	Если НЕ ЗначениеЗаполнено(ХозяйствующийСубъект) Тогда
		...
		Оповещение = Новый ОписаниеОповещения("ЗагрузитьЕдиницыИзмеренияПродолжение", ЭтотОбъект, Новый Структура("ФормаСписка", ЭтотОбъект));
