...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	// +РАРУС Отключаем установку отбора
	//Если Параметры.Отбор.Свойство("ТолькоВарианты") Тогда
	//	Если Параметры.Отбор.ТолькоВарианты Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	Инструкция = СтандартныеПодсистемыСервер.ИнструкцияУсловногоОформления();
	Инструкция.Поля = "ОбъектДоступа";
	Условие = Новый Структура("Вид, Значение", "Равно", Перечисления.ТипыДоступаКВариантуОтчета.БезОграничения);
	Инструкция.Отборы.Вставить("ТипДоступа", Условие);
	Инструкция.Оформление.Вставить("Текст", НСтр("ru = 'Для всех'"));
	СтандартныеПодсистемыСервер.ДобавитьЭлементУсловногоОформления(Список, Инструкция);
