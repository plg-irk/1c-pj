...
Процедура ПередЗаписью(Отказ)
	...
	// +РАРУС
	Если ТипДоступа = Перечисления.ТипыДоступаКВариантуОтчета.ПоПользователю Тогда
	...
	ИначеЕсли ТипДоступа = Перечисления.ТипыДоступаКВариантуОтчета.ПоГруппеПользователей Тогда
		ДопустимыеТипы = Новый ОписаниеТипов("СправочникСсылка.ГруппыПользователей");
		ОбъектДоступа = ДопустимыеТипы.ПривестиЗначение(ОбъектДоступа);
	ИначеЕсли ТипДоступа = Перечисления.ТипыДоступаКВариантуОтчета.ПоПодразделениюКомпании Тогда
