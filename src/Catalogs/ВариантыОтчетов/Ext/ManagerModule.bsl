...
Функция РеквизитыРедактируемыеВГрупповойОбработке() Экспорт
	...
	// +РАРУС
	Результат.Добавить("ВидПериода");
	Результат.Добавить("ТипДоступа");
	Результат.Добавить("ОбъектДоступа");
	// -РАРУС
...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	// Переопределение для целей избранного - вместо карточки с настройками размещения отчета
	// будет открываться его основная форма.
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.Ссылка.ТипОтчета = Перечисления.ТипыОтчетов.Внутренний Тогда
		Представление = Данные.Ссылка.Отчет.Синоним + ": "+ Данные.Наименование;
	ИначеЕсли Данные.Ссылка.ТипОтчета = Перечисления.ТипыОтчетов.Дополнительный Тогда
		Представление = Данные.Наименование;
	Иначе
		Представление = Сред(Данные.Ссылка.Отчет, 14) + ": "+ Данные.Наименование;
	КонецЕсли;
