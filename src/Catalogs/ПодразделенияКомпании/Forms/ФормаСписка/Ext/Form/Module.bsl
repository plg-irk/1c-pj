// Модуль формы списка справочника "Подразделения компании"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыборкаФорматов = Справочники.ФорматыКатегорий.Выбрать();
	
	Элементы.ГруппаПоставки.Видимость = ВыборкаГруппПоставки.Следующий();
	Элементы.ФорматыАссортимента.Видимость = ВыборкаФорматов.Следующий();
