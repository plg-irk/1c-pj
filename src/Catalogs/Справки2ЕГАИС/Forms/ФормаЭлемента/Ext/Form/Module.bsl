// Модуль формы элемента справочника "Справки 1 ЕГАИС"
...
Процедура УправлениеДиалогомНаСервере()
	...
	Элементы.ЗапроситьСправку1.Доступность = ЗначениеЗаполнено(Объект.НомерСправки1);
...
&НаСервере
Функция ПолучитьТранспортныйМодуль()
	...
	Запрос.УстановитьПараметр("ОрганизацияЕГАИС", Объект.Грузополучатель);
...
Процедура ЗапроситьСправку1(Команда)
	...
	ТранспортныйМодуль = ПолучитьТранспортныйМодуль();
	
	ПараметрыЗапроса = Новый Структура("Номер", Объект.НомерСправки1);
