// Модуль формы элемента справочника "Свойства записей складского журнала ВЕТИС"
...
Процедура ПриОткрытии(Отказ)
	...
	ЗащищенныеФункцииКлиент.НастроитьЭлементФормыТабличнойЧасти(ЭтотОбъект, "СопроводительныеДокументы");
