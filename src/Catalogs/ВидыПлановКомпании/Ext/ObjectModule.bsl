// Модуль объекта справочника "Виды планов компании"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если ДанныеЗаполнения <> Неопределено И ТипЗнч(ДанныеЗаполнения)=Тип("СправочникСсылка.ВидыПлановКомпании") И ЗначениеЗаполнено(ДанныеЗаполнения) Тогда
		// будем копировать реквизиты
		ПериодичностьПланирования = ДанныеЗаполнения.ПериодичностьПланирования;
		ВидОбъектаПланирования = ДанныеЗаполнения.ВидАналитикиПланирования1;
