// Модуль формы списка справочника "Транспортные средства ВЕТИС"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьОтборЛичный = Ложь;
	Если Параметры.Отбор.Свойство("Личный") Тогда
		УстановитьОтборЛичный = Истина;
		Параметры.Отбор.Удалить("Личный");
	КонецЕсли;
	...
	Если УстановитьОтборЛичный Тогда
		ОбщегоНаЗначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "Личный", Истина, ВидСравненияКомпоновкиДанных.Равно,,Истина,РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
	КонецЕсли;
