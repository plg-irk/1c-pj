// Модуль объекта справочника "Сценарии планирования"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если НЕ ЭтотОбъект.ЭтоГруппа И НЕ ЗначениеЗаполнено(ЭтотОбъект.Периодичность) Тогда
		ЭтотОбъект.Периодичность = Перечисления.ПериодичностьПланирования.Месяц;
	КонецЕсли;
