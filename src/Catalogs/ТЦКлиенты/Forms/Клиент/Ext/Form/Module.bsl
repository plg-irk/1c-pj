...
&НаКлиенте
// Устанавливает имя исполняемого файла в зависимости от выбранного типа браузера
//
...
// Вариант вызова с кэшированием результата
//
// Параметры:
	...
	Для каждого ОбщийРеквизит Из Метаданные.ОбщиеРеквизиты Цикл
		Если ОбщийРеквизит.РазделениеДанных <> НеИспользовать Тогда
			Если Разделители.Найти(ОбщийРеквизит.Имя, "Имя") = Неопределено Тогда
				СтрокаРазделителя              = Разделители.Добавить();
				СтрокаРазделителя.Используется = Истина;
				СтрокаРазделителя.Имя          = ОбщийРеквизит.Имя;
				СтрокаРазделителя.Значение     = ОбщийРеквизит.Тип.ПривестиЗначение();
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
