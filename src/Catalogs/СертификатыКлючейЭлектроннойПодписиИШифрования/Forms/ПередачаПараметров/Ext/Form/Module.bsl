...
Процедура ОбновитьХранениеФормы(Контекст)
	...
	ПродлитьХранение = ТипЗнч(Контекст.КлиентскиеПараметры) = Тип("Структура")
		...
		И ТипЗнч(Контекст.КлиентскиеПараметры.ОписаниеДанных.КонтекстОперации) = Тип("ФормаКлиентскогоПриложения");
	
	Если ПродлитьХранение Тогда
