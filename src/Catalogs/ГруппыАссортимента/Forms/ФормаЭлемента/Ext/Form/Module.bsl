...
Процедура УправлениеДиалогомНаСервере()
	...
	// Если объект не записан, убираем доступность
	НовыйОбъект = НЕ ЗначениеЗаполнено(Объект.Ссылка);
	Элементы.СодержаниеГруппАссортимента.Видимость = НЕ НовыйОбъект;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		СодержаниеГруппАссортимента.Параметры.УстановитьЗначениеПараметра("ГруппаАссортимента",Объект.Ссылка);
		СодержаниеГруппАссортимента.Параметры.УстановитьЗначениеПараметра("Период",ТекущаяДатаСеанса());
		Возврат;
	КонецЕсли;
