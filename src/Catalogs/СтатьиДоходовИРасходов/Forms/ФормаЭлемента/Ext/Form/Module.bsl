// Модуль формы элемента справочника "Статьи доходов и расходов"
...
Процедура ПриОткрытии(Отказ)
	...
	//Мальцев А.Ю. +++
	ОтобразитьЗакладкуПользователейРазрешения();	
	//Мальцев А.Ю. ---
	...
	// Произведем настройку параметров отображения кнопок командной панели списка Статьи распределения.
	ЗащищенныеФункцииКлиент.НастроитьЭлементФормыТабличнойЧасти(ЭтотОбъект, "СтатьиРаспределения");
...
//Мальцев А.Ю. +++
&НаКлиенте
Процедура итКонтрольИспользованияПриИзменении(Элемент)
	ОтобразитьЗакладкуПользователейРазрешения();	
КонецПроцедуры

&НаКлиенте
Процедура ОтобразитьЗакладкуПользователейРазрешения()
	Элементы.ГруппаПользователиРазрешение.Видимость = Объект.итКонтрольИспользования;	
КонецПроцедуры
//Мальцев А.Ю. ---
