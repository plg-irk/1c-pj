// Модуль формы списка справочника "Единицы измерения"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") И НЕ Параметры.Отбор.Свойство("Владелец") Тогда
		ВывестиСообщение(НСтр("ru='Справочник единиц измерения без указания владельца не имеет смысла. Используйте для открытия единиц справочники ""Номенклатура"" или ""Типы номенклатуры"" .'"),,,,Отказ);
		Возврат;
	КонецЕсли;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "АктивизацияСтрокиНоменклатуры" И Источник = ВладелецФормы Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Владелец", ДанныеВладельца.ВладелецДляОтбора, ВидСравненияКомпоновкиДанных.Равно,, Истина);
