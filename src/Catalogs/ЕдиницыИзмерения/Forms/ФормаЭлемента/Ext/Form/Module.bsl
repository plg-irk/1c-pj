// Модуль формы элемента справочника "Единицы измерения"
...
// Обработчик события возникающего на клиенте при изменении данных реквизита "ЕдиницаПоКлассификатору".
&НаКлиенте
...
КонецПроцедуры // ЕдиницаПоКлассификаторуПриИзменении()
