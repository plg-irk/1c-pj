...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	// +рарус ПометитьНеДействующиеСертификатыВСписке(); // -РАРУС
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	// +Рарус
	ПодключитьОбработчикОжидания("УстановитьВидимостьЭлементовОбработчикОжидания", 0.1, Истина); // -РАРУС
...
&НаКлиенте
Процедура УстановитьВидимостьЭлементовОбработчикОжидания()
