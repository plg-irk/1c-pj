// Модуль формы группы справочника "Карточки"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Справочники.Карточки.ПолучитьВидКарточки(Объект.Родитель)) Тогда
		ВывестиСообщение(НСтр("ru = 'Добавить группу можно только для выбранной предопределенной группы.'"),,,, Отказ);
		Возврат;
	КонецЕсли;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если НЕ ЗначениеЗаполнено(ТекущийОбъект.Родитель) И НЕ ТекущийОбъект.Предопределенный Тогда
		Справочники.Карточки.ПолучитьРодителя(ТекущийОбъект);
	ИначеЕсли ЗначениеЗаполнено(ТекущийОбъект.Родитель) И ТекущийОбъект.Предопределенный И ТекущийОбъект.Родитель = ТекущийОбъект.Ссылка Тогда
