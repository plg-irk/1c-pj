...
Процедура НастроитьИспользованиеКоманд()
	...
	// +РАРУС
	ВидимостьВОграниченномДоступе = ПравоДоступа("Изменение", Метаданные.Справочники.НаборыДополнительныхРеквизитовИСведений);
	Элементы.СвойстваТолькоСоздать  .Видимость = ВидимостьВОграниченномДоступе;
	Элементы.СвойстваПодменюДобавить.Видимость = ВидимостьВОграниченномДоступе;
	// -РАРУС
