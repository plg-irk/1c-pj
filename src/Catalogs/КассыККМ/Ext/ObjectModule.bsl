// Модуль объекта справочника "Кассы ККМ"
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ЭтотОбъект.ПодразделениеКомпании) Тогда
		ЭтотОбъект.ПодразделениеКомпании = ПараметрыСеанса.ПодразделениеКомпании;
		Справочники.КассыККМ.ПодразделениеКомпанииПриИзменении(ЭтотОбъект);
	КонецЕсли;
	Если НЕ ЗначениеЗаполнено(ЭтотОбъект.Организация) Тогда
		ЭтотОбъект.Организация = ПараметрыСеанса.Организация;
		Справочники.КассыККМ.ОрганизацияПриИзменении(ЭтотОбъект);
	КонецЕсли;
