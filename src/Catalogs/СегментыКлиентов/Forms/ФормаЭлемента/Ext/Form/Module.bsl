// Модуль формы элемента справочника "Сегменты клиента"
...
Процедура УправлениеДиалогомНаСервере()
	...
	ТаблицаКлиентов.Загрузить(РегистрыСведений.СегментацияКлиентов.ПолучитьТаблицуКлиентов(Объект.Ссылка));
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	РегистрыСведений.СегментацияКлиентов.ЗаписатьТаблицуКлиентов(ТаблицаКлиентов,Объект.Ссылка);
