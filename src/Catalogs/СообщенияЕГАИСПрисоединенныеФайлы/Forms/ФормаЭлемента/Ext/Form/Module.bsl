// Модуль формы элемента справочника "Присоединенные файлы (Запросы)"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстСообщенияXML = ИнтеграцияГосИС.ТекстСообщенияXMLИзПротокола(Объект.Ссылка);
	ТекстСообщенияXML = ИнтеграцияГосИС.ФорматироватьXMLСПараметрами(ТекстСообщенияXML, ИнтеграцияГосИС.ПараметрыФорматированияXML(Истина, "  "));
	...
	Элементы.ГруппаИнформация.ТолькоПросмотр = Не РежимОтладки;
