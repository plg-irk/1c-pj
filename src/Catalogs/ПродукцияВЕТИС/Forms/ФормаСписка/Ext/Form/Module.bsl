// Модуль формы списка справочника "Продукция ВЕТИС"
...
Процедура Подбор(Команда)
	...
	Если ТекущиеДанные.УровеньВложенности = 4 Тогда
		ТипПродукции = ТекущиеДанные.Родитель;
	Иначе
		ТипПродукции = ТекущиеДанные.Ссылка;
	КонецЕсли;
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	// __Интеграция ВЕТИС
	ИнтеграцияВЕТИСКлиент.ПродукцияФормаСпискаПриАктивизацииСтроки(ЭтаФорма, Элемент);
