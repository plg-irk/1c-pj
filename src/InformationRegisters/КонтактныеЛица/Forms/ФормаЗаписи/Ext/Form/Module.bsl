...
Процедура ВладелецПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Запись.КонтактноеЛицо) И Запись.КонтактноеЛицо = Запись.Владелец Тогда
		...
		ВывестиСообщение(НСтр("ru='Нельзя выбирать в качестве ""Владельца"" контактного лица, само ""Контактное лицо""'"));
	КонецЕсли;
		
КонецПроцедуры // ВладелецПриИзменении()

// Обработчик события возникающего на клиенте при изменении данных реквизита "Контактное лицо".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//
...
Процедура КонтактноеЛицоПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Запись.Владелец) И Запись.КонтактноеЛицо = Запись.Владелец Тогда
		...
		ВывестиСообщение(НСтр("ru='Нельзя выбирать в качестве ""Контактного лица"" владельца, самого ""Владельца""'"));
	КонецЕсли;
