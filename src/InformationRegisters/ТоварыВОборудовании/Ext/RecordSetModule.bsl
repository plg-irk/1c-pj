	...
	Для каждого ЗаписьНабора Из ЭтотОбъект Цикл
		...
		Пока Выборка.Следующий() Цикл
			Если ЗаписьНабора.Номенклатура<>Выборка.Номенклатура Тогда
				ЗаписьНабора.НомерЯчейки = РегистрыСведений.ТоварыВОборудовании.ПолучитьНомерНовойЯчейки(ЗаписьНабора.ГруппаТоваров);
				//Отказ = Истина; 
				//ВывестиСообщение(НСтр("ru = 'Ячейка с номером'") + " " +ЗаписьНабора.НомерЯчейки
