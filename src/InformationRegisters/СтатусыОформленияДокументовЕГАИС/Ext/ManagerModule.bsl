...
Функция ЗначенияПоУмолчанию(Основание, СсылкаНаОформляемыйДокумент) Экспорт
	...
	СтруктураЗначенияПоУмолчанию.Вставить("Организация");
	СтруктураЗначенияПоУмолчанию.Вставить("ПодразделениеКомпании");
	СтруктураЗначенияПоУмолчанию.Вставить("Автор");
