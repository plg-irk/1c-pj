// Модуль формы записи регистра "Кванты поставки"
...
Процедура УправлениеДиалогомНаСервере()
	...
	Элементы.ТорговаяСеть.Доступность	= ЗначениеЗаполнено(Запись.Контрагент);
	Элементы.ГруппаПоставки.Доступность	= ЗначениеЗаполнено(Запись.ТорговаяСеть);
	Элементы.Формат.Доступность			= ЗначениеЗаполнено(Запись.ГруппаПоставки);
	Элементы.Номенклатура.Доступность	= ЗначениеЗаполнено(Запись.Формат);
	Элементы.Количество.Видимость		= (Запись.ВидУпаковки=Перечисления.ВидыУпаковокДляЗаказа.Количество);
...
&НаКлиенте
Процедура ТорговаяСетьПриИзменении(Элемент)
	
	// Обновляем отображение элементов формы
	УправлениеДиалогомНаСервере();
	
КонецПроцедуры //ТорговаяСетьПриИзменении()

&НаКлиенте
Процедура ГруппаПоставкиПриИзменении(Элемент)
	
	// Обновляем отображение элементов формы
	УправлениеДиалогомНаСервере();
	
КонецПроцедуры //ГруппаПоставкиПриИзменении()
...
КонецПроцедуры //ФорматПриИзменении()
...
КонецПроцедуры //ВидУпаковкиПриИзменении()
