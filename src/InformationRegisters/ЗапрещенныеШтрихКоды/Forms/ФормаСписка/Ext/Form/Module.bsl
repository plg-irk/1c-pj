...
Процедура ОбработкаОповещенияНаСервере(ИмяСобытия, ПараметрыДействия)
	...
	Если ПараметрыДействия.Свойство("ШтрихКод")	Тогда
		...
		// Подставим считанный штрихкод и выполним поиск
		Если ПараметрыДействия.ШтрихКод <> "" Тогда 
			
			ЭлементОтбораШтрихкод = Неопределено;
			ПолеКомпоновкиДанных = Новый ПолеКомпоновкиДанных("Штрихкод");
			
			Для каждого ЭлементОтбора Из Список.Отбор.Элементы Цикл
				Если ЭлементОтбора.ЛевоеЗначение = ПолеКомпоновкиДанных Тогда
					ЭлементОтбораШтрихкод = ЭлементОтбора;
					Прервать;
				КонецЕсли;
			КонецЦикла;
			
			Если ЭлементОтбораШтрихкод = Неопределено Тогда
				ЭлементОтбораШтрихкод = Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			КонецЕсли;
			
			ЭлементОтбораШтрихкод.ЛевоеЗначение = ПолеКомпоновкиДанных;
			ЭлементОтбораШтрихкод.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
			ЭлементОтбораШтрихкод.Использование = Истина;
			ЭлементОтбораШтрихкод.ПравоеЗначение = ПараметрыДействия.ШтрихКод;
