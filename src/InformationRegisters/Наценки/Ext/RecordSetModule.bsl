...
Функция УстановитьНаценки() Экспорт
	...
	Пока ВыборкаДанных.Следующий() Цикл
		...
		НоваяЗапись.ТипЦен         = ВыборкаДанных.ТипЦен;
		НоваяЗапись.Номенклатура   = ВыборкаДанных.Номенклатура;
		НоваяЗапись.ПроцентНаценки = ВыборкаДанных.ПроцентНаценки;
		НоваяЗапись.СуммаНаценки   = ВыборкаДанных.СуммаНаценки;
		НоваяЗапись.МинимальнаяНаценка   = ВыборкаДанных.МинимальнаяНаценка;
	КонецЦикла;
