...
Функция ПолучитьСтруктуруХраненияМетаданных()
	...
	Для Каждого ФункциональнаяОпция Из Метаданные.ФункциональныеОпции Цикл
		...
		Если Метаданные.Константы.Содержит(ФункциональнаяОпция.Хранение) И ОписаниеТиповФункциональнойОпции.СодержитТип(Тип("Булево")) Тогда
			Если РазделениеВключено Тогда
				...
				ЕстьРазделение = ОбщегоНазначенияПовтИсп.ЭтоРазделенныйОбъектМетаданных(ПолноеИмяКонстанты, РазделительОсновныхДанных) 
					Или ОбщегоНазначенияПовтИсп.ЭтоРазделенныйОбъектМетаданных(ПолноеИмяКонстанты, РазделительВспомогательныхДанных);
			Иначе
				ЕстьРазделение = Ложь;
			КонецЕсли;
