	...
	Для каждого ИмяКоллекции Из ИменаКоллекций Цикл
		Если ИмяКоллекции = "ТабличныеЧасти"
		 ИЛИ ИмяКоллекции = "СтандартныеТабличныеЧасти" Тогда
			...
			// +РАРУС Пропустим обработку предопределенной табличной части планов счетов. Выполнение приводит к ошибке.
			Если ИмяТипа="ПланСчетов" И ИмяКоллекции="СтандартныеТабличныеЧасти" Тогда
				Продолжить;
			КонецЕсли;
			// -РАРУС
