...
Процедура ОбновитьДанныеРегистра(ГруппыДоступа     = Неопределено,
	...
	|	ГруппыДоступаПрофилиДоступа.Ссылка.ПометкаУдаления КАК ПометкаУдаления
	|ПОМЕСТИТЬ ТаблицаГруппПрофилей
	|ИЗ
	...
	|ИЗ
	|	ТаблицаГруппПрофилей КАК ГруппыДоступа
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ТаблицаГруппПрофилей КАК ГруппыДоступа
