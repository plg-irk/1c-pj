...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если НЕ Отбор.УзелИнформационнойБазы.Значение.Метаданные().Состав.Найти(Метаданные.РегистрыСведений.СоответствияОбъектовИнформационныхБаз) = Неопределено Тогда
