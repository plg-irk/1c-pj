...
&НаКлиенте
Процедура ОбработкаРезультатаВопросаОЗаполненииПоУмолчанию(ОтветНаВопрос, ДополнительныеПараметры=Неопределено) Экспорт
...
Процедура УстановитьЗначенияПоУмолчанию(Команда)
	...
	ОбработчикВопроса = Новый ОписаниеОповещения("ОбработкаРезультатаВопросаОЗаполненииПоУмолчанию", ЭтотОбъект);
	ТекстВопроса = НСтр("ru = 'Внимание! Шаблоны префиксов ВСЕХ объектов будут установлены в значения по умолчанию! Продолжить?'");
...
// Обработчик события возникающего на сервере при выполнении команды "По умолчанию".
//
// Параметры:
//  Команда - КомандаФормы - Команда, в которой возникло данное событие.
//
...
КонецПроцедуры //УстановитьЗначенияПоУмолчаниюНаСервере()

// Обработчик события возникающего на клиенте при выполнении команды "Синхронизировать с конфигурацией".
//
// Параметры:
//  Команда - КомандаФормы - Команда, в которой возникло данное событие.
//
...
КонецПроцедуры //СинхронизироватьСКонфигурацией()

// Обработчик события возникающего на сервере при выполнении команды "Синхронизировать с конфигурацией".
//
// Параметры:
//  Команда - КомандаФормы - Команда, в которой возникло данное событие.
//
...
КонецПроцедуры //СинхронизироватьСКонфигурациейНаСервере()
