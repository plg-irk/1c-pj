...
// Возвращает реквизит "Артикул" из номенклатуры при выборе номенклатуры для заполнения поля "Артикул" в форме.
//
...
КонецФункции // ПолучитьАртикулНаСервере(СсылкаНаНоменклатуру)
...
КонецПроцедуры // ОбработкаРезультатаОповещенияВыборНоменклатуры()


////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ЭЛЕМЕНТОВ ФОРМЫ

// Обработчик события возникающего на клиенте при начале выбора 
// значения реквизита "Основная единица измерения".
//
// Параметры:
//  Элемент - ПолеФормы - Элемент управления, в котором возникло данное событие.
//  ДанныеВыбора - СписокЗначений - содержит данные для выбора.
...
Процедура АртикулНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	// Установим параметры формы выбора
...
КонецПроцедуры // АртикулНачалоВыбора()
