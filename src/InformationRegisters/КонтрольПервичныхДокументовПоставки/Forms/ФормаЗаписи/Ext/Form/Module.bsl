// Модуль формы записи регистра "КонтрольПервичныхДокументовПоставки"
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗначенияЗаполнения 	= ПолучитьЗначениеПараметраСтруктуры(Параметры,"ЗначенияЗаполнения", Новый Структура);
	ДокРегистратор 		= ПолучитьЗначениеПараметраСтруктуры(ЗначенияЗаполнения,"Регистратр", Документы.ПоступлениеТоваров.ПустаяСсылка());
	
	Запись.Пользователь 		= ПараметрыСеанса.ТекущийПользователь;
	Запись.ДокументРегистратор 	= ДокРегистратор;
