...
Процедура СписокПриАктивизацииСтрокиНаСервере()
	...
	// Вызываем общий обработчик события
	УправлениеСпискомРегистраСервер.СписокПриАктивизацииСтроки(ЭтотОбъект, Элементы.Список);
...
Процедура Подключаемый_СписокПриАктивизацииСтроки()
	...
	// Вызываем общий обработчик события
	Если НЕ УправлениеСпискомРегистраКлиент.СписокПриАктивизацииСтроки(ЭтотОбъект, Элементы.Список, ИСТИНА) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОбработкаОповещенияНаСервере(ИмяСобытия, ПараметрыДействия)
	...
	Если ПараметрыДействия.Свойство("ШтрихКод")	Тогда
		...
		Если ПараметрыДействия.ШтрихКод <> "" Тогда 
			...
			Отбор.Вставить("Штрихкод", ПараметрыДействия.ШтрихКод);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "АктивизацияСтрокиНоменклатуры" И Источник = ВладелецФормы И СкрытьОбъект Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Объект", Параметр, ВидСравненияКомпоновкиДанных.Равно, "Объект", Истина);
...
Процедура СписокПередУдалением(Элемент, Отказ)
	Отказ = Истина;
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Установлен запрет удаления штрихкодов. Удаление не выполнено.");
КонецПроцедуры
//Мальцев А.Ю.---
