// Модуль формы списка регистра сведений "Параметры номенклатуры"
...
//
&НаСервере
Процедура СписокПриЗагрузкеПользовательскихНастроекНаСервере(Элемент, Настройки, НастройкиИспользуютсяСтандартныеНастройки)
