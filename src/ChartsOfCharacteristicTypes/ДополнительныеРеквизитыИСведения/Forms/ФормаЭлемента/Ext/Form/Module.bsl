...
Процедура ПриОткрытии(Отказ)
	...
	// +РАРУС
	УправлениеДиалогомСправочникаКлиент.ПриОткрытии(ЭтотОбъект, Отказ);
	// -РАРУС
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	// +Рарус
	ПодключитьОбработчикОжидания("УстановитьЗависимостиДополнительныхРеквизитовНаКлиенте", 0.1, Истина);
	// УстановитьЗависимостиДополнительныхРеквизитов();  // -РАРУС
	
КонецПроцедуры

// +рарус
&НаКлиенте
Процедура УстановитьЗависимостиДополнительныхРеквизитовНаКлиенте()
